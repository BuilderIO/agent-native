...
Keep locally generated standalone apps and workspaces installable before the
headless packages are published by overriding their dependencies with local
package artifacts.
