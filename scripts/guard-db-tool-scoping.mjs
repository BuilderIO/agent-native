...
const INTENTIONAL_RAW_DB_DENYLIST = {
  ...
  "plan:contract_evidence": "child rows scoped through plans",
  "plan:contract_events": "child rows scoped through plans",
  "plan:contract_feedback": "child rows scoped through plans",
  "plan:contract_items": "child rows scoped through plans",
  "plan:contract_verifications": "child rows scoped through plans",
