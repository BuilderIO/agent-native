...
| `a2a.queuedLifetimeMaxMs`                     | `A2A_QUEUED_LIFETIME_MAX_MS`                                                                                             | number  | `180000`                                     | Milliseconds a task may stay queued before it is failed as undeliverable.                                                                                                                                                                                 |
| `a2a.processingLifetimeMaxMs`                 | `A2A_PROCESSING_LIFETIME_MAX_MS`                                                                                         | number  | `1800000`                                    | Milliseconds a task may stay in processing before it is failed as overrunning.                                                                                                                                                                            |
