...
| `GIT_DISCOVERY_ACROSS_FILESYSTEM`                                                                                                                                                     | Git's own repository-discovery toggle, honored by `agent-native create` when deciding whether an enclosing repository means it should skip `git init`. |
