...
| `migration.prebuiltOnly`                      | `MIGRATION_ONLY`, `SKIP_BUILD_MIGRATIONS`                                                                                | boolean | `false`                                      | GitHub Actions deployment controls: run the release migration separately or prevent a prebuilt docs artifact from running it again.                                                                                                                       |
