...
| `migration.runningReleaseMigrations`          | `AGENT_NATIVE_RUN_RELEASE_MIGRATIONS`                                                                                    | boolean | `false`                                      | Set only by the production deploy step while it executes migrate:production, so that step can refuse to migrate a local database.                                                                                                                         |
