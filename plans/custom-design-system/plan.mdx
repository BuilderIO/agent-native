...
The repository contains 16 live templates. Each now exposes a typed
`app/design-system.ts` seam and provider wiring; ghost/retired shells are not
treated as active templates. The standard preserves the default visuals when
no custom system is registered.
