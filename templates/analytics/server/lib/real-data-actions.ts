...
export function looksLikeDashboardConstructionRequest(text: string): boolean {
  ...
  const constructionRequestText = lower.replace(
    DASHBOARD_AUTOMATION_NESTED_ACTION_TERMS,
    " automation ",
  );
