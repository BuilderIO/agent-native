...
export default createAgentChatPlugin({
  ...
  extraContext: async (event) => {
    ...
    const sourceGuidance =
      ...
      "The built-in `demo` dashboard source is sample-only. It may be used for demo dashboards and sample panels, but it must never satisfy REAL_DATA_REQUIRED or be cited as real analytics evidence. " +
