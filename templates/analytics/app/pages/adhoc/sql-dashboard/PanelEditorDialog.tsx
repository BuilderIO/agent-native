  ...
  const handleDescribe = () => {
    ...
    send({
      ...
      context:
        ...
        `The \`demo\` source is sample-only and never satisfies REAL_DATA_REQUIRED; use it only when the user explicitly asks for demo/sample dashboards or demo panels. ` +
        ...
        `For demo panels, sql is a fixed-query JSON descriptor such as {"adapter":"prometheus","dataset":"node-exporter","query":"cpu-busy-by-mode","mode":"range","params":{"instance":"{{instance}}"}}. Demo adapters are fixed sample datasets, not arbitrary PromQL or SQL. ` +
