            ...
            <div key={idx} className="space-y-1">
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      dropoff.count === maxDropoff.count ? "font-semibold" : ""
                    }
                  >
                    {dropoff.stage}
                  </span>
              ...
              <div className="relative h-8 rounded-md overflow-hidden bg-muted/30">
                <div
                  ...
                  style={{
                    width: `${(dropoff.count / maxDropoff.count) * 100}%`,
                  }}
                />
              </div>
            </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs">
              ...
              <span className="text-muted-foreground ml-1">
                {maxDropoff.stage} — {maxDropoff.count.toLocaleString()} users (
                {maxDropoff.percentage.toFixed(1)}% of signups)
              </span>
            </div>
          </div>
          <div className="text-xs text-muted-foreground">
            Total signups analyzed:{" "}
            <span className="font-semibold text-foreground">
