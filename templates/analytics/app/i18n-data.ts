...
const enUS = {
  ...
  dataSources: {
    ...
    connect: "Connect",
    manage: "Manage",
    dbtSharedIdentity: "Uses the workspace's shared dbt service identity.",
    dbtConnectedTools: "Connected · {{count}} tools",
...
const analyticsSliceTranslations: {
  ...
  "zh-CN": {
    ...
    dataSources: {
      ...
      connect: "连接",
      manage: "管理",
      dbtSharedIdentity: "使用工作区共享的 dbt 服务身份。",
      dbtConnectedTools: "已连接 · {{count}} 个工具",
  ...
  "es-ES": {
    ...
    dataSources: {
      ...
      manage: "Administrar",
      dbtSharedIdentity:
        "Usa la identidad de servicio dbt compartida del espacio de trabajo.",
      dbtConnectedTools: "Conectado · {{count}} herramientas",
  ...
  "fr-FR": {
    ...
    dataSources: {
      ...
      manage: "Gérer",
      dbtSharedIdentity:
        "Utilise l’identité de service dbt partagée de l’espace de travail.",
      dbtConnectedTools: "Connecté · {{count}} outils",
  ...
  "de-DE": {
    ...
    dataSources: {
      ...
      manage: "Verwalten",
      dbtSharedIdentity:
        "Verwendet die gemeinsame dbt-Serviceidentität des Arbeitsbereichs.",
      dbtConnectedTools: "Verbunden · {{count}} Tools",
  ...
  "ja-JP": {
    ...
    dataSources: {
      ...
      manage: "管理",
      dbtSharedIdentity:
        "ワークスペースで共有される dbt サービス ID を使用します。",
      dbtConnectedTools: "接続済み · {{count}} 個のツール",
  ...
  "ko-KR": {
    ...
    dataSources: {
      ...
      connect: "연결하다",
      manage: "관리",
      dbtSharedIdentity: "워크스페이스의 공유 dbt 서비스 ID를 사용합니다.",
      dbtConnectedTools: "연결됨 · 도구 {{count}}개",
  ...
  "pt-BR": {
    ...
    dataSources: {
      ...
      manage: "Gerenciar",
      dbtSharedIdentity:
        "Usa a identidade de serviço dbt compartilhada do workspace.",
      dbtConnectedTools: "Conectado · {{count}} ferramentas",
      connectedAs: "Conectado como {{viewer}}",
      githubConnected: "GitHub está conectado",
  ...
  "hi-IN": {
    ...
    dataSources: {
      ...
      dbtSharedIdentity: "वर्कस्पेस की साझा dbt सेवा पहचान का उपयोग करता है।",
      dbtConnectedTools: "कनेक्टेड · {{count}} टूल",
  ...
  "ar-SA": {
    ...
    dataSources: {
      ...
      connect: "يتصل",
      manage: "إدارة",
      dbtSharedIdentity: "يستخدم هوية خدمة dbt المشتركة لمساحة العمل.",
      dbtConnectedTools: "متصل · {{count}} أداة",
