...
const enUS = {
  ...
  sqlDashboard: {
    ...
    reportFilterSnapshot: "{{count}} current filters saved with this report",
...
const translatedSessionReplayTranslations = {
  "zh-CN": {
    ...
    sessions: {
      ...
      metadataOnly: "仅事件",
      noSessions: "未找到会话",
      noSessionsDescription: "尝试不同的时间范围或筛选器。",
      backToSessions: "返回会话",
      replayPlayer: "回放播放器",
  ...
  "es-ES": {
    ...
    sessions: {
      ...
      noSessionsDescription: "Prueba otro intervalo o filtro.",
  ...
  "fr-FR": {
    ...
    sessions: {
      ...
      noSessionsDescription: "Essayez une autre période ou un autre filtre.",
  ...
  "de-DE": {
    ...
    sessions: {
      ...
      noSessionsDescription: "Versuche einen anderen Zeitraum oder Filter.",
  ...
  "ja-JP": {
    ...
    sessions: {
      ...
      noSessionsDescription: "別の期間またはフィルターを試してください。",
  ...
  "ko-KR": {
    ...
    sessions: {
      ...
      noSessionsDescription: "다른 기간 또는 필터를 시도하세요.",
  ...
  "pt-BR": {
    ...
    sessions: {
      ...
      noSessionsDescription: "Tente outro período ou filtro.",
  ...
  "hi-IN": {
    ...
    sessions: {
      ...
      noSessionsDescription: "कोई दूसरी अवधि या फ़िल्टर आज़माएँ।",
  ...
  "ar-SA": {
    ...
    sessions: {
      ...
      noSessionsDescription: "جرّب نطاقًا أو عامل تصفية مختلفًا.",
...
const translatedDashboardReportTranslations = {
  "zh-CN": {
    sqlDashboard: {
      ...
      reportTimezone: "时区",
      reportEnabled: "已启用",
      reportFilterSnapshot: "此报告已保存 {{count}} 个当前筛选器",
      reportLastRun: "上次发送",
      reportNextRun: "下次发送",
      reportSendNow: "立即发送",
      reportSending: "正在发送...",
  ...
  "es-ES": {
    sqlDashboard: {
      ...
      reportFilterSnapshot:
        "{{count}} filtros actuales guardados con este informe",
  ...
  "fr-FR": {
    sqlDashboard: {
      ...
      reportFilterSnapshot:
        "{{count}} filtres actuels enregistrés avec ce rapport",
  ...
  "de-DE": {
    sqlDashboard: {
      ...
      reportFilterSnapshot:
        "{{count}} aktuelle Filter mit diesem Bericht gespeichert",
  ...
  "ja-JP": {
    sqlDashboard: {
      ...
      reportEnabled: "有効",
      reportFilterSnapshot:
        "このレポートには現在のフィルター {{count}} 件が保存されています",
      reportLastRun: "前回送信",
      reportNextRun: "次回送信",
      reportSendNow: "今すぐ送信",
      reportSending: "送信中...",
  ...
  "pt-BR": {
    sqlDashboard: {
      ...
      reportFilterSnapshot:
        "{{count}} filtros atuais salvos com este relatório",
  ...
  "hi-IN": {
    sqlDashboard: {
      ...
      reportEnabled: "सक्षम",
      reportFilterSnapshot: "इस रिपोर्ट के साथ {{count}} मौजूदा फ़िल्टर सहेजे गए",
  ...
  "ar-SA": {
    sqlDashboard: {
      ...
      reportEnabled: "مفعل",
      reportFilterSnapshot: "تم حفظ {{count}} عوامل تصفية حالية مع هذا التقرير",
