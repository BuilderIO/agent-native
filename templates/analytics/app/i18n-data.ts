...
const enUS = {
  ...
  dataSources: {
    ...
    reconnect: "Reconnect",
    connect: "Connect",
    dbtSharedIdentity: "Shared workspace service identity",
...
const analyticsSliceTranslations: {
  ...
  "es-ES": {
    ...
    dataSources: {
      ...
      connect: "Conectar",
      dbtSharedIdentity:
        "Identidad de servicio compartida del espacio de trabajo",
  ...
  "fr-FR": {
    ...
    dataSources: {
      ...
      connect: "Connecter",
      dbtSharedIdentity: "Identité de service partagée de l’espace de travail",
  ...
  "de-DE": {
    ...
    dataSources: {
      ...
      connect: "Verbinden",
      dbtSharedIdentity: "Geteilte Arbeitsbereich-Serviceidentität",
  ...
  "ja-JP": {
    ...
    dataSources: {
      ...
      dbtSharedIdentity: "ワークスペース共有サービス ID",
  ...
  "ko-KR": {
    ...
    dataSources: {
      ...
      reconnect: "다시 연결",
      connect: "연결하다",
      dbtSharedIdentity: "워크스페이스 공유 서비스 ID",
  ...
  "pt-BR": {
    ...
    dataSources: {
      ...
      reconnect: "Reconectar",
      connect: "Conectar",
      dbtSharedIdentity: "Identidade de serviço compartilhada do workspace",
  ...
  "hi-IN": {
    ...
    dataSources: {
      ...
      reconnect: "रिकनेक्ट",
      connect: "जोड़ना",
      dbtSharedIdentity: "वर्कस्पेस साझा सेवा पहचान",
  ...
  "ar-SA": {
    ...
    dataSources: {
      ...
      connect: "يتصل",
      dbtSharedIdentity: "هوية خدمة مشتركة لمساحة العمل",
