export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} 件の連続クリック",
    showingSingular: "{{count}} 件のセッション",
    labName: "セッションの絞り込み",
    labDescription: "セッションのフィルターと並べ替えを確認します。",
    allApps: "すべてのアプリ",
    customRange: "カスタム期間",
    fromDate: "開始",
    toDate: "終了",
    ...
    rageClicksFilter: "連続クリック",
    visitors: "訪問者",
    allVisitors: "すべての訪問者",
    internalVisitors: "内部",
    workVisitors: "仕事用メール",
    personalVisitors: "個人用メール",
    hideInternal: "内部を非表示",
    emailDomain: "メールドメイン",
    sortBy: "並べ替え",
    anyDuration: "すべての長さ",
    minDuration: "{{minutes}} 分以上",
    sortNewest: "新しい順",
    sortLongest: "長い順",
    sortErrors: "エラーが多い順",
    sortEvents: "イベントが多い順",
    sortRageClicks: "連続クリックが多い順",
    errorCountSingular: "{{count}} 件のエラー",
    networkErrorCountSingular: "{{count}} 件のネットワークエラー",
    networkErrorCount: "{{count}} 件のネットワークエラー",
    previousPage: "前へ",
    nextPage: "次へ",
