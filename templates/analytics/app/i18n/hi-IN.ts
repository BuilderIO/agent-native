export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} बार-बार क्लिक",
    showingSingular: "{{count}} सत्र",
    labName: "सत्र जाँच",
    labDescription: "सत्र फ़िल्टर और क्रम देखें।",
    allApps: "सभी ऐप",
    ...
    rageClicksFilter: "बार-बार क्लिक",
    visitors: "आगंतुक",
    allVisitors: "सभी आगंतुक",
    internalVisitors: "आंतरिक",
    workVisitors: "कार्य ईमेल",
    personalVisitors: "निजी ईमेल",
    hideInternal: "आंतरिक छिपाएँ",
    emailDomain: "ईमेल डोमेन",
    sortBy: "क्रमबद्ध करें",
    anyDuration: "कोई भी अवधि",
    minDuration: "{{minutes}} मिनट या अधिक",
    sortNewest: "नवीनतम",
    sortLongest: "सबसे लंबे",
    sortErrors: "सर्वाधिक त्रुटियाँ",
    sortEvents: "सर्वाधिक इवेंट",
    sortRageClicks: "सर्वाधिक बार-बार क्लिक",
    errorCountSingular: "{{count}} त्रुटि",
    networkErrorCountSingular: "{{count}} नेटवर्क त्रुटि",
    networkErrorCount: "{{count}} नेटवर्क त्रुटियाँ",
    previousPage: "पिछला",
    nextPage: "अगला",
