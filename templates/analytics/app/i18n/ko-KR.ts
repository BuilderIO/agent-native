export default {
  ...
  sessions: {
    rageClickCountSingular: "반복 클릭 {{count}}회",
    showingSingular: "세션 {{count}}개",
    labName: "세션 분류",
    labDescription: "세션 필터와 정렬을 살펴보세요.",
    allApps: "모든 앱",
    ...
    rageClicksFilter: "반복 클릭",
    visitors: "방문자",
    allVisitors: "모든 방문자",
    internalVisitors: "내부",
    workVisitors: "업무용 이메일",
    personalVisitors: "개인 이메일",
    hideInternal: "내부 숨기기",
    emailDomain: "이메일 도메인",
    sortBy: "정렬 기준",
    anyDuration: "모든 길이",
    minDuration: "{{minutes}}분 이상",
    sortNewest: "최신순",
    sortLongest: "긴 순서",
    sortErrors: "오류 많은 순",
    sortEvents: "이벤트 많은 순",
    sortRageClicks: "반복 클릭 많은 순",
    errorCountSingular: "오류 {{count}}개",
    networkErrorCountSingular: "네트워크 오류 {{count}}개",
    networkErrorCount: "네트워크 오류 {{count}}개",
    previousPage: "이전",
    nextPage: "다음",
