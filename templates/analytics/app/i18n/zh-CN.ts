export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} 次愤怒点击",
    showingSingular: "{{count}} 个会话",
    labName: "会话筛选",
    labDescription: "探索会话筛选和排序。",
    allApps: "所有应用",
    customRange: "自定义日期范围",
    fromDate: "开始",
    toDate: "结束",
    ...
    networkErrors: "网络错误",
    rageClicksFilter: "愤怒点击",
    visitors: "访客",
    allVisitors: "所有访客",
    internalVisitors: "内部",
    workVisitors: "工作邮箱",
    personalVisitors: "个人邮箱",
    hideInternal: "隐藏内部访客",
    emailDomain: "邮箱域名",
    sortBy: "排序方式",
    anyDuration: "任意时长",
    minDuration: "至少 {{minutes}} 分钟",
    sortNewest: "最新",
    sortLongest: "最长",
    sortErrors: "错误最多",
    sortEvents: "事件最多",
    sortRageClicks: "愤怒点击最多",
    errorCountSingular: "{{count}} 个错误",
    networkErrorCountSingular: "{{count}} 个网络错误",
    networkErrorCount: "{{count}} 个网络错误",
    previousPage: "上一页",
    nextPage: "下一页",
