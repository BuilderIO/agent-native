export default {
  ...
  sessions: {
    ...
    rageClicksFilter: "Clics répétés",
    visitors: "Visiteurs",
    allVisitors: "Tous les visiteurs",
    internalVisitors: "Internes",
    workVisitors: "Adresse professionnelle",
    personalVisitors: "Adresse personnelle",
    hideInternal: "Masquer les internes",
    emailDomain: "Domaine de messagerie",
    sortBy: "Trier par",
    anyDuration: "Toute durée",
    minDuration: "{{minutes}} min ou plus",
    sortNewest: "Plus récentes",
    sortLongest: "Plus longues",
    sortErrors: "Plus d'erreurs",
    sortEvents: "Plus d'événements",
    sortRageClicks: "Plus de clics répétés",
    errorCountSingular: "{{count}} erreur",
    networkErrorCountSingular: "{{count}} erreur réseau",
    networkErrorCount: "{{count}} erreurs réseau",
