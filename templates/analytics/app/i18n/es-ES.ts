export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} clic repetido",
    showingSingular: "{{count}} sesión",
    labName: "Clasificación de sesiones",
    labDescription: "Explora los filtros y la ordenación de sesiones.",
    ...
    rageClicksFilter: "Clics repetidos",
    visitors: "Visitantes",
    allVisitors: "Todos los visitantes",
    internalVisitors: "Internos",
    workVisitors: "Correo laboral",
    personalVisitors: "Correo personal",
    hideInternal: "Ocultar internos",
    emailDomain: "Dominio de correo",
    sortBy: "Ordenar por",
    anyDuration: "Cualquier duración",
    minDuration: "{{minutes}} min o más",
    sortNewest: "Más recientes",
    sortLongest: "Más largas",
    sortErrors: "Más errores",
    sortEvents: "Más eventos",
    sortRageClicks: "Más clics repetidos",
    errorCountSingular: "{{count}} error",
    networkErrorCountSingular: "{{count}} error de red",
    networkErrorCount: "{{count}} errores de red",
