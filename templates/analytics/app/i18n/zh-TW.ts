export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} 次憤怒點擊",
    showingSingular: "{{count}} 個工作階段",
    labName: "工作階段篩選",
    labDescription: "探索工作階段篩選與排序。",
    allApps: "所有應用程式",
    customRange: "自訂日期範圍",
    fromDate: "開始",
    toDate: "結束",
    ...
    networkErrors: "網路錯誤",
    rageClicksFilter: "憤怒點擊",
    visitors: "訪客",
    allVisitors: "所有訪客",
    internalVisitors: "內部",
    workVisitors: "工作電子郵件",
    personalVisitors: "個人電子郵件",
    hideInternal: "隱藏內部訪客",
    emailDomain: "電子郵件網域",
    sortBy: "排序方式",
    anyDuration: "不限時長",
    minDuration: "至少 {{minutes}} 分鐘",
    sortNewest: "最新",
    sortLongest: "最長",
    sortErrors: "錯誤最多",
    sortEvents: "事件最多",
    sortRageClicks: "憤怒點擊最多",
    errorCountSingular: "{{count}} 個錯誤",
    networkErrorCountSingular: "{{count}} 個網路錯誤",
    networkErrorCount: "{{count}} 個網路錯誤",
    previousPage: "上一頁",
    nextPage: "下一頁",
