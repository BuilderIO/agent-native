export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} Wutklick",
    showingSingular: "{{count}} Sitzung",
    labName: "Sitzungen prüfen",
    labDescription: "Sitzungsfilter und Sortierung erkunden.",
    allApps: "Alle Apps",
    ...
    rageClicksFilter: "Wutklicks",
    visitors: "Besucher",
    allVisitors: "Alle Besucher",
    internalVisitors: "Intern",
    workVisitors: "Geschäftliche E-Mail",
    personalVisitors: "Private E-Mail",
    hideInternal: "Interne ausblenden",
    emailDomain: "E-Mail-Domain",
    sortBy: "Sortieren nach",
    anyDuration: "Beliebige Dauer",
    minDuration: "{{minutes}} Min. oder länger",
    sortNewest: "Neueste",
    sortLongest: "Längste",
    sortErrors: "Meiste Fehler",
    sortEvents: "Meiste Ereignisse",
    sortRageClicks: "Meiste Wutklicks",
    errorCountSingular: "{{count}} Fehler",
    networkErrorCountSingular: "{{count}} Netzwerkfehler",
    networkErrorCount: "{{count}} Netzwerkfehler",
    previousPage: "Zurück",
    nextPage: "Weiter",
