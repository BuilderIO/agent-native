export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} clique de raiva",
    showingSingular: "{{count}} sessão",
    labName: "Triagem de sessões",
    labDescription: "Explore filtros e ordenação de sessões.",
    ...
    rageClicksFilter: "Cliques de raiva",
    visitors: "Visitantes",
    allVisitors: "Todos os visitantes",
    internalVisitors: "Internos",
    workVisitors: "E-mail de trabalho",
    personalVisitors: "E-mail pessoal",
    hideInternal: "Ocultar internos",
    emailDomain: "Domínio de e-mail",
    sortBy: "Ordenar por",
    anyDuration: "Qualquer duração",
    minDuration: "{{minutes}} min ou mais",
    sortNewest: "Mais recentes",
    sortLongest: "Mais longas",
    sortErrors: "Mais erros",
    sortEvents: "Mais eventos",
    sortRageClicks: "Mais cliques de raiva",
    errorCountSingular: "{{count}} erro",
    networkErrorCountSingular: "{{count}} erro de rede",
    networkErrorCount: "{{count}} erros de rede",
