export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} rage click",
    showingSingular: "{{count}} session",
    labName: "Sessions triage",
    labDescription: "Explore session filters and sorting.",
    allApps: "All apps",
    ...
    rageClicksFilter: "Rage clicks",
    visitors: "Visitors",
    allVisitors: "All visitors",
    internalVisitors: "Internal",
    workVisitors: "Work email",
    personalVisitors: "Personal email",
    hideInternal: "Hide internal",
    emailDomain: "Email domain",
    sortBy: "Sort by",
    anyDuration: "Any duration",
    minDuration: "{{minutes}}m or longer",
    sortNewest: "Newest",
    sortLongest: "Longest",
    sortErrors: "Most errors",
    sortEvents: "Most events",
    sortRageClicks: "Most rage clicks",
    errorCountSingular: "{{count}} error",
    networkErrorCountSingular: "{{count}} network error",
    networkErrorCount: "{{count}} network errors",
