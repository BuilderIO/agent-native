export default {
  ...
  sessions: {
    rageClickCountSingular: "{{count}} نقرة متكررة",
    showingSingular: "{{count}} جلسة",
    labName: "فرز الجلسات",
    labDescription: "استكشف عوامل تصفية الجلسات وترتيبها.",
    ...
    rageClicksFilter: "النقرات المتكررة",
    visitors: "الزوار",
    allVisitors: "كل الزوار",
    internalVisitors: "داخلي",
    workVisitors: "بريد العمل",
    personalVisitors: "البريد الشخصي",
    hideInternal: "إخفاء الداخليين",
    emailDomain: "نطاق البريد الإلكتروني",
    sortBy: "ترتيب حسب",
    anyDuration: "أي مدة",
    minDuration: "{{minutes}} دقيقة أو أكثر",
    sortNewest: "الأحدث",
    sortLongest: "الأطول",
    sortErrors: "الأكثر أخطاء",
    sortEvents: "الأكثر أحداثًا",
    sortRageClicks: "الأكثر نقرات متكررة",
    errorCountSingular: "{{count}} خطأ",
    networkErrorCountSingular: "{{count}} خطأ شبكة",
    networkErrorCount: "{{count}} أخطاء شبكة",
    previousPage: "السابق",
    nextPage: "التالي",
