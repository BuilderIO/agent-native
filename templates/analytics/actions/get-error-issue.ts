...
export default defineAction({
  description:
    "Get one captured error issue with its recent occurrence frequency, parsed/raw stack traces, breadcrumbs, tags/extra, and links to the session replays where the error happened. Use this to triage a specific issue and jump to the replay.",
  schema: z.object({
