      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Let me walk you through the diagnostic logic for identifying a <strong>Signup Form Issue</strong> using the dashboard you're looking at right now.
          </p>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Step-by-Step Process Header */}
          <div>
            <h3 className="font-semibold text-base mb-4">Step-by-Step Diagnostic Process</h3>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="ml-7 space-y-2 text-sm">
              <p>Look at the <strong>Data Quality Check</strong> section (top of dashboard):</p>
              ...
              <p className="text-muted-foreground italic">
                <strong>Why this matters:</strong> If data quality is bad, you can't trust any analysis. This confirms the decline is real, not a tracking bug.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="ml-7 space-y-2 text-sm">
              <p>Look at the <strong>Overall Conversion Trend</strong> chart:</p>
              <div className="bg-background/50 rounded p-3 space-y-1">
                <div className="font-medium">What you'd see:</div>
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Recent 4 Weeks Avg: <strong>2.8%</strong></li>
                  <li>Baseline 4 Weeks Avg: <strong>3.5%</strong></li>
                  <li>Change: <strong className="text-destructive">-0.7%</strong> (-20% decline)</li>
                </ul>
              </div>
              <p className="text-muted-foreground italic">
                <strong>What this tells you:</strong> Yes, conversion is definitely declining. Now we need to find WHERE in the funnel.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="ml-7 space-y-2 text-sm">
              <p>Look at the <strong>Conversion Funnel Analysis</strong> (side-by-side comparison):</p>
              <div className="bg-background/50 rounded p-3">
                <div className="font-medium mb-2">Here's what a SIGNUP FORM ISSUE looks like:</div>
                  ...
                  <table className="w-full text-xs">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="text-center font-semibold">1,400 (2.8%)</td>
                        <td className="text-center font-semibold">1,680 (3.5%)</td>
                        <td className="text-right text-destructive font-semibold">-17% 🚨</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded p-3 mt-3">
                <div className="font-semibold text-orange-900 dark:text-orange-200 mb-2">🎯 The Problem:</div>
                <ul className="list-disc list-inside space-y-1 text-orange-800 dark:text-orange-300 text-sm">
                  ...
                  <li><strong>But signup completion DROPPED -17%</strong></li>
                </ul>
                <p className="mt-3 font-semibold text-orange-900 dark:text-orange-200">
                  → This means users WANT to sign up (they're reaching the form) but something is PREVENTING completion.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <div className="font-semibold mb-3">Possible Causes of Signup Form Issue:</div>
          ...
          <div className="bg-destructive/10 border border-destructive/20 rounded p-4">
            <div className="font-semibold text-destructive mb-2">Business Impact:</div>
            <p className="text-sm text-destructive/90">
              You're losing <strong>ready-to-buy customers at the finish line</strong>. They want your product (proven by reaching the signup page), but the form is blocking them. This is the most expensive type of conversion loss because the hardest part (getting them interested) is already done.
            </p>
          </div>
        </CardContent>
      </Card>
