...
1. **Query actual metrics FIRST** — use Grafana/Prometheus, Cloud Monitoring, Sentry, and Cloud Logging before looking at code. Real data tells you what happened; code only tells you what *could* happen.
