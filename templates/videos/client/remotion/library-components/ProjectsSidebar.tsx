...
export const ProjectsSidebar = createInteractiveComposition<ProjectsSidebarProps>({
  ...
  render: ({ cursorHistory, registerForCursor }, props) => {
    ...
    const nav1 = useInteractiveComponent({
      ...
      zone: { x: x + 13, y: y + paddingTop + 21 + 17 + 11, width: 35, height: 35 },
      cursorHistory,
    ...
    const nav2 = useInteractiveComponent({
      ...
      label: "Navigation 2",
      compositionId: "projects-sidebar",
      zone: { x: x + 18, y: y + paddingTop + 21 + 17 + 11 + 35 + 18, width: 24, height: 24 },
      cursorHistory,
      interactiveElementType: "button",
      hoverAnimation: brightnessHover(0.2),
    });
