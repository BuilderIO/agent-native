...
export const StandardSidebar = createInteractiveComposition<StandardSidebarProps>({
  ...
  render: ({ cursorHistory, registerForCursor }, props) => {
    ...
    const projectsIcon = useInteractiveComponent({
      ...
      zone: { x: x + 18, y: y + paddingTop + 21 + 17 + 16, width: 24, height: 24 },
      cursorHistory,
    ...
    const contentIcon = useInteractiveComponent({
      ...
      label: "Content",
      compositionId: "standard-sidebar",
      zone: { x: x + 18, y: y + paddingTop + 21 + 17 + 16 + 24 + 11, width: 24, height: 24 },
      cursorHistory,
      interactiveElementType: "button",
      hoverAnimation: brightnessHover(0.2),
    });
    ...
    const assetsIcon = useInteractiveComponent({
      ...
      label: "Assets",
      compositionId: "standard-sidebar",
      zone: { x: x + 18, y: y + paddingTop + 21 + 17 + 16 + 24 + 11 + 24 + 19, width: 24, height: 24 },
      cursorHistory,
      interactiveElementType: "button",
      hoverAnimation: brightnessHover(0.2),
    });
