 ...
 */
export const BlankComposition = createInteractiveComposition<BlankCompositionProps>({
        ...
        >
          ...
          {showExamples && (
            <>
              ...
              >
                Hover over the examples below to see them in the Cursor Interactions panel →
              </p>
              ...
              <div style={{ position: "absolute", top: 600, left: 460, display: "flex", gap: 40 }}>
                <InteractiveCard
                  id="example-card-1"
                  compositionId="blank"
