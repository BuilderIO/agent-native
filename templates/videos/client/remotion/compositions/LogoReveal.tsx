...
export const LogoReveal: React.FC<LogoRevealProps> = ({
  ...
  const radiusFromPct = parseFloat(
    particleTrack.animatedProps?.find((a) => a.property === "radius")?.from ??
      "0",
  );
  const radiusToPct = parseFloat(
    particleTrack.animatedProps?.find((a) => a.property === "radius")?.to ??
      "35",
  );
  ...
  const opFrom = parseFloat(
    particleTrack.animatedProps?.find((a) => a.property === "opacity")?.from ??
      "1",
  );
  const opTo = parseFloat(
    particleTrack.animatedProps?.find((a) => a.property === "opacity")?.to ??
      "0",
  );
