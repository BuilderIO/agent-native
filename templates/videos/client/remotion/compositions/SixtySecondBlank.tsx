  ...
  },
  {
    ...
    animatedProps: [
      { property: "y", from: "30", to: "0", unit: "px", keyframes: [] },
      {
        ...
        to: "1",
        unit: "",
        keyframes: [{ frame: 234, value: "1", easing: "linear" }],
      },
    ],
  },
  {
 ...
 */
export const SixtySecondBlank =
  createInteractiveComposition<SixtySecondBlankProps>({
 ...
 */
const Scene1Announcing: React.FC<{
  accentColor: string;
 ...
 */
const Scene2Blank: React.FC<{
  accentColor: string;
  backgroundColor: string;
  tracks: AnimationTrack[];
}> = ({ accentColor, backgroundColor, tracks }) => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  ...
  const claudeOpacity = getPropValue(
    claudeProgress,
    claudeTrack,
    "opacity",
    1,
  ...
  const jiraSidebarOpacity = getPropValue(
    jiraSidebarProgress,
    jiraSidebarTrack,
    "opacity",
    1,
  ...
  const worksTextOpacity = getPropValue(
    worksTextProgress,
    worksTextTrack,
    "opacity",
    0,
  ...
  const whereYouTextTrack = findTrack(
    tracks,
    "where-you-text",
    FALLBACK_TRACKS[7],
  );
  const whereYouTextProgress = trackProgress(
    globalFrame,
    fps,
    whereYouTextTrack,
  );
  const whereYouTextY = getPropValue(
    whereYouTextProgress,
    whereYouTextTrack,
    "y",
    30,
    0,
  );
  const whereYouTextOpacity = getPropValue(
    whereYouTextProgress,
    whereYouTextTrack,
    "opacity",
    0,
  ...
  const workTextOpacity = getPropValue(
    workTextProgress,
    workTextTrack,
    "opacity",
    0,
            ...
            <>
              ...
              <div
                style={{
                  ...
                  top: leftCursorY + 58,
                  opacity:
                    globalFrame >= 170 ? 0 : claudeOpacity * fadeOutOpacity,
                }}
              >
                <svg
                  height="64"
            ...
            <>
              ...
              <div
                style={{
                  ...
                  top: rightCursorY + 58,
                  opacity:
                    globalFrame >= 170 ? 0 : codexOpacity * fadeOutOpacity,
                }}
              >
                <svg
                  height="64"
 ...
 */
const Scene3TeamCollaboration: React.FC<{
  accentColor: string;
  backgroundColor: string;
  tracks: AnimationTrack[];
}> = ({ accentColor, backgroundColor, tracks }) => {
  ...
  const secondAvatarTrack = findTrack(
    tracks,
    "second-avatar",
    FALLBACK_TRACKS[10],
  );
  const secondAvatarProgress = trackProgress(
    globalFrame,
    fps,
    secondAvatarTrack,
  );
  const secondAvatarX = getPropValue(
    secondAvatarProgress,
    secondAvatarTrack,
    "x",
    -75,
    0,
  );
  const secondAvatarOpacity = getPropValue(
    secondAvatarProgress,
    secondAvatarTrack,
    "opacity",
    0,
  ...
  const thirdAvatarOpacity = getPropValue(
    thirdAvatarProgress,
    thirdAvatarTrack,
    "opacity",
    0,
  ...
  const fourthAvatarTrack = findTrack(
    tracks,
    "fourth-avatar",
    FALLBACK_TRACKS[12],
  );
  const fourthAvatarProgress = trackProgress(
    globalFrame,
    fps,
    fourthAvatarTrack,
  );
  const fourthAvatarX = getPropValue(
    fourthAvatarProgress,
    fourthAvatarTrack,
    "x",
    -75,
    0,
  );
  const fourthAvatarOpacity = getPropValue(
    fourthAvatarProgress,
    fourthAvatarTrack,
    "opacity",
    0,
