/**
 * ═══════════════════════════════════════════════════════════════════════════
 * BRANCHES LAYOUT ORGANISM
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Complete branches layout combining the StandardSidebar with the BranchesScreen.
 * Demonstrates the full Builder.io branches Kanban interface layout.
 *
 * Features:
 * - StandardSidebar navigation on the left (61px width)
 * - BranchesScreen main content area
...
export type BranchesLayoutProps = {
  x?: number;
  y?: number;
  width?: number;
  height?: number;
...
export const BranchesLayout: React.FC<BranchesLayoutProps> = (props) => {
  const {
    x = 0,
    y = 0,
    width = 1920,
