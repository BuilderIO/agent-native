...
export default runMigrations([
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sql: `CREATE TABLE IF NOT EXISTS spaces (
      ...
      icon_emoji TEXT,
      is_all_company INTEGER NOT NULL DEFAULT 0,
      created_at TEXT NOT NULL DEFAULT (datetime('now'))
    )`,
  },
  {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sql: `CREATE TABLE IF NOT EXISTS recordings (
      ...
      enable_reactions INTEGER NOT NULL DEFAULT 1,
      enable_downloads INTEGER NOT NULL DEFAULT 1,
      default_speed TEXT NOT NULL DEFAULT '1.2',
      animated_thumbnail_enabled INTEGER NOT NULL DEFAULT 1,
      created_at TEXT NOT NULL DEFAULT (datetime('now')),
      updated_at TEXT NOT NULL DEFAULT (datetime('now')),
      archived_at TEXT,
      trashed_at TEXT,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sql: `CREATE TABLE IF NOT EXISTS recording_viewers (
      ...
      counted_view INTEGER NOT NULL DEFAULT 0,
