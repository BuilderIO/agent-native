/**
 * Aggregate analytics across an entire workspace.
 *
 * Produces:
 ...
 *   pnpm action get-workspace-insights --workspaceId=<id> --days=14
 */
...
export default defineAction({
  description:
    "Workspace-wide insights for the Insights Hub. Returns totals for the period, top videos by views / reactions / comments, top creators, and a day-by-day engagement trend time series. Default period is the last 30 days.",
  schema: z.object({
    workspaceId: z
      .string()
      .optional()
      .describe(
        "Workspace id — falls back to current-workspace application state when omitted.",
      ),
  ...
  run: async (args) => {
    ...
    // All recordings in this workspace. Filter engagement down to this set.
