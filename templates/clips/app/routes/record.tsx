...
export default function RecordRoute() {
  ...
  return (
    <div className="relative min-h-screen bg-background">
      <InvitationBanner className="absolute left-0 right-0 top-0 z-20" />
      {showBackButton && (
        <button
          type="button"
      ...
      {/* Idle / pre-record panel. Org setup is handled by the framework's
          auto-create / auto-join path before recording actions run. */}
      {uiState === "idle" && (
