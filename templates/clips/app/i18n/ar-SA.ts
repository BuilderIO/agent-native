const messages = {
  ...
  screenshot: {
    ...
    editConfirm: "يستبدل الحفظ الصورة المشتركة ليرى الجميع هذه العلامات. يمكنك نقلها أو إزالتها لاحقًا. هل تريد الحفظ؟",
    ...
    backgroundNone: "بلا",
    notYetBurned: "وُضعت {{count}} من مناطق الإخفاء لكنها لم تُثبَّت بعد. لم يُخفَ شيء حتى الآن، ولا يمكن لأحد غيرك رؤية لقطة الشاشة هذه حتى تثبّتها.",
    ...
    burnInWarning: "ستُتلف المناطق المغطاة في نسخة جديدة من لقطة الشاشة، وسيُحذف الملف الأصلي. لا يمكن التراجع عن ذلك. تبقى المربعات والأسهم والنصوص قابلة للنقل. أي نسخة نُزّلت مسبقًا تحتفظ بما فيها.",
    burning: "جارٍ التثبيت…",
