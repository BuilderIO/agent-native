const messages = {
  ...
  recordingPage: {
    ...
    aiSummarySent: "الملخص في طريقه إلى بريدك الوارد",
    aiSummaryAlreadySent: "تم إرساله بالفعل إلى بريدك الوارد",
    aiSummaryFailed: "تعذر إرسال الملخص — حاول مرة أخرى من بريد المشاركة",
    share: "مشاركة",
