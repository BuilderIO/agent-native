const messages = {
  ...
  recordingPage: {
    ...
    processingStuck:
      "لا يزال العمل جاريًا — هذا المقطع في حالة {{status}} منذ فترة. قد تستغرق التسجيلات الطويلة عدة دقائق للضغط والتحميل، ويتم تحديث هذه الصفحة تلقائيًا. إذا لم يتغير شيء لفترة طويلة جدًا، فتحقق من سجلات الخادم بحثًا عن رسائل التجزئة/الإنهاء.",
    uploadingAssembling:
    ...
    uploadStalled:
      "لم يكتمل هذا الرفع. إذا سجّلت باستخدام تطبيق سطح المكتب، فالنسخة المحلية ما زالت آمنة — أعد المحاولة أو صدّرها من أيقونة شريط القوائم. وإلا فسجّل من جديد.",
    recordAgain: "تسجيل من جديد",
  ...
  sharePage: {
    ...
    uploadNotCompleteSession:
      "يستغرق التحميل وقتًا أطول من المعتاد. قد تحتاج التسجيلات الطويلة إلى عدة دقائق — ويتم تحديث هذه الصفحة تلقائيًا. يمكنك أيضًا فتح لوحة التحكم لهذا المقطع أو الطلب من منشئ المحتوى التحقق من مساحة التخزين.",
    uploadNotCompleteSignIn:
      "يستغرق التحميل وقتًا أطول من المعتاد. قد تحتاج التسجيلات الطويلة إلى عدة دقائق — ويتم تحديث هذه الصفحة تلقائيًا. إذا كان هذا هو المقطع الخاص بك، فقم بتسجيل الدخول لفتح عناصر تحكم المالك والتحقق من مساحة التخزين.",
...
- يمكنك الآن رؤية الجديد مباشرة داخل Clips. أصبح سجل التغييرات متاحًا في قائمة الأوامر (Cmd+K) وفي الإعدادات.`,
    ...
    backupTranscription: "النسخ الاحتياطي السحابي للتفريغ",
  ...
  editVersions: {
    history: "سجل التحرير",
    historyTitle: "إصدارات التحرير",
    historyDescription:
      "جميع نسخ المونتاج المقترحة والمقبولة والمرفوضة والمستبدلة لهذا التسجيل.",
    historyEmpty: "لا توجد إصدارات تحرير بعد",
    preview: "معاينة المونتاج",
    previewing: "معاينة: {{title}}",
    previewFailed: "تعذّر تحميل المعاينة",
    exitPreview: "إنهاء المعاينة",
    restore: "استعادة",
    restored: "تمت استعادة الإصدار — تمت أرشفة التعديلات السابقة",
    restoreFailed: "فشلت الاستعادة",
  ...
  editorToolbar: {
    ...
    cutStartToTime: "قص البداية ← {{time}}",
    cutTimeToEnd: "قص {{time}} ← النهاية",
  ...
  dictateRoute: {
    ...
    browserDictationDescriptionDesktop:
      "استخدم الزر أدناه لالتقاط ملاحظة هنا في هذه الصفحة مباشرة. لا يتم اللصق في تطبيقات أخرى — لذلك استخدم اختصار سطح المكتب.",
    quickNoteTitle: "ملاحظة إملاء سريعة",
    quickNoteHint:
      "يلتقط هنا دون مغادرة هذه الصفحة — لا يلصق في تطبيقات أخرى. استخدم الزر للبدء والإيقاف.",
    ...
    dictionaryDescription:
      "توجّه هذه المصطلحات التعرف على الكلام نحو الهجاء الذي تفضّله — تُتعلّم تلقائيًا من تصحيحاتك، أو أضف مصطلحاتك.",
    dictionaryTermPlaceholder: "المصطلح",
    dictionaryReplacementPlaceholder: "البديل (اختياري)",
    dictionaryAdd: "إضافة",
    dictionaryLoading: "جارٍ تحميل القاموس…",
    dictionaryEmpty: "لا توجد مصطلحات متعلَّمة بعد.",
  ...
  meetingsRoute: {
    ...
    howToTriggerTitle: "كيفية بدء ملاحظات الاجتماع",
    howToTriggerDescription:
      "ملاحظات الاجتماع هي تدفق Clips بأسلوب Granola: تظهر أحداث التقويم هنا، ويلتقط تطبيق سطح المكتب الميكروفون وصوت النظام، ويعود النص المفرّغ مع ملاحظات الذكاء الاصطناعي إلى هذا السجل.",
    guideCalendarTitle: "اربط Google Calendar",
    guideCalendarDescription: "تُجلب الاجتماعات من تقويمك ليعرف Clips متى يذكّرك.",
    guideDesktopTitle: "أبقِ Clips Desktop مفتوحًا",
    guideDesktopDescription:
      "التقاط سطح المكتب مطلوب لتفريغ الميكروفون مع صوت النظام.",
    guideStartTitle: "انقر بدء الملاحظات",
    guideStartDescription:
      "استخدم تذكير سطح المكتب أو عنصر «بدء ملاحظات الاجتماع» في شريط القوائم عند بدء المكالمة.",
  },
  videoProjects: {
    listPageTitle: "مشاريع الفيديو · Clips",
    editorPageTitle: "مشروع فيديو · Clips",
    title: "مشاريع الفيديو",
    intro:
      "تراكيب متعددة المسارات تجمع بين التسجيلات ولقطات B-roll والترجمات والنصوص في المحرر الكامل.",
    newProject: "مشروع جديد",
    emptyTitle: "لا توجد مشاريع فيديو بعد",
    emptyDescription:
      'أنشئ مشروعًا، أو افتح أي تسجيل واختر "مشروع فيديو" لاستخدامه كمصدر.',
    sourceCount_zero: "{{count}} مقطع",
    sourceCount_one: "{{count}} مقطع",
    sourceCount_two: "{{count}} مقطعان",
    sourceCount_few: "{{count}} مقاطع",
    sourceCount_many: "{{count}} مقطعًا",
    sourceCount_other: "{{count}} مقطع",
    projectOptions: "خيارات المشروع",
    moveToTrash: "نقل إلى المهملات",
    deleteTitle: "نقل المشروع إلى المهملات؟",
    deleteDescription:
      'سيتم نقل "{{title}}" إلى المهملات. لن تتأثر التسجيلات المستخدمة فيه.',
    deleteFailed: "تعذر حذف المشروع",
    createFailed: "تعذر إنشاء المشروع",
    openInProject: "فتح في مشروع فيديو",
    openInProjectButton: "مشروع فيديو",
    openInProjectDescription:
      "أضف هذا التسجيل كمصدر في مشروع فيديو متعدد المسارات.",
    respectEdits: "تطبيق عمليات القص التي أجريتها في محرر المقاطع",
    includeCaptions: "إضافة النص المفرّغ كترجمات",
    createAndOpen: "إنشاء المشروع",
    addAndOpen: "إضافة إلى المشروع",
    addFailed: "تعذرت الإضافة إلى المشروع",
    cancel: "إلغاء",
    back: "رجوع",
    backToLibrary: "العودة إلى المكتبة",
    saving: "جارٍ الحفظ…",
