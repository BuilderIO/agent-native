...
- Clips 内で最新情報を直接確認できるようになりました。変更履歴はコマンドメニュー（Cmd+K）と設定にあります。`,
    ...
    s3UrlInvalid: "有効な URL を入力してください（例: https://s3.us-east-1.amazonaws.com）",
    s3BucketInvalid: "バケット名は 3〜63 文字の小文字、数字、またはハイフンで指定してください",
    s3RegionInvalid: "有効なリージョン（例: us-east-1）または \"auto\" を入力してください",
    apiSetup: "AI 設定",
    apiSetupDescription:
