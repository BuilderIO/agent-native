const messages = {
  ...
  recordingPage: {
    ...
    processingStuck:
      "処理は継続中です — このクリップはしばらく {{status}} の状態が続いています。長い録画は圧縮とアップロードに数分かかることがあり、このページは自動的に更新されます。非常に長い時間何も変わらない場合は、サーバー ログでチャンク/ファイナライズ メッセージを確認してください。",
    uploadingAssembling:
    ...
    uploadStalled:
      "このアップロードは完了しませんでした。デスクトップアプリで録画した場合、ローカルのコピーは無事です。メニューバーのアイコンから再試行または書き出してください。それ以外の場合はもう一度録画してください。",
    recordAgain: "もう一度録画",
  ...
  sharePage: {
    ...
    uploadNotCompleteSession:
      "アップロードに通常より時間がかかっています。長い録画には数分かかることがあり、このページは自動的に更新されます。このクリップのダッシュボードを開くか、作成者にストレージを確認するよう依頼することもできます。",
    uploadNotCompleteSignIn:
      "アップロードに通常より時間がかかっています。長い録画には数分かかることがあり、このページは自動的に更新されます。これが自分のクリップである場合は、サインインしてオーナー コントロールを開き、ストレージを確認してください。",
...
- Clips 内で最新情報を直接確認できるようになりました。変更履歴はコマンドメニュー（Cmd+K）と設定にあります。`,
  ...
  editVersions: {
    history: "編集履歴",
    historyTitle: "編集バージョン",
    historyDescription:
      "この録画の提案済み・承認済み・却下済み・置き換え済みのカットの一覧です。",
    historyEmpty: "編集バージョンはまだありません",
    preview: "カットをプレビュー",
    previewing: "プレビュー中: {{title}}",
    previewFailed: "プレビューを読み込めませんでした",
    exitPreview: "プレビューを終了",
    restore: "復元",
    restored: "バージョンを復元しました — 以前の編集はアーカイブされました",
    restoreFailed: "復元に失敗しました",
    statusProposed: "提案中",
    statusAccepted: "承認済み",
    statusRejected: "却下",
    ...
    accept: "バージョンを承認",
    reject: "却下",
    accepted: "バージョンを適用しました（以前の編集はアーカイブ済み）",
    rejected: "バージョンを却下しました",
    reviewFailed: "レビューに失敗しました",
    pendingFrom: "{{author}} が提案したカットがレビュー待ちです",
    editor: "エディター",
  },
  editorToolbar: {
    selectionSegment: "セグメント",
    selectionRange: "選択範囲",
