const messages = {
  ...
  shareDialog: {
    ...
    redactionsPendingBody:
      "この録画には {{count}} 件のマスクが描かれていますが、まだ焼き込まれていません。そのためファイルにはその下がすべて残っています。エディタを開いて焼き込むと、共有が再び利用できます。",
  ...
  screenshot: {
    ...
    editConfirm: "保存すると共有中の画像が置き換わり、全員にこれらの書き込みが表示されます。後から移動や削除もできます。保存しますか？",
    ...
    crop: "切り抜き",
    cropApply: "切り抜きを適用",
    cropApplyHint: "この部分だけを表示します。残りは保持されるので、後から広く切り抜き直せます",
    cropReset: "画像全体を表示",
    kind: {
      box: "枠",
      arrow: "矢印",
    ...
    backgroundNone: "なし",
    notYetBurned: "{{count}} 件のマスクが配置されていますが、まだ焼き込まれていません。まだ何も隠されておらず、焼き込むまで他の人はこのスクリーンショットを見られません。",
    burnInHint: "マスクで覆った部分を完全に消去し、元の画像を削除します",
    burnInTitle: "このスクリーンショットに {{count}} 件のマスクを焼き込みますか？",
    burnInWarning: "覆われた部分はスクリーンショットの新しいコピーで消去され、元のファイルは削除されます。元に戻すことはできません。枠、矢印、テキストは引き続き移動できます。すでにダウンロードされたものはそのまま残ります。",
    burning: "焼き込み中…",
    burned: "マスクを焼き込みました",
    burnFailed: "マスクを焼き込めませんでした",
  },
