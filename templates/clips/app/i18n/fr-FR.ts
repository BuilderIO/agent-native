...
- Vous pouvez maintenant voir les nouveautés directement dans Clips. Le journal des modifications est disponible dans le menu de commandes (Cmd+K) et dans les paramètres.`,
  ...
  captureInstall: {
    title: "Choisissez votre enregistreur",
    description:
      "Utilisez Chrome lorsque vous avez besoin des journaux du navigateur, ou l’application de bureau pour la capture quotidienne la plus fluide.",
    chromeTitle: "Extension Chrome",
    chromeDescription:
      "Idéale lorsque vous voulez des diagnostics expurgés de la console et du réseau depuis l’onglet du navigateur.",
    chromePendingDescription:
      "L’option journaux du navigateur est prête, en attente de l’URL du Chrome Web Store.",
    desktopTitle: "Application de bureau",
    desktopDescription:
      "La plus fluide pour les raccourcis globaux, l’enregistrement depuis la barre de menus, les réunions et les captures répétées.",
  },
  editableTitle: {
    untitled: "Clip sans titre",
    renameFailed: "Impossible de renommer le clip",
    emptyTitle: "Le titre ne peut pas être vide",
    generatingTitle: "Génération du titre",
    placeholder: "Titre du clip",
    editLabel: "Modifier le titre du clip",
  },
  chapters: {
    title: "Chapitres",
    addHere: "Ajouter ici",
    empty: "Aucun chapitre pour le moment.",
  ...
  editVersions: {
    ...
    historyTitle: "Versions de montage",
    historyDescription:
      "Tous les montages proposés, acceptés, refusés et remplacés de cet enregistrement.",
    historyEmpty: "Aucune version de montage pour l'instant",
    preview: "Prévisualiser le montage",
    previewing: "Prévisualisation : {{title}}",
    previewFailed: "Impossible de charger la prévisualisation",
    exitPreview: "Quitter la prévisualisation",
    restore: "Restaurer",
    restored: "Version restaurée — modifications précédentes archivées",
    restoreFailed: "Échec de la restauration",
  ...
  editorToolbar: {
    ...
    cutStartToTime: "Couper début → {{time}}",
    cutTimeToEnd: "Couper {{time}} → fin",
    undoTooltip: "Annuler (Cmd/Ctrl+Z)",
    playPauseTooltip: "Lecture / Pause (Espace)",
    sourceDuration: "({{duration}} source)",
    previewSpeed: "Vitesse d’aperçu",
    previewSpeedTooltip: "Vitesse d’aperçu pendant le découpage",
    cutSelectedRange: "Couper la plage sélectionnée",
    edit: "Modifier",
    playheadEdits: "Modifications à la tête de lecture",
    splitAtPlayhead: "Couper à la tête de lecture",
    cutBeforePlayhead: "Couper avant la tête de lecture",
    cutAfterPlayhead: "Couper après la tête de lecture",
    panels: "Panneaux",
    hideChapters: "Masquer les chapitres",
    showChapters: "Afficher les chapitres",
    thumbnail: "Miniature",
    stitchClips: "Assembler des clips",
    zoom: "Zoom",
    zoomOut: "Zoom arrière",
    fitToWidth: "Ajuster à la largeur",
    zoomIn: "Zoom avant",
    clearAllEdits: "Effacer toutes les modifications",
    loadingFfmpeg: "Chargement de ffmpeg…",
    exportMp4: "Exporter en MP4",
    longExportTitle: "Cet export est long",
    longExportDescription:
      "La vidéo montée dure {{duration}}. ffmpeg.wasm s’exécute dans votre navigateur et peut manquer de mémoire pour les exports très longs. Vous pouvez quand même essayer, ou télécharger le fichier original à la place.",
    downloadOriginal: "Télécharger l’original",
    exportAnyway: "Exporter quand même",
    clearAllEditsTitle: "Effacer toutes les modifications ?",
    clearAllEditsDescription:
      "Cela supprime tous les découpages, les flous et la miniature personnalisée de cet enregistrement. La vidéo originale n’est jamais modifiée.",
    clearEdits: "Effacer les modifications",
    nothingToUndo: "Rien à annuler",
    undoFailed: "Échec de l’annulation",
    editsCleared: "Modifications effacées",
    clearFailed: "Échec de l’effacement",
    selectRangeFirst:
      "Sélectionnez d’abord une plage sur la forme d’onde ou la transcription",
    selectionCut: "Sélection coupée",
    trimFailed: "Échec du découpage",
    movePlayheadPastIntro:
      "Déplacez la tête de lecture après l’intro que vous voulez couper",
    startCut: "Couper le début",
    movePlayheadBeforeEnding:
      "Déplacez la tête de lecture avant la fin que vous voulez couper",
    endCut: "Couper la fin",
    splitAdded: "Coupe ajoutée",
    splitFailed: "Échec de la coupe",
    videoNotReady: "Vidéo pas encore prête",
    exportedMp4: "MP4 exporté",
    exportFailed:
      "Échec de l’export — ffmpeg.wasm ne gère pas toujours les vidéos longues. Essayez des montages plus courts ou utilisez le fichier original.",
  },
  preRecord: {
    ...
    surfaceWindowDescription: "Idéal pour des diapositives ou une application",
    surfaceBrowser: "Onglet du navigateur",
    surfaceBrowserDescription: "Choisissez un onglet ouvert",
    surfaceScreen: "Écran",
    surfaceScreenDescription: "Capturer tout",
    microphoneSelectionUnsupported:
      "Ce navigateur ne prend pas en charge la sélection du micro.",
    enumerateFailed: "Impossible d’énumérer les périphériques",
    noMicrophone: "Aucun micro",
    defaultMicrophone: "Micro par défaut",
    shortMicLabel: "Micro {{id}}",
    defaultCamera: "Caméra par défaut",
    shortCameraLabel: "Caméra {{id}}",
    noAudio: "Pas d’audio",
    noCamera: "Pas de caméra",
    loomImportFailed: "Impossible d’importer ce Loom.",
    fixMicrophoneAccess:
      "Corrigez l’accès au micro ou désactivez l’audio avant d’enregistrer.",
    fixCameraAccess:
      "Corrigez l’accès à la caméra ou passez en mode Écran avant d’enregistrer.",
    captureSource: "Source de capture",
    selectedSurface: "{{surface}} sélectionné",
    change: "Changer",
    audioAndCamera: "Audio et caméra",
    audio: "Audio",
    check: "Vérifier",
    choose: "Choisir",
    defaultMicPlaceholder: "Micro par défaut",
    openingMicrophone: "Ouverture du micro...",
    chooseMicrophone: "Choisir un micro...",
    includeAudioAria: "Inclure l’audio dans cet enregistrement",
    tryClipsDesktop: "Essayez Clips Desktop.",
    cameraOff: "Caméra désactivée",
    includeCameraAria: "Inclure la caméra dans cet enregistrement",
    startRecording: "Démarrer l’enregistrement",
    uploadVideo: "Importer une vidéo",
    importLoom: "Importer un Loom",
  ...
  playerSettings: {
    ...
    passwordSetPlaceholder:
      "Un mot de passe est défini — saisissez pour le remplacer, laissez vide + Enregistrer pour le supprimer",
    noPasswordPlaceholder: "Aucun mot de passe",
    expiry: "Expiration",
    viewerOptions: "Options pour les spectateurs",
    comments: "Commentaires",
    reactions: "Réactions",
    allowDownloads: "Autoriser les téléchargements",
    animatedThumbnail: "Miniature animée",
    defaultPlaybackSpeed: "Vitesse de lecture par défaut",
    callToAction: "Appel à l’action",
    defaultCtaLabel: "En savoir plus",
    addCta: "+ Ajouter",
    noCtas:
      "Aucun CTA pour le moment. Ajoutez un bouton qui apparaît pendant ou après la vidéo.",
    buttonLabelPlaceholder: "Libellé du bouton",
    placementThroughout: "Pendant toute la vidéo",
    placementEnd: "À la fin",
    delete: "Supprimer",
  },
  recordRoute: {
    pageTitle: "Nouvel enregistrement — Clips",
    uploadFailed: "Échec de l’envoi",
    uploadFailedAtChunk:
      "Échec de l’envoi au fragment {{chunk}}/{{total}} : {{message}}",
    couldNotStartRecording: "Impossible de démarrer l’enregistrement",
    couldNotStartRecorder: "Impossible de démarrer l’enregistreur",
    openSettings: "Ouvrir les paramètres",
    openedRecorderInNewTab: "Enregistreur ouvert dans un nouvel onglet",
    videoReadyToUpload: "La vidéo est prête à être envoyée",
    videoUploaded: "Vidéo envoyée",
    videoTooLarge: "La vidéo est trop volumineuse",
    storageNeededToFinishLoomImport:
      "Stockage requis pour terminer l’import Loom",
    loomImported: "Loom importé",
    ...
    backToLibrary: "Retour à la bibliothèque",
    clipsRecorder: "Enregistreur Clips",
    preparingSources: "Préparation des sources…",
    recordingScreen:
      "Enregistrement de votre écran — passez à la fenêtre que vous voulez capturer",
    largeClipsNeedReencode:
      "Les clips volumineux nécessitent un rapide réencodage avant l’envoi.",
    savingRecording: "Sauvegarde de votre enregistrement…",
    sessionExpired: "Session expirée",
    sessionExpiredDescription:
      "Votre session de connexion a expiré. Reconnectez-vous pour commencer à enregistrer.",
    logIn: "Se connecter",
    betterInDesktop: "Encore mieux dans l’application de bureau",
    desktopAppDescription:
      "Lancement depuis la barre de menus, raccourcis globaux, mises à jour automatiques et enregistrements répétés plus fluides.",
    ...
    openRecorderInTab: "Ouvrir l’enregistreur dans un onglet",
  ...
  dictateRoute: {
    pageTitle: "Dicter · Clips",
    howToUse: "Comment utiliser Dicter",
    browserDictation: "Dictée dans le navigateur",
    browserDictationDescription:
      "Utilisez le bouton de cette page, ou appuyez sur le raccourci lorsque cet onglet est actif. La dictée du navigateur est enregistrée ici pour la copie et le nettoyage.",
    ...
    replacedOriginal: "Original remplacé par le texte nettoyé",
    noText: "Aucun texte",
    emptyTranscript: "Transcription vide",
    replaceOriginal: "Remplacer l’original par la version nettoyée",
    cleanupWithAi: "Nettoyer avec l’IA",
    cleanupHint:
      "Cliquez sur « Nettoyer avec l’IA » pour corriger la ponctuation, les majuscules et les mots de remplissage.",
    startFirst: "Commencez votre première dictée",
    emptyDesktopDescription:
      "Maintenez {{fnKey}} n’importe où sur votre Mac, ou appuyez sur {{modifierKey}} ⇧ Espace. Votre historique s’affichera ici.",
    emptyWebDescription:
      "La dictée passe par l’application de bureau pour des raccourcis globaux qui fonctionnent dans n’importe quelle application — Slack, votre éditeur, partout.",
    downloadDesktopApp: "Télécharger l’application de bureau Clips",
    holdToDictate: "maintenir pour dicter",
    toggle: "basculer",
    desktopCtaTitle: "Dictez depuis n’importe où avec l’application de bureau",
    desktopCtaDescription:
      "Appuyez sur {{modifierKey}} ⇧ Espace dans n’importe quelle application. La dictée du navigateur est peu fiable — l’application de bureau est la bonne façon de l’utiliser.",
    noSpeechCaptured: "Aucune parole capturée",
    dictationSaved: "Dictée enregistrée",
  ...
  meetingsRoute: {
    pageTitle: "Réunions · Clips",
    transcriptPending: "Transcription en attente",
    notesPending: "Notes en attente",
    pastRecordings: "Enregistrements passés",
