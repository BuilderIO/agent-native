const messages = {
  ...
  recordingPage: {
    ...
    aiSummarySent: "Le résumé est en route vers votre boîte de réception",
    aiSummaryAlreadySent: "Déjà envoyé dans votre boîte de réception",
    aiSummaryFailed:
      "Impossible d'envoyer le résumé — réessayez depuis l'e-mail de partage",
    share: "Partager",
