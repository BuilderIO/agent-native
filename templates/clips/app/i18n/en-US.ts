const messages = {
  ...
  shareDialog: {
    ...
    redactionsPendingBody:
      "{{count}} redaction(s) are drawn on this recording but have not been burned in, so the file still shows everything under them. Open the editor, burn them in, and sharing comes back.",
