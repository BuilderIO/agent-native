const messages = {
  ...
  recordingPage: {
    ...
    aiSummarySent: "Summary on its way to your inbox",
    aiSummaryAlreadySent: "Already sent to your inbox",
    aiSummaryFailed: "Couldn't send the summary — try again from the share email",
    share: "Share",
