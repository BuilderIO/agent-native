...
- See what's new right inside Clips. A changelog now lives in the command menu (Cmd+K) and in Settings.`,
  ...
  editVersions: {
    ...
    historyTitle: "Edit versions",
    historyDescription:
      "Every proposed, accepted, rejected, and superseded cut for this recording.",
    historyEmpty: "No edit versions yet",
    preview: "Preview cut",
    previewing: "Previewing: {{title}}",
    previewFailed: "Could not load the preview",
    exitPreview: "Exit preview",
    restore: "Restore",
    restored: "Version restored — previous edits archived",
    restoreFailed: "Restore failed",
  ...
  editorToolbar: {
    ...
    cutStartToTime: "Cut start → {{time}}",
    cutTimeToEnd: "Cut {{time}} → end",
