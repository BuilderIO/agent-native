const messages = {
  ...
  shareDialog: {
    ...
    redactionsPendingBody:
      "이 녹화에 가림 영역 {{count}}개가 그려져 있지만 아직 적용되지 않아, 파일에는 그 아래 내용이 모두 남아 있습니다. 편집기를 열어 적용하면 다시 공유할 수 있습니다.",
  ...
  screenshot: {
    ...
    editConfirm: "저장하면 공유된 이미지가 바뀌어 모두가 이 표시를 보게 됩니다. 나중에도 옮기거나 지울 수 있습니다. 저장할까요?",
    ...
    crop: "자르기",
    cropApply: "자르기 적용",
    cropApplyHint: "이 부분만 표시합니다. 나머지는 보관되므로 나중에 다시 넓게 자를 수 있습니다",
    cropReset: "전체 이미지 보기",
    kind: {
      box: "상자",
      arrow: "화살표",
    ...
    backgroundNone: "없음",
    notYetBurned: "가림 영역 {{count}}개가 배치되었지만 아직 적용되지 않았습니다. 아직 아무것도 가려지지 않았으며, 적용하기 전까지 다른 사람은 이 스크린샷을 볼 수 없습니다.",
    burnInHint: "가림 영역이 덮은 내용을 영구히 없애고 원본을 삭제합니다",
    burnInTitle: "이 스크린샷에 가림 영역 {{count}}개를 적용할까요?",
    burnInWarning: "덮인 영역은 스크린샷의 새 사본에서 지워지고 원본 파일은 삭제됩니다. 되돌릴 수 없습니다. 상자, 화살표, 텍스트는 계속 옮길 수 있습니다. 이미 다운로드된 사본은 그대로 남습니다.",
    burning: "적용 중…",
