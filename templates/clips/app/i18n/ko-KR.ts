const messages = {
  ...
  recordingPage: {
    ...
    processingStuck:
      "아직 작업 중입니다 — 이 클립은 한동안 {{status}} 상태에 있습니다. 긴 녹화는 압축 및 업로드에 몇 분이 걸릴 수 있으며 이 페이지는 자동으로 업데이트됩니다. 아주 오랫동안 아무 변화가 없다면 서버 로그에서 청크/완결 메시지를 확인하세요.",
    uploadingAssembling:
  ...
  sharePage: {
    ...
    uploadNotCompleteSession:
      "업로드가 평소보다 오래 걸리고 있습니다. 긴 녹화는 몇 분이 필요할 수 있으며 이 페이지는 자동으로 업데이트됩니다. 이 클립의 대시보드를 열거나 제작자에게 저장 공간 확인을 요청할 수도 있습니다.",
    uploadNotCompleteSignIn:
      "업로드가 평소보다 오래 걸리고 있습니다. 긴 녹화는 몇 분이 필요할 수 있으며 이 페이지는 자동으로 업데이트됩니다. 귀하의 클립인 경우 로그인하여 소유자 컨트롤을 열고 저장 공간을 확인하세요.",
...
- 이제 Clips 안에서 바로 새 소식을 볼 수 있습니다. 변경 로그는 명령 메뉴(Cmd+K)와 설정에 있습니다.`,
  ...
  editVersions: {
    history: "편집 기록",
    historyTitle: "편집 버전",
    historyDescription: "이 녹화의 제안됨·수락됨·거절됨·대체됨 컷 전체입니다.",
    historyEmpty: "아직 편집 버전이 없습니다",
    preview: "컷 미리보기",
    previewing: "미리보기 중: {{title}}",
    previewFailed: "미리보기를 불러오지 못했습니다",
    exitPreview: "미리보기 종료",
    restore: "복원",
    restored: "버전이 복원되었습니다 — 이전 편집은 보관되었습니다",
    restoreFailed: "복원 실패",
    statusProposed: "제안됨",
    statusAccepted: "수락됨",
    statusRejected: "거절됨",
  ...
  editorToolbar: {
    ...
    split: "분할",
    cutSegment: "세그먼트 잘라내기",
    removeSplit: "분할 제거",
    actions: "작업",
    splitAtTime: "{{time}}에서 분할",
    cutSelection: "선택 영역 잘라내기",
    cutStartToTime: "시작 → {{time}} 잘라내기",
    cutTimeToEnd: "{{time}} → 끝 잘라내기",
  ...
  dictateRoute: {
    ...
    browserDictationDescriptionDesktop:
      "아래 버튼으로 이 페이지에서 바로 메모를 받아쓸 수 있습니다. 다른 앱에는 붙여넣지 않습니다 — 그 용도로는 오른쪽의 데스크톱 단축키를 사용하세요.",
    quickNoteTitle: "빠른 받아쓰기 메모",
    quickNoteHint:
      "이 페이지를 벗어나지 않고 여기에 기록합니다 — 다른 앱에 붙여넣지 않습니다. 버튼으로 시작하고 중지하세요.",
    browserUnavailable:
    ...
    dictionaryDescription:
      "여기의 용어는 음성 인식이 선호하는 표기를 따르도록 돕습니다 — 수정에서 자동 학습되며 직접 추가할 수도 있습니다.",
    dictionaryTermPlaceholder: "용어",
    dictionaryReplacementPlaceholder: "대체어 (선택)",
    dictionaryAdd: "추가",
    dictionaryLoading: "사전 불러오는 중…",
    dictionaryEmpty: "아직 학습된 용어가 없습니다.",
    dictionaryUsesCount: "{{count}}회 사용됨",
    dictionaryRemove: "삭제",
  ...
  meetingsRoute: {
    ...
    desktopReminder:
      "Google 캘린더를 연결하고 Clips Desktop을 열어 둔 뒤, 회의가 시작되면 알림이나 메뉴 막대에서 노트 시작을 클릭하세요.",
    getDesktopApp: "데스크톱 앱 받기",
    requiredForReminders:
      "데스크톱이 회의 전사를 위해 마이크 + 시스템 오디오를 캡처합니다.",
    ...
    title: "회의",
    intro:
      "다가오는 캘린더 회의와 녹음된 노트입니다. 회의 시간에 Clips Desktop에서 라이브 노트를 시작하세요.",
    searchPlaceholder: "회의 검색...",
    clearSearch: "검색 지우기",
    noMeetingsYet: "아직 회의가 없습니다",
    noMeetingsDescription:
      "캘린더를 연결하고 Clips Desktop을 열어 두세요. 회의가 시작되면 알림이나 메뉴 막대에서 노트 시작을 사용하세요.",
    noMeetingsMatch: '"{{query}}"과(와) 일치하는 회의가 없습니다',
    refreshing: "새로 고치는 중…",
    howToTriggerTitle: "회의 노트 시작 방법",
    howToTriggerDescription:
      "회의 노트는 Clips의 Granola식 흐름입니다. 캘린더 일정이 여기에 표시되고, 데스크톱 앱이 마이크와 시스템 오디오를 캡처하며, 전사와 AI 노트가 이 기록으로 돌아옵니다.",
    guideCalendarTitle: "Google 캘린더 연결",
    guideCalendarDescription:
      "회의는 캘린더에서 가져오므로 Clips가 알림 시점을 알 수 있습니다.",
    guideDesktopTitle: "Clips Desktop을 열어 두기",
    guideDesktopDescription:
      "마이크와 시스템 오디오 전사에는 데스크톱 캡처가 필요합니다.",
    guideStartTitle: "노트 시작 클릭",
    guideStartDescription:
      "통화가 시작되면 데스크톱 알림이나 메뉴 막대의 '회의 노트 시작'을 사용하세요.",
  },
  videoProjects: {
