const messages = {
  ...
  clipsFinalRaw: {
    ...
    uploadFailed: "Falha no upload",
    connectStorageToFinish: "Abra para conectar o armazenamento e concluir o salvamento.",
    retryFromClipsMenu: "Tente novamente pelo menu do Clips; não precisa gravar de novo.",
    ...
    passwordProtectedDescription: "Este vídeo está protegido. Digite a senha para assistir.",
    password: "Senha",
    unlock: "Desbloquear",
