...
- Du kannst Neuigkeiten jetzt direkt in Clips ansehen. Das Änderungsprotokoll ist im Befehlsmenü (Cmd+K) und in den Einstellungen verfügbar.`,
  ...
  meetingsRoute: {
    ...
    desktopReminder:
      "Erhalte eine Desktop-Erinnerung, wenn Meetings starten, damit aufgezeichnete Notizen automatisch in diesem Verlauf landen.",
    getDesktopApp: "Desktop-App holen",
    requiredForReminders:
      "Erforderlich für Meeting-Erinnerungen und Transkription.",
    ...
    title: "Meetings",
    intro: "Anstehende Kalender-Meetings und deine aufgezeichneten Notizen.",
    searchPlaceholder: "Meetings durchsuchen...",
    clearSearch: "Suche löschen",
    noMeetingsYet: "Noch keine Meetings",
    noMeetingsDescription:
      "Anstehende Kalender-Meetings erscheinen hier, und fertige Aufnahmen landen hier, sobald du Notizen machst.",
