...
- Du kannst Neuigkeiten jetzt direkt in Clips ansehen. Das Änderungsprotokoll ist im Befehlsmenü (Cmd+K) und in den Einstellungen verfügbar.`,
  ...
  captureInstall: {
    title: "Wähle deinen Recorder",
    description:
      "Nutze Chrome, wenn du Browser-Logs brauchst, oder die Desktop-App für die reibungsloseste Aufnahme im Alltag.",
    chromeTitle: "Chrome-Erweiterung",
    chromeDescription:
      "Am besten, wenn du redigierte Konsolen- und Netzwerkdiagnosen aus dem Browser-Tab möchtest.",
    chromePendingDescription:
      "Die Browser-Logs-Option ist bereit und wartet noch auf die Chrome Web Store URL.",
    desktopTitle: "Desktop-App",
    desktopDescription:
      "Am nahtlosesten für globale Kurzbefehle, Aufnahmen aus der Menüleiste, Meetings und wiederholte Aufnahmen.",
  },
  editableTitle: {
    untitled: "Unbenannter Clip",
    renameFailed: "Clip konnte nicht umbenannt werden",
    emptyTitle: "Titel darf nicht leer sein",
    generatingTitle: "Titel wird generiert",
    placeholder: "Clip-Titel",
    editLabel: "Clip-Titel bearbeiten",
  },
  chapters: {
    title: "Kapitel",
    ...
    duplicateAtPoint: "An dieser Stelle existiert bereits ein Kapitel",
  ...
  editorToolbar: {
    ...
    splitAtPlayhead: "An Abspielposition teilen",
    cutBeforePlayhead: "Vor Abspielposition schneiden",
    cutAfterPlayhead: "Nach Abspielposition schneiden",
    panels: "Panels",
    hideChapters: "Kapitel ausblenden",
    showChapters: "Kapitel einblenden",
    thumbnail: "Vorschaubild",
    stitchClips: "Clips zusammenfügen",
    zoom: "Zoom",
    zoomOut: "Herauszoomen",
    fitToWidth: "An Breite anpassen",
    zoomIn: "Hineinzoomen",
    clearAllEdits: "Alle Bearbeitungen löschen",
    loadingFfmpeg: "ffmpeg wird geladen…",
    exportMp4: "MP4 exportieren",
    longExportTitle: "Dieser Export ist lang",
    longExportDescription:
      "Das bearbeitete Video ist {{duration}} lang. ffmpeg.wasm läuft in deinem Browser und kann bei sehr langen Exporten zu wenig Speicher haben. Du kannst es trotzdem versuchen oder stattdessen die Originaldatei herunterladen.",
    downloadOriginal: "Original herunterladen",
    exportAnyway: "Trotzdem exportieren",
    clearAllEditsTitle: "Alle Bearbeitungen löschen?",
    clearAllEditsDescription:
      "Dies entfernt jeden Zuschnitt, jede Unschärfe und das eigene Vorschaubild aus dieser Aufnahme. Das Originalvideo wird nie verändert.",
    clearEdits: "Bearbeitungen löschen",
    nothingToUndo: "Nichts rückgängig zu machen",
    undoFailed: "Rückgängig machen fehlgeschlagen",
    editsCleared: "Bearbeitungen gelöscht",
    clearFailed: "Löschen fehlgeschlagen",
    selectRangeFirst:
      "Wähle zuerst einen Bereich in der Wellenform oder im Transkript aus",
    selectionCut: "Auswahl geschnitten",
    trimFailed: "Zuschneiden fehlgeschlagen",
    movePlayheadPastIntro:
      "Bewege die Abspielposition hinter das Intro, das du schneiden möchtest",
    startCut: "Anfang schneiden",
    movePlayheadBeforeEnding:
      "Bewege die Abspielposition vor das Ende, das du schneiden möchtest",
    endCut: "Ende schneiden",
    splitAdded: "Teilung hinzugefügt",
    splitFailed: "Teilen fehlgeschlagen",
    videoNotReady: "Video noch nicht bereit",
    exportedMp4: "MP4 exportiert",
    exportFailed:
      "Export fehlgeschlagen — ffmpeg.wasm kommt mit langen Videos nicht immer zurecht. Versuche kürzere Bearbeitungen oder nutze die Originaldatei.",
  },
  preRecord: {
    ...
    surfaceWindowDescription: "Ideal für Folien oder eine App",
    surfaceBrowser: "Browser-Tab",
    surfaceBrowserDescription: "Wähle einen offenen Tab",
    surfaceScreen: "Bildschirm",
    surfaceScreenDescription: "Alles aufnehmen",
    microphoneSelectionUnsupported:
      "Dieser Browser unterstützt keine Auswahl des Mikrofongeräts.",
    enumerateFailed: "Geräte konnten nicht ermittelt werden",
    noMicrophone: "Kein Mikrofon",
    defaultMicrophone: "Standardmikrofon",
    shortMicLabel: "Mikrofon {{id}}",
    defaultCamera: "Standardkamera",
    shortCameraLabel: "Kamera {{id}}",
    noAudio: "Kein Audio",
    noCamera: "Keine Kamera",
    loomImportFailed: "Dieses Loom konnte nicht importiert werden.",
    fixMicrophoneAccess:
      "Behebe den Mikrofonzugriff oder schalte Audio vor der Aufnahme aus.",
    fixCameraAccess:
      "Behebe den Kamerazugriff oder wechsle vor der Aufnahme in den Bildschirmmodus.",
    captureSource: "Aufnahmequelle",
    selectedSurface: "{{surface}} ausgewählt",
    change: "Ändern",
    audioAndCamera: "Audio & Kamera",
    audio: "Audio",
    check: "Prüfen",
    choose: "Auswählen",
    defaultMicPlaceholder: "Standardmikrofon",
    openingMicrophone: "Mikrofon wird geöffnet...",
    chooseMicrophone: "Mikrofon auswählen...",
    includeAudioAria: "Audio in diese Aufnahme einschließen",
    tryClipsDesktop: "Probiere Clips Desktop.",
    cameraOff: "Kamera aus",
    includeCameraAria: "Kamera in diese Aufnahme einschließen",
    startRecording: "Aufnahme starten",
    uploadVideo: "Video hochladen",
    importLoom: "Loom importieren",
  ...
  playerSettings: {
    ...
    passwordSetPlaceholder:
      "Passwort ist gesetzt — tippe zum Ersetzen, leer lassen + Speichern zum Entfernen",
    noPasswordPlaceholder: "Kein Passwort",
    expiry: "Ablauf",
    viewerOptions: "Zuschaueroptionen",
    comments: "Kommentare",
    reactions: "Reaktionen",
    allowDownloads: "Downloads erlauben",
    animatedThumbnail: "Animiertes Vorschaubild",
    defaultPlaybackSpeed: "Standard-Wiedergabegeschwindigkeit",
    callToAction: "Call-to-Action",
    defaultCtaLabel: "Mehr erfahren",
    addCta: "+ Hinzufügen",
    noCtas:
      "Noch keine CTAs. Füge einen Button hinzu, der während oder nach dem Video erscheint.",
    buttonLabelPlaceholder: "Button-Beschriftung",
    placementThroughout: "Durchgehend",
    placementEnd: "Am Ende",
    delete: "Löschen",
  },
  recordRoute: {
    pageTitle: "Neue Aufnahme — Clips",
    uploadFailed: "Upload fehlgeschlagen",
    uploadFailedAtChunk:
      "Upload bei Teil {{chunk}}/{{total}} fehlgeschlagen: {{message}}",
    couldNotStartRecording: "Aufnahme konnte nicht gestartet werden",
    couldNotStartRecorder: "Recorder konnte nicht gestartet werden",
    openSettings: "Einstellungen öffnen",
    openedRecorderInNewTab: "Recorder in neuem Tab geöffnet",
    videoReadyToUpload: "Video ist bereit zum Hochladen",
    videoUploaded: "Video hochgeladen",
    videoTooLarge: "Video ist zu groß",
    storageNeededToFinishLoomImport:
      "Speicher nötig, um den Loom-Import abzuschließen",
    loomImported: "Loom importiert",
    ...
    preparingSources: "Quellen werden vorbereitet…",
    recordingScreen:
      "Dein Bildschirm wird aufgenommen — wechsle zu dem Fenster, das du aufnehmen möchtest",
    largeClipsNeedReencode:
      "Große Clips brauchen vor dem Upload eine kurze Neucodierung.",
    savingRecording: "Deine Aufnahme wird gespeichert…",
    sessionExpired: "Sitzung abgelaufen",
    sessionExpiredDescription:
      "Deine Anmeldesitzung ist abgelaufen. Melde dich erneut an, um mit der Aufnahme zu starten.",
    logIn: "Anmelden",
    betterInDesktop: "Besser in der Desktop-App",
    desktopAppDescription:
      "Start aus der Menüleiste, globale Kurzbefehle, automatische Updates und flüssigere wiederholte Aufnahmen.",
    downloadDesktopApp: "Desktop-App herunterladen",
    technicalDetails: "Technische Details",
    whatToCheck: "Was du prüfen kannst",
    downloadRecording: "Aufnahme herunterladen",
    openRecorderInTab: "Recorder im Tab öffnen",
  ...
  dictateRoute: {
    pageTitle: "Diktieren · Clips",
    howToUse: "So nutzt du Diktieren",
    browserDictation: "Browser-Diktat",
    browserDictationDescription:
      "Nutze den Button auf dieser Seite oder drücke den Kurzbefehl, während dieser Tab fokussiert ist. Browser-Diktate werden hier zum Kopieren und Bereinigen gespeichert.",
    desktopShortcuts: "Desktop-Kurzbefehle",
    desktopShortcutsDescriptionSuffix: ", in der Desktop-App.",
    holdFn: "Fn gedrückt halten",
    browserDictationDescriptionDesktop:
      "Nutze den Button unten, um direkt auf dieser Seite eine Notiz aufzunehmen. Der Text wird nicht in andere Apps eingefügt — dafür gibt es den Desktop-Kurzbefehl rechts.",
    quickNoteTitle: "Schnelle Diktatnotiz",
    quickNoteHint:
      "Nimmt hier auf, ohne die Seite zu verlassen — es wird nichts in andere Apps eingefügt. Starte und stoppe mit dem Button.",
    browserUnavailable:
      "Browser-Spracherkennung ist hier nicht verfügbar. Nutze Chrome oder die Desktop-App für globales Diktieren.",
    browserUnavailableShort: "Browser-Spracherkennung ist hier nicht verfügbar",
    startSpeaking: "Sprich los...",
    replacedOriginal: "Original durch bereinigten Text ersetzt",
    noText: "Kein Text",
    emptyTranscript: "Leeres Transkript",
    replaceOriginal: "Original durch bereinigte Version ersetzen",
    cleanupWithAi: "Mit KI bereinigen",
    cleanupHint:
      "Klicke auf „Mit KI bereinigen“, um Zeichensetzung, Groß-/Kleinschreibung und Füllwörter zu korrigieren.",
    startFirst: "Starte dein erstes Diktat",
    emptyDesktopDescription:
      "Halte {{fnKey}} überall auf deinem Mac gedrückt oder drücke {{modifierKey}} ⇧ Leertaste. Dein Verlauf erscheint hier.",
    emptyWebDescription:
      "Diktieren läuft über die Desktop-App mit globalen Kurzbefehlen, die in jeder App funktionieren — Slack, deinem Editor, überall.",
    downloadDesktopApp: "Clips Desktop-App herunterladen",
    holdToDictate: "halten zum Diktieren",
    toggle: "umschalten",
    desktopCtaTitle: "Diktiere von überall mit der Desktop-App",
    desktopCtaDescription:
      "Drücke {{modifierKey}} ⇧ Leertaste in jeder App. Browser-Diktat ist unzuverlässig — die Desktop-App ist der richtige Weg dafür.",
    noSpeechCaptured: "Keine Sprache erkannt",
    dictationSaved: "Diktat gespeichert",
    voiceToTextDescription:
      "Sprache-zu-Text-Diktat mit KI-Bereinigung. Hol dir die Desktop-App, um von überall mit einem globalen Kurzbefehl zu diktieren.",
    loadFailed: "Diktate konnten nicht geladen werden.",
    noFilterMatches: "Keine Diktate entsprechen diesem Filter.",
    dictionaryTitle: "Wörterbuch",
    dictionaryDescription:
      "Diese Begriffe lenken die Spracherkennung zu deinen bevorzugten Schreibweisen — automatisch aus Korrekturen gelernt, oder füge eigene hinzu.",
    dictionaryTermPlaceholder: "Begriff",
    dictionaryReplacementPlaceholder: "Ersetzung (optional)",
    dictionaryAdd: "Hinzufügen",
    dictionaryLoading: "Wörterbuch wird geladen…",
    dictionaryEmpty: "Noch keine gelernten Begriffe.",
    dictionaryUsesCount: "{{count}}× verwendet",
  ...
  meetingsRoute: {
    ...
    notesPending: "Notizen ausstehend",
    pastRecordings: "Frühere Aufnahmen",
    calendarNeedsReconnect:
      "Google Calendar muss neu verbunden werden, um deine anstehenden Meetings weiterhin anzuzeigen.",
    connectGoogleCalendar: "Google Calendar verbinden",
    desktopReminder:
      "Verbinde Google Calendar, lass Clips Desktop geöffnet und klicke bei Meeting-Beginn in der Erinnerung oder Menüleiste auf „Notizen starten“.",
    getDesktopApp: "Desktop-App holen",
    requiredForReminders:
      "Die Desktop-App nimmt Mikrofon + Systemaudio für die Meeting-Transkription auf.",
    calendarConnected: "Kalender verbunden",
    calendarDisconnected: "Kalender getrennt",
    calendarSettings: "Kalendereinstellungen",
    connectCalendarReminder:
      "Verbinde Google Calendar für Meeting-Erinnerungen.",
    disconnectGoogleCalendarTitle: "Google Calendar trennen?",
    title: "Meetings",
    intro:
      "Anstehende Kalender-Meetings und deine aufgezeichneten Notizen. Starte Live-Notizen zur Meeting-Zeit über Clips Desktop.",
    searchPlaceholder: "Meetings durchsuchen...",
    clearSearch: "Suche löschen",
    noMeetingsYet: "Noch keine Meetings",
    noMeetingsDescription:
      "Verbinde deinen Kalender und lass Clips Desktop geöffnet. Wenn ein Meeting beginnt, nutze „Notizen starten“ in der Erinnerung oder Menüleiste.",
    noMeetingsMatch: "Keine Meetings entsprechen „{{query}}“",
    refreshing: "Wird aktualisiert…",
    howToTriggerTitle: "So startest du Meeting-Notizen",
    howToTriggerDescription:
      "Meeting-Notizen sind der Granola-artige Ablauf in Clips: Kalendertermine erscheinen hier, die Desktop-App nimmt Mikrofon und Systemaudio auf, und Transkript plus KI-Notizen landen wieder in diesem Verlauf.",
    guideCalendarTitle: "Google Calendar verbinden",
    guideCalendarDescription:
      "Meetings kommen aus deinem Kalender, damit Clips weiß, wann es dich erinnern soll.",
    guideDesktopTitle: "Clips Desktop geöffnet lassen",
    guideDesktopDescription:
      "Die Desktop-Aufnahme ist für die Transkription von Mikrofon plus Systemaudio erforderlich.",
    guideStartTitle: "Auf „Notizen starten“ klicken",
    guideStartDescription:
      "Nutze die Desktop-Erinnerung oder den Menüleisten-Eintrag „Meeting-Notizen starten“, sobald der Call beginnt.",
  },
  videoProjects: {
