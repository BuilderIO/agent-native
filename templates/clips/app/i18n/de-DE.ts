const messages = {
  ...
  shareDialog: {
    ...
    redactionsPendingBody:
      "{{count}} Schwärzung(en) sind auf dieser Aufnahme eingezeichnet, aber noch nicht eingebrannt. Die Datei zeigt also weiterhin alles darunter. Öffnen Sie den Editor, brennen Sie sie ein, und das Teilen steht wieder zur Verfügung.",
