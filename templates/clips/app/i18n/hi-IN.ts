const messages = {
  ...
  recordingPage: {
    ...
    processingStuck:
      "काम अभी भी जारी है — यह क्लिप कुछ समय से {{status}} स्थिति में है। लंबी रिकॉर्डिंग को संपीड़ित और अपलोड करने में कई मिनट लग सकते हैं, और यह पेज अपने आप अपडेट होता है। यदि बहुत लंबे समय तक कुछ नहीं बदलता है, तो चंक/फ़ाइनलाइज़ संदेशों के लिए सर्वर लॉग की जाँच करें।",
    uploadingAssembling:
    ...
    savedLocallyHint:
      "लोकल फ़ाइल मेन्यू बार के Clips ऐप में है: ट्रे आइकन पर क्लिक करें और सेव किए गए क्लिप के फ़ोल्डर बटन से उसे खोलें, या दोबारा अपलोड करने के लिए रीट्राई करें।",
    uploadStalled:
      "यह अपलोड पूरा नहीं हुआ. यदि आपने डेस्कटॉप ऐप से रिकॉर्ड किया था, तो स्थानीय प्रति अब भी सुरक्षित है — मेन्यू बार आइकन से पुनः प्रयास करें या निर्यात करें. अन्यथा दोबारा रिकॉर्ड करें.",
  ...
  sharePage: {
    ...
    uploadNotCompleteSession:
      "अपलोड में सामान्य से अधिक समय लग रहा है। लंबी रिकॉर्डिंग को कई मिनट लग सकते हैं — यह पेज अपने आप अपडेट होता है। आप इस क्लिप के लिए डैशबोर्ड भी खोल सकते हैं या निर्माता से भंडारण की जांच करने के लिए कह सकते हैं।",
    uploadNotCompleteSignIn:
      "अपलोड में सामान्य से अधिक समय लग रहा है। लंबी रिकॉर्डिंग को कई मिनट लग सकते हैं — यह पेज अपने आप अपडेट होता है। यदि यह आपकी क्लिप है, तो स्वामी नियंत्रण खोलने और भंडारण की जांच करने के लिए साइन इन करें।",
...
- अब आप Clips के अंदर ही नया क्या है देख सकते हैं। बदलाव लॉग अब कमांड मेनू (Cmd+K) और सेटिंग्स में उपलब्ध है।`,
    ...
    transcript: "ट्रांसक्रिप्ट",
    transcriptCleanup: "AI ट्रांसक्रिप्ट सफ़ाई",
    transcriptCleanupDescription:
      "डिफ़ॉल्ट रूप से बंद। चालू करने पर, ट्रांसक्रिप्शन के बाद AI विराम-चिह्न और पठनीयता के लिए टेक्स्ट को फिर से लिखता है। तकनीकी शब्द कभी-कभी बदले जा सकते हैं — मूल ट्रांसक्रिप्ट हमेशा सुरक्षित रहता है, कुछ भी खोता नहीं।",
    backupTranscription: "क्लाउड बैकअप ट्रांसक्रिप्शन",
  ...
  recordingToolbar: {
    ...
    addMarker: "टाइमस्टैम्प मार्कर जोड़ें",
    markerShortcut: "मार्कर (⌥⇧M) · नोट ⌥⇧E · बी-रोल ⌥⇧B · रीटेक ⌥⇧N",
  },
  annotationsStrip: {
    comment: "टिप्पणी",
    resolvedChip: "हल हो गया",
    moreComments: "+{{count}} और टिप्पणियाँ",
    addKindAt: "{{time}} पर {{kind}} जोड़ें",
    changeType: "प्रकार बदलें",
    addMarkerAt: "{{time}} पर मार्कर जोड़ें",
    jumpTo: "{{time}} पर जाएँ",
    resolve: "समाधान के रूप में चिह्नित करें",
    reopen: "फिर से खोलें",
    title: "मार्कर ({{count}})",
    editorNote: "एडिटर के लिए नोट",
    bRoll: "बी-रोल",
    retake: "रीटेक",
    marker: "मार्कर",
    wholeVideo: "पूरा वीडियो",
    delete: "मार्कर हटाएँ",
  },
  countdownOverlay: {
  ...
  transcriptEditor: {
    segmentStart: "सेगमेंट की शुरुआत",
    ignore: "अनदेखा करें",
    restore: "पुनर्स्थापित करें",
    addMarker: "मार्कर जोड़ें",
    createSection: "सेक्शन बनाएँ",
    copy: "कॉपी करें",
    cut: "काटें",
    delete: "मिटाएँ",
    transcript: "ट्रांसक्रिप्ट",
  ...
  editVersions: {
    history: "संपादन इतिहास",
    historyTitle: "संपादन संस्करण",
    historyDescription:
      "इस रिकॉर्डिंग के सभी प्रस्तावित, स्वीकृत, अस्वीकृत और प्रतिस्थापित कट।",
    historyEmpty: "अभी कोई संपादन संस्करण नहीं",
    preview: "कट का पूर्वावलोकन",
    previewing: "पूर्वावलोकन: {{title}}",
    previewFailed: "पूर्वावलोकन लोड नहीं हो सका",
    exitPreview: "पूर्वावलोकन बंद करें",
    restore: "पुनर्स्थापित करें",
    restored: "संस्करण पुनर्स्थापित — पिछले संपादन संग्रहीत",
    restoreFailed: "पुनर्स्थापना विफल",
    statusProposed: "प्रस्तावित",
    statusAccepted: "स्वीकृत",
    statusRejected: "अस्वीकृत",
    statusSuperseded: "प्रतिस्थापित",
    review: "समीक्षा करें",
    accept: "संस्करण स्वीकारें",
    reject: "अस्वीकारें",
    accepted: "संस्करण लागू — पिछले संपादन संग्रहीत",
    rejected: "संस्करण अस्वीकृत",
    reviewFailed: "समीक्षा विफल",
    pendingFrom: "{{author}} का प्रस्तावित कट आपकी समीक्षा की प्रतीक्षा में",
    editor: "एक संपादक",
  },
  editorToolbar: {
    selectionSegment: "सेगमेंट",
    selectionRange: "चयन",
    clearSelection: "चयन हटाएँ",
    split: "विभाजित करें",
    cutSegment: "सेगमेंट काटें",
    removeSplit: "विभाजन हटाएँ",
    actions: "क्रियाएँ",
    splitAtTime: "{{time}} पर विभाजित करें",
    cutSelection: "चयन काटें",
    cutStartToTime: "शुरुआत → {{time}} काटें",
    cutTimeToEnd: "{{time}} → अंत काटें",
  ...
  dictateRoute: {
    ...
    browserDictationDescriptionDesktop:
      "नीचे दिए बटन से इसी पेज पर नोट रिकॉर्ड करें। यह दूसरे ऐप्स में पेस्ट नहीं करता — उसके लिए दाईं ओर का डेस्कटॉप शॉर्टकट इस्तेमाल करें।",
    quickNoteTitle: "त्वरित डिक्टेशन नोट",
    quickNoteHint:
      "इस पेज को छोड़े बिना यहीं रिकॉर्ड होता है — दूसरे ऐप्स में पेस्ट नहीं होता। शुरू और बंद करने के लिए बटन का उपयोग करें।",
    ...
    dictionaryDescription:
      "यहाँ के शब्द वाक् पहचान को आपकी पसंदीदा वर्तनी की ओर ले जाते हैं — सुधारों से अपने आप सीखे जाते हैं, या अपने जोड़ें।",
    dictionaryTermPlaceholder: "शब्द",
    dictionaryReplacementPlaceholder: "प्रतिस्थापन (वैकल्पिक)",
    dictionaryAdd: "जोड़ें",
    dictionaryLoading: "शब्दकोश लोड हो रहा है…",
    dictionaryEmpty: "अभी कोई सीखे गए शब्द नहीं।",
    dictionaryUsesCount: "{{count}} बार उपयोग",
    dictionaryRemove: "हटाएँ",
    vocabularyAddFailed: "शब्द जोड़ा नहीं जा सका",
    vocabularyRemoveFailed: "शब्द हटाया नहीं जा सका",
  },
  clipsFinalRaw: {
  ...
  meetingsRoute: {
    ...
    howToTriggerTitle: "मीटिंग नोट्स कैसे शुरू करें",
    howToTriggerDescription:
      "मीटिंग नोट्स Clips का Granola-शैली फ़्लो है: कैलेंडर इवेंट यहाँ दिखते हैं, डेस्कटॉप ऐप माइक और सिस्टम ऑडियो कैप्चर करता है, और ट्रांसक्रिप्ट व AI नोट्स इसी इतिहास में लौटते हैं।",
    guideCalendarTitle: "Google Calendar कनेक्ट करें",
    guideCalendarDescription:
      "मीटिंगें आपके कैलेंडर से आती हैं ताकि Clips जान सके कि कब याद दिलाना है।",
    guideDesktopTitle: "Clips Desktop खुला रखें",
    guideDesktopDescription:
      "माइक और सिस्टम ऑडियो की ट्रांसक्रिप्शन के लिए डेस्कटॉप कैप्चर ज़रूरी है।",
    guideStartTitle: "नोट्स शुरू करें पर क्लिक करें",
    guideStartDescription:
      "कॉल शुरू होने पर डेस्कटॉप रिमाइंडर या मेनू बार के 'मीटिंग नोट्स शुरू करें' का उपयोग करें।",
  },
  videoProjects: {
    listPageTitle: "वीडियो प्रोजेक्ट · Clips",
    editorPageTitle: "वीडियो प्रोजेक्ट · Clips",
    title: "वीडियो प्रोजेक्ट",
    intro:
      "मल्टी-ट्रैक कंपोज़िशन जो पूरे एडिटर में रिकॉर्डिंग, बी-रोल, कैप्शन और टेक्स्ट को जोड़ती हैं।",
    newProject: "नया प्रोजेक्ट",
    emptyTitle: "अभी कोई वीडियो प्रोजेक्ट नहीं",
    emptyDescription:
      'कोई प्रोजेक्ट बनाएँ, या कोई भी रिकॉर्डिंग खोलकर "वीडियो प्रोजेक्ट" चुनें ताकि उसे स्रोत के रूप में इस्तेमाल किया जा सके।',
    sourceCount_one: "{{count}} क्लिप",
    sourceCount_other: "{{count}} क्लिप",
    projectOptions: "प्रोजेक्ट विकल्प",
    moveToTrash: "ट्रैश में ले जाएँ",
    deleteTitle: "प्रोजेक्ट को ट्रैश में ले जाएँ?",
    deleteDescription:
      '"{{title}}" को ट्रैश में ले जाया जाएगा। इसमें इस्तेमाल की गई रिकॉर्डिंग प्रभावित नहीं होंगी।',
    deleteFailed: "प्रोजेक्ट हटाया नहीं जा सका",
    createFailed: "प्रोजेक्ट बनाया नहीं जा सका",
    openInProject: "वीडियो प्रोजेक्ट में खोलें",
    openInProjectButton: "वीडियो प्रोजेक्ट",
    openInProjectDescription:
      "इस रिकॉर्डिंग को मल्टी-ट्रैक वीडियो प्रोजेक्ट में स्रोत के रूप में जोड़ें।",
    respectEdits: "क्लिप एडिटर से मेरे ट्रिम लागू करें",
    includeCaptions: "ट्रांसक्रिप्ट को कैप्शन के रूप में जोड़ें",
    createAndOpen: "प्रोजेक्ट बनाएँ",
    addAndOpen: "प्रोजेक्ट में जोड़ें",
    addFailed: "प्रोजेक्ट में जोड़ा नहीं जा सका",
    cancel: "रद्द करें",
    back: "वापस",
    backToLibrary: "लाइब्रेरी पर वापस जाएँ",
    saving: "सहेजा जा रहा है…",
