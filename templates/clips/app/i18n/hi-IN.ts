const messages = {
  ...
  recordingPage: {
    ...
    aiSummarySent: "सारांश आपके इनबॉक्स की ओर जा रहा है",
    aiSummaryAlreadySent: "पहले ही आपके इनबॉक्स में भेजा जा चुका है",
    aiSummaryFailed: "सारांश नहीं भेजा जा सका — शेयर ईमेल से फिर से प्रयास करें",
    share: "शेयर करें",
