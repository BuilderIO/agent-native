const messages = {
  ...
  editVersions: {
    ...
    historyTitle: "編輯版本",
    historyDescription:
      "此錄影的所有已提議、已接受、已拒絕與已取代的剪輯版本。",
    historyEmpty: "尚無編輯版本",
    preview: "預覽剪輯",
    previewing: "正在預覽：{{title}}",
    previewFailed: "無法載入預覽",
    exitPreview: "結束預覽",
    restore: "還原",
    restored: "版本已還原 — 先前的編輯已封存",
    restoreFailed: "還原失敗",
    statusProposed: "已提議",
    statusAccepted: "已接受",
    statusRejected: "已拒絕",
  ...
  editorToolbar: {
    ...
    removeSplit: "移除分割點",
    actions: "動作",
    splitAtTime: "在 {{time}} 分割",
    cutSelection: "剪掉所選範圍",
    cutStartToTime: "剪掉開頭 → {{time}}",
    cutTimeToEnd: "剪掉 {{time}} → 結尾",
  ...
  videoProjects: {
    listPageTitle: "影片專案 · Clips",
    editorPageTitle: "影片專案 · Clips",
    title: "影片專案",
    intro: "在完整編輯器中結合錄製、B-roll、字幕與文字的多軌合成。",
    newProject: "新增專案",
    emptyTitle: "尚無影片專案",
    emptyDescription:
      "建立專案，或開啟任一錄製並選擇「影片專案」，將其用作素材來源。",
    sourceCount_one: "{{count}} 個剪輯",
    sourceCount_other: "{{count}} 個剪輯",
    projectOptions: "專案選項",
    moveToTrash: "移到廢紙簍",
    deleteTitle: "要將專案移到廢紙簍嗎？",
    deleteDescription: "「{{title}}」將被移到廢紙簍。其中使用的錄製不受影響。",
    deleteFailed: "無法刪除專案",
    createFailed: "無法建立專案",
    openInProject: "在影片專案中開啟",
    openInProjectButton: "影片專案",
    openInProjectDescription: "將此錄製新增為多軌影片專案中的素材來源。",
    respectEdits: "套用我在剪輯編輯器中的修剪",
    includeCaptions: "將轉錄新增為字幕",
    createAndOpen: "建立專案",
    addAndOpen: "加入專案",
    addFailed: "無法加入專案",
    cancel: "取消",
    ...
    saved: "已儲存",
    saveFailed: "儲存失敗",
    loadFailed: "無法載入此專案。它可能已被刪除，或你沒有存取權限。",
