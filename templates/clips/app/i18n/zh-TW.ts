const messages = {
  ...
  settings: {
    ...
    experimentVideoEditingDescription: "試用新的影片編輯器。",
    experimentMeetings: "會議與轉錄",
    experimentMeetingsDescription: "試用自動會議擷取與轉錄功能。",
    experimentWisprFlow: "語音聽寫",
    experimentWisprFlowDescription: "試用新的語音聽寫功能。",
