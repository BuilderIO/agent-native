const messages = {
  ...
  clipsFinalRaw: {
    ...
    connectStorageToFinish: "Ábrelo para conectar almacenamiento y terminar de guardar.",
    retryFromClipsMenu: "Reintenta desde el menú de Clips; no hace falta grabar de nuevo.",
    ...
    passwordProtectedDescription: "Este video está protegido. Introduce la contraseña para verlo.",
    password: "Contraseña",
    unlock: "Desbloquear",
