const messages = {
  ...
  recordingPage: {
    ...
    aiSummarySent: "El resumen va en camino a tu bandeja de entrada",
    aiSummaryAlreadySent: "Ya se envió a tu bandeja de entrada",
    aiSummaryFailed:
      "No se pudo enviar el resumen; inténtalo de nuevo desde el correo compartido",
    share: "Compartir",
