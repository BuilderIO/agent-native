export default {
  ...
  settings: {
    ...
    eventRulePlaceholderAccept: "مثال: اقبل الاجتماعات الفردية مع فريقي",
    ...
    eventRuleActivityDeclined: "تم الرفض",
    eventRuleActivityHidden: "تم الإخفاء",
    eventRuleUndoDone: "تم التراجع عن الإجراء",
    eventRuleUndoFailed: "تعذّر التراجع عن هذا الإجراء",
    eventRulesActive:
      "تعمل القواعد كل 5 دقائق على التقويم الأساسي للحسابات المتصلة.",
    eventRulesDisabled:
      "فعّل RUN_BACKGROUND_JOBS=1 على خادم Calendar دائم التشغيل.",
    eventRulesDeploymentDisabled: "تم تعطيل الأتمتة المجدولة لهذا النشر.",
