...
const PLATFORM_DEFINITIONS: PlatformDefinition[] = [
  {
    ...
    label: "Slack",
    icon: IconBrandSlack,
    description: "Receive mentions and DMs in one workspace-aware dispatcher.",
  ...
  },
  {
    ...
    description: "Chat with dispatcher through a Telegram bot.",
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              ...
              dispatcher can receive inbound messages and respond in the same
              conversation.
            </p>
          </div>
