...
const enUS = {
  ...
  multiScreenCanvas: {
    ...
    option: "Option",
    openAndDuplicate:
      "Open {{display}}. Option-click or Option-drag to duplicate.",
    openAndPreview: "Open {{display}}. Option-drag previews a duplicate.",
    sources: {
      localhost: {
        label: "Localhost",
...
const designModeFeatureOverrides = {
  ...
  "zh-CN": {
    ...
    multiScreenCanvas: {
      ...
      preview: "预览",
      option: "Option",
      openAndDuplicate: "打开 {{display}}。按 Option 点击或拖拽即可复制。",
      openAndPreview: "打开 {{display}}。按 Option 拖拽可预览副本。",
      sources: {
  ...
  "es-ES": {
    ...
    multiScreenCanvas: {
      ...
      option: "Opción",
      openAndDuplicate:
        "Abrir {{display}}. Opción-clic o arrastra para duplicar.",
      openAndPreview:
        "Abrir {{display}}. Arrastra con Opción para previsualizar.",
      sources: {
        localhost: {
          label: "Local",
  ...
  "fr-FR": {
    ...
    multiScreenCanvas: {
      ...
      option: "Option",
      openAndDuplicate:
        "Ouvrir {{display}}. Option-clic ou glisser pour dupliquer.",
      openAndPreview:
        "Ouvrir {{display}}. Glisser avec Option pour prévisualiser.",
      sources: {
  ...
  "de-DE": {
    ...
    multiScreenCanvas: {
      ...
      option: "Option",
      openAndDuplicate:
        "{{display}} öffnen. Option-Klick oder Ziehen dupliziert.",
      openAndPreview:
        "{{display}} öffnen. Ziehen mit Option zeigt Duplikatvorschau.",
      sources: {
        localhost: {
          label: "Lokal",
  ...
  "ja-JP": {
    ...
    multiScreenCanvas: {
      ...
      option: "Option",
      openAndDuplicate:
        "{{display}} を開きます。Optionクリックまたはドラッグで複製。",
      openAndPreview:
        "{{display}} を開きます。Optionドラッグで複製をプレビュー。",
      sources: {
        localhost: {
          label: "ローカル",
  ...
  "ko-KR": {
    ...
    multiScreenCanvas: {
      ...
      option: "Option",
      openAndDuplicate:
        "{{display}} 열기. Option 클릭 또는 드래그로 복제합니다.",
      openAndPreview: "{{display}} 열기. Option 드래그로 복제를 미리봅니다.",
      sources: {
  ...
  "pt-BR": {
    ...
    multiScreenCanvas: {
      ...
      option: "Opção",
      openAndDuplicate:
        "Abrir {{display}}. Clique ou arraste com Opção para duplicar.",
      openAndPreview:
        "Abrir {{display}}. Arraste com Opção para pré-visualizar.",
      sources: {
  ...
  "hi-IN": {
    ...
    multiScreenCanvas: {
      ...
      preview: "पूर्वावलोकन",
      option: "Option",
      openAndDuplicate: "{{display}} खोलें। Option-क्लिक या ड्रैग से डुप्लिकेट करें।",
      openAndPreview: "{{display}} खोलें। Option-ड्रैग से डुप्लिकेट पूर्वावलोकन करें।",
      sources: {
  ...
  "ar-SA": {
    ...
    multiScreenCanvas: {
      ...
      preview: "معاينة",
      option: "Option",
      openAndDuplicate: "افتح {{display}}. انقر أو اسحب مع Option للتكرار.",
      openAndPreview: "افتح {{display}}. اسحب مع Option لمعاينة التكرار.",
      sources: {
