    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["es-ES"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "Prueba los ajustes de diseño con IA. Son inestables y pueden tener errores.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["fr-FR"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "Essayez les ajustements de design avec l’IA. Ils sont instables et peuvent contenir des bugs.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["de-DE"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "Teste KI-gestützte Design-Anpassungen. Sie sind instabil und können Fehler enthalten.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["ja-JP"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "AI によるデザイン調整をお試しください。不安定でバグがある可能性があります。",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["ko-KR"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "AI 기반 디자인 트윅을 사용해 보세요. 불안정하며 버그가 있을 수 있습니다.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["pt-BR"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "Experimente ajustes de design com IA. Eles são instáveis e podem apresentar bugs.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["hi-IN"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "AI-संचालित डिज़ाइन ट्वीक आज़माएँ। यह अस्थिर है और इसमें बग हो सकते हैं।",
        },
        designEditor: {
          toasts: {
            tweakConflict:
    ...
    mergePartialMessages(
      ...
      designAuthorFilterOverrides["ar-SA"],
      {
        ...
        settings: {
          ...
          experimentTweaksDescription:
            "جرّب تعديلات التصميم المدعومة بالذكاء الاصطناعي. إنها غير مستقرة وقد تحتوي على أخطاء.",
        },
        designEditor: {
          toasts: {
            tweakConflict:
