...
export function ShaderControlsDemo() {
  ...
  return (
    <div style={{ display: "flex", gap: 24, padding: 24, background: "#111", minHeight: "100vh" }}>
      <div style={{ width: 280 }}>
        <h3 style={{ color: "white", marginBottom: 12, fontSize: 12 }}>MeshGradient</h3>
        <ShaderControls descriptor={mesh} onChange={setMesh} />
        <pre style={{ color: "#888", fontSize: 10, marginTop: 8, overflow: "auto" }}>
          {JSON.stringify(mesh, null, 2)}
        </pre>
      </div>
      <div style={{ width: 280 }}>
        <h3 style={{ color: "white", marginBottom: 12, fontSize: 12 }}>GrainGradient</h3>
