...
function ReviewPin({
  ...
  return (
    <div
      ...
      style={{
        left: !sameReviewAnchorPoint(dragPoint, point)
          ? canvasRect.left + (dragPoint.xPct / 100) * canvasRect.width
          : (clientPoint?.x ??
            canvasRect.left + (point.xPct / 100) * canvasRect.width),
        top: !sameReviewAnchorPoint(dragPoint, point)
          ? canvasRect.top + (dragPoint.yPct / 100) * canvasRect.height
          : (clientPoint?.y ??
