...
const messages = {
  systemCreation: {
    sourcesTitle: "新增參考資料",
    fileTypes: "design.md、文件與圖片 · 每個檔案最大 20 MiB",
    fileTooLarge: "請選擇小於 20 MiB 的檔案。",
    title: "建立設計系統",
    name: "名稱",
    startFrom: "起點",
    fresh: "從頭開始",
    freshDescription: "與代理程式一起決定新的設計方向。",
    references: "參考資料",
    referencesDescription: "從檔案、Figma 或網站開始建立。",
    continue: "繼續",
    back: "返回",
    cancel: "取消",
    create: "建立設計系統",
    ...
    submitting: "正在儲存…",
    remove: "移除 {{name}}",
    nameRequired: "請輸入設計系統名稱。",
    sourceRequired: "請新增參考資料，並完成或移除待處理的檔案。",
    invalidWebsite: "請輸入以 http:// 或 https:// 開頭的網站網址。",
    invalidFigma: "請輸入有效的 Figma 檔案或設計網址。",
    unsupportedFile: "請選擇 Markdown、文字、PDF、DOCX、PPTX 或圖片。",
    emptyFile: "無法新增空檔案。",
    uploadFailed: "無法上傳此檔案，請重試。",
    submitFailed: "無法儲存。參考資料已保留，請重試。",
    editUnavailable: "無法編輯此系統。",
  },
  systemWorkspace: {
    openPreview: "開啟預覽",
    chatTab: "聊天",
    canvasTab: "畫布",
    tokenDetails: "設計權杖詳細資料",
    excludeSource: "排除來源",
    restoreSource: "還原來源",
    freshKickoff: "幫我決定此系統的方向。",
    referencesKickoff: "根據參考資料建立此系統。",
    foundations: "基礎",
    components: "元件",
    rules: "使用規則",
    colors: "色彩",
    ...
    retry: "重試",
    empty: "在聊天中描述系統以開始建立。",
    emptySection: "尚無已儲存的輸出",
    conversation: "系統對話",
    canvas: "系統畫布",
    loadFailed: "無法載入此系統",
    previewFailed: "無法載入此產物",
    selected: "已選取",
    preparing: "正在準備工作區",
    awaitingDirection: "等待你的方向",
    readingSources: "正在讀取來源",
    draftingFoundations: "正在規劃基礎",
    buildingComponents: "正在建立元件",
    ready: "已儲存",
    needsAttention: "需要處理",
    extracted: "已擷取",
    inferred: "已推斷",
  ...
  composerContext: {
    unsupportedDocument: "無法讀取此文件。請移除它或附加支援的文字檔案。",
    design: "設計",
    slides: "投影片",
    useSystem: "使用設計系統",
    attachFigma: "附加 Figma",
    referenceDesign: "參照設計",
    referenceDeck: "參照簡報",
    unavailable: "無法讀取此來源。請重試或移除。",
    saveFailed: "無法儲存脈絡",
    inspect: "檢視脈絡",
    invalidFigmaUrl: "請輸入有效的 Figma 檔案或畫框連結。",
    figmaUrl: "Figma 連結",
    browseFrames: "瀏覽畫框",
    retry: "重試",
    search: "搜尋",
    noResults: "沒有結果",
    refineSearch: "縮小搜尋範圍以尋找更多結果。",
    resolving: "解析中…",
    attach: "附加",
    back: "返回",
    remove: "移除",
  ...
  home: {
    ...
    starterSaas: "建立 SaaS 到達頁面",
    starterDashboard: "建立儀表板",
    starterPricing: "定價頁面",
    starterMobile: "建立簡報",
    prototype: "原型",
    other: "其他",
  ...
  designSystemSetup: {
    simple: {
      name: "名稱",
      startingPoint: "開始方式",
      freshDescription: "與代理程式一起構思新的設計方向。",
      referencesDescription: "根據你的檔案、Figma 或網站建立。",
      startFresh: "從零開始",
      yourReferences: "參考資料",
      select: "選擇",
      website: "網站",
      advanced: "進階",
      freshPrompt: "幫我確定「{{name}}」的設計方向。",
      referencePrompt: "根據我的參考資料設定「{{name}}」。",
      nameRequired: "請輸入設計系統名稱。",
    ...
    staged: {
      ...
      files: "檔案與本機程式碼",
      chooseFiles: "選擇檔案",
      websiteUrls: "網站網址（每行一個）",
      addRepository: "新增儲存庫",
      sourceRequired: "請至少新增一項參考資料。",
      referenceAdded: "已新增",
      chatFailed: "無法啟動聊天。參考資料已保留在此處，請重試。",
      startFailed: "無法準備參考資料，請重試。",
      descriptions: {
        figma: "上傳 Figma 本機副本。",
        website: "參考網站的外觀與風格。",
        github: "新增儲存庫、分支或指定路徑。",
        files: "使用文件、圖片、素材或原始碼。",
        designMd: "新增已儲存的設計指南。",
        existing: "以設計系統或專案為起點。",
        notes: "加入偏好與可重複使用的指示。",
      },
    },
    importedBrand: "進口品牌",
