...
- Slack mentions asking about analytics, pageviews, traffic, visits, views, conversions, or dashboard metrics must be delegated to the analytics agent via call-agent.
