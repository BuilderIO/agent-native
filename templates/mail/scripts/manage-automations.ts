 ...
 *
 * Usage:
 *   pnpm script manage-automations --action=list
 *   pnpm script manage-automations --action=create --name="Label newsletters" --condition="from a newsletter or marketing mailing list" --actions='[{"type":"label","labelName":"newsletters"}]'
 *   pnpm script manage-automations --action=update --id=abc123 --enabled=false
 *   pnpm script manage-automations --action=delete --id=abc123
 *   pnpm script manage-automations --action=enable --id=abc123
 *   pnpm script manage-automations --action=disable --id=abc123
 */
...
export default async function main(): Promise<void> {
  ...
  if (!args.action) {
    fatal(
      "--action is required. Usage: pnpm script manage-automations --action=list",
    );
  }
