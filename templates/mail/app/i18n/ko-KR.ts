const messages = {
  ...
  mail: {
    ...
    sort: {
      ...
      priorityScoreHelp:
        "점수가 높을수록 Jev가 더 중요하다고 판단한 메시지입니다.",
      priorityFeedbackSuggestion:
        "이 피드백 패턴을 중요도 또는 자동 보관 규칙으로 만들 수 있습니다.",
      priorityFeedbackAskAgent: "에이전트에 규칙 제안 요청",
      aiSetupTitle: "AI 받은편지함 설정",
      aiSetupTagLabel: "AI 태그 만들기",
      aiSetupImportanceLabel: "중요한 메일",
      aiSetupSpamLabel: "스팸 및 원치 않는 메일",
      aiSetupArchiveLabel: "자동 보관",
      aiSetupSave: "설정 저장",
      aiSetupSkip: "나중에 하기",
      aiSetupImportantHeadline: "중요한 항목",
      aiSetupSkipInboxHeadline: "받은편지함을 건너뛸 항목",
      aiSetupTagsHeadline: "탭 선택",
      aiSetupArchiveSpamHeadline: "자동 보관 및 스팸",
      aiSetupTagReceipts: "영수증",
      aiSetupTagUpdates: "제품 업데이트",
      aiSetupTagGitHub: "GitHub 사람 댓글",
      aiSetupPromptReceipts: "온라인 상점의 영수증 및 주문 확인",
      aiSetupPromptUpdates: "사용 중인 도구의 제품 업데이트 및 릴리스 노트",
      aiSetupPromptGitHub: "사람이 댓글을 남긴 GitHub 알림",
      ...
      aiSetupTagTravel: "여행",
      aiSetupPromptTravel: "필요한 여행 확인 및 예약",
      aiSetupTagFinance: "금융",
      aiSetupPromptFinance: "필요한 청구서와 계좌 명세서",
      priorityFeedbackLabel: "중요도 피드백",
      priorityScoreHigh: "중요도 높음",
      priorityScoreMedium: "중요도 보통",
      priorityScoreLow: "중요도 낮음",
      priorityEditRules: "중요도 규칙 편집",
      aiSetupContinue: "계속",
    },
    toolbar: {
      toggleMenu: "메뉴 전환",
    ...
    tabSettings: {
      ...
      allTab: "전체 탭",
      help: "통합 받은편지함은 모든 계정을 함께 표시합니다. 끄면 메일이 탭으로 나뉩니다.",
      aiSetup: "AI 태그 및 규칙 설정",
    },
    accounts: {
      remove: "제거",
      connecting: "연결 중...",
    ...
    aiFilter: {
      ...
      archivePlaceholder: "예: 확인할 필요가 없는 GitHub 봇 알림",
