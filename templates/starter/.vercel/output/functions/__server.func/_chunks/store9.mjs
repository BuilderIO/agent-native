import{i as e,l as t,o as n}from"./client.mjs";import{t as r}from"./migrations.mjs";function i(e,t){if(!e)return t;try{return JSON.parse(String(e))}catch{return t}}const a=[`agent_trace_spans`,`agent_trace_summaries`,`agent_satisfaction_scores`,`agent_evals`,`agent_feedback`];function o(e,t,n){return n==null?{where:e,args:t}:{where:`${e} AND user_id = ?`,args:[...t,n]}}let s;async function c(){return s||=(async()=>{let t=e();await t.execute(`
