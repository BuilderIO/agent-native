import{i as e}from"./request-context-60tSGHqu.mjs";import"./auth-Dww4On4H.mjs";import{a as t,o as n}from"./store-0r6YYqsq.mjs";import{r,t as i}from"./utils-Bt3wDA98.mjs";function a(){let t=e();return!t||t===`local@localhost`?`local@localhost`:t}function o(e){let t=new Date(e),n=new Date().getTime()-t.getTime(),r=Math.floor(n/864e5);return r===0?t.toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}):r===1?`Yesterday`:r<7?t.toLocaleDateString([],{weekday:`short`}):t.toLocaleDateString([],{month:`short`,day:`numeric`})}async function s(e){let s=r(e);if(s.help===`true`){console.log(`Usage: pnpm action search-chats [options]
