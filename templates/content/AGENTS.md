...
| `lookup-builder-safe-model-intent`          | `--marker <exact-marker>` or `--exactTitle <exact-title>`                                                                                                                                          | Read-only ambiguous-write proof in the safe Builder model; returns count, IDs, timestamps, and publication state only                                                                                                                 |
