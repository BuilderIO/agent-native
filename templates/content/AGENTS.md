...
| `list-document-properties`                  | `--documentId <id> --databaseId <id> [--format json]`                                                                                                                                              | List property definitions and values from the exact database membership                                                                                                           |
| `configure-document-property`               | `--documentId <id> --databaseId <id> [--id <propertyId>] --name <name> --type <type> [--description <text>] [--visibility always_show\|hide_when_empty\|always_hide] [--options <json>]`           | Create or update a property definition in the exact database membership                                                                                                           |
| `duplicate-document-property`               | `--documentId <id> --databaseId <id> --propertyId <propertyId>`                                                                                                                                    | Duplicate a property definition and its stored values in the exact database                                                                                                       |
| `delete-document-property`                  | `--documentId <id> --databaseId <id> --propertyId <propertyId>`                                                                                                                                    | Delete a property definition and its stored values from the exact database                                                                                                        |
| `set-document-property`                     | `--documentId <id> --databaseId <id> --propertyId <propertyId> --value <json>`                                                                                                                     | Set a value in the exact database membership (for a `blocks` field, the value is its markdown content)                                                                            |
| `reorder-document-property`                 | `--documentId <id> --databaseId <id> --propertyId <propertyId> --targetPropertyId <id> [--position before\|after]`                                                                                 | Reorder a property definition within the exact database (used to reorder Blocks fields on the page)                                                                               |
