 ...
 *   pnpm script update-document --id abc123 --title "New" --content "New body"
 *   pnpm script update-document --id abc123 --icon "📝"
 *
 * Options:
...
export default async function main(args: string[]) {
  ...
  if (opts.help) {
    console.log(
      'Usage: pnpm script update-document --id <id> [--title "New Title"] [--content "# New"]',
    );
    return;
  }
