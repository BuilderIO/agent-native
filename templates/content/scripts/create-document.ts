 ...
 *
 * Usage:
 *   pnpm script create-document --title "My Page"
 *   pnpm script create-document --title "My Page" --content "# Hello"
 *   pnpm script create-document --title "Sub Page" --parentId parent123
 *   pnpm script create-document --title "Notes" --icon "📝"
 *
 * Options:
...
export default async function main(args: string[]) {
  ...
  if (opts.help) {
    console.log(
      'Usage: pnpm script create-document --title "My Page" [--content "# Hello"] [--parentId id] [--icon "📝"]',
    );
    return;
  }
