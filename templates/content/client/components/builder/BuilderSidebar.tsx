...
export function BuilderSidebar({
  ...
  } = useFileContent(projectSlug, activeDraft);
  ...
  const metadataMarkdown = isEditingDraft
    ? markdown
    : draftContentState || draftData?.content || "";
  const isReady =
    isEditingDraft || (!isDraftLoading && (draftData || isDraftError));
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-border shrink-0 bg-muted/30">
        <h3 className="text-sm font-semibold text-foreground flex items-center gap-2">
          ...
          >
            ...
            <path
              d="M0 109.714H182.857V182.857H0V109.714Z"
              fill="currentColor"
            />
            <path
              d="M0 219.429H109.714V292.571H0V219.429Z"
              fill="currentColor"
            />
          </svg>
          Builder.io
