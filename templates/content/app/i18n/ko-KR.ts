...
const rawLiterals = {
  ...
  sidebar: {
    ...
    moveToSpaceWarningShared: "{{space}}의 모든 사람이 “{{title}}” 및 하위 페이지를 볼 수 있게 됩니다. 현재 공유 설정과 공개 링크가 제거되고 내가 소유자가 됩니다.",
    moveToSpaceWarningPrivate: "“{{title}}” 및 하위 페이지는 {{space}}에서 나만 볼 수 있게 됩니다. 현재 공유 설정과 공개 링크가 제거되고 내가 소유자가 됩니다.",
    back: "뒤로",
    movePage: "이동",
