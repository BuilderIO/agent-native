...
const overrides = {
  ...
  comments: {
    ...
    aiAppliedAndResolved: "적용 후 해결됨",
    aiChangeUndone: "변경 취소됨",
    aiUndo: "실행 취소",
    aiDone: "완료",
    ...
    retry: "다시 시도",
    aiQueued: "AI가 대기 중…",
    aiRefreshing: "AI가 최신 페이지를 확인 중…",
    aiCancelled: "AI 요청이 중지됨",
    aiStop: "중지",
    aiStopping: "중지 중…",
    aiReplyToAi: "AI에게 답글",
    aiReplyingToAi: "AI에게 답글 작성 중",
    aiOpenConversation: "AI 대화 열기",
    aiConversationPrefill: "이 댓글 대화 계속하기…",
