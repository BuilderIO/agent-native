...
const editor = {
  ...
  properties: {
    ...
    back: "뒤로",
    relatedDatabase: "관련 데이터베이스",
    searchDatabases: "데이터베이스 검색",
    thisDatabase: "이 데이터베이스",
    noDatabases: "데이터베이스를 찾을 수 없음",
    searchPages: "페이지 검색",
    noMatchingPages: "일치하는 페이지 없음",
    removeRelation: "{{name}} 제거",
    openPage: "{{name}} 열기",
    unavailablePage: "사용할 수 없는 페이지",
    unavailablePageCount_zero: "{{count}}개 사용할 수 없음",
    unavailablePageCount_one: "{{count}}개 사용할 수 없음",
    unavailablePageCount_two: "{{count}}개 사용할 수 없음",
    unavailablePageCount_few: "{{count}}개 사용할 수 없음",
    unavailablePageCount_many: "{{count}}개 사용할 수 없음",
    unavailablePageCount_other: "{{count}}개 사용할 수 없음",
    noRelatedDatabase: "관련 데이터베이스가 설정되지 않음",
    linkAPage: "페이지 연결 또는 만들기…",
    createPage: "“{{name}}” 만들기",
    reorderRelation: "{{name}} 순서 변경",
    selectMore: "더 선택",
    selectAPage: "페이지 선택",
    selectedCount_zero: "{{count}}개 선택됨",
    selectedCount_one: "{{count}}개 선택됨",
    selectedCount_two: "{{count}}개 선택됨",
    selectedCount_few: "{{count}}개 선택됨",
    selectedCount_many: "{{count}}개 선택됨",
    selectedCount_other: "{{count}}개 선택됨",
