...
const overrides = {
  ...
  comments: {
    ...
    aiAppliedAndResolved: "लागू किया और हल किया",
    aiChangeUndone: "बदलाव पूर्ववत किया गया",
    aiUndo: "पूर्ववत करें",
    aiDone: "हो गया",
    ...
    aiQueued: "AI कतार में है…",
    aiRefreshing: "AI नवीनतम पेज जाँच रहा है…",
    aiCancelled: "AI अनुरोध रोक दिया गया",
    aiStop: "रोकें",
    aiStopping: "रोका जा रहा है…",
    aiReplyToAi: "AI को जवाब दें",
    aiReplyingToAi: "AI को जवाब दे रहे हैं",
    aiOpenConversation: "AI बातचीत खोलें",
    aiConversationPrefill: "इस टिप्पणी की बातचीत जारी रखें…",
