...
const rawLiterals = {
  ...
  sidebar: {
    ...
    moveToSpaceWarningShared: "{{space}} में सभी लोग “{{title}}” और इसके सब-पेज देख सकेंगे। मौजूदा शेयरिंग और सार्वजनिक लिंक हटा दिए जाएँगे, और आप इसके मालिक बन जाएँगे।",
    moveToSpaceWarningPrivate: "{{space}} में “{{title}}” और इसके सब-पेज केवल आपके लिए निजी होंगे। मौजूदा शेयरिंग और सार्वजनिक लिंक हटा दिए जाएँगे, और आप इसके मालिक बन जाएँगे।",
    back: "वापस",
    movePage: "ले जाएँ",
