...
const overrides = {
  ...
  comments: {
    ...
    aiAppliedAndResolved: "تم التطبيق والحل",
    aiChangeUndone: "تم التراجع عن التغيير",
    aiUndo: "تراجع",
    aiDone: "تم",
    ...
    aiQueued: "طلب الذكاء الاصطناعي في قائمة الانتظار…",
    aiRefreshing: "الذكاء الاصطناعي يتحقق من أحدث صفحة…",
    aiCancelled: "تم إيقاف طلب الذكاء الاصطناعي",
    aiStop: "إيقاف",
    aiStopping: "جارٍ الإيقاف…",
    aiReplyToAi: "الرد على الذكاء الاصطناعي",
    aiReplyingToAi: "الرد على الذكاء الاصطناعي",
    aiOpenConversation: "فتح محادثة الذكاء الاصطناعي",
    aiConversationPrefill: "متابعة محادثة التعليق هذه…",
