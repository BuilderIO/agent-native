...
const rawLiterals = {
  ...
  sidebar: {
    ...
    moveToSpaceWarningShared: "{{space}} の全員が「{{title}}」とそのサブページを閲覧できるようになります。現在の共有設定と公開リンクは削除され、あなたが所有者になります。",
    moveToSpaceWarningPrivate: "「{{title}}」とそのサブページは {{space}} であなただけが閲覧できるようになります。現在の共有設定と公開リンクは削除され、あなたが所有者になります。",
    back: "戻る",
    movePage: "移動",
