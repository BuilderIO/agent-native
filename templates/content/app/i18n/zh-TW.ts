...
const messages = {
  ...
  relationships: {
    ...
    forwardLabel: "欄名稱",
    forwardLabelPlaceholder: "貢獻者",
    inverseLabel: "在連結頁面上顯示的名稱",
    inverseLabelPlaceholder: "交付項目",
    ...
    retryDatabases: "重新載入集合",
    noDatabases: "沒有相符的集合",
    createInverseProperty: "同時在 {{name}} 中新增一欄",
    createInversePropertyUnselected: "同時在連結的集合中新增一欄",
    inverseEditable: "允許從反向屬性編輯",
    retryRelationships: "重新載入關聯",
    noExistingRelationships: "沒有現有關聯",
    configurationFailed: "無法新增關聯。",
    valueUnavailable: "無法使用",
    empty: "空白",
    moreCount: "+{{count}} 個",
    searchPages: "搜尋頁面",
    searchForProperty: "搜尋 {{name}} 的頁面",
    noMatchingPages: "沒有相符的頁面",
    loadFailed: "無法載入關聯。",
    tryAgain: "再試一次",
    routeUnavailable: "此關聯在這裡是唯讀的。",
    refreshBeforeReplacing: "請重新整理後再取代此關聯。",
    updateFailed: "無法更新關聯。",
    requestInterrupted: "請求已中斷。請重試相同變更，以確認是否已儲存。",
    retrySavedChange: "重試相同變更",
    legacyUnsupported: "尚無法在這裡編輯此舊版關聯。",
    done: "完成",
    cancel: "取消",
    connections: "連結",
    noConnections: "沒有連結",
    retryConnections: "重新載入連結",
    removeConnection: "移除與 {{name}} 的連結",
    connectionRemoved: "已移除連結",
    removeFailed: "無法移除連結。",
    history: "歷史記錄",
    noHistory: "沒有關聯歷史記錄",
    retryHistory: "重新載入歷史記錄",
    ...
    noSharedRelationships: "所選資料列中沒有相符的關聯",
    apply: "套用",
    bulkAdded: "已將關聯新增至 {{count}} 列",
    bulkRemoved: "已從 {{count}} 列移除關聯",
    bulkUpdated: "已更新 {{count}} 個關聯",
    bulkFailed: "未變更任何關聯。",
    bulkInverseMaxOne: "單頁關聯無法將一個來源頁面指派給多個所選資料列。",
    removeProperty: "移除關聯屬性",
    removePropertyNamed: "從此資料庫移除 {{name}}。",
    relationshipsPreserved: "預設會保留關聯",
    selectRelationshipsToRemove: "同時移除所選關聯",
    filterRelationships: "篩選關聯",
    noMatchingRelationships: "沒有相符的關聯",
    removalPreviewFailed: "無法載入關聯預覽。",
    removePropertyOnly: "僅移除屬性",
    removePropertyAndSelected: "移除屬性和 {{count}} 個所選關聯",
    propertyRemoved: "已移除關聯屬性",
    removePropertyFailed: "無法移除關聯屬性。",
    states: {
      active: "有效",
      suspended: "已暫停",
      inactive: "無效",
