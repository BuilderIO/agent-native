...
const overrides = {
  ...
  comments: {
    ...
    aiAppliedAndResolved: "已套用並解決",
    aiChangeUndone: "已復原變更",
    aiUndo: "復原",
    aiDone: "完成",
    ...
    retry: "重試",
    aiQueued: "AI 正在排隊…",
    aiRefreshing: "AI 正在檢查最新頁面…",
    aiCancelled: "AI 請求已停止",
    aiStop: "停止",
    aiStopping: "正在停止…",
    aiReplyToAi: "回覆 AI",
    aiReplyingToAi: "正在回覆 AI",
    aiOpenConversation: "開啟 AI 對話",
    aiConversationPrefill: "繼續此留言對話…",
    aiConversationUnavailable: "此 AI 對話無法使用。",
    aiFollowUpYou: "你",
    aiFollowUpIncomplete: "此回覆尚未完成。",
    aiRequestCouldNotBeConfirmed: "無法確認 AI 請求",
    aiFollowUpCouldNotBeConfirmed: "無法確認 AI 後續請求",
    aiRequestStopCouldNotBeConfirmed: "由於傳送未確認，無法停止 AI 請求",
    sourceComment: "來源留言",
    resolve: "解決",
    resolved: "已解決（{{count}}）",
    unanchored: "無法使用醒目提示",
