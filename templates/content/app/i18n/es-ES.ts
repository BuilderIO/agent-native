...
const rawLiterals = {
  ...
  sidebar: {
    ...
    moveToSpaceWarningShared: "Todos en {{space}} podrán ver «{{title}}» y sus subpáginas. Se quitan el uso compartido actual y el enlace público, y pasas a ser el propietario.",
    moveToSpaceWarningPrivate: "«{{title}}» y sus subpáginas serán privadas para ti en {{space}}. Se quitan el uso compartido actual y el enlace público, y pasas a ser el propietario.",
    back: "Atrás",
    movePage: "Mover",
