...
const editor = {
  ...
  failedToCreateDatabase: "Échec de la création de la base de données intégrée",
  ...
  properties: {
    ...
    addDatabaseDescription: "Ajoutez une description de cette base de données…",
...
const overrides = {
  ...
  root: {
    ...
    commandSearchPlaceholder: "Rechercher des documents et bases de données...",
