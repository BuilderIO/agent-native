...
const overrides = {
  ...
  comments: {
    ...
    aiAppliedAndResolved: "已应用并解决",
    aiChangeUndone: "已撤销更改",
    aiUndo: "撤销",
    aiDone: "完成",
    ...
    retry: "重试",
    aiQueued: "AI 正在排队…",
    aiRefreshing: "AI 正在检查最新页面…",
    aiCancelled: "AI 请求已停止",
    aiStop: "停止",
    aiStopping: "正在停止…",
    aiReplyToAi: "回复 AI",
    aiReplyingToAi: "正在回复 AI",
    aiOpenConversation: "打开 AI 对话",
    aiConversationPrefill: "继续此评论对话…",
    aiConversationUnavailable: "此 AI 对话不可用。",
    aiFollowUpYou: "你",
    aiFollowUpIncomplete: "此回复未完成。",
    aiRequestCouldNotBeConfirmed: "无法确认 AI 请求",
    aiFollowUpCouldNotBeConfirmed: "无法确认 AI 后续请求",
    aiRequestStopCouldNotBeConfirmed: "由于发送未确认，无法停止 AI 请求",
    sourceComment: "源评论",
    resolve: "解决",
    resolved: "已解决（{{count}}）",
    reply: "回复...",
