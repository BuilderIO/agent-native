...
const previewDraftRecoveryMessagesByLocale = {
  "zh-CN": [
    "选择要保留的版本",
    "你的编辑",
    "已保存版本",
  ...
  "es-ES": [
    ...
    "Guardar la mía como página aparte",
    "Tus cambios se guardaron en el historial",
    "Tus cambios se guardaron como página aparte",
  ],
  "fr-FR": [
  ...
  "ko-KR": [
    ...
    "저장된 버전 사용",
    "내 버전을 별도 페이지로 저장",
    "편집 내용이 버전 기록에 저장되었습니다",
    "편집 내용이 별도 페이지로 저장되었습니다",
  ],
  "pt-BR": [
    ...
    "Manter minha versão",
    "Usar a versão salva",
    "Salvar a minha como página separada",
    "Suas edições foram salvas no histórico",
    "Suas edições foram salvas como página separada",
  ],
  "hi-IN": [
    "चुनें कि कौन-सा वर्शन रखना है",
    "आपके बदलाव",
    "सहेजा गया वर्शन",
    "मेरा वर्शन रखें",
    "सहेजा गया वर्शन इस्तेमाल करें",
    "मेरे वर्शन को अलग पेज के रूप में सहेजें",
    "आपके बदलाव वर्शन इतिहास में सहेजे गए",
    "आपके बदलाव अलग पेज के रूप में सहेजे गए",
  ],
  "ar-SA": [
    "اختر الإصدار الذي تريد الاحتفاظ به",
    "تعديلاتك",
    "الإصدار المحفوظ",
    "الاحتفاظ بإصداري",
    "استخدام الإصدار المحفوظ",
    "حفظ إصداري كصفحة منفصلة",
    "تم حفظ تعديلاتك في سجل الإصدارات",
    "تم حفظ تعديلاتك كصفحة منفصلة",
  ],
} as const;
const previewDraftOpenPageMessagesByLocale = {
  "zh-CN": "打开页面",
  "zh-TW": "開啟頁面",
  "es-ES": "Abrir página",
  "fr-FR": "Ouvrir la page",
  "de-DE": "Seite öffnen",
  "ja-JP": "ページを開く",
  "ko-KR": "페이지 열기",
  "pt-BR": "Abrir página",
...
const historyCheckpointRecoveryMessagesByLocale = {
  "zh-CN": "已恢复草稿",
  "zh-TW": "已復原草稿",
  "es-ES": "Borrador recuperado",
  "fr-FR": "Brouillon récupéré",
  "de-DE": "Wiederhergestellter Entwurf",
  "ja-JP": "復元した下書き",
  "ko-KR": "복구된 초안",
  "pt-BR": "Rascunho recuperado",
  "hi-IN": "बहाल किया गया ड्राफ़्ट",
  "ar-SA": "مسودة مستردة",
};
...
function mergeMessagesForLocale(
  ...
  return {
    ...
    editor: {
      ...
      previewDraftCompare: previewDraftRecoveryMessagesByLocale[locale][0],
      previewDraftYourEdits: previewDraftRecoveryMessagesByLocale[locale][1],
      previewDraftSavedVersion: previewDraftRecoveryMessagesByLocale[locale][2],
      previewDraftKeepMine: previewDraftRecoveryMessagesByLocale[locale][3],
      previewDraftUseSaved: previewDraftRecoveryMessagesByLocale[locale][4],
      previewDraftSaveSeparately:
        previewDraftRecoveryMessagesByLocale[locale][5],
      previewDraftSavedToHistory:
        previewDraftRecoveryMessagesByLocale[locale][6],
      previewDraftSavedSeparately:
        previewDraftRecoveryMessagesByLocale[locale][7],
      previewDraftOpenSavedPage: previewDraftOpenPageMessagesByLocale[locale],
      historyCheckpointRecovery:
        historyCheckpointRecoveryMessagesByLocale[locale],
