...
const relationshipMessages = {
  ...
  forwardLabel: "Column name",
  forwardLabelPlaceholder: "Contributors",
  inverseLabel: "Name shown on linked pages",
  inverseLabelPlaceholder: "Deliverables",
  inverseLabelHelper:
    "If shown on linked pages, this relationship is called {{name}}.",
  cardinality: "Links per row",
  onePage: "Just one",
  manyPages: "Multiple allowed",
  emptyLinksHelper: "Rows can also be left empty.",
  linkContextOne:
    "Each row in {{source}} can link to just one page in {{target}}.",
  linkContextMany:
    "Each row in {{source}} can link to multiple pages in {{target}}.",
  targetDatabase: "Link to pages in",
  searchDatabases: "Search collections",
  retryDatabases: "Retry collections",
  noDatabases: "No matching collections",
  createInverseProperty: "Also add a column in {{name}}",
  createInversePropertyUnselected: "Also add a column in the linked collection",
  inverseEditable: "Allow editing from the inverse property",
  retryRelationships: "Retry relationships",
  noExistingRelationships: "No existing relationships",
  configurationFailed: "The relation could not be added.",
  valueUnavailable: "Unavailable",
  empty: "Empty",
  moreCount: "+{{count}} more",
  searchPages: "Search pages",
  searchForProperty: "Search pages for {{name}}",
  noMatchingPages: "No matching pages",
  loadFailed: "Relationships could not be loaded.",
  tryAgain: "Try again",
  routeUnavailable: "This relationship is read-only from here.",
  refreshBeforeReplacing: "Refresh before replacing this relationship.",
  updateFailed: "The relationship could not be updated.",
  requestInterrupted:
    "The request was interrupted. Retry the same change to confirm whether it was saved.",
  retrySavedChange: "Retry same change",
  legacyUnsupported: "This legacy relation cannot be edited here yet.",
  done: "Done",
  cancel: "Cancel",
  connections: "Connections",
  noConnections: "No connections",
  retryConnections: "Retry connections",
  removeConnection: "Remove connection to {{name}}",
  connectionRemoved: "Connection removed",
  removeFailed: "The connection could not be removed.",
  history: "History",
  noHistory: "No relationship history",
  retryHistory: "Retry history",
  historyDetailsUnavailable:
    "Relationship history details are unavailable. Refresh history.",
  historyChangeAdded: "Added",
  historyChangeRemoved: "Removed",
  historyChangeReplaced: "Replaced",
  historyChangeRestored: "Restored",
  historyPreviousTarget: "Previously {{name}}",
  historyActor: "{{kind}}: {{name}}",
  historyActorPerson: "Person",
  historyActorAgent: "Agent",
  historyActorAutomation: "Automation",
  historyActorProgrammatic: "Programmatic",
  historyOrigin: "Origin: {{origin}}",
  historyAuthorizedBy: "Authorized by {{principal}}",
  undo: "Undo",
  ...
  noSharedRelationships: "No matching relationships on the selected rows",
  apply: "Apply",
  bulkAdded: "Added relationships to {{count}} rows",
  bulkRemoved: "Removed relationships from {{count}} rows",
  bulkUpdated: "Updated {{count}} relationships",
  bulkFailed: "No relationships changed.",
  bulkInverseMaxOne:
    "A one-page relationship cannot assign one source page to multiple selected rows.",
  removeProperty: "Remove relation property",
  removePropertyNamed: "Remove {{name}} from this database.",
  relationshipsPreserved: "Relationships are preserved by default",
  selectRelationshipsToRemove: "Also remove selected relationships",
  filterRelationships: "Filter relationships",
  noMatchingRelationships: "No matching relationships",
  removalPreviewFailed: "The relationship preview could not be loaded.",
  removePropertyOnly: "Remove property",
  removePropertyAndSelected: "Remove property and {{count}} selected",
  propertyRemoved: "Relation property removed",
  removePropertyFailed: "The relation property could not be removed.",
  states: {
    active: "Active",
    suspended: "Suspended",
    inactive: "Inactive",
...
const enUS = {
  ...
  relationships: relationshipMessages,
  landing: {
...
const relationshipMessagesByLocale = {
  "zh-CN": {
    ...
    adding: "正在添加…",
    definition: "关联定义",
    newRelationship: "新建关联",
    existingRelationship: "现有关联",
    forwardLabel: "列名称",
    inverseLabel: "在链接页面上显示的名称",
    inverseLabelHelper: "如果显示在链接页面上，此关系称为 {{name}}。",
    cardinality: "每行链接数",
    onePage: "仅一个",
    manyPages: "允许多个",
    emptyLinksHelper: "行也可以留空。",
    linkContextOne: "{{source}} 中的每行只能链接到 {{target}} 中的一个页面。",
    linkContextMany: "{{source}} 中的每行可以链接到 {{target}} 中的多个页面。",
    targetDatabase: "链接到以下集合中的页面",
    searchDatabases: "搜索集合",
    noDatabases: "没有匹配的集合",
    createInverseProperty: "同时在 {{name}} 中添加一列",
    createInversePropertyUnselected: "同时在链接的集合中添加一列",
    inverseEditable: "允许从反向属性编辑",
    searchPages: "搜索页面",
    ...
    apply: "应用",
    addToSelected: "添加",
    removeFromSelected: "移除",
    removeProperty: "移除关联属性",
    relationshipsPreserved: "默认保留关联",
    selectRelationshipsToRemove: "同时移除所选关联",
    removePropertyOnly: "仅移除属性",
    removePropertyAndSelected: "移除属性和 {{count}} 个所选关联",
    retryDatabases: "重试加载集合",
    retryRelationships: "重试加载关联",
    noExistingRelationships: "没有现有关联",
    configurationFailed: "无法添加关联。",
    loadFailed: "无法加载关联。",
    tryAgain: "重试",
    routeUnavailable: "此处的关联为只读。",
    refreshBeforeReplacing: "请刷新后再替换此关联。",
    updateFailed: "无法更新关联。",
    requestInterrupted: "请求已中断。请重试相同的更改，以确认是否已保存。",
    retrySavedChange: "重试相同更改",
    legacyUnsupported: "尚无法在此处编辑此旧版关联。",
    retryConnections: "重试加载连接",
    connectionRemoved: "已移除连接",
    removeFailed: "无法移除连接。",
    retryHistory: "重试加载历史记录",
    historyDetailsUnavailable: "关联历史记录详情不可用。请重新加载历史记录。",
    undoChange: "撤销更改",
    changeUndone: "已撤销更改",
    undoFailed: "无法撤销此更改。",
    noSharedRelationships: "所选行中没有匹配的关联",
    bulkFailed: "未更改任何关联。",
    bulkInverseMaxOne: "单页面关联无法将一个源页面分配给多个所选行。",
    filterRelationships: "筛选关联",
    noMatchingRelationships: "没有匹配的关联",
    removalPreviewFailed: "无法加载关联预览。",
    propertyRemoved: "已移除关联属性",
    removePropertyFailed: "无法移除关联属性。",
    states: { active: "有效", suspended: "已暂停", inactive: "无效" },
  },
  "zh-TW": {
    ...relationshipMessages,
    addRelation: "新增關聯",
    ...
    definition: "關聯定義",
    newRelationship: "新關聯",
    existingRelationship: "現有關聯",
    forwardLabel: "欄名稱",
    inverseLabel: "在連結頁面上顯示的名稱",
    inverseLabelHelper: "如果顯示在連結頁面上，此關係稱為 {{name}}。",
    cardinality: "每列連結數",
    onePage: "僅一個",
    manyPages: "允許多個",
    emptyLinksHelper: "列也可以留空。",
    linkContextOne: "{{source}} 中的每列只能連結到 {{target}} 中的一個頁面。",
    linkContextMany: "{{source}} 中的每列可以連結到 {{target}} 中的多個頁面。",
    targetDatabase: "連結到以下集合中的頁面",
    searchDatabases: "搜尋集合",
    noDatabases: "沒有相符的集合",
    createInverseProperty: "同時在 {{name}} 中新增一欄",
    createInversePropertyUnselected: "同時在連結的集合中新增一欄",
    inverseEditable: "允許從反向屬性編輯",
    searchPages: "搜尋頁面",
    noMatchingPages: "沒有相符的頁面",
    done: "完成",
    cancel: "取消",
    connections: "連結",
    noConnections: "沒有連結",
    ...
    noHistory: "沒有關聯歷史記錄",
    historyDetailsUnavailable:
      "無法使用關聯歷史記錄詳細資料。請重新載入歷史記錄。",
    historyChangeAdded: "已新增",
    historyChangeRemoved: "已移除",
    historyChangeReplaced: "已取代",
    historyChangeRestored: "已還原",
    historyPreviousTarget: "先前為 {{name}}",
    historyActor: "{{kind}}：{{name}}",
    historyActorPerson: "使用者",
    historyActorAgent: "代理",
    historyActorAutomation: "自動化",
    historyActorProgrammatic: "程式呼叫",
    historyOrigin: "來源：{{origin}}",
    historyAuthorizedBy: "授權者：{{principal}}",
    undo: "復原",
    apply: "套用",
    addToSelected: "新增",
    removeFromSelected: "移除",
    bulkUpdated: "已更新 {{count}} 個關聯",
    removeProperty: "移除關聯屬性",
    relationshipsPreserved: "預設會保留關聯",
    selectRelationshipsToRemove: "同時移除所選關聯",
    removePropertyOnly: "僅移除屬性",
    removePropertyAndSelected: "移除屬性和 {{count}} 個所選關聯",
    states: { active: "有效", suspended: "已暫停", inactive: "無效" },
  },
  "es-ES": {
    ...relationshipMessages,
    addRelation: "Añadir relación",
    adding: "Añadiendo…",
    definition: "Definición de la relación",
    newRelationship: "Nueva relación",
    existingRelationship: "Relación existente",
    forwardLabel: "Nombre de la columna",
    inverseLabel: "Nombre mostrado en las páginas vinculadas",
    inverseLabelHelper:
      "Si se muestra en las páginas vinculadas, esta relación se llama {{name}}.",
    cardinality: "Enlaces por fila",
    onePage: "Solo uno",
    manyPages: "Se permiten varios",
    emptyLinksHelper: "Las filas también pueden dejarse vacías.",
    linkContextOne:
      "Cada fila de {{source}} puede vincularse con una sola página de {{target}}.",
    linkContextMany:
      "Cada fila de {{source}} puede vincularse con varias páginas de {{target}}.",
    targetDatabase: "Vincular a páginas de",
    searchDatabases: "Buscar colecciones",
    noDatabases: "No hay colecciones coincidentes",
    createInverseProperty: "Añadir también una columna en {{name}}",
    createInversePropertyUnselected:
      "Añadir también una columna en la colección vinculada",
    inverseEditable: "Permitir editar desde la propiedad inversa",
    ...
    history: "Historial",
    noHistory: "Sin historial de relaciones",
    undo: "Deshacer",
    apply: "Aplicar",
    addToSelected: "Añadir",
    removeFromSelected: "Quitar",
    removeProperty: "Quitar propiedad de relación",
    relationshipsPreserved:
      "Las relaciones se conservan de forma predeterminada",
    selectRelationshipsToRemove: "Quitar también las relaciones seleccionadas",
    removePropertyOnly: "Quitar propiedad",
    removePropertyAndSelected: "Quitar propiedad y {{count}} seleccionadas",
    retryDatabases: "Reintentar colecciones",
    retryRelationships: "Reintentar relaciones",
    noExistingRelationships: "No hay relaciones existentes",
    configurationFailed: "No se pudo añadir la relación.",
    loadFailed: "No se pudieron cargar las relaciones.",
    tryAgain: "Intentar de nuevo",
    routeUnavailable: "Esta relación es de solo lectura desde aquí.",
    refreshBeforeReplacing: "Actualiza antes de reemplazar esta relación.",
    updateFailed: "No se pudo actualizar la relación.",
    requestInterrupted:
      "La solicitud se interrumpió. Reintenta el mismo cambio para confirmar si se guardó.",
    retrySavedChange: "Reintentar el mismo cambio",
    legacyUnsupported: "Esta relación heredada aún no se puede editar aquí.",
    retryConnections: "Reintentar conexiones",
    connectionRemoved: "Conexión eliminada",
    removeFailed: "No se pudo eliminar la conexión.",
    retryHistory: "Reintentar historial",
    historyDetailsUnavailable:
      "Los detalles del historial de relaciones no están disponibles. Vuelve a cargar el historial.",
    undoChange: "Deshacer cambio",
    changeUndone: "Cambio deshecho",
    undoFailed: "No se pudo deshacer este cambio.",
    noSharedRelationships:
      "No hay relaciones coincidentes en las filas seleccionadas",
    bulkFailed: "No se modificó ninguna relación.",
    bulkInverseMaxOne:
      "Una relación de una página no puede asignar una página de origen a varias filas seleccionadas.",
    filterRelationships: "Filtrar relaciones",
    noMatchingRelationships: "No hay relaciones coincidentes",
    removalPreviewFailed: "No se pudo cargar la vista previa de relaciones.",
    propertyRemoved: "Propiedad de relación eliminada",
    removePropertyFailed: "No se pudo eliminar la propiedad de relación.",
    states: { active: "Activa", suspended: "Suspendida", inactive: "Inactiva" },
  },
  "fr-FR": {
    ...relationshipMessages,
    addRelation: "Ajouter une relation",
    adding: "Ajout…",
    definition: "Définition de la relation",
    newRelationship: "Nouvelle relation",
    existingRelationship: "Relation existante",
    forwardLabel: "Nom de la colonne",
    inverseLabel: "Nom affiché sur les pages liées",
    inverseLabelHelper:
      "Si elle apparaît sur les pages liées, cette relation s’appelle {{name}}.",
    cardinality: "Liens par ligne",
    onePage: "Un seul",
    manyPages: "Plusieurs autorisés",
    emptyLinksHelper: "Les lignes peuvent aussi rester vides.",
    linkContextOne:
      "Chaque ligne de {{source}} peut être liée à une seule page de {{target}}.",
    linkContextMany:
      "Chaque ligne de {{source}} peut être liée à plusieurs pages de {{target}}.",
    targetDatabase: "Lier aux pages de",
    searchDatabases: "Rechercher des collections",
    noDatabases: "Aucune collection correspondante",
    createInverseProperty: "Ajouter aussi une colonne dans {{name}}",
    createInversePropertyUnselected:
      "Ajouter aussi une colonne dans la collection liée",
    inverseEditable: "Autoriser la modification depuis la propriété inverse",
    ...
    history: "Historique",
    noHistory: "Aucun historique de relation",
    undo: "Annuler",
    apply: "Appliquer",
    addToSelected: "Ajouter",
    removeFromSelected: "Supprimer",
    removeProperty: "Supprimer la propriété de relation",
    relationshipsPreserved: "Les relations sont conservées par défaut",
    selectRelationshipsToRemove: "Supprimer aussi les relations sélectionnées",
    removePropertyOnly: "Supprimer la propriété",
    removePropertyAndSelected:
      "Supprimer la propriété et {{count}} sélectionnées",
    retryDatabases: "Réessayer les collections",
    retryRelationships: "Réessayer les relations",
    noExistingRelationships: "Aucune relation existante",
    configurationFailed: "Impossible d’ajouter la relation.",
    loadFailed: "Impossible de charger les relations.",
    tryAgain: "Réessayer",
    routeUnavailable:
      "Cette relation est en lecture seule depuis cet emplacement.",
    refreshBeforeReplacing: "Actualisez avant de remplacer cette relation.",
    updateFailed: "Impossible de mettre à jour la relation.",
    requestInterrupted:
      "La requête a été interrompue. Réessayez la même modification pour confirmer son enregistrement.",
    retrySavedChange: "Réessayer la même modification",
    legacyUnsupported:
      "Cette relation héritée ne peut pas encore être modifiée ici.",
    retryConnections: "Réessayer les connexions",
    connectionRemoved: "Connexion supprimée",
    removeFailed: "Impossible de supprimer la connexion.",
    retryHistory: "Réessayer l’historique",
    historyDetailsUnavailable:
      "Les détails de l’historique des relations ne sont pas disponibles. Rechargez l’historique.",
    undoChange: "Annuler la modification",
    changeUndone: "Modification annulée",
    undoFailed: "Impossible d’annuler cette modification.",
    noSharedRelationships:
      "Aucune relation correspondante dans les lignes sélectionnées",
    bulkFailed: "Aucune relation n’a été modifiée.",
    bulkInverseMaxOne:
      "Une relation limitée à une page ne peut pas attribuer une page source à plusieurs lignes sélectionnées.",
    filterRelationships: "Filtrer les relations",
    noMatchingRelationships: "Aucune relation correspondante",
    removalPreviewFailed: "Impossible de charger l’aperçu des relations.",
    propertyRemoved: "Propriété de relation supprimée",
    removePropertyFailed: "Impossible de supprimer la propriété de relation.",
    states: { active: "Active", suspended: "Suspendue", inactive: "Inactive" },
  },
  "de-DE": {
    ...relationshipMessages,
    addRelation: "Beziehung hinzufügen",
    adding: "Wird hinzugefügt…",
    definition: "Beziehungsdefinition",
    newRelationship: "Neue Beziehung",
    existingRelationship: "Bestehende Beziehung",
    forwardLabel: "Spaltenname",
    inverseLabel: "Auf verknüpften Seiten angezeigter Name",
    inverseLabelHelper:
      "Wenn diese Beziehung auf verknüpften Seiten angezeigt wird, heißt sie {{name}}.",
    cardinality: "Links pro Zeile",
    onePage: "Nur eine",
    manyPages: "Mehrere erlaubt",
    emptyLinksHelper: "Zeilen können auch leer bleiben.",
    linkContextOne:
      "Jede Zeile in {{source}} kann mit nur einer Seite in {{target}} verknüpft werden.",
    linkContextMany:
      "Jede Zeile in {{source}} kann mit mehreren Seiten in {{target}} verknüpft werden.",
    targetDatabase: "Mit Seiten verknüpfen in",
    searchDatabases: "Sammlungen durchsuchen",
    noDatabases: "Keine passenden Sammlungen",
    createInverseProperty: "Auch eine Spalte in {{name}} hinzufügen",
    createInversePropertyUnselected:
      "Auch eine Spalte in der verknüpften Sammlung hinzufügen",
    inverseEditable: "Bearbeitung über die umgekehrte Eigenschaft erlauben",
    ...
    history: "Verlauf",
    noHistory: "Kein Beziehungsverlauf",
    undo: "Rückgängig",
    apply: "Anwenden",
    addToSelected: "Hinzufügen",
    removeFromSelected: "Entfernen",
    removeProperty: "Beziehungseigenschaft entfernen",
    relationshipsPreserved: "Beziehungen bleiben standardmäßig erhalten",
    selectRelationshipsToRemove: "Ausgewählte Beziehungen ebenfalls entfernen",
    removePropertyOnly: "Eigenschaft entfernen",
    removePropertyAndSelected:
      "Eigenschaft und {{count}} ausgewählte entfernen",
    retryDatabases: "Sammlungen erneut laden",
    retryRelationships: "Beziehungen erneut laden",
    noExistingRelationships: "Keine bestehenden Beziehungen",
    configurationFailed: "Die Beziehung konnte nicht hinzugefügt werden.",
    loadFailed: "Beziehungen konnten nicht geladen werden.",
    tryAgain: "Erneut versuchen",
    routeUnavailable: "Diese Beziehung ist hier schreibgeschützt.",
    refreshBeforeReplacing: "Vor dem Ersetzen dieser Beziehung neu laden.",
    updateFailed: "Die Beziehung konnte nicht aktualisiert werden.",
    requestInterrupted:
      "Die Anfrage wurde unterbrochen. Wiederholen Sie dieselbe Änderung, um zu prüfen, ob sie gespeichert wurde.",
    retrySavedChange: "Dieselbe Änderung wiederholen",
    legacyUnsupported:
      "Diese ältere Beziehung kann hier noch nicht bearbeitet werden.",
    ...
    historyDetailsUnavailable:
      "Die Details des Beziehungsverlaufs sind nicht verfügbar. Laden Sie den Verlauf neu.",
    undoChange: "Änderung rückgängig machen",
    changeUndone: "Änderung rückgängig gemacht",
    undoFailed: "Diese Änderung konnte nicht rückgängig gemacht werden.",
    noSharedRelationships:
      "Keine passenden Beziehungen in den ausgewählten Zeilen",
    bulkFailed: "Keine Beziehungen geändert.",
    bulkInverseMaxOne:
      "Bei einer Beziehung mit einer Seite kann eine Quellseite nicht mehreren ausgewählten Zeilen zugewiesen werden.",
    filterRelationships: "Beziehungen filtern",
    noMatchingRelationships: "Keine passenden Beziehungen",
    removalPreviewFailed: "Die Beziehungsvorschau konnte nicht geladen werden.",
    propertyRemoved: "Beziehungseigenschaft entfernt",
    removePropertyFailed:
      "Die Beziehungseigenschaft konnte nicht entfernt werden.",
    states: { active: "Aktiv", suspended: "Pausiert", inactive: "Inaktiv" },
  },
  "ja-JP": {
    ...relationshipMessages,
    ...
    adding: "追加中…",
    definition: "リレーション定義",
    newRelationship: "新しいリレーション",
    existingRelationship: "既存のリレーション",
    forwardLabel: "列名",
    inverseLabel: "リンク先のページに表示する名前",
    inverseLabelHelper:
      "リンク先のページに表示される場合、このリレーションは {{name}} と呼ばれます。",
    cardinality: "行ごとのリンク数",
    onePage: "1 つのみ",
    manyPages: "複数可",
    emptyLinksHelper: "行を空のままにすることもできます。",
    linkContextOne:
      "{{source}} の各行は、{{target}} の 1 ページだけにリンクできます。",
    linkContextMany:
      "{{source}} の各行は、{{target}} の複数のページにリンクできます。",
    targetDatabase: "ページのリンク先",
    searchDatabases: "コレクションを検索",
    noDatabases: "一致するコレクションはありません",
    createInverseProperty: "{{name}} にも列を追加",
    createInversePropertyUnselected: "リンク先のコレクションにも列を追加",
    ...
    cancel: "キャンセル",
    connections: "つながり",
    noConnections: "つながりはありません",
    history: "履歴",
    noHistory: "リレーション履歴はありません",
    undo: "元に戻す",
    apply: "適用",
    addToSelected: "追加",
    removeFromSelected: "削除",
    removeProperty: "リレーションプロパティを削除",
    relationshipsPreserved: "リレーションは既定で保持されます",
    selectRelationshipsToRemove: "選択したリレーションも削除",
    removePropertyOnly: "プロパティを削除",
    removePropertyAndSelected: "プロパティと選択した {{count}} 件を削除",
    retryDatabases: "コレクションを再読み込み",
    retryRelationships: "リレーションを再読み込み",
    noExistingRelationships: "既存のリレーションはありません",
    configurationFailed: "リレーションを追加できませんでした。",
    loadFailed: "リレーションを読み込めませんでした。",
    tryAgain: "再試行",
    routeUnavailable: "このリレーションはここからは読み取り専用です。",
    refreshBeforeReplacing:
      "このリレーションを置き換える前に更新してください。",
    updateFailed: "リレーションを更新できませんでした。",
    requestInterrupted:
      "リクエストが中断されました。同じ変更を再試行して、保存されたか確認してください。",
    retrySavedChange: "同じ変更を再試行",
    legacyUnsupported: "この従来のリレーションはまだここでは編集できません。",
    retryConnections: "つながりを再読み込み",
    connectionRemoved: "つながりを削除しました",
    removeFailed: "つながりを削除できませんでした。",
    retryHistory: "履歴を再読み込み",
    historyDetailsUnavailable:
      "リレーション履歴の詳細を利用できません。履歴を再読み込みしてください。",
    undoChange: "変更を元に戻す",
    changeUndone: "変更を元に戻しました",
    undoFailed: "この変更を元に戻せませんでした。",
    noSharedRelationships: "選択した行に一致するリレーションはありません",
    bulkFailed: "リレーションは変更されませんでした。",
    bulkInverseMaxOne:
      "1 ページのリレーションでは、1 つの参照元ページを複数の選択行に割り当てられません。",
    filterRelationships: "リレーションを絞り込む",
    noMatchingRelationships: "一致するリレーションはありません",
    removalPreviewFailed: "リレーションのプレビューを読み込めませんでした。",
    propertyRemoved: "リレーションプロパティを削除しました",
    removePropertyFailed: "リレーションプロパティを削除できませんでした。",
    states: { active: "有効", suspended: "一時停止", inactive: "無効" },
  },
  "ko-KR": {
    ...relationshipMessages,
    addRelation: "관계 추가",
    adding: "추가 중…",
    definition: "관계 정의",
    newRelationship: "새 관계",
    existingRelationship: "기존 관계",
    forwardLabel: "열 이름",
    inverseLabel: "연결된 페이지에 표시되는 이름",
    inverseLabelHelper:
      "연결된 페이지에 표시되는 경우 이 관계의 이름은 {{name}}입니다.",
    cardinality: "행당 링크 수",
    onePage: "하나만",
    manyPages: "여러 개 허용",
    emptyLinksHelper: "행을 비워 둘 수도 있습니다.",
    linkContextOne:
      "{{source}}의 각 행은 {{target}}의 페이지 하나에만 연결할 수 있습니다.",
    linkContextMany:
      "{{source}}의 각 행은 {{target}}의 여러 페이지에 연결할 수 있습니다.",
    targetDatabase: "페이지를 연결할 컬렉션",
    searchDatabases: "컬렉션 검색",
    noDatabases: "일치하는 컬렉션이 없습니다",
    createInverseProperty: "{{name}}에도 열 추가",
    createInversePropertyUnselected: "연결된 컬렉션에도 열 추가",
    inverseEditable: "역방향 속성에서 편집 허용",
    searchPages: "페이지 검색",
    ...
    apply: "적용",
    addToSelected: "추가",
    removeFromSelected: "제거",
    removeProperty: "관계 속성 제거",
    relationshipsPreserved: "관계는 기본적으로 유지됩니다",
    selectRelationshipsToRemove: "선택한 관계도 제거",
    removePropertyOnly: "속성 제거",
    removePropertyAndSelected: "속성 및 선택한 {{count}}개 제거",
    retryDatabases: "컬렉션 다시 불러오기",
    retryRelationships: "관계 다시 불러오기",
    noExistingRelationships: "기존 관계 없음",
    configurationFailed: "관계를 추가하지 못했습니다.",
    loadFailed: "관계를 불러오지 못했습니다.",
    tryAgain: "다시 시도",
    routeUnavailable: "여기서는 이 관계를 읽기만 할 수 있습니다.",
    refreshBeforeReplacing: "이 관계를 바꾸기 전에 새로 고침하세요.",
    updateFailed: "관계를 업데이트하지 못했습니다.",
    requestInterrupted:
      "요청이 중단되었습니다. 동일한 변경을 다시 시도하여 저장되었는지 확인하세요.",
    retrySavedChange: "동일한 변경 다시 시도",
    legacyUnsupported: "이 기존 관계는 아직 여기서 편집할 수 없습니다.",
    retryConnections: "연결 다시 불러오기",
    connectionRemoved: "연결 제거됨",
    removeFailed: "연결을 제거하지 못했습니다.",
    retryHistory: "기록 다시 불러오기",
    historyDetailsUnavailable:
      "관계 기록 세부 정보를 사용할 수 없습니다. 기록을 다시 불러오세요.",
    undoChange: "변경 실행 취소",
    changeUndone: "변경을 실행 취소했습니다",
    undoFailed: "이 변경을 실행 취소하지 못했습니다.",
    noSharedRelationships: "선택한 행에 일치하는 관계가 없습니다",
    bulkFailed: "변경된 관계가 없습니다.",
    bulkInverseMaxOne:
      "한 페이지 관계에서는 하나의 원본 페이지를 선택한 여러 행에 할당할 수 없습니다.",
    filterRelationships: "관계 필터링",
    noMatchingRelationships: "일치하는 관계 없음",
    removalPreviewFailed: "관계 미리보기를 불러오지 못했습니다.",
    propertyRemoved: "관계 속성이 제거되었습니다",
    removePropertyFailed: "관계 속성을 제거하지 못했습니다.",
    states: { active: "활성", suspended: "일시 중지", inactive: "비활성" },
  },
  "pt-BR": {
    ...relationshipMessages,
    addRelation: "Adicionar relação",
    adding: "Adicionando…",
    definition: "Definição da relação",
    newRelationship: "Nova relação",
    existingRelationship: "Relação existente",
    forwardLabel: "Nome da coluna",
    inverseLabel: "Nome exibido nas páginas vinculadas",
    inverseLabelHelper:
      "Se aparecer nas páginas vinculadas, esta relação se chama {{name}}.",
    cardinality: "Links por linha",
    onePage: "Apenas um",
    manyPages: "Vários permitidos",
    emptyLinksHelper: "As linhas também podem ficar vazias.",
    linkContextOne:
      "Cada linha em {{source}} pode ser vinculada a apenas uma página em {{target}}.",
    linkContextMany:
      "Cada linha em {{source}} pode ser vinculada a várias páginas em {{target}}.",
    targetDatabase: "Vincular a páginas em",
    searchDatabases: "Pesquisar coleções",
    noDatabases: "Nenhuma coleção correspondente",
    createInverseProperty: "Adicionar também uma coluna em {{name}}",
    createInversePropertyUnselected:
      "Adicionar também uma coluna na coleção vinculada",
    inverseEditable: "Permitir edição pela propriedade inversa",
    ...
    history: "Histórico",
    noHistory: "Sem histórico de relações",
    undo: "Desfazer",
    apply: "Aplicar",
    addToSelected: "Adicionar",
    removeFromSelected: "Remover",
    removeProperty: "Remover propriedade de relação",
    relationshipsPreserved: "As relações são preservadas por padrão",
    selectRelationshipsToRemove: "Remover também as relações selecionadas",
    removePropertyOnly: "Remover propriedade",
    removePropertyAndSelected: "Remover propriedade e {{count}} selecionadas",
    retryDatabases: "Tentar carregar coleções novamente",
    retryRelationships: "Tentar carregar relações novamente",
    noExistingRelationships: "Nenhuma relação existente",
    configurationFailed: "Não foi possível adicionar a relação.",
    loadFailed: "Não foi possível carregar as relações.",
    tryAgain: "Tentar novamente",
    routeUnavailable: "Esta relação é somente leitura neste local.",
    refreshBeforeReplacing: "Atualize antes de substituir esta relação.",
    updateFailed: "Não foi possível atualizar a relação.",
    requestInterrupted:
      "O pedido foi interrompido. Repita a mesma alteração para confirmar se foi guardada.",
    retrySavedChange: "Repetir a mesma alteração",
    legacyUnsupported: "Esta relação antiga ainda não pode ser editada aqui.",
    retryConnections: "Tentar carregar conexões novamente",
    connectionRemoved: "Conexão removida",
    removeFailed: "Não foi possível remover a conexão.",
    retryHistory: "Tentar carregar histórico novamente",
    historyDetailsUnavailable:
      "Os detalhes do histórico de relações estão indisponíveis. Recarregue o histórico.",
    undoChange: "Desfazer alteração",
    changeUndone: "Alteração desfeita",
    undoFailed: "Não foi possível desfazer esta alteração.",
    noSharedRelationships:
      "Nenhuma relação correspondente nas linhas selecionadas",
    bulkFailed: "Nenhuma relação foi alterada.",
    bulkInverseMaxOne:
      "Uma relação de uma página não pode atribuir uma página de origem a várias linhas selecionadas.",
    filterRelationships: "Filtrar relações",
    noMatchingRelationships: "Nenhuma relação correspondente",
    removalPreviewFailed:
      "Não foi possível carregar a visualização das relações.",
    propertyRemoved: "Propriedade de relação removida",
    removePropertyFailed: "Não foi possível remover a propriedade de relação.",
    states: { active: "Ativa", suspended: "Suspensa", inactive: "Inativa" },
  },
  "hi-IN": {
    ...relationshipMessages,
    addRelation: "रिलेशन जोड़ें",
    adding: "जोड़ा जा रहा है…",
    definition: "रिलेशन की परिभाषा",
    newRelationship: "नया रिलेशन",
    existingRelationship: "मौजूदा रिलेशन",
    forwardLabel: "कॉलम का नाम",
    inverseLabel: "लिंक किए गए पेजों पर दिखाया गया नाम",
    inverseLabelHelper:
      "लिंक किए गए पेजों पर दिखने पर इस रिलेशन को {{name}} कहा जाता है।",
    cardinality: "हर पंक्ति में लिंक",
    onePage: "सिर्फ़ एक",
    manyPages: "एक से अधिक की अनुमति",
    emptyLinksHelper: "पंक्तियाँ खाली भी छोड़ी जा सकती हैं।",
    linkContextOne:
      "{{source}} की हर पंक्ति {{target}} के सिर्फ़ एक पेज से लिंक हो सकती है।",
    linkContextMany:
      "{{source}} की हर पंक्ति {{target}} के कई पेजों से लिंक हो सकती है।",
    targetDatabase: "इनमें मौजूद पेजों से लिंक करें",
    searchDatabases: "कलेक्शन खोजें",
    noDatabases: "कोई मिलता हुआ कलेक्शन नहीं",
    createInverseProperty: "{{name}} में भी एक कॉलम जोड़ें",
    createInversePropertyUnselected: "लिंक किए गए कलेक्शन में भी एक कॉलम जोड़ें",
    inverseEditable: "उलटी प्रॉपर्टी से संपादन की अनुमति दें",
    searchPages: "पेज खोजें",
    noMatchingPages: "कोई मिलता हुआ पेज नहीं",
    done: "पूरा हुआ",
    cancel: "रद्द करें",
    connections: "कनेक्शन",
    noConnections: "कोई कनेक्शन नहीं",
    history: "इतिहास",
    noHistory: "रिलेशन का कोई इतिहास नहीं",
    undo: "पहले जैसा करें",
    apply: "लागू करें",
    addToSelected: "जोड़ें",
    removeFromSelected: "हटाएँ",
    removeProperty: "रिलेशन प्रॉपर्टी हटाएँ",
    relationshipsPreserved: "रिलेशन डिफ़ॉल्ट रूप से सुरक्षित रहते हैं",
    selectRelationshipsToRemove: "चुने हुए रिलेशन भी हटाएँ",
    removePropertyOnly: "प्रॉपर्टी हटाएँ",
    removePropertyAndSelected: "प्रॉपर्टी और चुने हुए {{count}} हटाएँ",
    retryDatabases: "कलेक्शन फिर लोड करें",
    retryRelationships: "रिलेशन फिर लोड करें",
    noExistingRelationships: "कोई मौजूदा रिलेशन नहीं",
    configurationFailed: "रिलेशन नहीं जोड़ा जा सका।",
    loadFailed: "रिलेशन लोड नहीं किए जा सके।",
    tryAgain: "फिर कोशिश करें",
    routeUnavailable: "इस रिलेशन को यहाँ से केवल देखा जा सकता है।",
    refreshBeforeReplacing: "इस रिलेशन को बदलने से पहले रीफ़्रेश करें।",
    updateFailed: "रिलेशन अपडेट नहीं किया जा सका।",
    requestInterrupted:
      "अनुरोध बाधित हो गया। यह पुष्टि करने के लिए वही बदलाव फिर से आज़माएँ कि वह सहेजा गया था या नहीं।",
    retrySavedChange: "वही बदलाव फिर से आज़माएँ",
    legacyUnsupported: "इस पुराने रिलेशन को अभी यहाँ संपादित नहीं किया जा सकता।",
    retryConnections: "कनेक्शन फिर लोड करें",
    connectionRemoved: "कनेक्शन हटा दिया गया",
    removeFailed: "कनेक्शन नहीं हटाया जा सका।",
    retryHistory: "इतिहास फिर लोड करें",
    historyDetailsUnavailable:
      "रिलेशनशिप इतिहास का विवरण उपलब्ध नहीं है। इतिहास फिर से लोड करें।",
    undoChange: "बदलाव पहले जैसा करें",
    changeUndone: "बदलाव पहले जैसा कर दिया गया",
    undoFailed: "यह बदलाव पहले जैसा नहीं किया जा सका।",
    noSharedRelationships: "चुनी हुई पंक्तियों में कोई मिलता हुआ रिलेशन नहीं",
    bulkFailed: "कोई रिलेशन नहीं बदला।",
    bulkInverseMaxOne:
      "एक-पेज वाला रिलेशन एक स्रोत पेज को कई चुनी हुई पंक्तियों से नहीं जोड़ सकता।",
    filterRelationships: "रिलेशन फ़िल्टर करें",
    noMatchingRelationships: "कोई मिलता हुआ रिलेशन नहीं",
    removalPreviewFailed: "रिलेशन का प्रीव्यू लोड नहीं किया जा सका।",
    propertyRemoved: "रिलेशन प्रॉपर्टी हटा दी गई",
    removePropertyFailed: "रिलेशन प्रॉपर्टी नहीं हटाई जा सकी।",
    states: { active: "सक्रिय", suspended: "रुका हुआ", inactive: "निष्क्रिय" },
  },
  "ar-SA": {
    ...relationshipMessages,
    addRelation: "إضافة علاقة",
    adding: "جارٍ الإضافة…",
    definition: "تعريف العلاقة",
    newRelationship: "علاقة جديدة",
    existingRelationship: "علاقة موجودة",
    forwardLabel: "اسم العمود",
    inverseLabel: "الاسم الظاهر على الصفحات المرتبطة",
    inverseLabelHelper:
      "إذا ظهرت هذه العلاقة على الصفحات المرتبطة، فسيكون اسمها {{name}}.",
    cardinality: "الروابط لكل صف",
    onePage: "واحدة فقط",
    manyPages: "يُسمح بعدة صفحات",
    emptyLinksHelper: "يمكن أيضًا ترك الصفوف فارغة.",
    linkContextOne:
      "يمكن ربط كل صف في {{source}} بصفحة واحدة فقط في {{target}}.",
    linkContextMany: "يمكن ربط كل صف في {{source}} بعدة صفحات في {{target}}.",
    targetDatabase: "الربط بصفحات في",
    searchDatabases: "البحث في المجموعات",
    noDatabases: "لا توجد مجموعات مطابقة",
    createInverseProperty: "إضافة عمود أيضًا في {{name}}",
    createInversePropertyUnselected: "إضافة عمود أيضًا في المجموعة المرتبطة",
    inverseEditable: "السماح بالتحرير من الخاصية العكسية",
    ...
    history: "السجل",
    noHistory: "لا يوجد سجل للعلاقات",
    undo: "تراجع",
    apply: "تطبيق",
    addToSelected: "إضافة",
    removeFromSelected: "إزالة",
    removeProperty: "إزالة خاصية العلاقة",
    relationshipsPreserved: "يتم الاحتفاظ بالعلاقات افتراضيًا",
    selectRelationshipsToRemove: "إزالة العلاقات المحددة أيضًا",
    removePropertyOnly: "إزالة الخاصية",
    removePropertyAndSelected: "إزالة الخاصية و{{count}} من المحدد",
    retryDatabases: "إعادة تحميل المجموعات",
    retryRelationships: "إعادة تحميل العلاقات",
    noExistingRelationships: "لا توجد علاقات حالية",
    configurationFailed: "تعذرت إضافة العلاقة.",
    loadFailed: "تعذر تحميل العلاقات.",
    tryAgain: "المحاولة مرة أخرى",
    routeUnavailable: "هذه العلاقة للقراءة فقط من هنا.",
    refreshBeforeReplacing: "حدّث قبل استبدال هذه العلاقة.",
    updateFailed: "تعذر تحديث العلاقة.",
    requestInterrupted:
      "انقطع الطلب. أعد محاولة التغيير نفسه للتأكد مما إذا كان قد تم حفظه.",
    retrySavedChange: "إعادة محاولة التغيير نفسه",
    legacyUnsupported: "لا يمكن تحرير هذه العلاقة القديمة هنا بعد.",
    retryConnections: "إعادة تحميل الاتصالات",
    connectionRemoved: "تمت إزالة الاتصال",
    removeFailed: "تعذرت إزالة الاتصال.",
    retryHistory: "إعادة تحميل السجل",
    historyDetailsUnavailable: "تفاصيل سجل العلاقات غير متاحة. أعد تحميل السجل.",
    undoChange: "التراجع عن التغيير",
    changeUndone: "تم التراجع عن التغيير",
    undoFailed: "تعذر التراجع عن هذا التغيير.",
    noSharedRelationships: "لا توجد علاقات مطابقة في الصفوف المحددة",
    bulkFailed: "لم تتغير أي علاقات.",
    bulkInverseMaxOne:
      "لا يمكن لعلاقة من صفحة واحدة تعيين صفحة مصدر واحدة إلى عدة صفوف محددة.",
    filterRelationships: "تصفية العلاقات",
    noMatchingRelationships: "لا توجد علاقات مطابقة",
    removalPreviewFailed: "تعذر تحميل معاينة العلاقات.",
    propertyRemoved: "تمت إزالة خاصية العلاقة",
    removePropertyFailed: "تعذرت إزالة خاصية العلاقة.",
    states: { active: "نشطة", suspended: "معلقة", inactive: "غير نشطة" },
  },
} satisfies Record<Exclude<LocaleCode, "en-US">, typeof relationshipMessages>;
...
function mergeMessages(overrides: PartialMessages): Messages {
  return {
    ...
    relationships: { ...enUS.relationships, ...overrides.relationships },
...
function mergeMessagesForLocale(
  ...
  return {
    ...
    relationships: {
      ...base.relationships,
      ...relationshipMessagesByLocale[locale],
    },
