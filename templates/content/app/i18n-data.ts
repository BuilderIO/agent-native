...
const relationshipMessages = {
  ...
  forwardLabel: "Property name",
  forwardLabelPlaceholder: "Contributors",
  inverseLabel: "Inverse name",
  inverseLabelPlaceholder: "Deliverables",
  cardinality: "Pages per row",
  onePage: "One page",
  manyPages: "Many pages",
  targetDatabase: "Target database",
  searchDatabases: "Search databases",
  retryDatabases: "Retry databases",
  noDatabases: "No matching databases",
  createInverseProperty: "Create inverse property",
...
const relationshipMessagesByLocale = {
  ...
  "zh-TW": {
    ...
    noDatabases: "沒有相符的資料庫",
    createInverseProperty: "建立反向屬性",
  ...
  "es-ES": {
    ...
    forwardLabel: "Nombre de la propiedad",
    inverseLabel: "Nombre inverso",
    cardinality: "Páginas por fila",
    onePage: "Una página",
    manyPages: "Varias páginas",
    targetDatabase: "Base de datos de destino",
    searchDatabases: "Buscar bases de datos",
    noDatabases: "No hay bases de datos coincidentes",
    createInverseProperty: "Crear propiedad inversa",
    ...
    retryDatabases: "Reintentar bases de datos",
  ...
  "fr-FR": {
    ...
    forwardLabel: "Nom de la propriété",
    inverseLabel: "Nom inverse",
    cardinality: "Pages par ligne",
    onePage: "Une page",
    manyPages: "Plusieurs pages",
    targetDatabase: "Base de données cible",
    searchDatabases: "Rechercher des bases de données",
    noDatabases: "Aucune base de données correspondante",
    createInverseProperty: "Créer la propriété inverse",
    ...
    retryDatabases: "Réessayer les bases de données",
  ...
  "de-DE": {
    ...
    forwardLabel: "Eigenschaftsname",
    inverseLabel: "Umgekehrter Name",
    cardinality: "Seiten pro Zeile",
    onePage: "Eine Seite",
    manyPages: "Mehrere Seiten",
    targetDatabase: "Zieldatenbank",
    searchDatabases: "Datenbanken suchen",
    noDatabases: "Keine passenden Datenbanken",
    ...
    retryDatabases: "Datenbanken erneut laden",
  ...
  "ja-JP": {
    ...
    forwardLabel: "プロパティ名",
    inverseLabel: "逆方向の名前",
    cardinality: "行ごとのページ数",
    onePage: "1 ページ",
    manyPages: "複数ページ",
    targetDatabase: "対象データベース",
    searchDatabases: "データベースを検索",
    noDatabases: "一致するデータベースはありません",
    createInverseProperty: "逆方向プロパティを作成",
  ...
  "ko-KR": {
    ...
    forwardLabel: "속성 이름",
    inverseLabel: "역방향 이름",
    cardinality: "행당 페이지 수",
    onePage: "페이지 하나",
    manyPages: "여러 페이지",
    targetDatabase: "대상 데이터베이스",
    searchDatabases: "데이터베이스 검색",
    noDatabases: "일치하는 데이터베이스가 없습니다",
    createInverseProperty: "역방향 속성 만들기",
  ...
  "pt-BR": {
    ...
    forwardLabel: "Nome da propriedade",
    inverseLabel: "Nome inverso",
    cardinality: "Páginas por linha",
    onePage: "Uma página",
    manyPages: "Várias páginas",
    targetDatabase: "Banco de dados de destino",
    searchDatabases: "Pesquisar bancos de dados",
    noDatabases: "Nenhum banco de dados correspondente",
    createInverseProperty: "Criar propriedade inversa",
    ...
    retryDatabases: "Tentar carregar bancos de dados novamente",
  ...
  "hi-IN": {
    ...
    forwardLabel: "प्रॉपर्टी का नाम",
    inverseLabel: "उलटा नाम",
    cardinality: "हर पंक्ति में पेज",
    onePage: "एक पेज",
    manyPages: "कई पेज",
    targetDatabase: "लक्षित डेटाबेस",
    searchDatabases: "डेटाबेस खोजें",
    noDatabases: "कोई मिलता हुआ डेटाबेस नहीं",
    createInverseProperty: "उलटी प्रॉपर्टी बनाएँ",
    ...
    retryDatabases: "डेटाबेस फिर लोड करें",
  ...
  "ar-SA": {
    ...
    inverseLabel: "الاسم العكسي",
    cardinality: "الصفحات لكل صف",
    onePage: "صفحة واحدة",
    manyPages: "صفحات متعددة",
    targetDatabase: "قاعدة البيانات المستهدفة",
    searchDatabases: "البحث في قواعد البيانات",
    noDatabases: "لا توجد قواعد بيانات مطابقة",
    createInverseProperty: "إنشاء خاصية عكسية",
    ...
    retryDatabases: "إعادة تحميل قواعد البيانات",
