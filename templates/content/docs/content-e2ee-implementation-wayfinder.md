...
| M3 cryptographic architecture           | PR 4 opens              | [Independent conditional-GO design record complete](./content-e2ee-m3-cryptographic-design.md), with current dependency candidates and frozen suite/field/cap/lifetime constants. Fixed known-byte vectors, ceremony transcript review, and native/WASM parity remain before runtime crypto merges.                                                                      |
