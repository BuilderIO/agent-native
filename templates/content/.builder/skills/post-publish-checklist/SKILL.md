...
secondary_keywords:
  ["RSC", "server-side rendering react", "next.js server components"]
search_volume: 12100
...
frontmatter_issues: []
meta_description:
  { length: 142, has_primary_keyword: true, follows_formula: true, issues: [] }
...
reverse_internal_links:
  [
    { url: "https://www.builder.io/blog/post-1", status: pending },
    { url: "https://www.builder.io/blog/post-2", status: pending },
  ]
