# Long-Tail Keyword Buckets

Long-tail keywords are defined by low individual search volume, not query length.
They fall into two distinct buckets that require different strategies.

## Bucket 1: Broad-Topic Long Tails
...
- All these rank the same pages -- one comprehensive post captures all of them

## Bucket 2: Topical Long Tails
...
- Top pages get roughly the amount of traffic the volume suggests (no "bonus"
