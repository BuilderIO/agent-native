...
function isStandardTextBlock(block: any): boolean {
  ...
  return (
    keys.length === 1 && keys[0] === "marginTop" && styles.marginTop === "20px"
  );
}
...
const blocks = [
  {
    ...
    responsiveStyles: { large: { marginTop: "20px" } },
  },
  {
    component: { name: "Text", options: { text: "<h2>2</h2>" } },
    responsiveStyles: { large: { marginTop: "20px" } },
  },
  ...
  },
  {
    component: {
      name: "Text",
      options: { text: "<blockquote>4</blockquote>" },
    },
    responsiveStyles: { large: { marginTop: "20px", paddingLeft: "10px" } },
  },
  {
    component: { name: "Text", options: { text: "<p>5</p>" } },
    responsiveStyles: { large: { marginTop: "20px" } },
  },
];
...
for (const block of blocks) {
  if (block.component?.name === "Text" && isStandardTextBlock(block)) {
    ...
    if (
      lastBlock &&
      lastBlock.component?.name === "Text" &&
      isStandardTextBlock(lastBlock)
    ) {
