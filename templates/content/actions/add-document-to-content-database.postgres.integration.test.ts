...
// a real PostgreSQL pool, where two adoptions genuinely overlap. CI runs it
// through the root `test:content-db-postgres` script, as its own vitest
// invocation so it never races the migration suite's schema setup.
