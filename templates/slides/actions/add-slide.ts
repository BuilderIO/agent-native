...
export default defineAction({
  ...
  description:
    ...
    "If the deck has a designSystemId, use the returned `designSystem.agentContext` from `create-deck` or `get-deck` when available; otherwise call `get-design-system` before authoring and apply its tokens/docs. Never use generic slide styling from the id alone. " +
