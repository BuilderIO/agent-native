 ...
 *
 * Usage:
 *   pnpm action image-search --query "builder.io logo"
 *   pnpm action image-search --query "dark abstract background" --count 6
 *
 * Options:
...
Usage:
  pnpm action image-search --query "search terms"
