...
export default defineAction({
  ...
  description:
    ...
    "For longer decks or live in-app generation, create the deck with slides: [], add the first one or two slides with add-slide sequentially to establish one visual contract, then use patch-deck with at most three add-slide operations per atomic batch when useful; never issue parallel writes to the same deck, and read back compact deck style between batches. The new deck is also opened in the connected Slides UI. " +
