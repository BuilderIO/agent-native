...
read of the same slide using slideId and compact=false; do not read the full deck. After a multi-slide
patch-deck write, verify the completed batch once with get-deck compact=true.
