...
const VARIABLE_AXIS_GOOGLE_FONTS = [
  "Archivo", "Asap", "Catamaran", "Chivo", "DM Sans", "Epilogue", "Exo 2",
  "Geist", "Heebo", "Inter", "Jost", "League Spartan", "Lexend",
  "Libre Franklin", "Montserrat", "Noto Sans", "Noto Serif", "Onest", "Outfit",
  "Overpass", "Public Sans", "Raleway", "Roboto", "Roboto Condensed",
  "Roboto Slab", "Urbanist", "Work Sans",
];

const STATIC_WEIGHT_GOOGLE_FONTS = [
  "Abril Fatface", "Anton", "Arimo", "Assistant", "Barlow", "Barlow Condensed",
  "Bebas Neue", "Bodoni Moda", "Bricolage Grotesque", "Cabin", "Caveat",
  "Cormorant Garamond", "Cousine", "Crimson Text", "Dancing Script",
  "David Libre", "EB Garamond", "Figtree", "Fira Sans", "Hind",
  "Homemade Apple", "IBM Plex Sans", "Inconsolata", "Instrument Sans",
  "Josefin Sans", "Kanit", "Karla", "Lato", "Libre Baskerville", "Lora",
  "Manrope", "Merriweather", "Mulish", "Nova Square", "Nunito", "Nunito Sans",
  "Open Sans", "Oswald", "Oxygen", "PT Sans", "PT Serif", "Pacifico",
  "Playfair Display", "Plus Jakarta Sans", "Poppins", "Prompt", "Quicksand",
  "Red Hat Display", "Roboto Mono", "Rubik", "Schibsted Grotesk", "Sora",
  "Source Sans 3", "Space Grotesk", "Syne", "Teko", "Tinos", "Titillium Web",
  "Ubuntu", "Yanone Kaffeesatz",
];
