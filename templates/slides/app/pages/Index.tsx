...
export default function Index() {
  ...
  const handleCreateDeckWithPrompt = async (
    ...
    const referenceSourceContext = referenceSource
      ...
      : "";
    const sourceDeckContext = buildSourceDeckContext(
      importedSourceDeck ? importedSourceDeck.slideCount : null,
    );
    const sourceModeInstructions = buildSourceModeInstructions({
      deckId,
      hasImportedSourceDeck: Boolean(importedSourceDeck),
    });
