...
const messages = {
  ...
  promptContext: {
    ...
    unsupportedFiles:
      "لا يمكن قراءة هذه الملفات هنا. استخدم ملفات نصية غير فارغة أصغر من 200 كيلوبايت أو ارفع ملف ‎.fig.",
    context: "السياق",
    designSystem: "نظام التصميم",
    useSystem: "استخدام نظام تصميم",
    attachFigma: "إرفاق Figma",
    referenceDesign: "الاستعانة بتصميم",
    referenceDeck: "الاستعانة بعرض تقديمي",
    loadFailed: "تعذر تحميل السياق. حاول مجددًا.",
    saveFailed: "تعذر حفظ السياق. حاول مجددًا قبل الإرسال.",
    governing: "يحدد الألوان والخطوط والرموز المرئية.",
    supporting: "مرجع مساعد فقط. لا يستورد الشرائح أو يستبدلها.",
    openSource: "فتح المصدر",
    remove: "إزالة",
    figmaUrl: "رابط ملف أو إطار Figma",
  ...
  designSystemSetup: {
    simple: {
      startFrom: "البدء من",
      freshDescription: "حدّد اتجاهًا جديدًا في الدردشة.",
      referencesDescription: "ابنِ على ملفاتك أو Figma أو موقعك الإلكتروني.",
      name: "الاسم",
      ...
      continue: "متابعة",
      back: "رجوع",
      chooseFigma: "اختيار ملف .fig",
      chooseFiles: "اختيار الملفات",
      invalidWebsite: "أدخل عنوان موقع إلكتروني صالحًا.",
      freshPrompt: "ساعدني في تحديد اتجاه التصميم لـ «{{name}}».",
      referencePrompt: "أعدّ «{{name}}» باستخدام مراجعي.",
      yourReferences: "المراجع",
      figmaSource: "Figma (.fig)",
      added: "تمت الإضافة",
      invalidRepository: "أدخل رابط مستودع صالحًا.",
      addRepository: "إضافة مستودع",
      preparingReferences: "جارٍ بدء المحادثة…",
      startFailed: "تعذّر بدء المحادثة. مراجعك محفوظة هنا؛ حاول مجددًا.",
      figmaDescription: "ملفات Figma المحلية.",
      websiteDescription: "توجّه العلامة التجارية من موقع ويب.",
      githubDescription: "مستودع، مع فرع ومجلدات اختيارية.",
      filesDescription: "مستندات أو صور أو شيفرة محلية.",
      advancedDescription: "أنظمة حالية وملاحظات وتعليمات.",
      unsupportedFiles:
        "اختر ملفات نصية أو شيفرة أصغر من 200 كيلوبايت، أو PDF أو DOCX أو PPTX أو صورًا مدعومة. أضف ملفات .fig ضمن Figma.",
      github: "GitHub",
    },
