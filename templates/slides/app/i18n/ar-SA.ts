...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "إنشاء عرض فارغ",
    importDeck: "استيراد عرض",
    recent: "الأحدث",
    sharedWithMe: "تمت مشاركتها معي",
    noSharedDecks: "لم تتم مشاركة أي عروض معك بعد.",
    suggestionProductLaunch: "إنشاء عرض لإطلاق منتج",
    suggestionQuarterlyReview: "إنشاء مراجعة أعمال ربع سنوية",
    suggestionInvestorPitch: "إنشاء عرض تقديمي للمستثمرين",
    suggestionFromNotes: "تحويل ملاحظاتي إلى شرائح",
