...
const messages = {
  ...
  home: {
    ...
    firstPresentationTitle: "Créons votre première présentation",
    startBlankDeck: "Créer une présentation vierge",
    importDeck: "Importer une présentation",
    recent: "Récents",
    sharedWithMe: "Partagés avec moi",
    noSharedDecks: "Aucune présentation n’a encore été partagée avec vous.",
    suggestionProductLaunch: "Créer une présentation de lancement produit",
    suggestionQuarterlyReview: "Créer une revue trimestrielle d’activité",
    suggestionInvestorPitch: "Créer un pitch pour les investisseurs",
    suggestionFromNotes: "Transformer mes notes en diapositives",
