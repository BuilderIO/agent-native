...
const messages = {
  ...
  promptContext: {
    createNew: "Créer",
    unsupportedFiles:
      "Ces fichiers ne peuvent pas être lus ici. Utilisez des fichiers texte non vides de moins de 200 Ko ou importez un fichier .fig.",
    context: "Contexte",
    ...
    loadFailed: "Impossible de charger le contexte. Réessayez.",
    saveFailed:
      "Impossible de sauvegarder le contexte. Réessayez avant d’envoyer.",
    governing: "Définit les couleurs, la typographie et les tokens visuels.",
    supporting:
      "Référence complémentaire uniquement. Aucune diapositive n’est importée ou remplacée.",
    openSource: "Ouvrir la source",
    remove: "Retirer",
    figmaUrl: "URL du fichier ou du cadre Figma",
    browse: "Parcourir les cadres",
    retry: "Réessayer",
    search: "Rechercher des sources…",
    empty: "Aucune source correspondante.",
    previous: "Précédent",
    next: "Suivant",
  },
  ...
  designSystemSetup: {
    simple: {
      startFrom: "Commencer à partir de",
      freshDescription: "Définissez une nouvelle direction dans le chat.",
      ...
      continue: "Continuer",
      back: "Retour",
      chooseFigma: "Choisir un fichier .fig",
      chooseFiles: "Choisir des fichiers",
      invalidWebsite: "Saisissez une URL de site web valide.",
      freshPrompt:
        "Aidez-moi à définir la direction du design de « {{name}} ».",
      referencePrompt: "Configurez « {{name}} » à partir de mes références.",
      yourReferences: "Références",
      figmaSource: "Figma (.fig)",
      added: "Ajouté",
      invalidRepository: "Saisissez une URL de dépôt valide.",
      addRepository: "Ajouter un dépôt",
      preparingReferences: "Démarrage du chat…",
      startFailed:
        "Impossible de démarrer le chat. Vos références sont conservées ici ; réessayez.",
      figmaDescription: "Fichiers Figma locaux.",
      websiteDescription: "Orientation de marque issue d’un site web.",
      githubDescription: "Un dépôt, avec branche et dossiers facultatifs.",
      filesDescription: "Documents, images ou code local.",
      advancedDescription: "Systèmes existants, notes et instructions.",
      unsupportedFiles:
        "Choisissez des fichiers texte/code de moins de 200 Ko, PDF, DOCX, PPTX ou des images compatibles. Ajoutez les fichiers .fig dans Figma.",
      github: "GitHub",
    },
