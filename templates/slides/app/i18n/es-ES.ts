...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "Crear un deck en blanco",
    importDeck: "Importar deck",
    recent: "Recientes",
    sharedWithMe: "Compartidos conmigo",
    noSharedDecks: "Aún no han compartido decks contigo.",
    suggestionProductLaunch: "Crear un deck para lanzar un producto",
    suggestionQuarterlyReview: "Crear una revisión trimestral del negocio",
    suggestionInvestorPitch: "Crear un pitch para inversores",
    suggestionFromNotes: "Convertir mis notas en diapositivas",
