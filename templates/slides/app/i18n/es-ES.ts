...
const messages = {
  ...
  promptContext: {
    ...
    unsupportedFiles:
      "Estos archivos no se pueden leer aquí. Usa archivos de texto no vacíos de menos de 200 KB o sube un archivo .fig.",
    context: "Contexto",
    ...
    loadFailed: "No se pudo cargar el contexto. Inténtalo de nuevo.",
    saveFailed: "No se pudo guardar el contexto. Reinténtalo antes de enviar.",
    governing: "Define los colores, la tipografía y los tokens visuales.",
    supporting: "Solo como referencia. No importa ni reemplaza diapositivas.",
    openSource: "Abrir fuente",
    remove: "Quitar",
    figmaUrl: "URL de archivo o marco de Figma",
    browse: "Explorar marcos",
    retry: "Reintentar",
    search: "Buscar fuentes…",
    empty: "No hay fuentes coincidentes.",
    previous: "Anterior",
    next: "Siguiente",
  },
  ...
  designSystemSetup: {
    simple: {
      startFrom: "Empezar desde",
      freshDescription: "Define una nueva dirección en el chat.",
      referencesDescription: "Parte de tus archivos, Figma o sitio web.",
      name: "Nombre",
      ...
      continue: "Continuar",
      back: "Atrás",
      chooseFigma: "Elegir un archivo .fig",
      chooseFiles: "Elegir archivos",
      invalidWebsite: "Introduce una URL de sitio web válida.",
      ...
      added: "Añadido",
      invalidRepository: "Introduce una URL de repositorio válida.",
      addRepository: "Añadir repositorio",
      preparingReferences: "Iniciando chat…",
      startFailed:
        "No se pudo iniciar el chat. Tus referencias siguen guardadas aquí; inténtalo de nuevo.",
      figmaDescription: "Archivos locales de Figma.",
      websiteDescription: "Dirección de marca desde un sitio web.",
      githubDescription: "Un repositorio, con rama y carpetas opcionales.",
      filesDescription: "Documentos, imágenes o código local.",
      advancedDescription: "Sistemas existentes, notas e instrucciones.",
      unsupportedFiles:
        "Elige archivos de texto o código de menos de 200 KB, PDF, DOCX, PPTX o imágenes compatibles. Añade archivos .fig en Figma.",
      github: "GitHub",
    },
