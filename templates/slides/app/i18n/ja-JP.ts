...
const messages = {
  ...
  promptContext: {
    createNew: "新規作成",
    unsupportedFiles:
      "これらのファイルはここでは読み取れません。200 KB未満の空でないテキストファイルを使うか、.figファイルをアップロードしてください。",
    context: "コンテキスト",
    designSystem: "デザインシステム",
    useSystem: "デザインシステムを使用",
    attachFigma: "Figmaを添付",
    referenceDesign: "デザインを参照",
    referenceDeck: "スライド資料を参照",
    loadFailed: "コンテキストを読み込めませんでした。もう一度お試しください。",
    saveFailed:
      "コンテキストを保存できませんでした。送信前に再試行してください。",
    governing: "色、タイポグラフィ、ビジュアルトークンを規定します。",
    supporting:
      "補助的な参照としてのみ使用します。スライドのインポートや置換は行いません。",
    openSource: "参照元を開く",
    remove: "削除",
    figmaUrl: "FigmaファイルまたはフレームのURL",
    browse: "フレームを選ぶ",
    retry: "再試行",
    search: "参照元を検索…",
    empty: "一致する参照元はありません。",
  ...
  designSystemSetup: {
    simple: {
      startFrom: "作成の開始点",
      freshDescription: "チャットで新しい方向性を考えます。",
      ...
      continue: "続ける",
      back: "戻る",
      chooseFigma: ".fig ファイルを選択",
      chooseFiles: "ファイルを選択",
      invalidWebsite: "有効なウェブサイトの URL を入力してください。",
      freshPrompt: "「{{name}}」のデザインの方向性を一緒に考えてください。",
      referencePrompt: "参考資料をもとに「{{name}}」を設定してください。",
      yourReferences: "参考資料",
      figmaSource: "Figma（.fig）",
      added: "追加済み",
      invalidRepository: "有効なリポジトリURLを入力してください。",
      addRepository: "リポジトリを追加",
      preparingReferences: "チャットを開始中…",
      startFailed:
        "チャットを開始できませんでした。参考資料は保持されています。もう一度お試しください。",
      figmaDescription: "ローカルのFigmaファイル。",
      websiteDescription: "ウェブサイトからブランドの方向性を取得。",
      githubDescription: "リポジトリ。ブランチやフォルダーも指定できます。",
      filesDescription: "文書、画像、ローカルコード。",
      advancedDescription: "既存のシステム、メモ、指示。",
      unsupportedFiles:
        "200 KB未満のテキスト／コード、PDF、DOCX、PPTX、または対応画像を選択してください。.figファイルはFigmaで追加してください。",
      github: "GitHub",
    },
