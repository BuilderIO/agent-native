...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "空のデッキを作成",
    importDeck: "デッキをインポート",
    recent: "最近",
    sharedWithMe: "共有されたデッキ",
    noSharedDecks: "共有されたデッキはまだありません。",
    suggestionProductLaunch: "製品ローンチのデッキを作成",
    suggestionQuarterlyReview: "四半期の事業レビューを作成",
    suggestionInvestorPitch: "投資家向けピッチデッキを作成",
    suggestionFromNotes: "メモをスライドにまとめる",
