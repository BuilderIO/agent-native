...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "빈 덱 만들기",
    importDeck: "덱 가져오기",
    recent: "최근",
    sharedWithMe: "공유됨",
    noSharedDecks: "아직 공유된 덱이 없습니다.",
    suggestionProductLaunch: "제품 출시 덱 만들기",
    suggestionQuarterlyReview: "분기별 비즈니스 리뷰 만들기",
    suggestionInvestorPitch: "투자자 피치 덱 만들기",
    suggestionFromNotes: "메모를 슬라이드로 바꾸기",
