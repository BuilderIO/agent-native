...
const messages = {
  ...
  promptContext: {
    createNew: "새로 만들기",
    unsupportedFiles:
      "여기서는 이 파일을 읽을 수 없습니다. 비어 있지 않은 200KB 미만의 텍스트 파일을 사용하거나 .fig 파일을 업로드하세요.",
    context: "컨텍스트",
    ...
    loadFailed: "컨텍스트를 불러오지 못했습니다. 다시 시도하세요.",
    saveFailed: "컨텍스트를 저장하지 못했습니다. 보내기 전에 다시 시도하세요.",
    governing: "색상, 서체, 시각적 토큰을 결정합니다.",
    supporting:
      "보조 참조로만 사용합니다. 슬라이드를 가져오거나 교체하지 않습니다.",
    openSource: "원본 열기",
    remove: "제거",
    figmaUrl: "Figma 파일 또는 프레임 URL",
    browse: "프레임 찾아보기",
    retry: "다시 시도",
    search: "참조 자료 검색…",
    empty: "일치하는 참조 자료가 없습니다.",
    previous: "이전",
    next: "다음",
  },
  ...
  designSystemSetup: {
    simple: {
      startFrom: "시작 기준",
      freshDescription: "채팅에서 새로운 방향을 잡아 보세요.",
      referencesDescription: "파일, Figma 또는 웹사이트를 바탕으로 만드세요.",
      name: "이름",
      startFresh: "새로 시작",
      files: "파일",
      ...
      continue: "계속",
      back: "뒤로",
      chooseFigma: ".fig 파일 선택",
      chooseFiles: "파일 선택",
      invalidWebsite: "올바른 웹사이트 URL을 입력하세요.",
      freshPrompt: "“{{name}}”의 디자인 방향을 잡는 데 도움을 주세요.",
      referencePrompt: "내 참고 자료로 “{{name}}”을 설정해 주세요.",
      yourReferences: "참고 자료",
      figmaSource: "Figma (.fig)",
      added: "추가됨",
      invalidRepository: "올바른 저장소 URL을 입력하세요.",
      addRepository: "저장소 추가",
      preparingReferences: "채팅 시작 중…",
      startFailed:
        "채팅을 시작하지 못했습니다. 참고 자료가 유지되었으니 다시 시도하세요.",
      figmaDescription: "로컬 Figma 파일.",
      websiteDescription: "웹사이트에서 브랜드 방향을 참고합니다.",
      githubDescription: "저장소와 선택적 브랜치 및 폴더.",
      filesDescription: "문서, 이미지 또는 로컬 코드.",
      advancedDescription: "기존 시스템, 메모 및 지침.",
      unsupportedFiles:
        "200 KB 미만의 텍스트/코드 파일, PDF, DOCX, PPTX 또는 지원되는 이미지를 선택하세요. .fig 파일은 Figma에서 추가하세요.",
      github: "GitHub",
    },
