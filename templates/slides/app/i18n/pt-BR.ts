...
const messages = {
  ...
  home: {
    ...
    firstPresentationTitle: "Vamos criar sua primeira apresentação",
    startBlankDeck: "Criar uma apresentação em branco",
    importDeck: "Importar apresentação",
    recent: "Recentes",
    sharedWithMe: "Compartilhados comigo",
    noSharedDecks: "Nenhuma apresentação foi compartilhada com você ainda.",
    suggestionProductLaunch: "Criar uma apresentação de lançamento de produto",
    suggestionQuarterlyReview: "Criar uma revisão trimestral de negócios",
    suggestionInvestorPitch: "Criar um pitch para investidores",
    suggestionFromNotes: "Transformar minhas anotações em slides",
