...
const messages = {
  ...
  promptContext: {
    ...
    unsupportedFiles:
      "Não é possível ler estes arquivos aqui. Use arquivos de texto não vazios com menos de 200 KB ou envie um arquivo .fig.",
    context: "Contexto",
    ...
    loadFailed: "Não foi possível carregar o contexto. Tente novamente.",
    saveFailed:
      "Não foi possível salvar o contexto. Tente novamente antes de enviar.",
    governing: "Define cores, tipografia e tokens visuais.",
    supporting: "Apenas referência de apoio. Não importa nem substitui slides.",
    openSource: "Abrir fonte",
    remove: "Remover",
    figmaUrl: "URL de arquivo ou quadro do Figma",
    browse: "Explorar quadros",
    retry: "Tentar novamente",
    search: "Buscar fontes…",
    empty: "Nenhuma fonte correspondente.",
    previous: "Anterior",
    next: "Próximo",
  },
  ...
  designSystemSetup: {
    simple: {
      ...
      freshDescription: "Defina uma nova direção no chat.",
      referencesDescription: "Use seus arquivos, Figma ou site como base.",
      name: "Nome",
      ...
      continue: "Continuar",
      back: "Voltar",
      chooseFigma: "Escolher arquivo .fig",
      chooseFiles: "Escolher arquivos",
      invalidWebsite: "Insira uma URL de site válida.",
      freshPrompt: "Ajude-me a definir a direção do design de “{{name}}”.",
      referencePrompt: "Configure “{{name}}” com base nas minhas referências.",
      yourReferences: "Referências",
      figmaSource: "Figma (.fig)",
      added: "Adicionado",
      invalidRepository: "Insira uma URL de repositório válida.",
      addRepository: "Adicionar repositório",
      preparingReferences: "Iniciando conversa…",
      startFailed:
        "Não foi possível iniciar a conversa. Suas referências continuam salvas aqui; tente novamente.",
      figmaDescription: "Arquivos locais do Figma.",
      websiteDescription: "Direção de marca a partir de um site.",
      githubDescription: "Um repositório, com branch e pastas opcionais.",
      filesDescription: "Documentos, imagens ou código local.",
      advancedDescription: "Sistemas existentes, notas e instruções.",
      unsupportedFiles:
        "Escolha arquivos de texto/código com menos de 200 KB, PDF, DOCX, PPTX ou imagens compatíveis. Adicione arquivos .fig em Figma.",
      github: "GitHub",
    },
