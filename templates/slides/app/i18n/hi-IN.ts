...
const messages = {
  ...
  promptContext: {
    createNew: "नया बनाएँ",
    unsupportedFiles:
      "ये फ़ाइलें यहाँ पढ़ी नहीं जा सकतीं। 200 KB से छोटी, गैर-खाली टेक्स्ट फ़ाइलें इस्तेमाल करें या .fig फ़ाइल अपलोड करें।",
    context: "संदर्भ",
    designSystem: "डिज़ाइन सिस्टम",
    useSystem: "डिज़ाइन सिस्टम इस्तेमाल करें",
    attachFigma: "Figma संलग्न करें",
    referenceDesign: "डिज़ाइन का संदर्भ लें",
    referenceDeck: "प्रस्तुति का संदर्भ लें",
    loadFailed: "संदर्भ लोड नहीं हो सका। फिर कोशिश करें।",
    saveFailed: "संदर्भ सहेजा नहीं जा सका। भेजने से पहले फिर कोशिश करें।",
    governing: "रंग, टाइपोग्राफ़ी और विज़ुअल टोकन तय करता है।",
    supporting: "केवल सहायक संदर्भ। स्लाइड आयात या बदली नहीं जातीं।",
    openSource: "स्रोत खोलें",
    remove: "हटाएँ",
    figmaUrl: "Figma फ़ाइल या फ़्रेम URL",
    browse: "फ़्रेम देखें",
    retry: "फिर कोशिश करें",
    search: "स्रोत खोजें…",
    empty: "कोई मेल खाता स्रोत नहीं मिला।",
    previous: "पिछला",
    next: "अगला",
  },
  ...
  designSystemSetup: {
    simple: {
      startFrom: "यहाँ से शुरू करें",
      freshDescription: "चैट में एक नई दिशा तय करें।",
      ...
      continue: "जारी रखें",
      back: "वापस",
      chooseFigma: ".fig फ़ाइल चुनें",
      chooseFiles: "फ़ाइलें चुनें",
      invalidWebsite: "एक मान्य वेबसाइट URL दर्ज करें।",
      freshPrompt: "“{{name}}” की डिज़ाइन दिशा तय करने में मेरी मदद करें।",
      referencePrompt: "मेरे संदर्भों से “{{name}}” सेट अप करें।",
      yourReferences: "संदर्भ",
      figmaSource: "Figma (.fig)",
      added: "जोड़ा गया",
      invalidRepository: "मान्य रिपॉज़िटरी URL दर्ज करें।",
      addRepository: "रिपॉज़िटरी जोड़ें",
      preparingReferences: "चैट शुरू हो रही है…",
      startFailed: "चैट शुरू नहीं हो सकी। आपके संदर्भ यहीं सुरक्षित हैं; फिर से कोशिश करें।",
      figmaDescription: "स्थानीय Figma फ़ाइलें।",
      websiteDescription: "वेबसाइट से ब्रांड की दिशा।",
      githubDescription: "रिपॉज़िटरी, वैकल्पिक ब्रांच और फ़ोल्डर के साथ।",
      filesDescription: "दस्तावेज़, इमेज या स्थानीय कोड।",
      advancedDescription: "मौजूदा सिस्टम, नोट्स और निर्देश।",
      unsupportedFiles:
        "200 KB से छोटी टेक्स्ट/कोड फ़ाइलें, PDF, DOCX, PPTX या समर्थित इमेज चुनें। .fig फ़ाइलें Figma में जोड़ें।",
      github: "GitHub",
    },
