const messages = {
  ...
  designSystemSetup: {
    ...
    createFailed: "डिज़ाइन सिस्टम नहीं बनाया जा सका",
    ...
    parsingFigmaFile: "Figma फ़ाइल पार्स हो रही है...",
    uploadFigDescription:
      "स्लाइड डिज़ाइन सिस्टम बनाने के लिए .fig लोकल कॉपी अपलोड करें",
    ...
    colorAccent: "एक्सेंट",
    colorPrimary: "प्राइमरी",
    colorSecondary: "सेकेंडरी",
    colorBackground: "बैकग्राउंड",
    colorText: "टेक्स्ट",
    figmaThumbnailAlt: "Figma फ़ाइल थंबनेल",
    designSystemName: "डिज़ाइन सिस्टम नाम",
    brandNamePlaceholder: "ब्रांड नाम",
    figPreviewStats: "{{nodes}}, {{gradients}}, {{images}}",
    nodeCount_one: "{{formattedCount}} नोड",
    nodeCount_other: "{{formattedCount}} नोड",
    gradientCount_one: "{{formattedCount}} ग्रेडिएंट",
    gradientCount_other: "{{formattedCount}} ग्रेडिएंट",
    imageCount_one: "{{formattedCount}} इमेज",
    imageCount_other: "{{formattedCount}} इमेज",
    headingsLabel: "हेडिंग्स:",
    bodyLabel: "बॉडी:",
