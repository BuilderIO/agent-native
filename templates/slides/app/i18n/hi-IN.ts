...
const messages = {
  ...
  home: {
    ...
    workspaceDefaultDeckBody:
      'इस कार्यस्थान में बनने वाला हर नया डेक "{{title}}" को शैली संदर्भ के रूप में उपयोग करेगा। सदस्य डेक बनाते समय कोई अन्य संदर्भ डेक चुन सकते हैं या कोई भी संदर्भ न चुनने का विकल्प ले सकते हैं।',
    ...
    workspaceDefaultSystemBody:
      'इस कार्यस्थान में बनने वाला हर नया डेक "{{title}}" डिज़ाइन सिस्टम का उपयोग करेगा। जिन सदस्यों ने अपना स्वयं का डिफ़ॉल्ट सेट किया है, उनका डिफ़ॉल्ट बना रहेगा, और कोई भी सदस्य डेक बनाते समय कोई अन्य डिज़ाइन सिस्टम चुन सकता है।',
