...
const messages = {
  ...
  home: {
    ...
    firstPresentationTitle: "आइए आपकी पहली प्रस्तुति बनाएं",
    startBlankDeck: "खाली डेक बनाएं",
    importDeck: "डेक आयात करें",
    recent: "हाल ही के",
    sharedWithMe: "मेरे साथ साझा किए गए",
    noSharedDecks: "अभी तक कोई डेक आपके साथ साझा नहीं किया गया है।",
    suggestionProductLaunch: "प्रोडक्ट लॉन्च डेक बनाएं",
    suggestionQuarterlyReview: "तिमाही व्यावसायिक समीक्षा बनाएं",
    suggestionInvestorPitch: "निवेशक पिच डेक बनाएं",
    suggestionFromNotes: "मेरे नोट्स को स्लाइड में बदलें",
