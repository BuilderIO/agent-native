...
const messages = {
  ...
  home: {
    ...
    firstPresentationTitle: "開始建立你的第一份簡報",
    startBlankDeck: "建立空白簡報",
    importDeck: "匯入簡報",
    recent: "最近",
    sharedWithMe: "與我分享",
    noSharedDecks: "還沒有簡報與你分享。",
    suggestionProductLaunch: "建立產品發表簡報",
    suggestionQuarterlyReview: "建立季度業務回顧簡報",
    suggestionInvestorPitch: "建立投資人提案簡報",
    suggestionFromNotes: "將我的筆記整理成投影片",
    skipPrompt: "跳過提示",
