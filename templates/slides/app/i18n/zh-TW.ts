...
const messages = {
  ...
  promptContext: {
    createNew: "新增",
    unsupportedFiles:
      "此處無法讀取這些檔案。請使用小於200 KB的非空文字檔，或上傳.fig檔案。",
    context: "上下文",
    designSystem: "設計系統",
    useSystem: "使用設計系統",
    attachFigma: "附加 Figma",
    referenceDesign: "引用設計",
    referenceDeck: "引用簡報",
    loadFailed: "無法載入上下文，請重試。",
    saveFailed: "無法儲存上下文，請在傳送前重試。",
    governing: "決定色彩、字體排版和視覺權杖。",
    supporting: "僅作為輔助參考，不會匯入或取代投影片。",
    openSource: "開啟來源",
    remove: "移除",
    figmaUrl: "Figma 檔案或畫框 URL",
    browse: "瀏覽畫框",
    retry: "重試",
    search: "搜尋來源…",
    empty: "沒有符合的來源。",
  ...
  designSystemSetup: {
    simple: {
      ...
      continue: "繼續",
      back: "返回",
      chooseFigma: "選擇 .fig 檔案",
      chooseFiles: "選擇檔案",
      invalidWebsite: "請輸入有效的網站網址。",
      freshPrompt: "幫我確定「{{name}}」的設計方向。",
      referencePrompt: "根據我的參考資料設定「{{name}}」。",
      yourReferences: "參考資料",
      figmaSource: "Figma（.fig）",
      added: "已新增",
      invalidRepository: "請輸入有效的儲存庫網址。",
      addRepository: "新增儲存庫",
      preparingReferences: "正在啟動聊天…",
      startFailed: "無法啟動聊天。參考資料已保留，請重試。",
      figmaDescription: "本機 Figma 檔案。",
      websiteDescription: "從網站取得品牌方向。",
      githubDescription: "程式碼儲存庫，可指定分支和資料夾。",
      filesDescription: "文件、圖片或本機程式碼。",
      advancedDescription: "現有設計系統、備註和指令。",
      unsupportedFiles:
        "請選擇小於 200 KB 的文字或程式碼檔案、PDF、DOCX、PPTX 或支援的圖片。請在 Figma 中新增 .fig 檔案。",
      github: "GitHub",
    },
    importedBrand: "匯入的品牌",
    figFileRequired:
