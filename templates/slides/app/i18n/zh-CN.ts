...
const messages = {
  ...
  home: {
    ...
    firstPresentationTitle: "开始创建你的第一份演示文稿",
    startBlankDeck: "创建空白演示文稿",
    importDeck: "导入演示文稿",
    recent: "最近",
    sharedWithMe: "与我共享",
    noSharedDecks: "还没有人与您共享演示文稿。",
    suggestionProductLaunch: "创建产品发布演示文稿",
    suggestionQuarterlyReview: "创建季度业务回顾演示文稿",
    suggestionInvestorPitch: "创建投资者推介演示文稿",
    suggestionFromNotes: "将我的笔记整理成幻灯片",
    skipPrompt: "跳过提示",
