...
const messages = {
  ...
  promptContext: {
    createNew: "新建",
    unsupportedFiles:
      "此处无法读取这些文件。请使用小于200 KB的非空文本文件，或上传.fig文件。",
    context: "上下文",
    designSystem: "设计系统",
    useSystem: "使用设计系统",
    ...
    loadFailed: "无法加载上下文，请重试。",
    saveFailed: "无法保存上下文，请在发送前重试。",
    governing: "决定颜色、字体排版和视觉令牌。",
    supporting: "仅作为辅助参考，不会导入或替换幻灯片。",
    openSource: "打开来源",
    remove: "移除",
    figmaUrl: "Figma 文件或画框 URL",
    browse: "浏览画框",
    retry: "重试",
    search: "搜索来源…",
    empty: "没有匹配的来源。",
  ...
  designSystemSetup: {
    simple: {
      startFrom: "从这里开始",
      freshDescription: "在聊天中构思新的设计方向。",
      referencesDescription: "基于你的文件、Figma 或网站进行创建。",
      name: "名称",
      startFresh: "从头开始",
      files: "文件",
      website: "网站",
      ...
      added: "已添加",
      invalidRepository: "请输入有效的仓库网址。",
      addRepository: "添加仓库",
      preparingReferences: "正在启动聊天…",
      startFailed: "无法启动聊天。参考资料已保留，请重试。",
      figmaDescription: "本地 Figma 文件。",
      websiteDescription: "从网站获取品牌方向。",
      githubDescription: "代码仓库，可指定分支和文件夹。",
      filesDescription: "文档、图片或本地代码。",
      advancedDescription: "现有设计系统、备注和指令。",
      unsupportedFiles:
        "请选择小于 200 KB 的文本或代码文件、PDF、DOCX、PPTX 或支持的图片。请在 Figma 中添加 .fig 文件。",
      github: "GitHub",
    },
    importedBrand: "导入的品牌",
    figFileRequired:
