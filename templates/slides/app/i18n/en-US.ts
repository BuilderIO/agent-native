...
const messages = {
  ...
  promptContext: {
    ...
    unsupportedFiles:
      "These files cannot be read here. Use non-empty text files under 200 KB or upload a .fig file.",
    context: "Context",
    ...
    loadFailed: "Context could not be loaded. Try again.",
    saveFailed: "Context could not be saved. Try again before sending.",
    governing: "Governs colors, typography, and visual tokens.",
    supporting: "Supporting reference only. Does not import or replace slides.",
    openSource: "Open source",
    remove: "Remove",
    figmaUrl: "Figma file or frame URL",
  ...
  designSystemSetup: {
    simple: {
      startFrom: "Start from",
      freshDescription: "Shape a new direction in chat.",
      referencesDescription: "Build on your files, Figma, or website.",
      name: "Name",
      ...
      added: "Added",
      invalidRepository: "Enter a valid repository URL.",
      addRepository: "Add repository",
      preparingReferences: "Starting chat…",
      startFailed:
        "Could not start the chat. Your references are saved here; try again.",
      figmaDescription: "Local Figma files.",
      websiteDescription: "Brand direction from a website.",
      githubDescription: "A repository, with optional branch and folders.",
      filesDescription: "Documents, images, or local code.",
      advancedDescription: "Existing systems, notes, and instructions.",
      unsupportedFiles:
        "Choose text/code files under 200 KB, PDF, DOCX, PPTX, or supported images. Add .fig files under Figma.",
      github: "GitHub",
    },
