...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "Create a blank deck",
    importDeck: "Import deck",
    recent: "Recent",
    sharedWithMe: "Shared with me",
    noSharedDecks: "No decks have been shared with you yet.",
    suggestionProductLaunch: "Build a product launch deck",
    suggestionQuarterlyReview: "Create a quarterly business review",
    suggestionInvestorPitch: "Make an investor pitch deck",
    suggestionFromNotes: "Turn my notes into slides",
