...
const messages = {
  ...
  home: {
    ...
    startBlankDeck: "Leere Präsentation erstellen",
    importDeck: "Präsentation importieren",
    recent: "Zuletzt",
    sharedWithMe: "Mit mir geteilt",
    noSharedDecks: "Es wurden noch keine Präsentationen mit dir geteilt.",
    suggestionProductLaunch: "Präsentation zur Produkteinführung erstellen",
    suggestionQuarterlyReview: "Quartalsrückblick erstellen",
    suggestionInvestorPitch: "Pitch für Investoren erstellen",
    suggestionFromNotes: "Meine Notizen in Folien umwandeln",
