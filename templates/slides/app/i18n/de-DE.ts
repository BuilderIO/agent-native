...
const messages = {
  ...
  promptContext: {
    ...
    unsupportedFiles:
      "Diese Dateien können hier nicht gelesen werden. Verwende nicht leere Textdateien unter 200 KB oder lade eine .fig-Datei hoch.",
    context: "Kontext",
    designSystem: "Designsystem",
    useSystem: "Designsystem verwenden",
    attachFigma: "Figma anhängen",
    referenceDesign: "Design als Referenz",
    referenceDeck: "Präsentation als Referenz",
    loadFailed: "Der Kontext konnte nicht geladen werden. Erneut versuchen.",
    saveFailed:
      "Der Kontext konnte nicht gespeichert werden. Vor dem Senden erneut versuchen.",
    governing: "Bestimmt Farben, Typografie und visuelle Tokens.",
    supporting:
      "Nur als ergänzende Referenz. Importiert oder ersetzt keine Folien.",
    openSource: "Quelle öffnen",
    remove: "Entfernen",
    figmaUrl: "URL einer Figma-Datei oder eines Frames",
    browse: "Frames durchsuchen",
    retry: "Erneut versuchen",
    search: "Quellen suchen…",
    empty: "Keine passenden Quellen.",
    previous: "Zurück",
    next: "Weiter",
  },
  ...
  designSystemSetup: {
    simple: {
      startFrom: "Beginnen mit",
      freshDescription: "Entwickle eine neue Richtung im Chat.",
      referencesDescription:
      ...
      continue: "Weiter",
      back: "Zurück",
      chooseFigma: ".fig-Datei auswählen",
      chooseFiles: "Dateien auswählen",
      invalidWebsite: "Gib eine gültige Website-URL ein.",
      freshPrompt: "Hilf mir, die Designrichtung für „{{name}}“ zu entwickeln.",
      referencePrompt: "Richte „{{name}}“ anhand meiner Referenzen ein.",
      yourReferences: "Referenzen",
      figmaSource: "Figma (.fig)",
      added: "Hinzugefügt",
      invalidRepository: "Gib eine gültige Repository-URL ein.",
      addRepository: "Repository hinzufügen",
      preparingReferences: "Chat wird gestartet…",
      startFailed:
        "Der Chat konnte nicht gestartet werden. Deine Referenzen bleiben hier gespeichert; versuche es erneut.",
      figmaDescription: "Lokale Figma-Dateien.",
      websiteDescription: "Markenrichtung von einer Website.",
      githubDescription: "Ein Repository, optional mit Branch und Ordnern.",
      filesDescription: "Dokumente, Bilder oder lokaler Code.",
      advancedDescription: "Vorhandene Systeme, Notizen und Anweisungen.",
      unsupportedFiles:
        "Wähle Text-/Codedateien unter 200 KB, PDF, DOCX, PPTX oder unterstützte Bilder. Füge .fig-Dateien unter Figma hinzu.",
      github: "GitHub",
    },
