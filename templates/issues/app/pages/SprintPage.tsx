          ...
          {isLoading ? (
            ...
            <>
              ...
              {activeSprint && (
                <div>
                  <div className="flex items-center gap-2 border-b border-border/30 bg-muted/30 px-4 py-2.5">
                    <span className="inline-flex h-4 items-center rounded-full bg-green-500/15 px-1.5 text-[10px] font-medium text-green-500">
                      ACTIVE
                    </span>
              ...
              {futureSprints.map((sprint: any) => (
                <div key={sprint.id}>
                  <div className="flex items-center gap-2 border-b border-border/30 bg-muted/30 px-4 py-2.5">
                    <span className="inline-flex h-4 items-center rounded-full bg-muted px-1.5 text-[10px] font-medium text-muted-foreground">
                      FUTURE
                    </span>
                    <span className="text-[13px] font-semibold text-foreground">
                      {sprint.name}
