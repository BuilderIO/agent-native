...
export default defineAction({
  description: "Clone immutable governed media bytes into an editable Assets library without exposing the private source payload.",
  schema: z.object({ contextId: z.string(), artifactKey: z.string(), resourceId: z.string(), expectedUpdatedAt: z.string().optional(), libraryId: z.string(), title: z.string().optional() }),
  run: async (args) => {
