...
const HTML_EVENT_HANDLER_ACTION_PATTERN = String.raw`(?:execute|run|fire|trigger|call|invok|evaluat|eval|perform|fetch|post|request|redirect|navigat|access|open|load|write|beacon|emit|message|leak|exfiltrat|steal|read|send|transmit|disclos|expos|capture|harvest)\w*`;
