const messages = {
  ...
  triage: {
    ...
    confidencePlaceholder: "Todos los niveles de confianza",
    confidenceValues: {
      unknown: "Desconocido",
      low: "Bajo",
      medium: "Medio",
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "Ningún elemento coincide con este filtro.",
    ...
    auditRunDuration: "Duró {{duration}}",
    auditRunBegan: "Comenzado {{age}}",
    ...
    auditSectionItems: "Elementos",
    auditAdded: "{{count}} añadidos",
    auditExamined: "{{count}} examinados",
    ...
    automationEffort: "Esfuerzo",
    automationEffortAuto: "Auto",
    automationEffortLow: "Bajo",
    automationEffortMedium: "Medio",
    automationEffortHigh: "Alto",
    automationEffortXhigh: "Extra alto",
    automationEffortMax: "Máx.",
