const messages = {
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "このフィルターに一致する項目はありません。",
    ...
    auditRunDuration: "実行時間 {{duration}}",
    auditRunBegan: "起動 {{age}}",
    ...
    automationEffortMedium: "中",
    automationEffortHigh: "高",
    automationEffortXhigh: "非常に高い",
    automationEffortMax: "最大",
