const messages = {
  ...
  factoryRoute: {
    ...
    inboxRowActions: "{{title}} の操作",
    inboxMarkResolved: "解決済みにする",
    inboxSendBackToAutomation: "自動化に差し戻す",
    inboxOutcomeUpdated: "ステータスを更新しました",
    inboxOutcomeFailed: "ステータスを更新できませんでした",
