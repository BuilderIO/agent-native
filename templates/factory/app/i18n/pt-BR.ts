const messages = {
  ...
  triage: {
    ...
    confidencePlaceholder: "Todos os níveis de confiança",
    confidenceValues: {
      unknown: "Desconhecido",
      low: "Baixo",
      medium: "Médio",
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "Nenhum item corresponde a este filtro.",
    ...
    auditRunDuration: "Durou {{duration}}",
    auditRunBegan: "Começou {{age}}",
    ...
    automationEffort: "Esforço",
    automationEffortAuto: "Auto",
    automationEffortLow: "Baixo",
    automationEffortMedium: "Médio",
