const messages = {
  ...
  factoryRoute: {
    ...
    inboxRowActions: "Actions for {{title}}",
    inboxMarkResolved: "Mark resolved",
    inboxSendBackToAutomation: "Send back to automation",
    inboxOutcomeUpdated: "Status updated",
    inboxOutcomeFailed: "Could not update status",
    selectObservation:
