const messages = {
  ...
  triage: {
    ...
    confidencePlaceholder: "All confidence",
    confidenceValues: {
      unknown: "Unknown",
      low: "Low",
      medium: "Medium",
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "No items match this filter.",
    ...
    auditRunDuration: "Ran for {{duration}}",
    auditRunBegan: "Began {{age}}",
    ...
    auditSectionItems: "Items",
    auditAdded: "{{count}} added",
    auditExamined: "{{count}} examined",
    ...
    automationEffort: "Effort",
    automationEffortAuto: "Auto",
    automationEffortLow: "Low",
    automationEffortMedium: "Medium",
    automationEffortHigh: "High",
    automationEffortXhigh: "Extra high",
    automationEffortMax: "Max",
