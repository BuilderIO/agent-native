const messages = {
  ...
  triage: {
    ...
    confidencePlaceholder: "Alle Konfidenzstufen",
    confidenceValues: {
      unknown: "Unbekannt",
      low: "Niedrig",
      medium: "Mittel",
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "Keine Elemente entsprechen diesem Filter.",
    ...
    auditRunDuration: "Lief {{duration}}",
    auditRunBegan: "Begonnen {{age}}",
    ...
    auditSectionItems: "Elemente",
    auditAdded: "{{count}} hinzugefügt",
    auditExamined: "{{count}} geprüft",
    ...
    automationEffort: "Aufwand",
    automationEffortAuto: "Auto",
    automationEffortLow: "Niedrig",
    automationEffortMedium: "Mittel",
    automationEffortHigh: "Hoch",
    automationEffortXhigh: "Extra hoch",
