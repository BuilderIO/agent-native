const messages = {
  ...
  triage: {
    ...
    confidencePlaceholder: "Tous les niveaux de confiance",
    confidenceValues: {
      unknown: "Inconnu",
      low: "Faible",
      medium: "Moyen",
  ...
  factoryRoute: {
    ...
    auditNoItemsMatchFilter: "Aucun élément ne correspond à ce filtre.",
    ...
    auditRunDuration: "A duré {{duration}}",
    auditRunBegan: "Commencé {{age}}",
    ...
    auditSectionItems: "Éléments",
    auditAdded: "{{count}} ajouté(s)",
    auditExamined: "{{count}} examiné(s)",
    ...
    automationEffortLow: "Faible",
    automationEffortMedium: "Moyen",
    automationEffortHigh: "Élevé",
    automationEffortXhigh: "Très élevé",
