...
export const PRIVATE_VAULT_NATIVE_SERVICE_LIMITS = Object.freeze({
  ...
  hostedJobEnvelopeBytes: E2EE_SIZE_LIMITS.jobPayloadBytes + 64 * 1024,
  hostedJobPayloadBytes: E2EE_SIZE_LIMITS.jobPayloadBytes,
  hostedResultEnvelopeBytes: E2EE_SIZE_LIMITS.resultPayloadBytes + 64 * 1024,
...
function parseResultUnchecked(value: unknown): PrivateVaultNativeServiceResult {
  ...
  switch (operation) {
    ...
    case "openHostedJob": {
      const record = resultHeader(value, operation, ["jobPayload"]);
      return {
        ...base(operation),
