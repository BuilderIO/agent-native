  ...
  (
    ...
    <DialogPortal container={container}>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          // overflow-y-auto, not overflow-hidden: content taller than max-h is
          // otherwise clipped with no way to reach it, and the controls that
          // grow last (footers, advanced sections) are the ones that vanish.
