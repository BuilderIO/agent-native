...
function isNativeTestVectorArtifact(relativePath) {
  ...
  return (
    /(?:^|\/)native-(?:control-log|authority-store|recovery-wrap|genesis-bootstrap)-vectors\.ts$/.test(
      normalized,
    ) ||
    /(?:^|\/)fixtures\/anc-v1-native-(?:control-log|authority-store|recovery-wrap|genesis-bootstrap)-vectors\.json$/.test(
      normalized,
    )
  );
}
