...
| 2     | Builder.io managed (Gemini)     | Cloud fallback when native text is missing; no extra key needed once Builder is connected; Builder.io's free tier includes managed Agent Credits |
