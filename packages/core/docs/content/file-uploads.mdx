---
title: "File Uploads"
description: "Configure durable file upload storage — Builder.io or custom object storage for production."
---
...
- [**Database**](/docs/server-database) — why binary blobs stay out of SQL and go through this provider abstraction instead
