...
- **[What Is Agent-Native?](/docs/what-is-agent-native)**: the vision and the case for building this way.
...
- **[Native Chat UI](/docs/native-chat-ui)**: render action results as tables, charts, and typed cards.
- **[Context Awareness](/docs/context-awareness)**: `view-screen`, `navigate`, route state, and selected objects.
- **[Agent Surfaces](/docs/agent-surfaces)**: chat, inline UI, app pages, embedded sidecars, automation, and external agents.
