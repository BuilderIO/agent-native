---
title: "Toolkits"
description: "A balanced catalog of reusable foundations, editors and canvases, agent context, governance, workspace chrome, operations, and capability packages."
---
...
standard surfaces without making one app pattern the center of the catalog.
...
| Capability packages        | [Capability Packages](/docs/toolkit-capability-packages) | Separate domain packages, their ownership, and lifecycle manifests.             |
...
- The Context X-Ray engine remains **Core-owned**; its reusable presentation is
  Toolkit-owned.
- Creative Context and Scheduling remain **separate capability packages**, not
  Toolkit feature kits.
