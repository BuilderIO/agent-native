...
<<<<<<< HEAD
<!-- i18n-copy-ignore: Formatting-only blank-line normalization; Agent-Native punctuation is locale-invariant. -->
=======
<!-- i18n-copy-ignore: Agent-Native punctuation is locale-invariant; formatting-only blank line, no translated prose changed. -->
>>>>>>> origin/main
