...
<DataModel id="doc-block-1dtds8f" title="Plan data model" summary="One plan row owns ordered sections plus comments, events, versions, shares, and inline assets." entities={[
  {
    "id": "plans",
    "name": "plans",
