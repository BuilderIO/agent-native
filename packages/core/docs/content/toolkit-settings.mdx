...
Open **Settings → Agent** and select **Connect ChatGPT** in the **ChatGPT
subscription** row. Finish sign-in in the popup. After it connects, select
**Use in chat** to make it the current agent engine.
