...
Comments should be resource-scoped, access-scoped, and agent-readable. The UI
and agent should use the same actions to create, resolve, and list threads.
Apps can specialize anchor shapes, but the common model should preserve:
