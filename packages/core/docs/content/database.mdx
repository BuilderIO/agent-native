...
<DataModel id="doc-block-14e70da" title="The tasks table" summary={"Defined once with the framework helpers; the dialect is chosen at runtime from DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
