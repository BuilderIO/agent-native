...
(skills, memory, instructions, sub-agents, and connected MCP servers),
**Automations**, **Thread history**, and **Settings**. Those are usually enough
— talk to it, see what it's done, configure how it behaves. Reach for
