...
| `AGENT_NATIVE_ENABLE_KEEP_WARM`                | Opts into the Netlify keep-warm scheduled function; unset by default.                                                                                                  | `1`; see [Keep-warm](/docs/deployment#netlify-keep-warm).                                                      |
| `AGENT_NATIVE_DISABLE_KEEP_WARM`               | Compatibility kill switch for the Netlify keep-warm scheduled function.                                                                                                | `1`; see [Keep-warm](/docs/deployment#netlify-keep-warm).                                                      |
...
| `AGENT_NATIVE_DISABLE_KEEP_WARM_BACKGROUND`    | Drops only the background-function warm and keeps the server warm when keep-warm is enabled.                                                                          | `1`; see [Keep-warm](/docs/deployment#netlify-keep-warm).                                                      |
