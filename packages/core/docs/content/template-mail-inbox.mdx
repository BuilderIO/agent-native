...
Move through your inbox without touching the mouse. Priority sorting is available only when you have Builder access or a saved personal key. Use these keyboard shortcuts:
