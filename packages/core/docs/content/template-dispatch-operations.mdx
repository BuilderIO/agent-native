...
<Diagram id="doc-block-dispatch5" title={"Dreams input pipeline"} summary={"Evidence from untrusted sources is size-capped, sanitized, and schema-validated before it ever reaches a report — malformed candidates are dropped, not coerced."}>
...
<div class="dsp-dreams-flow">
  ...
  <div class="diagram-box" data-rough>
    Sanitize<br /><small class="diagram-muted"
      >size caps · strip control chars · escape</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Zod schema validate<br /><small class="diagram-muted"
      >malformed candidates dropped</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
