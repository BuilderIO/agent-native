---
title: "Content: Collections, Properties & Forms"
...
- **Add more rows** — the source's entries become their own new rows in your collection.
...
- [Writing & organizing documents](/docs/template-content-editing) — the editor, page tree, and sharing model a collection's row pages build on
- [Local files, Notion & Builder CMS sync](/docs/template-content-sync) — syncing whole documents, as opposed to collection rows
