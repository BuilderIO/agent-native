...
Destructive or external actions — sending money, shipping an outbound email, posting to Slack at scale — can require an admin OK before they fire. From Dispatch's **Approvals** page:
