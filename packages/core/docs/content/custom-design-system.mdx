...
The plugin generates the virtual theme CSS and injects it into the public
cacheable shell at build time. Version 1 does not choose a theme per request or
per organization.
...
| `Dialog`, `Avatar`, `Status` | Share dialog |
