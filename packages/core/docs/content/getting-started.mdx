...
In this guide, you'll create a blank agent-native app and call its included `hello` action
...
In a new directory, create a blank app:
...
The template includes a browser app, authentication, live sync, application
context, and an `actions/` directory. It also includes a small `hello` action
that you'll use throughout this guide.
...
can use as a tool. The blank app includes a simple `hello` action so you
