...
{
  "html": "<div class=\"diagram-machine\"><div class=\"diagram-card surface user\" data-rough><span class=\"diagram-pill\">User surface</span><div class=\"diagram-node diagram-accent\">Open Design tab<br><small class=\"diagram-muted\">navigate.activePanel</small></div><div class=\"diagram-node\">Add text block<br><small class=\"diagram-muted\">updatePlan.addBlock</small></div><div class=\"diagram-node\">Remove summary<br><small class=\"diagram-muted\">updatePlan.removeBlock</small></div></div><div class=\"diagram-lane\"><span class=\"diagram-pill\">intent -&gt; action</span><span class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</span><span class=\"diagram-pill ok\">state -&gt; UI</span></div><div class=\"core\"><div class=\"diagram-panel action\" data-rough><span class=\"diagram-pill accent\">Typed action</span><strong>navigate</strong><small class=\"diagram-muted\">actor: user &middot; input: activePanel = Design</small><ol><li>validate input</li><li>authorize actor</li><li>apply update</li></ol></div><div class=\"diagram-panel state\" data-rough><span class=\"diagram-pill ok\">Shared state</span><strong>SQL + application_state</strong><code>{ activePanel: \"Design\" }</code><small class=\"diagram-muted\">broadcast over live sync</small></div></div><div class=\"diagram-lane\"><span class=\"diagram-pill\">action &lt;- intent</span><span class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&larr;</span><span class=\"diagram-pill ok\">context -&gt; agent</span></div><div class=\"diagram-card surface agent\" data-rough><span class=\"diagram-pill\">Agent surface</span><div class=\"diagram-node\">Add diagram block<br><small class=\"diagram-muted\">updatePlan.addBlock</small></div><div class=\"diagram-node\">Remove stale block<br><small class=\"diagram-muted\">updatePlan.removeBlock</small></div><div class=\"diagram-node diagram-accent\">Focus review view<br><small class=\"diagram-muted\">navigate.reviewContext</small></div></div></div>",
  "css": ".diagram-machine{display:grid;grid-template-columns:minmax(150px,1fr) auto minmax(260px,1.7fr) auto minmax(150px,1fr);gap:12px;align-items:stretch}.diagram-machine .surface{display:flex;flex-direction:column;gap:8px;padding:14px}.diagram-machine .surface .diagram-pill{align-self:flex-start}.diagram-machine .diagram-node{display:flex;flex-direction:column;gap:2px;padding:10px 12px}.diagram-machine .diagram-lane{display:flex;flex-direction:column;justify-content:center;align-items:center;gap:8px;text-align:center;min-width:92px}.diagram-machine .diagram-arrow{font-size:22px;line-height:1}.diagram-machine .core{display:grid;grid-template-columns:1fr 1fr;gap:12px}.diagram-machine .diagram-panel{display:flex;flex-direction:column;gap:8px;min-width:0;padding:14px}.diagram-machine ol{margin:0;padding-left:18px;color:var(--wf-muted);font-size:0.9rem}.diagram-machine code{align-self:flex-start;max-width:100%;white-space:normal}@media(max-width:900px){.diagram-machine{grid-template-columns:1fr}.diagram-machine .diagram-lane{min-width:0;flex-direction:row;justify-content:flex-start}.diagram-machine .core{grid-template-columns:1fr}}"
}
```
