...
<WireframeBlock id="doc-block-13w9yli">
...
<DataModel id="doc-block-mpte5r" title="Video data model" summary="SQL-backed compositions plus design systems and nestable folders, each with a framework shares table." entities={[
  {
    "id": "compositions",
    "name": "compositions",
    ...
    "fields": [
      ...
      },
      {
        "name": "data",
        "type": "text",
        "note": "Full composition JSON blob"
      },
      {
        "name": "created_at",
        "type": "text"
