...
<AnnotatedCode id="doc-block-3pl82t" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# Morning digest\n\nSummarize the emails received overnight. Group by sender domain.\nPin the top 3 threads that look like they need a reply today to the\n\"Needs reply\" label. Draft replies for any that are obvious."} annotations={[
  {
    "lines": "2",
    "label": "When",
