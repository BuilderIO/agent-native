...
| -------------------- | --------------------------------------- | ------------------------------------------------ | --------------------------------------------- |
| `claude` _(default)_ | Claude Code CLI                         | `ANTHROPIC_API_KEY` or `CLAUDE_CODE_OAUTH_TOKEN` | —                                             |
...
| `CLAUDE_CODE_OAUTH_TOKEN` | Alternative to `ANTHROPIC_API_KEY`: a Claude subscription token from `claude setup-token`. Set one or the other, not both.         |
