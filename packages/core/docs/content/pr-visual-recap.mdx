...
| `openai-compatible`  | Agent-Native Code + OpenAI API | `VISUAL_RECAP_API_KEY` |
...
| `VISUAL_RECAP_BASE_URL`  | —                               | Variable. HTTP(S) base URL for the OpenAI-compatible backend; credentials are rejected.                                                         |
