...
<FileTree id="doc-block-ey1lgj" title="Guidage et comportement" entries={[
  {
    "path": "AGENTS.md",
...
<DataModel id="doc-block-1cx7jgd" title="Magasins principaux SQL" summary={"Créés automatiquement dans chaque modèle : l'agent et l'interface utilisateur les lisent et les écrivent."} entities={[
  {
