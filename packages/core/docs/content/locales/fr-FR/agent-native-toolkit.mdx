...
## Catalogue équilibré {#balanced-catalog}

Le catalogue couvre aussi les fondations, éditeurs et canevas, contexte et connaissances de l'agent, collaboration et gouvernance, cadre de l'espace de travail, opérations et packages de capacité. L'éditeur riche appartient à Toolkit ; Core conserve des réexportations de compatibilité. Les blocs restent dans Core. Design est un patron de modèle avec `design-tweaks`, pas un éditeur installable complet. Le moteur Context X-Ray appartient à Core et sa présentation réutilisable à Toolkit. Scheduling et Creative Context sont des packages de capacité séparés ; consultez [Cycle de vie des packages](/docs/package-lifecycle).
