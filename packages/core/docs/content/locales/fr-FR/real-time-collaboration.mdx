...
- **Fonctionne partout** – Toute base de données SQL prise en charge par Drizzle (PGlite, Postgres).
...
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres sur un hôte accessible publiquement**                                | La passerelle contacte la base de données depuis son propre réseau. PGlite, `localhost`, `*.internal` et les adresses IP nues sont refusés avant même que la chaîne de connexion ne quitte votre machine. | `DATABASE_URL` pointe vers un Postgres géré tel que Neon                                                                                                                                                        |
