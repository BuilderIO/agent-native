...
`extensionTools: true` sur `createAgentChatPlugin()`. Cela ajoute les actions
et les instructions destinées à l’agent, tout en conservant le runtime isolé et
les liens existants pour compatibilité.
