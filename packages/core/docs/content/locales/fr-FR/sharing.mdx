...
<DataModel id="doc-block-1rkh7kr" title="Tableau des partages de ressources et de compagnons" summary={"Coarse visibility lives on the resource; each fine-grained grant is a row in the shares table."} entities={[
  {
    "id": "deck",
    "name": "decks",
    "note": "...ownableColumns()",
