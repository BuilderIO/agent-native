...
avec `runDrizzleMigrations()` depuis l'étape de release. Conservez
`runMigrations()` pour l'historique écrit à la main et les cas particuliers.
N'utilisez jamais de SQL destructeur, `drizzle-kit push`, de renommage de tables ou
de suppression de colonnes.
