...
<AnnotatedCode id="doc-block-15ly4k5" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# Résumé du matin\n\nSummarize les e-mails reçus pendant la nuit. Regroupez par domaine d'expéditeur.\nPin les trois principaux sujets qui semblent avoir besoin d'une réponse aujourd'hui au libellé\n\"Réponse nécessaire\". Rédigez des réponses pour celles qui sont évidentes."} annotations={[
  {
    "lines": "2",
    "label": "Quand",
