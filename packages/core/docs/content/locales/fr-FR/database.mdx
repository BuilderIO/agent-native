  ...
  annotations={[
    {
      ...
      note: "`ADD COLUMN IF NOT EXISTS` peut être réexécuté en toute sécurité et ne perd jamais de données. Les noms ressemblent à drop+create en Drizzle, alors ajoutez-puis-migrez à la place.",
    },
    {
      lines: "13-16",
