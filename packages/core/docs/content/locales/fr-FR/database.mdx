...
<DataModel id="doc-block-18rt7fu" title={"Le tableau des tâches"} summary={"Définie une seule fois avec les helpers du framework ; le dialecte est choisi à l’exécution à partir de DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
