---
title: "Doctor (Vérifications de code)"
description: "agent-native doctor analyse le code source de l’application pour la sécurité et l’architecture."
---

# Doctor (Vérifications de code)
