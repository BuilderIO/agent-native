...
<DataModel id="doc-block-19f5mow" title="What ownableColumns() adds" summary="Les trois colonnes qui rendent une table sensible aux locataires et partageable." entities={[
  {
    "id": "ownable",
