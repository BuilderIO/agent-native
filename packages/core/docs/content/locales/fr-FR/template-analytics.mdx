...
<DataModel id="doc-block-1kot9n2" title={"Modèle de données Analytics"} summary={"Les dashboards et analyses sont les ressources ; vues, partages et cache de requêtes s’y rattachent. Les tables d’organisation viennent de @agent-native/core/org."} entities={[
  {
    "id": "dashboards",
    "name": "dashboards",
