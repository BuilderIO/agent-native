...
<DataModel id="doc-block-1sq21t8" title={"Le modèle de connexion"} summary={"A connection records safe provider metadata and credentialRefs (pointers, not secrets). Each grant unlocks one app — one connection, many grants."} entities={[
  {
    "id": "conn",
    ...
    "fields": [
      ...
      },
      {
        "name": "provider",
        "type": "string",
        "note": "identifiant de fournisseur stable, par ex. mou"
      },
      {
        "name": "label",
        "type": "string"
      ...
      },
      {
        ...
        "type": "json",
        "nullable": true,
        "note": "configuration sûre et non secrète"
      },
      {
        "name": "credentialRefs",
        "type": "json",
  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        "name": "appId",
        "type": "string",
        "note": "par ex. cerveau, analytique"
      }
    ]
  }
]} relations={[
