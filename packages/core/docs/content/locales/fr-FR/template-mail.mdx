...
<DataModel id="doc-block-zz1dhg" title="Tableaux Mail SQL" summary={"L'e-mail lui-même réside dans Gmail. Les tables SQL contiennent ce que Gmail ne contient pas : les brouillons en file d'attente, les événements de suivi d'envoi et les jetons OAuth. Les paramètres et l’état éphémère se trouvent dans les magasins settings et application_state."} entities={[
  {
