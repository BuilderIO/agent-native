...
<WireframeBlock id="doc-block-1k01b26">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-18s8emi" title="Construire, publier, collecter" summary={"L'agent et l'éditeur visuel modifient une définition de formulaire SQL-backed. La page de remplissage publique n'est pas authentifiée et les soumissions sont acheminées côté serveur vers vos destinations."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Prompt agent<br /><small class="diagram-muted"
  ...
  <div class="diagram-box">
    forms table<br /><small class="diagram-muted">SQL avec Drizzle</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-box">
...
<DataModel
  id="doc-block-b7l6hy"
  title={"Modèle de données Forms"}
  summary={
    "Trois tableaux. Les champs et les intégrations sont des colonnes JSON sur les formulaires, de sorte que les modifications de l'agent sont des correctifs chirurgicaux plutôt que des changements de lignes dans un tableau croisé."
  }
  entities={[
    {
      id: "forms",
      ...
      fields: [
        ...
        },
        {
          name: "fields",
          type: "json",
          note: "FormField[] — tous les types de champs",
        },
        {
          name: "settings",
          type: "json",
          note: "FormSettings — intégrations, etc.",
        },
        {
          name: "status",
          type: "enum",
          note: "brouillon | publié | fermé",
        },
        {
          name: "deleted_at",
          type: "datetime",
...
- [**Actions**](/docs/actions-overview) — le système d'action qui alimente le constructeur
