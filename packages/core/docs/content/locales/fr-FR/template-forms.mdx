...
<DataModel id="doc-block-b7l6hy" title={"Modèle de données Forms"} summary={"Trois tableaux. Les champs et les intégrations sont des colonnes JSON sur les formulaires, de sorte que les modifications de l'agent sont des correctifs chirurgicaux plutôt que des changements de lignes dans un tableau croisé."} entities={[
  {
    "id": "forms",
    "name": "forms",
