...
<DataModel id="doc-block-gcpufe" title={"Modèle de données vidéo"} summary={"Compositions adossées à SQL, ainsi que des systèmes de conception et des dossiers imbriqués, chacun avec une table de partage de cadre."} entities={[
  {
    "id": "compositions",
    "name": "compositions",
