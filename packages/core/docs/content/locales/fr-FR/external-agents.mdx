...
Dans l'application, ouvrez **Settings**, recherchez **MCP** et copiez la **MCP
server URL**. Collez cette URL dans l'hôte d'IA que vous souhaitez utiliser.
L'URL correspond à l'URL de base de l'application déployée suivie de `/mcp` ;
aucun réglage développeur n'est nécessaire.
