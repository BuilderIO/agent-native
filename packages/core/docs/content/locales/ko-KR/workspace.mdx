...
<DataModel id="doc-block-mdq7v" title={"작업공간 자원 모델"} summary={"하나의 리소스 형태는 모든 작업 공간 파일을 백업합니다. 런타임은 이를 경로 및 범위별로 키를 지정하고 읽기 시 유효 값을 확인합니다."} entities={[
  {
    "id": "resource",
...
<AnnotatedCode id="doc-block-1ey6igr" title={"맞춤형 상담원 프로필"} filename="agents/design.md" language="markdown" code={"---\nname: Design\ndescription: >-\n  Reviews layouts, interaction patterns, and product UX decisions.\nmodel: inherit\ntools: inherit\ndelegate-default: false\n---\n\n# 역할\n\n당신은 집중적인 디자인 에이전트입니다.\n\n## 책임\n\n- 레이아웃 및 상호 작용 흐름 검토\n- 더 강력한 시각적 방향 제안\n- 간결하고 자기 주장이 강합니다."} annotations={[
  {
    "lines": "2",
