...
<DataModel id="doc-block-10ub4z9" title={"작업 테이블"} summary={"Defined once with the framework helpers; the dialect is chosen at runtime from DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
