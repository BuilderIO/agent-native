...
<AnnotatedCode id="doc-block-16nk9rl" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# 아침 요약\n\n밤새 받은 이메일을 요약합니다. 발신자 도메인별로 그룹화하세요.\n오늘 답장이 필요한 것으로 보이는 상위 3개의 스레드를\n\"Needs reply\" 라벨에 고정하세요. 명백한 내용에 대한 답변 초안입니다."} annotations={[
  {
    "lines": "2",
    "label": "언제",
