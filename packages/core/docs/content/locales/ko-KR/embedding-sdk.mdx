...
<Diagram id="doc-block-ig37ik" title={"임베딩 멤브레인"} summary={"호스트 앱은 서버 측 인증 및 라이브 페이지 컨텍스트를 제공합니다. Agent-Native은 내구성 있는 사이드카를 실행하고 클라이언트 작업 및 호스트 명령을 통해 열린 탭에 도달합니다."}>

```html
<div class="diagram-embed">
  <div class="diagram-box" data-rough>
    <strong>호스트 SaaS 앱</strong
    ><small class="diagram-muted">내 UI, 내 인증</small>
  </div>
  <div class="diagram-col">
    <div class="diagram-pill accent">getContext &rarr;</div>
    <div class="diagram-pill">&larr; 클라이언트 작업</div>
    <div class="diagram-pill">&larr; 호스트 명령</div>
  </div>
  <div class="diagram-panel center" data-rough>
    <strong>Agent-Native sidecar</strong
    ><small class="diagram-muted">영구 채팅 · 앱 상태 · 확장</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    SQL<br /><small class="diagram-muted">프레임워크 테이블</small>
  </div>
</div>
```
...
<Diagram id="doc-block-1sxxt6z" title={"서버 중재 브라우저 세션 브리지"} summary={"백엔드 도구는 작업을 대기열에 넣습니다. 등록된 탭이 이를 요청하고 라이브 페이지에서 실행하면 결과가 에이전트에 반환됩니다. 따라서 backend/Slack/A2A 에이전트는 여전히 열려 있는 탭을 터치할 수 있습니다."}>

```html
<div class="diagram-bridge">
  <div class="diagram-node" data-rough>
    백엔드 에이전트<br /><small class="diagram-muted">채팅 · Slack · A2A</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node" data-rough>
    활성 탭이 가져감<br /><small class="diagram-muted">registered bridge</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
