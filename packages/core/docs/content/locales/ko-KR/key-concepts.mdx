...
<FileTree id="doc-block-1rnk9px" title={"지침과 동작"} entries={[
  {
    "path": "AGENTS.md",
...
<DataModel id="doc-block-xd1ed8" title={"핵심 SQL 매장"} summary={"모든 템플릿에서 자동 생성됩니다. 에이전트와 UI 모두 이를 읽고 씁니다."} entities={[
  {
