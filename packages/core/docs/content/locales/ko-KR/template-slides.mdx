...
<DataModel id="doc-block-1jdja0b" title={"슬라이드 데이터 모델"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
