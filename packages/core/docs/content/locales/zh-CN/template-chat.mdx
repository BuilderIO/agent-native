...
<Diagram id="doc-block-1nyi620" title={"Chat shell 中包含哪些内容"} summary={"框架标准运行时上的精简聊天界面（操作、持久线程、实时同步和身份验证），有空间添加您自己的 UI。"}>
