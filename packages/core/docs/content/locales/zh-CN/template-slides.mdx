...
<DataModel id="doc-block-h985pt" title={"幻灯片数据模型"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
