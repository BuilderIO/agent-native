...
本地堆栈特意使用示例身份验证密钥和本地 Postgres 卷，仅适用于 `localhost`，不适合直接暴露到互联网。完整的 Compose 文件和可复制步骤请参阅[英文快速入门](https://www.agent-native.com/docs/deployment#self-host-quickstart)。
