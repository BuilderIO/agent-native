...
<AnnotatedCode id="doc-block-lugzn6" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# 早间摘要\n\n总结隔夜收到的电子邮件。按发件人域分组。\n将今天看起来需要回复的前 3 个线程固定到\n\"Needs reply\" 标签。对任何显而易见的问题草拟答复。"} annotations={[
  {
    "lines": "2",
    "label": "当",
