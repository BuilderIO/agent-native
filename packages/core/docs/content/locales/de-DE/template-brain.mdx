...
<DataModel id="doc-block-19q0jla" title="Brain Datenmodell" summary={"Connectors erzeugen Roh-Captures; Distillation verwandelt sie in prüfbares Wissen; Vorschläge schützen sensible Einträge. Sync-Runs und die Ingest-Warteschlange verfolgen Hintergrundarbeit."} entities={[
  {
    "id": "sources",
    "name": "brain_sources",
