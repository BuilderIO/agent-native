...
<DataModel id="doc-block-1le43sm" title="Das Workspace-Ressourcenmodell" summary={"Eine Ressourcenform unterstützt jede Arbeitsbereichsdatei. Die Laufzeit verschlüsselt es nach Pfad und Umfang und löst den effektiven Wert beim Lesen auf."} entities={[
  {
    "id": "resource",
