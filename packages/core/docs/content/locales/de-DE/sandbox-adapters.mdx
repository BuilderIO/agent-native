...
<FileTree id="doc-block-vd1j1k" title="Die Sandbox-Nahtstelle in core" title="packages/core/src/coding-tools/sandbox/" entries={[
  {
    "path": "adapter.ts",
    "note": "Der SandboxAdapter-Vertrag (SandboxRunRequest / SandboxRunResult)"
  },
  {
    "path": "index.ts",
    "note": "Auswahl: getSandboxAdapter() / registerSandboxAdapter()"
  },
  {
    "path": "local-child-process-adapter.ts",
    "note": "Das Standard-Backend: gesperrter Node-Child-Prozess"
  },
  {
    "path": "../run-code.ts",
    "note": "Verdrahtet die Nahtstelle; ändert sich nie beim Backend-Wechsel"
  }
]} />
