...
`agentNative.mcp.listTools`, `agentNative.mcp.callTool` und
`agentNative.providerApi` über die Host-Aktionen; Verbindungs-URLs und Tokens
werden ihnen niemals übergeben.

### Atlassian / Jira

Das Atlassian-Preset verwendet den OAuth-2.1-Endpunkt von Atlassian Rovo MCP,
`https://mcp.atlassian.com/v1/mcp`, und stellt Tools für Jira und
