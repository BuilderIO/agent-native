...
<DataModel id="doc-block-12rdzxe" title="Videodatenmodell" summary={"Von SQL unterstützte Kompositionen sowie Designsysteme und verschachtelbare Ordner, jeweils mit einer Framework-Shares-Tabelle."} entities={[
  {
    "id": "compositions",
    "name": "compositions",
