...
Führen Sie zuerst das Browser-Identitäts-Flag aus. Aktivieren Sie nach dem Deployment der Organisations-Migrationsspalten in App und Dispatch `organization.cross-app-federation` für eine Organisation und prüfen Sie die kanonische ID und Rolle. Bestehende Organisationen ohne Zuordnung bleiben bis zu einer ausdrücklichen Migration unverändert.
