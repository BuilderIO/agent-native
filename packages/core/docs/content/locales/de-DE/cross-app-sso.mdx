...
- **Kanonischer gehosteter Client** → Die App zeigt für den registrierten Origin die Option **„Mit Agent-Native anmelden“**; selbst gehostete Apps müssen die Variable weiterhin setzen. Es gibt keine Schemaänderung und nichts zu migrieren.
