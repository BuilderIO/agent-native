...
<DataModel id="doc-block-fqoixq" title="Assets Datenmodell" summary={"Bibliotheken sind der besitzbare Container; Collections, Ordner und Presets organisieren sie. Sessions steuern Generieren-und-Auswählen; Assets und Runs halten Ausgabe und Audit-Log. Tabellennamen behalten das ältere Präfix image_* bei, decken aber alle Medien ab."} entities={[
  {
    "id": "library",
