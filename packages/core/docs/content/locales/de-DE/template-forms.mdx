...
<DataModel id="doc-block-wg20a4" title="Forms Datenmodell" summary={"Drei Tische. Felder und Integrationen sind JSON-Spalten in Formularen, sodass es sich bei den Bearbeitungen des Agenten eher um chirurgische Korrekturen als um tabellenübergreifende Zeilenänderungen handelt."} entities={[
  {
    "id": "forms",
    "name": "forms",
