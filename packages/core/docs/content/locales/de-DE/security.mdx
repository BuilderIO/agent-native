...
<DataModel id="doc-block-z688wd" title="What ownableColumns() adds" summary={"Die drei Spalten, die eine Tabelle mandantenfähig und gemeinsam nutzbar machen."} entities={[
  {
    "id": "ownable",
