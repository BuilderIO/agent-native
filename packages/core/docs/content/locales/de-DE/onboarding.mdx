...
Legen Sie in einem Multi-App-Arbeitsbereich `ONBOARDING_SHARED_COMPLETION` fest, um
abgeschlossenes Onboarding über Apps hinweg wiederzuverwenden. Wenn Sie es nicht
festlegen, verfolgt jede App den Onboarding-Abschluss separat.
...
Setup-Karten zeigen die verfügbaren Setup-Optionen. Sie listen nicht jeden
möglichen Schlüssel oder jede Anmeldeinformation auf.
