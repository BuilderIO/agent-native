...
<DataModel id="doc-block-1mt6whl" title="Mail SQL Tabellen" summary={"E-Mail selbst lebt in Gmail. Die SQL-Tabellen enthalten, was Gmail nicht enthält: Entwürfe in der Warteschlange, Sendeverfolgungsereignisse und OAuth-Tokens. Einstellungen und kurzlebiger Status sind in den Speichern „settings“ und „application_state“ gespeichert."} entities={[
  {
