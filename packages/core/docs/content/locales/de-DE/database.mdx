  ...
  annotations={[
    {
      ...
      note: "Migrationseinträge werden nachverfolgt und einmal angewendet. Halten Sie Änderungen additiv: Fügen Sie Spalten oder Tabellen hinzu und löschen oder benennen Sie sie niemals um.",
    },
    {
      lines: "13-16",
