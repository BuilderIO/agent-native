...
<DataModel id="doc-block-1p5aazr" title="Die Aufgabentabelle" summary={"Einmal mit den Framework-Helfern definiert; der Dialekt wird zur Laufzeit aus DATABASE_URL gewählt."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
