...
<DataModel id="doc-block-1sttqod" title="Calendar Datenmodell" summary={"Nur Nicht-Ereignisdaten werden lokal gespeichert – Ereignisse leben in Google Calendar. Buchungslinks verwenden ownableColumns, daher gilt das Freigabesystem."} entities={[
  {
    "id": "booking_links",
    "name": "booking_links",
