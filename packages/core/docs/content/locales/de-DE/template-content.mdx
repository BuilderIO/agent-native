...
<DataModel id="doc-block-1w21q1" title="Content Datenmodell" summary={"Neun Tabellen in server/db/schema.ts. documents ist der Seitenbaum; der Rest hängt daran für Versionen, Kommentare, Notion-Sync, Inline-Datenbanken und Freigaben."} entities={[
  {
    "id": "documents",
    "name": "documents",
