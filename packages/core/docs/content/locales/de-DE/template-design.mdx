...
<DataModel id="doc-block-1y77yy4" title="Entwerfen Sie ein Datenmodell" summary={"Ein Design ist Eigentümer seiner Dateien und versionierten Snapshots und verknüpft optional ein wiederverwendbares Designsystem. Sowohl Designs als auch Systeme sind besitzbar und verfügen jeweils über eine Tabelle mit Framework-Freigaben."} entities={[
  {
    "id": "designs",
    "name": "designs",
