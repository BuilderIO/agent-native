...
<DataModel id="doc-block-1etdmmd" title="Plan Datenmodell" summary={"Eine Planzeile enthält geordnete Abschnitte sowie Kommentare, Ereignisse, Versionen, Freigaben und Inline-Assets."} entities={[
  {
    "id": "plans",
    "name": "plans",
