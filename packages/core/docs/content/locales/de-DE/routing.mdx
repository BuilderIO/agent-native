...
Das ist alles – der Entwicklungsserver liest Routendateien beim Start. Wenn
`pnpm dev` bereits läuft, starten Sie es nach dem Hinzufügen der Datei neu. Keine
...
- [**Server**](/docs/server-overview) – dateibasierte Serverrouten und der `/_agent-native/`-Namespace
