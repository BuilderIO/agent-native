...
### Gruppenfreigaben {#group-grants}

Einige Ressourcen unterstützen Gruppenfreigaben. Eine Gruppe muss zur Organisation der Ressource gehören. Jedes aktuelle Gruppenmitglied erhält die ausgewählte Freigaberolle für diese Ressource. Unter [Organisationen, Teams und Berechtigungen → Benutzergruppen](/docs/organizations-teams-permissions#user-groups) steht, wofür Gruppen gelten und wofür nicht.
