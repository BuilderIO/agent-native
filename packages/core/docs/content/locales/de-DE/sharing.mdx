...
<DataModel id="doc-block-10alyfb" title={"Tabelle „Ressourcen- und Begleitanteile“."} summary={"Coarse visibility lives on the resource; each fine-grained grant is a row in the shares table."} entities={[
  {
    "id": "deck",
    "name": "decks",
    "note": "...ownableColumns()",
