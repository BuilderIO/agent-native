...
<DataModel id="doc-block-19af6z0" title="Slides-Datenmodell" summary={"Ein Deck besitzt seine Folien als JSON in decks.data; Kommentare, Versionen, Freigaben und Designsysteme hängen daran."} entities={[
  {
    "id": "decks",
    "name": "decks",
