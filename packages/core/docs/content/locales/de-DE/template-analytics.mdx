...
<DataModel id="doc-block-of9cf1" title="Analytics Datenmodell" summary={"Dashboards und Analysen sind die Ressourcen; Views, Shares und ein Query-Cache hängen daran. Organisationstabellen kommen aus @agent-native/core/org."} entities={[
  {
    "id": "dashboards",
    "name": "dashboards",
