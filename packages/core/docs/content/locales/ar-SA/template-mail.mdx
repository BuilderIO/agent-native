...
<DataModel id="doc-block-1izkaft" title={"جداول البريد SQL"} summary={"البريد الإلكتروني نفسه موجود في Gmail. تحتوي جداول SQL على ما لا يحتوي عليه Gmail: المسودات الموضوعة في قائمة الانتظار، وأحداث تتبع الإرسال، والرموز المميزة OAuth. الإعدادات والحالة المؤقتة موجودة في الإعدادات ومتاجر application_state."} entities={[
  {
