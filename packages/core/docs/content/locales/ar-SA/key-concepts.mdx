...
<FileTree id="doc-block-xid276" title={"الإرشاد والسلوك"} entries={[
  {
    "path": "AGENTS.md",
...
<DataModel id="doc-block-yuv4pv" title={"متاجر SQL الأساسية"} summary={"يتم إنشاؤه تلقائيًا في كل قالب — يقوم كل من الوكيل وUI بقراءة هذه العناصر وكتابتها."} entities={[
  {
