...
تتعرف التطبيقات المستضافة الأساسية على طلبات Desktop SSO Canary المجمعة من دون إعداد بيئة مركز هوية لكل تطبيق. وتظل المتصفحات العادية والتطبيقات ذاتية الاستضافة بحاجة إلى `AGENT_NATIVE_IDENTITY_HUB_URL`. لا تبدأ إصدارات Desktop المستقرة الوسيط قبل الموافقة على إصدار لاحق بشكل منفصل.
