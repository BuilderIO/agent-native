...
<DataModel id="doc-block-4s9xul" title={"نموذج بيانات التصميم"} summary={"يمتلك التصميم ملفاته ولقطاته ذات الإصدار، ويرتبط بشكل اختياري بنظام تصميم قابل لإعادة الاستخدام. كل من التصميمات والأنظمة قابلة للتملك، ولكل منها جدول مشاركات الإطار."} entities={[
  {
    "id": "designs",
    "name": "designs",
