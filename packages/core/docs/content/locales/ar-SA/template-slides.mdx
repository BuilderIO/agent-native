...
<DataModel id="doc-block-9goblm" title={"نموذج بيانات الشرائح"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
