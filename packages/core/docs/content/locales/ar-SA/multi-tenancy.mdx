...
## قائمة الحساب {#org-switcher}

تُعرض قائمة الحساب (`OrgSwitcher`، أسفل الشريط الجانبي) وصفحات المؤسسة في الإعدادات في كل قالب بدون تعليمات برمجية إضافية. وهي تستخدم مسارات REST الأساسية للمؤسسة ضمن `/_agent-native/org/*` (إنشاء مؤسسة، تبديل المؤسسة، عرض/دعوة/إزالة الأعضاء، تغيير الأدوار، تعيين نطاق البريد الإلكتروني المسموح به). يختار المستخدمون المؤسسة النشطة من قائمة الحساب؛ وتتولى صفحة **Settings › Organization › Members** الدعوات وتغييرات الأدوار.
