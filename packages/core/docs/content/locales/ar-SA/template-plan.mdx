...
<DataModel id="doc-block-1ovvfph" title={"نموذج بيانات الخطة"} summary={"يحتوي صف الخطة الواحد على أقسام مرتبة بالإضافة إلى التعليقات والأحداث والإصدارات والمشاركات والأصول المضمنة."} entities={[
  {
    "id": "plans",
    "name": "plans",
