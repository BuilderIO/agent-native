...
<Diagram id="doc-block-fj4ikg" title={"وثيقة واحدة والعديد من المحررين"} summary={"تقوم أنت والوكيل بالكتابة من خلال نفس خط الأنابيب Yjs. SQL هو المتجر الأساسي؛ الملفات المحلية وNotion هي أسطح مزامنة اختيارية."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      تكتب<br /><small class="diagram-muted">قائمة slash، شريط الأدوات</small>
    </div>
    <div class="diagram-node">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">مباشر، دمج بلا تعارض</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box">
    documents (markdown)<br /><small class="diagram-muted"
      >مخزن SQL القانوني</small
    >
  </div>
...
[مصادر المجلدات المحلية](/docs/template-content-local-files) للسياسات والتعارضات ومكونات MDX
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "string",
          nullable: true,
          note: "مزامنة Notion ثنائية الاتجاه",
        },
      ],
    },
    {
