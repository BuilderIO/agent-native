...
### مشاركة المجموعات {#group-grants}

تدعم بعض الموارد مشاركة المجموعات. يجب أن تنتمي المجموعة إلى مؤسسة المورد، ويحصل كل عضو حالي فيها على دور المشاركة المحدد لهذا المورد. راجع [المؤسسات والفرق والأذونات → مجموعات المستخدمين](/docs/organizations-teams-permissions#user-groups) لمعرفة ما الذي تحدده المجموعات وما الذي لا تحدده.
