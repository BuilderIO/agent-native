...
<AnnotatedCode id="doc-block-1xuuw14" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# الملخص الصباحي\n\nتلخيص رسائل البريد الإلكتروني المستلمة خلال الليل. التجميع حسب مجال المرسل.\nقم بتثبيت أهم 3 سلاسل رسائل تبدو وكأنها تحتاج إلى رد اليوم في التصنيف\n\"يلزم الرد\". مسودة ردود على أي ردود واضحة."} annotations={[
  {
    "lines": "2",
    "label": "متى",
