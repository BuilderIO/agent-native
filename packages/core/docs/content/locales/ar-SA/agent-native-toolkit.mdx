...
## كتالوج متوازن {#balanced-catalog}

يغطي الكتالوج أيضا الأسس والمحررات واللوحات وسياق الوكيل ومعرفته والتعاون والحوكمة وهيكل مساحة العمل والعمليات وحزم القدرات. المحرر الغني مملوك لـ Toolkit، مع إعادة تصدير للتوافق من Core؛ وتبقى الكتل في Core في هذه المرحلة. Design نمط قالب مع `design-tweaks` وليس محررا كاملا جاهزا للإضافة. محرك Context X-Ray مملوك لـ Core وعرضه القابل لإعادة الاستخدام لـ Toolkit. Scheduling وCreative Context حزم قدرات منفصلة؛ راجع [دورة حياة الحزمة](/docs/package-lifecycle).
