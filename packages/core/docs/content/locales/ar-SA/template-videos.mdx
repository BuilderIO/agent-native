...
<DataModel id="doc-block-3960iy" title={"نموذج بيانات الفيديو"} summary={"SQL المؤلفات المدعومة بالإضافة إلى أنظمة التصميم والمجلدات المتداخلة، كل منها مزود بجدول مشاركات إطار العمل."} entities={[
  {
    "id": "compositions",
    "name": "compositions",
