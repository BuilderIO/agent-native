...
<DataModel id="doc-block-s8v9za" title={"Calendar نموذج البيانات"} summary={"يتم تخزين البيانات غير المتعلقة بالحدث محليًا فقط - الأحداث مباشرة في Google Calendar. تستخدم روابط الحجز أعمدة خاصة بها بحيث يتم تطبيق نظام المشاركة."} entities={[
  {
    "id": "booking_links",
    "name": "booking_links",
