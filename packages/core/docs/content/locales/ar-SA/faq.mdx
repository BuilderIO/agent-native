...
نعم. اختر أي مضيف يقوم بتشغيل Node - Netlify، وVercel، وCloudflare، وAWS، وDeno Deploy، والخادم الخاص بك - وأي قاعدة بيانات SQL (Postgres، SQLite، Turso، D1). تم تصميم الإطار ليكون محمولاً. ابدأ بـ [دليل Docker المحلي السريع](/docs/deployment#self-host-quickstart)، ثم استخدم [Deployment](/docs/deployment) للإنتاج.
