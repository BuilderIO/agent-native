...
- [**ميزتك الأولى في الدردشة**](/docs/template-chat-first-edits) — مسار الدردشة الأولي، مع تعليقات توضيحية، بالإضافة إلى شرح كامل لإضافة ميزة حقيقية
...
- [**Actions**](/docs/actions-overview) — اتصال نظام الدردشة وUI معًا
