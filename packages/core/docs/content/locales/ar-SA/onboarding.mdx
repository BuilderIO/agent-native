...
في مساحة عمل متعددة التطبيقات، عيّن `ONBOARDING_SHARED_COMPLETION` لإعادة
استخدام الإعداد المكتمل عبر التطبيقات. إذا لم تقم بتعيينه، يتتبع كل تطبيق
اكتمال الإعداد بشكل منفصل.
...
تعرض بطاقات الإعداد خيارات الإعداد المتاحة. وهي لا تسرد كل مفتاح أو بيانات
اعتماد محتملة.
