...
<DataModel id="doc-block-1a2kyld" title={"جدول المهام"} summary={"يُعرّف مرة واحدة باستخدام مساعدات framework؛ ويُختار dialect في وقت التشغيل من DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
