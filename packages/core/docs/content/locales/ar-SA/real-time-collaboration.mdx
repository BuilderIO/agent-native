...
- **يعمل في كل مكان** — أي قاعدة بيانات SQL يدعمها Drizzle (PGlite، Postgres).
...
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres على مضيف يمكن الوصول إليه علنًا**                | تتصل البوابة بقاعدة البيانات من شبكتها الخاصة. أما PGlite و`localhost` و`*.internal` وعناوين IP المجردة فتُرفض قبل أن تغادر سلسلة الاتصال جهازك أصلًا. | أن يشير `DATABASE_URL` إلى Postgres مُدار مثل Neon                                                                                                                                            |
