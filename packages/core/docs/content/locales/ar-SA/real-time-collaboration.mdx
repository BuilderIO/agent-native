...
| **أن تعرّف المنصّة النشر**                                  | يرتكز التسجيل على الأصل (origin) العام للتطبيق، لذا يجب ألا تدّعي عملية ليست هي النشر فعليًا ملكيته.                                                            | تعرّف Netlify وVercel وAWS Lambda وCloud Run وRender عن نفسها. أما Cloudflare Workers فلا تعرّف عن نفسها، لذا اضبط `AGENT_NATIVE_REALTIME_APP_URL` على الأصل الخاص بالنشر نفسه. وعلى حاوية أو جهاز افتراضي بسيط، اضبط المتغير نفسه |
