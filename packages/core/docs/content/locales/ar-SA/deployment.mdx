...
| `AGENT_NATIVE_BUILDER_RELAY_TARGET_ORIGINS` | قائمة سماح مفصولة بفواصل ومخصّصة لرد الاتصال المؤسسي، وتحتوي على أصول المعاينة الموثوقة المطابقة تماماً (مثلاً `https://deploy-preview-42--content.netlify.app`). عيّنها فقط في نشر رد الاتصال المؤسسي. لا تُدعم أحرف البدل أو لاحقات النطاقات. |
