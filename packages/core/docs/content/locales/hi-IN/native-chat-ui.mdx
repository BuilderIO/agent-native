...
### चुनें कि एक्शन UI कब दिखे {#conditional-native-ui}

एक एक्शन कई तरह के काम कर सकता है, जबकि कार्ड केवल कुछ नतीजों के लिए ज़रूरी हो। उन कॉल को चुनने के लिए `chatUI` में `when(args, result)` जोड़ें। सफल एक्शन के बाद सर्वर इस प्रेडिकेट को चलाता है। अगर यह `false` लौटाता है, तो नतीजा सामान्य, संक्षिप्त किए जा सकने वाले टूल इतिहास में रहता है। प्रेडिकेट सहेजा या ब्राउज़र को भेजा नहीं जाता।

Mail में `manage-draft` इसका उपयोग करता है। ड्राफ़्ट बनाते समय कार्ड दिखता है, जबकि अपडेट और डिलीट सामान्य टूल कॉल रहते हैं:
...
कई write operations वाले एक्शन में arguments और सफल नतीजे, दोनों जाँचें। Mail का Gmail filter action केवल उन बनाए या बदले गए filters के लिए rule card चुनता है जिनमें summary fields हों:
