...
[लोकल फ़ोल्डर स्रोत](/docs/template-content-local-files) देखें।
...
- **`server/db/schema.ts`** — डेटा मॉडल। यहां एक कॉलम या टेबल जोड़ें. सामग्री टेम्पलेट में कोई `db:push` स्क्रिप्ट नहीं है; यह स्टार्टअप पर चलने वाले सख्ती से एडिटिव माइग्रेशन पर निर्भर करता है। `server/db/schema.ts` संपादित करें, एक मिलान एडिटिव माइग्रेशन लिखें, और अगली बार ऐप बूट होने पर परिवर्तन लागू होता है - स्कीमा अपडेट को कभी भी मौजूदा तालिकाओं या कॉलमों को छोड़ना, नाम बदलना या विनाशकारी रूप से बदलना नहीं चाहिए (दिशानिर्देशों के लिए [Database](/docs/server-database#migrations) देखें)।
