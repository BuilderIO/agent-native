...
<DataModel id="doc-block-1hzvub" title={"डेटा मॉडल बनाता है"} summary={"तीन टेबल। फ़ील्ड और एकीकरण प्रपत्रों पर JSON कॉलम हैं, इसलिए एजेंट के संपादन क्रॉस-टेबल पंक्ति परिवर्तनों के बजाय सर्जिकल पैच हैं।"} entities={[
  {
    "id": "forms",
    "name": "forms",
