...
<DataModel id="doc-block-1w9ef7x" title={"डेटा मॉडल स्लाइड करता है"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
