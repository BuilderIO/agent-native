...
<DataModel id="doc-block-fzuxbf" title={"मस्तिष्क डेटा मॉडल"} summary={"Connectors produce raw captures; distillation turns captures into reviewable knowledge; proposals gate sensitive entries. Sync runs and the ingest queue track background work."} entities={[
  {
    "id": "sources",
    "name": "brain_sources",
