...
मल्टी-ऐप वर्कस्पेस में, ऐप्स में पूर्ण ऑनबोर्डिंग का पुन: उपयोग करने के लिए
`ONBOARDING_SHARED_COMPLETION` सेट करें। यदि आप इसे सेट नहीं करते हैं, तो
प्रत्येक ऐप ऑनबोर्डिंग समापन को अलग से ट्रैक करता है।
...
सेटअप कार्ड उपलब्ध सेटअप विकल्प दिखाते हैं। वे हर संभावित कुंजी या
क्रेडेंशियल की सूची नहीं देते।
