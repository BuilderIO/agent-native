...
<DataModel id="doc-block-1j0vt1o" title={"एनालिटिक्स डेटा मॉडल"} summary={"Dashboards and analyses are the resources; views, shares, and a query cache hang off them. Org tables come from @agent-native/core/org."} entities={[
  {
    "id": "dashboards",
    "name": "dashboards",
