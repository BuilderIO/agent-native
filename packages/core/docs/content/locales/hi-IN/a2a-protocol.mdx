...
- `isA2AProductionRuntime()` Netlify, AWS Lambda, Cloudflare Workers, Vercel, Render, Fly, और Cloud Run पर `true` लौटाता है - तब भी जब `NODE_ENV` `"production"` नहीं है। कुछ सर्वर रहित प्रदाता लगातार `NODE_ENV` सेट नहीं करते हैं, इसलिए नीति प्रदाता-विशिष्ट फ़्लैग भी पढ़ती है।
