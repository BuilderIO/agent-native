...
ऑब्जर्वेबिलिटी और सीआई इवल गेट दोनों _गुणवत्ता_ स्कोर करते हैं, लेकिन विपरीत छोर से - वास्तविक ट्रैफ़िक की निष्क्रिय पोस्ट-हॉक स्कोरिंग बनाम निश्चित इनपुट पर सक्रिय पास/असफल जांच। पूरे हुए प्रोडक्शन ट्रेस को `*.eval.ts` केस बनाएँ (डैशबोर्ड **Promote to eval**, `promote-trace-eval`, या `agent-native eval promote <runId> --write evals/from-trace.eval.ts`)। देखें [प्रोडक्शन ट्रेस से](/docs/evals#from-trace)। अवलोकन संबंधी स्मृति का गुणवत्ता से कोई संबंध नहीं है; यह टोकन लागत और संदर्भ-विंडो दबाव के बारे में है।
...
### PostHog में फ़ीडबैक {#posthog-feedback}

थंब्स, श्रेणी और मुक्त-पाठ — तीनों `$ai_feedback` भेजते हैं। लेकिन PostHog के LLM एनालिटिक्स का फ़ीडबैक व्यू इसके बजाय `survey sent` इवेंट पढ़ता है, इसलिए `POSTHOG_AI_FEEDBACK_SURVEY_ID` को उस सर्वे पर सेट करें जिसे PostHog किसी ट्रेस के **Feedback** टैब से बनाता है। यही एक आईडी पूरी कॉन्फ़िगरेशन है; इसके बिना कोई सर्वे इवेंट नहीं भेजा जाता।

थंब्स वोट सर्वे के पहले प्रश्न का उत्तर PostHog के विकल्प क्रमांक के रूप में देता है (`1` ऊपर, `2` नीचे), और थंब्स-डाउन के बाद आया मुक्त-पाठ अनुवर्ती प्रश्न का उत्तर देता है, इसलिए पाठ कभी रेटिंग की जगह दर्ज नहीं होता। दोनों प्रति रेट किए गए संदेश एक ही सबमिशन आईडी रखते हैं, और इसी से PostHog उन्हें एक ही उत्तर में जोड़ता है; थंब्स-डाउन तब तक अपूर्ण चिह्नित रहता है जब तक उसका अनुवर्ती उत्तर नहीं आ जाता।
...
`defineAppConfig()` के साथ एक सर्वर प्लगइन से सेट करें। प्रत्येक फ़ील्ड का एक परिनियोजन एनवायरनमेंट वेरिएबल उपनाम भी है — घोषित कॉन्फ़िगरेशन संदर्भ देखें।
...
| POST | `/traces/:runId/promote`   | पूरे रन को CI eval में प्रमोट करें |
...
अपने ऐप में एक OpenTelemetry प्रदाता पंजीकृत करके Langfuse, Datadog, Grafana, या किसी भी OTel-संगत बैकएंड पर ट्रेस भेजें — नीचे [ओपनटेलीमेट्री स्पैन](#otel) देखें।

कोर जानबूझकर कोई एक्सपोर्टर शामिल नहीं करता और न ही कोई एक्सपोर्ट एंडपॉइंट या टोकन रखता है, इसलिए बैकएंड क्रेडेंशियल आपके प्रदाता वायरिंग (और वॉल्ट) में रहता है, कभी भी फ़्रेमवर्क कॉन्फ़िगरेशन में नहीं।

## ओपनटेलीमेट्री स्पैन {#otel}

एजेंट लूप प्रत्येक रन, मॉडल कॉल और टूल कॉल के लिए **लाइव ओपनटेलीमेट्री स्पैन** उत्सर्जित करता है — इसलिए एक होस्ट जो पहले से ही एक ओटेल कलेक्टर चलाता है, उसके बाकी वितरित ट्रेस के साथ एजेंट गतिविधि देखता है।
...
- [**Actions**](/docs/actions-overview) - वे ऑपरेशन जो ट्रेस में टूल कॉल के रूप में दिखाई देते हैं
