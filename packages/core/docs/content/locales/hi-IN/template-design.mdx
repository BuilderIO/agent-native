...
<DataModel id="doc-block-10gz2lx" title={"डेटा मॉडल डिज़ाइन करें"} summary={"एक डिज़ाइन अपनी फ़ाइलों और संस्करणित स्नैपशॉट का स्वामी होता है, और वैकल्पिक रूप से एक पुन: प्रयोज्य डिज़ाइन सिस्टम को लिंक करता है। डिज़ाइन और सिस्टम दोनों स्वामित्व योग्य हैं, प्रत्येक एक फ्रेमवर्क शेयर तालिका के साथ है।"} entities={[
  {
    "id": "designs",
    "name": "designs",
