...
- **ऑटो-माउंटेड** - प्रत्येक ऐप को मुफ्त में `/mcp` मिलता है, किसी सेटअप की आवश्यकता नहीं है
...
| **समापनबिंदु**       | `/mcp`                                                               | `/_agent-native/a2a`                          |
...
<Endpoint id="doc-block-1eenree" title={"MCP समापन बिंदु"} summary={"ऑटो-माउंटेड स्ट्रीमेबल HTTP एंडपॉइंट प्रत्येक एजेंट-नेटिव ऐप को उजागर करता है।"} method="POST" path="/mcp" summary={"MCP स्ट्रीम करने योग्य HTTP समापन बिंदु"} auth="Standard remote MCP OAuth (Bearer access token), connect-minted JWT, or static ACCESS_TOKEN/ACCESS_TOKENS" params={[
  {
    "name": "Authorization",
    "in": "header",
    "type": "string",
...
होस्ट किए गए MCP अनुरोध एक सीमित इनलाइन प्रतीक्षा का उपयोग करते हैं ताकि एक लंबा
एजेंट लूप किसी क्लाइंट या गेटवे टाइमआउट तक एक `tools/call` को खुला न रखे।
वैकल्पिक `async` तर्क स्थायी टास्क शुरू करता है और तुरंत लौट आता है; इसके बिना,
सर्वर एक त्वरित समापन के लिए संक्षेप में प्रतीक्षा करता है और फिर अधिक काम बाकी
रहने पर एक टास्क हैंडल लौटाता है। होस्ट की गई प्रतीक्षा 25 सेकंड तक सीमित है।
...
एजेंट इंटरैक्टिव चैट के समान लूप चलाता है - यह कई टूल को कॉल कर सकता है, संदर्भ के बारे में तर्क कर सकता है और एक विचारशील प्रतिक्रिया दे सकता है। एक टास्क जो पूरा नहीं हुआ है वह `taskId`, `status`, `pollAfterMs` वाला JSON लौटाता है, और:
...
टास्क के अंतिम स्थिति तक पहुंचने तक उन्हीं तर्कों के साथ `ask_app_status` को
कॉल करें। डिस्पैच का ऐप-स्वामित्व वाला `ask_app` उसी स्थायी टास्क और स्थिति
...
अनुपलब्ध है, न कि स्थायी टास्क विफल हुआ है। लौटाए गए उन्हीं `poll.arguments` के साथ
`ask_app_status` को फिर आज़माएँ, और उपलब्ध होने पर `taskHandle` शामिल करें। बिना
हैंडल वाले पुराने परिणामों में वही `app` और `taskId` दोबारा उपयोग करें; पुनर्प्राप्ति के लिए `ask_app` को कभी फिर से सबमिट
...
| `/mcp/oauth/register`                     | डायनामिक पब्लिक-क्लाइंट पंजीकरण    |
| `/mcp/oauth/authorize`                    | ब्राउज़र प्राधिकरण + सहमति         |
| `/mcp/oauth/token`                        | प्राधिकरण-कोड और ताज़ा-टोकन अनुदान |
