...
<DataModel id="doc-block-8dw6dq" title={"संसाधन + सहयोगी शेयर तालिका"} summary={"Coarse visibility lives on the resource; each fine-grained grant is a row in the shares table."} entities={[
  {
    "id": "deck",
    "name": "decks",
    "note": "...ownableColumns()",
