...
### समूह साझाकरण {#group-grants}

कुछ संसाधन समूहों के साथ साझा किए जा सकते हैं। समूह उसी संगठन का होना चाहिए जिसमें संसाधन है, और हर मौजूदा सदस्य को उस संसाधन पर चुना गया शेयर रोल मिलता है। समूह क्या स्कोप करते हैं और क्या नहीं, इसके लिए [Organizations, Teams & Permissions → User groups](/docs/organizations-teams-permissions#user-groups) देखें.
