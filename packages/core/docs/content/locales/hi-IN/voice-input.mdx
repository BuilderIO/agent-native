...
Builder सबसे आसान रास्ता है: **Settings → Connections → Integrations** से Builder.io (free tier उपलब्ध) कनेक्ट करें और डिफ़ॉल्ट प्रदाता Builder Gemini Flash-Lite बन जाता है। BYOK प्रदाताओं के लिए, मिलती-जुलती Gemini, Groq या OpenAI कुंजी जोड़ें।

### प्रति-उपयोगकर्ता (सास के लिए अनुशंसित)

उपयोगकर्ता **Settings → Agent → Model** पर **Personal providers** के तहत अपनी कुंजी जोड़ता है। इसे उपयोगकर्ता-स्कोप्ड एन्क्रिप्टेड रहस्य (`readAppSecret` के माध्यम से) के रूप में संग्रहीत किया जाता है। प्रत्येक उपयोगकर्ता अपने प्रतिलेखन के लिए स्वयं भुगतान करता है; होस्ट के लिए शून्य लागत।

### साझा (आंतरिक टूल के लिए)

`GEMINI_API_KEY`, `GROQ_API_KEY`, या `OPENAI_API_KEY` को पर्यावरण चर के रूप में सेट करें, या किसी owner या admin से इसे **Settings → Agent → Model** पर **Organization providers** के तहत संगठन के लिए जुड़वाएं। **Settings → Organization → Infrastructure** पर **Voice input** पंक्ति तय करती है कि कौन-सा प्रदाता पहले जवाब देगा। प्रत्येक उपयोगकर्ता का प्रतिलेखन साझा कुंजी का उपयोग करता है।
