...
ज्यादातर ऐप्स एआई को एक विचार के रूप में लागू करते हैं जो वास्तव में ऐप में काम नहीं कर सकता है। एजेंट-नेटिव ऐप में एजेंट एक प्रथम श्रेणी का नागरिक होता है जो actions, डेटाबेस और स्थिति को UI के समान साझा करता है, इसलिए यह बटन द्वारा किया जा सकने वाला कुछ भी कर सकता है। [What Is Agent-Native?](/docs/what-is-agent-native#the-ladder) देखें.
...
हां. यदि आप basic agentic app चाहते हैं, तो `npx @agent-native/core@latest create my-app --template base` चलाएँ; आपको actions, auth, SQL-backed runtime state, और अपनी screens जोड़ने की जगह मिलती है. यदि आप no-browser automation बना रहे हैं, तो `npx @agent-native/core@latest create my-agent --headless` चलाएं. [Getting Started](/docs/getting-started) और [Automation-First Apps](/docs/pure-agent-apps) देखें. `--template chat` का उपयोग केवल तब करें जब आप Chat product चाहते हों.
