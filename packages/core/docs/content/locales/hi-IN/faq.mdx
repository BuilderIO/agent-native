---
title: "FAQ"
description: "Agent-Native के बारे में सामान्य प्रश्न - यह क्या है, यह किसके लिए है, आप क्या बना सकते हैं और यह कैसे काम करता है।"
---

# FAQ

Agent-Native के बारे में सामान्य प्रश्न, "मैं बस देख रहा हूं" से लेकर "मैं अभी प्रमाणीकरण कर रहा हूं" तक व्यवस्थित।

## बुनियादी बातें {#general}

### Agent-Native क्या है? {#what-is-agent-native}

Agent-Native ऐप्स बनाने के लिए एक framework है जहां AI agent और उसके आसपास की product surface समान भागीदार हैं. सामान्य रास्ता chat से शुरू होता है, typed actions जोड़ता है, structured results inline render करता है, और उसी SQL state के ऊपर durable pages तक बढ़ता है. अपरिवर्तनीय यह है कि agent और मनुष्य समान actions, database और state साझा करते हैं. संपूर्ण स्पष्टीकरण के लिए [Agent-Native क्या है?](/docs/what-is-agent-native) देखें।

### यह किसके लिए है? {#who-is-this-for}

Agent-Native उन लोगों के लिए है जो एक ही डेटा और actions से काम करने के लिए एक वास्तविक ऐप और एक AI agent चाहते हैं। सामान्य पथ हैं:
...
- \*\*यदि आप Agent-Native ऐप का उपयोग करने के लिए Claude, ChatGPT, Codex, कर्सर, या GitHub कोपायलट / VS कोड चाहते हैं तो किसी अन्य agent या code tool को connect करें - [External Agents](/docs/external-agents) और [Skills Guide](/docs/skills-guide) देखें।

### यह किसी मौजूदा ऐप में AI जोड़ने से किस प्रकार भिन्न है? {#how-is-this-different}

ज्यादातर ऐप्स एआई को एक विचार के रूप में लागू करते हैं जो वास्तव में ऐप में काम नहीं कर सकता है। Agent-Native ऐप में एजेंट एक प्रथम श्रेणी का नागरिक होता है जो actions, डेटाबेस और स्थिति को UI के समान साझा करता है, इसलिए यह बटन द्वारा किया जा सकने वाला कुछ भी कर सकता है। [ऐप्स इस तरह क्यों बनाएं](/docs/what-is-agent-native#why-build-apps-this-way) देखें।
...
### क्या मैं किसी मौजूदा ऐप को Agent-Native में स्थानांतरित कर सकता हूं? {#can-i-use-existing-code}

आप कर सकते हैं, लेकिन Agent-Native सबसे अच्छा तब काम करता है जब उसे ज़मीन से ऊपर बनाया जाता है। आर्किटेक्चर - shared database, polling sync, actions, application state - को संपूर्ण रूप से integrate करने की आवश्यकता है। एक ऐप से शुरू करना और उसे customize करना अनुशंसित path है। इसे desktop-first से mobile-first में बदलाव की तरह समझें: आप retrofit कर सकते हैं, लेकिन native निर्माण करना बेहतर है।
...
यही पूरी बात है। किसी template से शुरू करें और उसे अपने repository और development workflow में customize करें। Embedded agent फिर resulting app को उसके actions और data के माध्यम से चलाता है।
...
### क्या embedded agent ऐप का source code संपादित करता है? {#can-the-agent-modify-code}

डिफ़ॉल्ट रूप से नहीं। वह source code केवल तभी संपादित कर सकता है जब host जानबूझकर repository/workspace write tooling दे। अन्यथा embedded agent actions, SQL-backed state और configured integrations के माध्यम से काम करता है। Components, routes, styles या actions बदलने के लिए अपने repository workflow या अलग code-capable development/Builder frame का उपयोग करें।
...
हां, [A2A (Agent-to-Agent) protocol](/docs/a2a-protocol) के माध्यम से। प्रत्येक Agent-Native ऐप को स्वचालित रूप से एक A2A एंडपॉइंट मिलता है। मेल ऐप से, आप डेटा क्वेरी करने के लिए एनालिटिक्स एजेंट को टैग कर सकते हैं। एक एजेंट पता लगाता है कि अन्य एजेंट क्या उपलब्ध हैं, उन्हें protocol पर call करता है, और UI में results दिखाता है। किसी configuration की आवश्यकता नहीं है - agent card आपके template के actions से स्वतः उत्पन्न होता है।
...
### कौन से AI coding tools Agent-Native के साथ काम करते हैं? {#which-ai-tools-work}
