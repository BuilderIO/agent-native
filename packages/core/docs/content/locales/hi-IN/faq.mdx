...
हां. कोई भी होस्ट चुनें जो नोड चलाता हो - नेटलिफाई, वर्सेल, क्लाउडफ्लेयर, AWS, डेनो डिप्लॉय, आपका अपना सर्वर - और कोई भी SQL डेटाबेस (Postgres, SQLite, Turso, D1)। ढांचा पोर्टेबल होने के लिए बनाया गया है। पहले [स्थानीय Docker quickstart](/docs/deployment#self-host-quickstart) से शुरू करें, फिर production के लिए [Deployment](/docs/deployment) देखें.
