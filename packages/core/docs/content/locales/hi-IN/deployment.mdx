...
| `A2A_SECRET`             | Inter-app A2A JSON-RPC के लिए shared HMAC। `SECRETS_ENCRYPTION_KEY` unset होने पर shared vault इस value से purpose-derived key उपयोग करता है, इसलिए इसे rotate करने से vault key भी rotate होती है।                                                                                                               |
| `SECRETS_ENCRYPTION_KEY` | Shared vault के लिए preferred stable AES-256-GCM key। इसे पढ़ने वाले हर app में समान value रखें। Reads derived `A2A_SECRET`, फिर legacy Better Auth और app-scoped keys पर fallback करती हैं। A2A rotate करने से पहले इसे हर जगह जोड़ें और पुराने A2A material के उपलब्ध रहते सभी rows read/migrate करें।          |
