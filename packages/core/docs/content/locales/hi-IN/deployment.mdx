...
| `AGENT_NATIVE_BUILDER_RELAY_TARGET_ORIGINS` | केवल कॉर्पोरेट कॉलबैक के लिए, सटीक विश्वसनीय पूर्वावलोकन origins की कॉमा से अलग की गई allowlist (उदाहरण: `https://deploy-preview-42--content.netlify.app`)। इसे केवल कॉर्पोरेट कॉलबैक परिनियोजन पर सेट करें। वाइल्डकार्ड और डोमेन प्रत्यय समर्थित नहीं हैं। |
