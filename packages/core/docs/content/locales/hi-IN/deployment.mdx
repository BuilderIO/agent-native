...
Worker के पास फ़ाइल सिस्टम नहीं होता, इसलिए डेटाबेस या तो बाहरी
`DATABASE_URL` होता है या Cloudflare D1। बिल्ड परिवेश में
`CLOUDFLARE_D1_DATABASE_NAME` और `CLOUDFLARE_D1_DATABASE_ID` दोनों सेट करें
ताकि बिल्ड जनरेट की गई `wrangler.json` में `DB` बाइंडिंग लिखे; इनमें से
केवल एक सेट करना त्रुटि है, चुपचाप छोड़ी गई बाइंडिंग नहीं। पूरा लोकल ब्रिंग-अप
क्रम अंग्रेज़ी डिप्लॉयमेंट गाइड में है।


### Browser Rendering {#cloudflare-browser-rendering}

Worker कोई Chromium प्रोसेस शुरू नहीं कर सकता, इसलिए ब्राउज़र एक बाइंडिंग होता
है और जनरेट की गई `wrangler.json` में
`{ "browser": { "binding": "BROWSER" } }` घोषित होता है। ब्राउज़र पर निर्भर
ऐक्शन इसी बाइंडिंग को `@cloudflare/playwright` के ज़रिए हल करते हैं। बाइंडिंग
अनुपस्थित होने पर उसका नाम बताया जाता है, न कि Chromium बाइनरी के गायब होने का
दावा। लोकल में यह `wrangler dev` के साथ चलता है, एक सीमा के साथ: लोकल रनटाइम
1 MB से बड़े अनुरोध अस्वीकार करता है।

### Cloudflare R2 {#cloudflare-r2}

Worker के पास फ़ाइल सिस्टम नहीं होता और फ़ाइल सामग्री SQL में नहीं रह सकती,
इसलिए अपलोड R2 में जाते हैं। बिल्ड परिवेश में `CLOUDFLARE_R2_BUCKET_NAME` सेट
करें ताकि जनरेट की गई `wrangler.json` में `UPLOADS` बाइंडिंग लिखी जाए, और
`CLOUDFLARE_R2_PUBLIC_BASE_URL` को बकेट के सार्वजनिक URL पर सेट करें। प्रदाता
पहले से अपलोड रजिस्ट्री में पंजीकृत है। बाइंडिंग अनुपस्थित या अनुपयोगी होने पर
पेलोड SQL में रखने के बजाय सेटअप मार्गदर्शन के साथ विफल होता है। विवरण अंग्रेज़ी
डिप्लॉयमेंट गाइड में हैं।
...
- `extensionTools: true` - ऐप के लिए फ्रेमवर्क एक्सटेंशन-प्रबंधन actions और
...
[Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=deployment) एक अलग managed code-capable workflow है जहाँ agent production में app UI बदल सकता है। Repository को Builder.io से जोड़ें और UI changes सीधे माँगें - redeploy की जरूरत नहीं।
