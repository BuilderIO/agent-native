...
<DataModel id="doc-block-inpw6j" title={"कनेक्शन मॉडल"} summary={"A connection records safe provider metadata and credentialRefs (pointers, not secrets). Each grant unlocks one app — one connection, many grants."} entities={[
  {
    "id": "conn",
    ...
    "fields": [
      ...
      },
      {
        "name": "provider",
        "type": "string",
        "note": "स्थिर प्रदाता आईडी, उदा. ढीला"
      },
      {
        "name": "label",
        "type": "string"
      ...
      },
      {
        ...
        "type": "json",
        "nullable": true,
        "note": "सुरक्षित, गैर-गुप्त कॉन्फ़िगरेशन"
      },
      {
        "name": "credentialRefs",
        "type": "json",
