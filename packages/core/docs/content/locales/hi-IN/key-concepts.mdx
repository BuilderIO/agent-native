  ...
  <div class="diagram-row">
    <div class="diagram-card">
      ...
      ><small class="diagram-muted"
        >डेटा पढ़ता और लिखता है, actions चलाता है, कोड बदलता है</small
      >
    </div>
    <div class="diagram-card">
...
(`databaseTools: "read"`), इसलिए agent app data को `db-schema` / `db-query`
से inspect करते हैं और writes typed app actions से करते हैं। `databaseTools: "write"`
...
require करने हेतु `databaseTools: "off"` / `false` सेट करें
पहुँच.
...
1. एक टेम्प्लेट से शुरू करें (उदाहरण के लिए एनालिटिक्स टेम्प्लेट)
