...
कैनोनिकल hosted apps, हर app पर identity-hub environment configuration के बिना packaged Desktop SSO Canary requests पहचानते हैं। सामान्य browsers और self-hosted apps को अब भी `AGENT_NATIVE_IDENTITY_HUB_URL` की आवश्यकता होती है। Stable Desktop builds अलग से स्वीकृत बाद के release से पहले broker शुरू नहीं करते।
