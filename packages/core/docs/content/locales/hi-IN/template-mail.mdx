...
<DataModel id="doc-block-7toley" title={"मेल SQL टेबल"} summary={"ईमेल स्वयं Gmail में रहता है। SQL तालिकाएँ वही रखती हैं जो Gmail नहीं रखती: कतारबद्ध ड्राफ्ट, भेजने-ट्रैकिंग ईवेंट, और OAuth टोकन। सेटिंग्स और अल्पकालिक स्थिति सेटिंग्स और एप्लिकेशन_स्टेट स्टोर में रहती हैं।"} entities={[
  {
