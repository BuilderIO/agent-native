...
## संतुलित कैटलॉग {#balanced-catalog}

कैटलॉग foundations, editors और canvases, agent context और knowledge, collaboration और governance, workspace chrome, operations और capability packages को भी कवर करता है। Rich editor Toolkit का है; Core compatibility re-exports रखता है। Blocks इस चरण में Core में रहते हैं। Design `design-tweaks` वाला template pattern है, पूरा drop-in editor नहीं। Context X-Ray engine Core का है और reusable presentation Toolkit का। Scheduling और Creative Context अलग capability packages हैं; [Package Lifecycle](/docs/package-lifecycle) देखें।
