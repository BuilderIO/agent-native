...
<DataModel id="doc-block-en3rol" title={"कार्य तालिका"} summary={"framework helpers के साथ एक बार परिभाषित; dialect को runtime पर DATABASE_URL से चुना जाता है."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
