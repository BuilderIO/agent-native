...
इस टेम्पलेट-स्थानीय पथ से `getDb` आयात करें - मार्गों में `../../server/db/index.js`, actions में `../server/db/index.js` - सीधे `@agent-native/core` के बजाय। मुख्य निर्यात एक सामान्य अलिखित उदाहरण लौटाता है; टेम्पलेट का `getDb()` आपके स्कीमा प्रकारों को वहन करता है। actions और कस्टम रूट प्रत्येक इसे कैसे आयात करते हैं, इसके लिए [Server](/docs/server-routes#request-context) देखें।
  ...
  annotations={[
    {
      lines: "6-7",
      label: "केवल योगात्मक",
      note: "Migration entries को track करके एक बार लागू किया जाता है। बदलाव additive रखें: columns या tables जोड़ें, और उन्हें कभी delete या rename न करें।",
    },
    {
      lines: "13-16",
