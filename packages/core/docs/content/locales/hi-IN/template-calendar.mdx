...
<DataModel id="doc-block-12vlmo" title={"Calendar डेटा मॉडल"} summary={"केवल गैर-इवेंट डेटा स्थानीय रूप से संग्रहीत किया जाता है - इवेंट Google Calendar में रहते हैं। बुकिंग लिंक स्वामित्व योग्य कॉलम का उपयोग करते हैं इसलिए साझाकरण प्रणाली लागू होती है।"} entities={[
  {
    "id": "booking_links",
    "name": "booking_links",
