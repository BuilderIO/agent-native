...
<DataModel id="doc-block-16ye6ti" title={"योजना डेटा मॉडल"} summary={"एक योजना पंक्ति में आदेशित अनुभागों के अलावा टिप्पणियाँ, ईवेंट, संस्करण, शेयर और इनलाइन संपत्तियां होती हैं।"} entities={[
  {
    "id": "plans",
    "name": "plans",
