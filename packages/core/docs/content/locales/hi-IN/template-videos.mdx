...
<DataModel id="doc-block-grug1j" title={"वीडियो डेटा मॉडल"} summary={"SQL-समर्थित रचनाएँ प्लस डिज़ाइन सिस्टम और नेस्टेबल फ़ोल्डर्स, प्रत्येक एक फ्रेमवर्क शेयर तालिका के साथ।"} entities={[
  {
    "id": "compositions",
    "name": "compositions",
