...
- **हर जगह काम करता है** - कोई भी SQL डेटाबेस Drizzle समर्थन करता है (PGlite, Postgres)।
...
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **सार्वजनिक रूप से पहुँच योग्य होस्ट पर Postgres**                                 | गेटवे अपने नेटवर्क से डेटाबेस को डायल करता है। PGlite, `localhost`, `*.internal` और सीधे IP पते तब ही अस्वीकार कर दिए जाते हैं जब कनेक्शन स्ट्रिंग आपकी मशीन से निकली भी नहीं होती। | `DATABASE_URL` Neon जैसे मैनेज्ड Postgres की ओर इंगित करता हो                                                                                                                                        |
