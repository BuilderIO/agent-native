...
सब्सक्राइब टोकन जारी किया जा सकता है, जिससे उसकी *बदलाव स्ट्रीम* उजागर होती है —
