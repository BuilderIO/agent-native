...
<AnnotatedCode id="doc-block-99ub1i" title={"सार्वजनिक सतह पर एक सुरक्षित कार्रवाई का विकल्प चुनना"} filename="actions/search-docs.ts" language="ts" code={"export default defineAction({\n  description: \"खोजें published docs\",\n  readOnly: true,\n  publicAgent: {\n    expose: true,\n    readOnly: true,\n    requiresAuth: false,\n    isConsequential: false,\n    title: \"खोजें published docs\",\n  },\n  run: async (args) => {\n    // ...\n  },\n});"} annotations={[
  {
    "lines": "4",
