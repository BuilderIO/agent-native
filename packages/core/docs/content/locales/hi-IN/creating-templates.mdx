...
समीक्षा योग्य SQL बनाएं और release चरण से `runDrizzleMigrations()` के माध्यम से
लोड करें। हाथ से लिखे इतिहास और विशेष मामलों के लिए `runMigrations()` रखें।
विनाशकारी SQL, `drizzle-kit push`, तालिका का नाम बदलने या कॉलम ड्रॉप का उपयोग न करें।
