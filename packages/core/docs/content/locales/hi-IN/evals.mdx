...
## प्रोडक्शन ट्रेस से {#from-trace}

जब कोई वास्तविक रन चौंकाए — डेमो में चला और प्रोडक्शन में टूटा, या गलत टूल बुलाया — प्रॉम्प्ट गढ़ने के बजाय उस पूरे हुए ट्रेस को CI केस बनाएँ।

```bash
agent-native eval promote <runId> --write evals/from-trace.eval.ts
```

यह कमांड एक `EvalDataset` पंक्ति सहेजता है (डैशबोर्ड और `promote-trace-eval` वाला वही हेल्पर) और एक `defineEval` फ़िक्स्चर लिखता है जिसे मौजूदा `agent-native eval` गेट पहले से खोजता है। डिफ़ॉल्ट स्कोरर हर सफल टूल के लिए `usesTool(...)` हैं, वैकल्पिक `--must-contain` के साथ। काटे, निरस्त या बिना यूज़र संदेश वाले रन बंद होकर असफल होते हैं।

होस्टेड ऐक्शन और `POST /_agent-native/observability/traces/:runId/promote` ऐप ट्री नहीं लिखते। CI के लिए `--write` इस्तेमाल करें। Observability ट्रेस विवरण में **Promote to eval** है।
