...
`agentNative.providerApi` का उपयोग कर सकती हैं; उन्हें कनेक्शन URL या टोकन
नहीं मिलते।

### Atlassian / Jira

Atlassian प्रीसेट, Atlassian Rovo MCP के OAuth 2.1 एंडपॉइंट
`https://mcp.atlassian.com/v1/mcp` का उपयोग करता है और Jira तथा Confluence टूल उपलब्ध कराता है। Jira टिकट बनाने के लिए Atlassian की वे अनुमतियां आवश्यक हैं जो Jira में लिखने की अनुमति देती हैं; उपयोगकर्ता को फिर भी केवल वही प्रोजेक्ट और सामग्री दिखाई देती है जिसकी अनुमति उसके Atlassian खाते को है।
