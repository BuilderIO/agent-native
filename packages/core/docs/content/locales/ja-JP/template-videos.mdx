...
<WireframeBlock id="doc-block-yo02mn">
...
<DataModel id="doc-block-1508siv" title={"ビデオデータモデル"} summary={"SQL でサポートされたコンポジションに加え、デザイン システムとネスト可能なフォルダーがあり、それぞれにフレームワーク共有テーブルが含まれます。"} entities={[
  {
    "id": "compositions",
    "name": "compositions",
