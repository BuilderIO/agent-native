...
<AnnotatedCode id="doc-block-1bo9g4p" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# 朝のダイジェスト\n\n夜間に受信したメールを要約します。送信者ドメインごとにグループ化します。\n今日返信が必要と思われる上位 3 つのスレッドを\n\"Needs reply\" ラベルに固定します。明らかなものについては返信草案を作成してください。"} annotations={[
  {
    "lines": "2",
    "label": "いつ",
