...
<DataModel id="doc-block-1rewyef" title={"スライドデータモデル"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
