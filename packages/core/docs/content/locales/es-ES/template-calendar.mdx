...
<DataModel id="doc-block-yzvg49" title="Modelo de datos de Calendar" summary={"Solo los datos que no son eventos se almacenan localmente: los eventos viven en Google Calendar. Los enlaces de reserva utilizan ownableColumns, por lo que se aplica el sistema para compartir."} entities={[
  {
    "id": "booking_links",
    "name": "booking_links",
