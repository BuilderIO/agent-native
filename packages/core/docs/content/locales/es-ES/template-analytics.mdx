...
<DataModel id="doc-block-1m98uos" title="Modelo de datos Analytics" summary={"Dashboards y análisis son los recursos; vistas, compartidos y una caché de consultas cuelgan de ellos. Las tablas de organización provienen de @agent-native/core/org."} entities={[
  {
    "id": "dashboards",
    "name": "dashboards",
