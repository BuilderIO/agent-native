...
establece `extensionTools: true` en `createAgentChatPlugin()`. Esto añade las
actions y la guía para el agente, mientras conserva el runtime aislado y los
enlaces existentes por compatibilidad.
