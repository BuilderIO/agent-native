...
En la aplicación, abra **Settings**, busque **MCP** y copie la **MCP server URL**.
Pegue esa URL en el host de IA que quiera usar. La URL es la URL base de la aplicación
desplegada más `/mcp`; no necesita buscar una opción de desarrollador.
