...
<DataModel id="doc-block-1mj35pp" title="Modelo de datos Plan" summary={"Una fila del plan posee secciones ordenadas además de comentarios, eventos, versiones, recursos compartidos y activos en línea."} entities={[
  {
    "id": "plans",
    "name": "plans",
