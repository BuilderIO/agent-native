...
<AnnotatedCode id="doc-block-uik2tb" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# Resumen matutino\n\nSummarize los correos electrónicos recibidos durante la noche. Agrupar por dominio del remitente.\nPin los 3 hilos principales que parecen necesitar una respuesta hoy a la etiqueta\n\"Necesita respuesta\". Borradores de respuestas para aquellos que sean obvios."} annotations={[
  {
    "lines": "2",
    "label": "cuando",
