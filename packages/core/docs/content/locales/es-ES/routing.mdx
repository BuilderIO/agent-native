...
<Diagram id="doc-block-oocqxt" title={"El diseño sin camino envuelve las páginas."} summary={"Un diseño _app.tsx (sin segmento URL) representa el shell compartido una vez; las páginas coincidentes se muestran dentro de su <Outlet/>, por lo que la barra lateral del agente nunca se vuelve a montar durante la navegación."}>
...
<div class="diagram-layout" data-rough>
  <div class="diagram-shell">
    ...
    ><small class="diagram-muted"
      >layout sin ruta · shell persistente + barra del agente</small
    >
...
Eso es todo: el servidor de desarrollo lee los archivos de ruta al iniciarse. Si
`pnpm dev` ya está en ejecución, reinícialo después de añadir el archivo. No es
...
- [**Server**](/docs/server-overview): rutas de servidor basadas en archivos y el espacio de nombres `/_agent-native/`
