...
<DataModel id="doc-block-1a4c35p" title="Modelo de datos Slides" summary={"Un deck posee sus diapositivas como JSON en decks.data; comentarios, versiones, compartidos y sistemas de diseño cuelgan de él."} entities={[
  {
    "id": "decks",
    "name": "decks",
