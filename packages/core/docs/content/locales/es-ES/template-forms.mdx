...
<DataModel id="doc-block-ljpo3c" title="Modelo de datos de Forms" summary={"Tres mesas. Los campos y las integraciones son columnas JSON en los formularios, por lo que las ediciones del agente son parches quirúrgicos en lugar de cambios de filas entre tablas."} entities={[
  {
    "id": "forms",
    "name": "forms",
