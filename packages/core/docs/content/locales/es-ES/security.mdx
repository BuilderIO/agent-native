...
<DataModel id="doc-block-1e2bdss" title="What ownableColumns() adds" summary="Las tres columnas que hacen que una tabla sea compatible con los inquilinos y se pueda compartir." entities={[
  {
    "id": "ownable",
