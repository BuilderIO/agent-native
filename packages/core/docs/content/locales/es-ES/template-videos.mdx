...
<DataModel id="doc-block-26knml" title={"Modelo de datos de vídeo"} summary={"Composiciones respaldadas por SQL más sistemas de diseño y carpetas encajables, cada una con una tabla de recursos compartidos."} entities={[
  {
    "id": "compositions",
    "name": "compositions",
