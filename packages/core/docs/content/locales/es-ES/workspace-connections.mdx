...
<DataModel id="doc-block-1ofz6yn" title={"El modelo de conexión"} summary={"A connection records safe provider metadata and credentialRefs (pointers, not secrets). Each grant unlocks one app — one connection, many grants."} entities={[
  {
    "id": "conn",
    ...
    "fields": [
      ...
      },
      {
        "name": "provider",
        "type": "string",
        "note": "ID de proveedor estable, p. flojo"
      },
      {
        "name": "label",
        "type": "string"
      ...
      },
      {
        ...
        "type": "json",
        "nullable": true,
        "note": "configuración segura y no secreta"
      },
      {
        "name": "credentialRefs",
        "type": "json",
