...
<Diagram id="doc-block-kwsu7t" title={"Tres fotogramas, un tiempo de ejecución"} summary={"Su aplicación y el panel de agentes son los mismos en todos los cuadros; sólo cambia la envoltura que los rodea."}>

```html
<div class="diagram-frames">
  <div class="diagram-card" data-rough>
    <span class="diagram-pill accent">Panel incrustado</span
    ><small class="diagram-muted">incluido en cada app · dev + prod</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">Marco de desarrollo local</span
    ><small class="diagram-muted">app en iframe + panel + terminal CLI</small>
  </div>
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">Marco cloud de Builder.io</span
    ><small class="diagram-muted"
      >alojado: colaboración · edición visual · ejecuciones paralelas</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-box" data-rough>
    Mismo runtime<br /><small class="diagram-muted"
      >tu app · acciones · estado de aplicación</small
    >
  </div>
</div>
```
...
- Proporciona la superficie completa de chat/CLI/recursos del agente, por lo que la entrada del agente permanece encendida
...
<Diagram id="doc-block-14b7eu4" title={"Puerta de solicitud de código"} summary={"Un mensaje escrito con código necesita un marco con capacidad para codificar. Con uno conectado, la solicitud se dirige allí; sin uno, el panel explica que los cambios de código necesitan Desktop o Builder."}>
...
<div class="diagram-gate">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-pill warn">
      no &rarr; dialog: needs Desktop or Builder
    </div>
  </div>
</div>
```
...
[Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=frames) proporciona un marco administrado que aloja el
