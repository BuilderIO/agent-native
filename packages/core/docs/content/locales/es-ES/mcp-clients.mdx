...
`agentNative.providerApi` a través de las acciones del host; nunca reciben URL
de conexión ni tokens.

### Atlassian / Jira

El ajuste preestablecido de Atlassian usa el punto de conexión OAuth 2.1 de Atlassian Rovo MCP,
`https://mcp.atlassian.com/v1/mcp`, y proporciona herramientas de Jira y Confluence. Para crear incidencias de Jira se necesitan los permisos de Atlassian que permiten escribir en Jira; el usuario solo puede ver los proyectos y el contenido a los que su cuenta de Atlassian tiene acceso.
