...
<DataModel id="doc-block-1p1oj2y" title="Modelo de datos Content" summary={"Nueve tablas en server/db/schema.ts. documents es el árbol de páginas; las demás cuelgan de él para versiones, comentarios, sincronización con Notion, bases de datos inline y uso compartido."} entities={[
  {
    "id": "documents",
    "name": "documents",
