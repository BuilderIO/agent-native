...
<DataModel id="doc-block-3j5dsl" title={"Modelo de datos de diseño"} summary={"Un diseño posee sus archivos e instantáneas versionadas y, opcionalmente, vincula un sistema de diseño reutilizable. Tanto los diseños como los sistemas son propios, cada uno con una tabla de acciones de marco."} entities={[
  {
    "id": "designs",
    "name": "designs",
