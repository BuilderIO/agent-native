...
a un **espacio** y figura en la colección del sistema **Files** de ese espacio. Una
...
es una colección de Content normal: sus propiedades, filtros, orden, agrupación y
