...
En un espacio de trabajo con varias aplicaciones, configure
`ONBOARDING_SHARED_COMPLETION` para reutilizar la incorporación completada
entre aplicaciones. Si no lo configura, cada aplicación realiza un seguimiento
de la finalización de la incorporación por separado.
...
Las tarjetas de configuración muestran las opciones de configuración disponibles.
No enumeran todas las claves o credenciales posibles.
