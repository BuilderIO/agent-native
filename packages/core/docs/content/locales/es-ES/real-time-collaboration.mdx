...
- **Funciona en todas partes**: cualquier base de datos SQL compatible con Drizzle (PGlite, Postgres).
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres en un host accesible públicamente**                             | La puerta de enlace marca la base de datos desde su propia red. PGlite, `localhost`, `*.internal` y las direcciones IP desnudas se rechazan antes de que la cadena de conexión salga siquiera de tu máquina. | `DATABASE_URL` apunta a un Postgres gestionado como Neon                                                                                                                                                      |
