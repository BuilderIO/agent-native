...
### Concesiones a grupos {#group-grants}

Algunos recursos permiten compartir con grupos. El grupo debe pertenecer a la organización del recurso, y cada miembro actual recibe el rol elegido para ese recurso. Consulta [Organizaciones, equipos y permisos → Grupos de usuarios](/docs/organizations-teams-permissions#user-groups) para saber qué abarcan los grupos y qué no.
