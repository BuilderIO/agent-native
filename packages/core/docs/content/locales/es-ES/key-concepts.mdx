...
<FileTree id="doc-block-huel4g" title={"Guía y comportamiento"} entries={[
  {
    "path": "AGENTS.md",
...
<DataModel id="doc-block-1azg8h5" title="Tiendas principales SQL" summary={"Creado automáticamente en cada plantilla: el agente y la interfaz de usuario los leen y escriben."} entities={[
  {
