---
title: "Doctor (Comprobaciones de código)"
description: "agent-native doctor analiza el código de la app para comprobar seguridad y arquitectura."
---

# Doctor (Comprobaciones de código)
