...
- **Cliente alojado canónico** → la aplicación muestra la opción **"Iniciar sesión con Agent-Native"** para el origen registrado; las apps autoalojadas deben seguir configurando la variable. No hay cambios de esquema ni nada que migrar.
