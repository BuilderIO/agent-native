...
<DataModel id="doc-block-1mx0tv0" title="El modelo de recursos del espacio de trabajo" summary={"Una forma de recurso respalda cada archivo de espacio de trabajo. El tiempo de ejecución lo clave por ruta y alcance y resuelve el valor efectivo en la lectura."} entities={[
  {
    "id": "resource",
