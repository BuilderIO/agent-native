...
`runDrizzleMigrations()` desde el paso de release. Mantenga `runMigrations()` para
el historial escrito a mano y casos especiales. Nunca utilice SQL destructivo,
`drizzle-kit push`, cambios de nombre de tablas ni eliminación de columnas.
