...
<Callout type="warning">
  ...
  obsoletas en favor de `frameworkTools.database` y
  `frameworkTools.extensions`. Siguen funcionando, pero definir una opción de
  nivel superior y su equivalente en `frameworkTools` con valores en conflicto
  lanza un error al iniciar el plugin en lugar de arrancar con una superficie de
  herramientas que nadie eligió.
</Callout>
