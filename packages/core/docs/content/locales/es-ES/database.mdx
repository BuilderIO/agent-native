  ...
  annotations={[
    {
      lines: "6-7",
      label: "Sólo aditivo",
      note: "Las entradas de migración se registran y se aplican una vez. Mantenga los cambios aditivos: agregue columnas o tablas y nunca las elimine ni las renombre.",
    },
    {
      lines: "13-16",
