...
<DataModel id="doc-block-pe44ma" title="la tabla de tareas" summary={"Definida una sola vez con los helpers del framework; el dialecto se elige en tiempo de ejecución a partir de DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
