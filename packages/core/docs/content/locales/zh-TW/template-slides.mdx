...
<DataModel id="doc-block-1ohcwiq" title={"幻燈片資料模型"} summary={"A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."} entities={[
  {
    "id": "decks",
    "name": "decks",
