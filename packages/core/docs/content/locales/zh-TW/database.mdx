...
<DataModel id="doc-block-zd29xc" title={"工作表"} summary={"Defined once with the framework helpers; the dialect is chosen at runtime from DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
