...
<DataModel id="doc-block-g3ro3n" title="Calendar modelo de dados" summary={"Apenas dados que não sejam de eventos são armazenados localmente — os eventos vivem em Google Calendar. Os links de reserva usam ownableColumns para que o sistema de compartilhamento seja aplicado."} entities={[
  {
    "id": "booking_links",
    "name": "booking_links",
