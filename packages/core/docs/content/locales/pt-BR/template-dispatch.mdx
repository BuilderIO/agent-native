...
# O Dispatch é incluído automaticamente. Desmarque Chat para usar apenas o Dispatch ou selecione os apps de domínio que serão criados com ele
```
