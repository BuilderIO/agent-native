...
<AnnotatedCode id="doc-block-1o1w7kq" title="jobs/morning-digest.md" filename="jobs/morning-digest.md" language="markdown" code={"---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# Resumo matinal\n\nResuma os e-mails recebidos durante a noite. Agrupe por domínio do remetente.\nFixe as três principais conversas que parecem precisar de uma resposta hoje no marcador\n\"Precisa de resposta\". Rascunhos de respostas para qualquer coisa que seja óbvia."} annotations={[
  {
    "lines": "2",
    "label": "Quando",
