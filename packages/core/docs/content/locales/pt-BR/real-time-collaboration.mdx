...
- **Funciona em qualquer lugar** — Qualquer banco de dados SQL compatível com Drizzle (PGlite, Postgres).
...
| --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres em um host publicamente acessível**                              | O gateway disca para o banco de dados a partir da própria rede. PGlite, `localhost`, `*.internal` e endereços IP nus são recusados antes que a string de conexão sequer saia da sua máquina.     | `DATABASE_URL` aponta para um Postgres gerenciado, como o Neon                                                                                                                                       |
