...
O agente nativo não é apenas para desenvolvedores. O agente incorporado oferece à equipe inteira uma forma compartilhada de operar o aplicativo, enquanto mudanças no código-fonte permanecem no fluxo de desenvolvimento normal. Ele só pode editar o código-fonte quando o host concede intencionalmente ferramentas de escrita de repository/workspace:
...
## Comece com um modelo e personalize {#fork-and-customize}

Os aplicativos nativos do agente seguem um modelo de começar com um app funcional. Você começa com um **modelo** — Calendário, Conteúdo, Apresentações, Analytics, Mail, Clipes, Design, Formulários, Envio — e personaliza-o. Cada um deles é um produto SaaS completo e funcional, e não uma estrutura em branco:
...
3. Crie seu próprio app a partir do modelo quando quiser personalizar — "conectar nossa conta Stripe", "adicionar um gráfico de coorte"
4. Personalize o código-fonte no seu repositório e fluxo de desenvolvimento
5. Implante seu app em seu próprio domínio — ou permaneça em agent-native.com

Como é _seu_ aplicativo, e não infraestrutura compartilhada, você possui o código-fonte e pode evoluí-lo sem alterar o framework compartilhado. O agente incorporado trabalha por meio de actions e dados e só pode ajudar no código-fonte com ferramentas de escrita concedidas intencionalmente. Veja [Templates](/docs/cloneable-saas) para a história completa.
