...
- **Automations** — automações pessoais e da organização Scheduled e Event com pausar/retomar, detalhes e excluir. A URL de compatibilidade continua sendo `/agent#jobs`.
...
A página usa atualmente o escopo pessoal e não oferece um seletor
**Personal / Organization** para toda a página. Uma aba pode mostrar suas
próprias seções de organização quando as actions subjacentes as suportam:
**Automations** mostra seções pessoais e da organização para Scheduled e Event.
Automações Event da organização sempre executam como seu criador. A página é uma camada
fina sobre componentes, actions e verificações de acesso existentes, não um
