...
- **Cliente hospedado canônico** → o aplicativo mostra a opção **"Entrar com Agent-Native"** para a origem registrada; apps auto-hospedados continuam precisando definir a variável. Não há alteração de esquema nem migração.
