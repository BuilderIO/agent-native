...
<DataModel id="doc-block-1nkt3fv" title={"Modelo de dados de vídeo"} summary={"Composições apoiadas por SQL, além de sistemas de design e pastas aninhadas, cada uma com uma tabela de compartilhamentos de estrutura."} entities={[
  {
    "id": "compositions",
    "name": "compositions",
