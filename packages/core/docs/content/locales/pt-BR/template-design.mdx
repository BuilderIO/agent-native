...
<DataModel id="doc-block-1hvfun7" title="Projetar modelo de dados" summary={"Um design possui seus arquivos e instantâneos versionados e, opcionalmente, vincula um sistema de design reutilizável. Tanto os designs quanto os sistemas podem ser adquiridos, cada um com uma tabela de compartilhamentos da estrutura."} entities={[
  {
    "id": "designs",
    "name": "designs",
