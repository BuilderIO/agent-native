...
<FileTree id="doc-block-1c0l5rq" title={"Orientação e comportamento"} entries={[
  {
    "path": "AGENTS.md",
...
<DataModel id="doc-block-zeyf73" title="Lojas principais SQL" summary={"Criado automaticamente em cada modelo — o agente e UI leem e gravam estes."} entities={[
  {
