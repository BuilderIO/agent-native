...
<DataModel id="doc-block-jbmdmw" title="Modelo de dados do plano" summary={"Uma linha do plano possui seções ordenadas, além de comentários, eventos, versões, compartilhamentos e ativos inline."} entities={[
  {
    "id": "plans",
    "name": "plans",
