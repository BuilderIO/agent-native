...
<DataModel id="doc-block-eqjd6s" title="What ownableColumns() adds" summary={"As três colunas que tornam uma tabela compatível com locatários e compartilhável."} entities={[
  {
    "id": "ownable",
