...
É isso aí - o servidor de desenvolvimento lê os arquivos de rota ao iniciar. Se
`pnpm dev` já estiver em execução, reinicie-o depois de adicionar o arquivo. Não é
necessário registrar a rota.
...
- [**Server**](/docs/server-overview) — rotas de servidor baseadas em arquivo e o namespace `/_agent-native/`
