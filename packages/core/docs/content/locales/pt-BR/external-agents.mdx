...
No aplicativo, abra **Settings**, pesquise **MCP** e copie a **MCP server URL**. Cole essa
URL no host de IA que você deseja usar. A URL é a URL base do aplicativo implantado seguida de `/mcp`;
você não precisa procurar uma configuração de desenvolvedor.
