...
É isso. O usuário agora tem um agente alternável em cada página – com histórico de bate-papo, guia Recursos do Agente, terminal CLI, entrada de voz e modo de tela cheia. O estado persiste durante as recargas via `localStorage`.
