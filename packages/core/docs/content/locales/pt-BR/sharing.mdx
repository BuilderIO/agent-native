...
### Compartilhamento com grupos {#group-grants}

Alguns recursos aceitam compartilhamento com grupos. O grupo precisa pertencer à organização do recurso, e cada membro atual recebe a função escolhida para esse recurso. Consulte [Organizações, equipes e permissões → Grupos de usuários](/docs/organizations-teams-permissions#user-groups) para ver o que os grupos abrangem e o que não abrangem.
