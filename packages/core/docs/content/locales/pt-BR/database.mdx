...
<DataModel id="doc-block-19her11" title="A tabela de tarefas" summary={"Definida uma vez com os auxiliares do framework; o dialeto é escolhido em tempo de execução a partir de DATABASE_URL."} entities={[
  {
    "id": "tasks",
    "name": "tasks",
