  ...
  annotations={[
    {
      ...
      note: "As entradas de migração são rastreadas e aplicadas uma vez. Mantenha as mudanças aditivas: adicione colunas ou tabelas e nunca as descarte nem renomeie.",
    },
    {
      lines: "13-16",
