...
<DataModel id="doc-block-qxh1b7" title={"O modelo de recursos do espaço de trabalho"} summary={"Um formato de recurso suporta cada arquivo do espaço de trabalho. O tempo de execução classifica-o por caminho e escopo e resolve o valor efetivo na leitura."} entities={[
  {
    "id": "resource",
