...
In the app, open **Settings**, search for **MCP**, and copy the **MCP server
URL**. Paste that URL into the AI host you want to use. The URL is the deployed
app base URL plus `/mcp`; you do not need to find a developer setting.
