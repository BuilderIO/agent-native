...
export function registerBuiltinEngines(): void {
  ...
  const providerDescriptions: Record<AISDKProvider, string> = {
    ...
    openrouter:
      "300+ models from Anthropic, OpenAI, Google, Meta, and more routed through a single endpoint. Use model IDs like 'anthropic/claude-sonnet-5' or 'openai/gpt-5.5'. Requires OPENROUTER_API_KEY.",
    google:
