...
export default async function main(_args: string[]) {
  ...
  console.log("  pnpm script list-events --from 2026-01-01 --to 2026-12-31");
  console.log(
    '  pnpm script create-event --title "Meeting" --start ... --end ...',
  );
  console.log("  pnpm script check-availability --date 2026-03-15");
