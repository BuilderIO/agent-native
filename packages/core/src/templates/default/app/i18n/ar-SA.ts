const messages = {
  ...
  org: {
    ...
    recentIcons: "الأيقونات الأخيرة",
    iconColors: "الألوان",
    defaultColor: "افتراضي",
    removeIcon: "إزالة الأيقونة",
    uploadIcon: "رفع أيقونة",
    uploadingIcon: "جارٍ الرفع…",
    workspaceIconSyncPending:
      "تم الحفظ هنا. قد يستغرق التحديث في التطبيقات الأخرى وقتًا أطول.",
  ...
  observability: {
    ...
    review: "مراجعة بشرية",
    reviewDescription:
      "راجع السؤال والإجابة، وسجّل الملاحظات، واكتب مسودة لتحديث التعليمات.",
    ask: "ما تم سؤاله",
    answer: "ما أجاب به الوكيل",
    ...
    looksGood: "يبدو جيدًا",
    needsChange: "يحتاج إلى تغيير",
    feedbackNote: "ملاحظة المراجعة",
    feedbackPlaceholder: "ما الذي يجب تغييره أو إبقاؤه كما هو؟",
    saveFeedback: "حفظ الملاحظات",
    updateInstructions: "تحديث التعليمات",
    draftNotice: "مسودة فقط - لا شيء يتغير تلقائيًا.",
    instructionTarget: "هدف التعليمات",
    agentTarget: "الوكيل",
    developerTarget: "المطور",
    skillTarget: "المهارة",
    instructionPlaceholder: "اكتب تغيير التعليمات لمراجعة بشرية.",
