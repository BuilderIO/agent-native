const messages = {
  ...
  org: {
    ...
    uploadingIcon: "アップロード中…",
    workspaceIconSyncPending:
      "ここに保存しました。他のアプリへの反映には時間がかかる場合があります。",
  ...
  observability: {
    ...
    review: "人によるレビュー",
    reviewDescription:
      "質問と回答を確認し、フィードバックと指示の更新案を保存します。",
    ask: "質問内容",
    answer: "エージェントの回答",
    ...
    feedbackPlaceholder: "変更または維持すべき点は？",
    saveFeedback: "フィードバックを保存",
    updateInstructions: "指示を更新",
    draftNotice: "下書きのみです。自動的には変更されません。",
    instructionTarget: "指示の対象",
    agentTarget: "エージェント",
    developerTarget: "開発者",
    skillTarget: "スキル",
    instructionPlaceholder: "人がレビューする指示の変更案を書いてください。",
    saveUpdate: "更新案を保存",
