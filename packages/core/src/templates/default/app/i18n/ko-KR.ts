const messages = {
  ...
  org: {
    ...
    workspaceIcon: "워크스페이스 아이콘",
    icons: "아이콘",
    emoji: "이모지",
    upload: "업로드",
    searchIcons: "아이콘 검색",
    noIconsFound: "아이콘을 찾을 수 없음",
    recentIcons: "최근 아이콘",
    iconColors: "색상",
    defaultColor: "기본값",
    removeIcon: "아이콘 제거",
    ...
    workspaceIconSyncPending:
      "여기에 저장했습니다. 다른 앱에 반영되기까지 시간이 더 걸릴 수 있습니다.",
  ...
  observability: {
    ...
    review: "사람 검토",
    reviewDescription:
      "질문과 답변을 검토하고 피드백과 지침 업데이트 초안을 저장합니다.",
    ask: "질문 내용",
    answer: "에이전트의 답변",
    reviewFeedback: "피드백",
    reviewOutput: "답변 검토",
    ...
    needsChange: "변경 필요",
    feedbackNote: "피드백 메모",
    feedbackPlaceholder: "무엇을 바꾸거나 유지해야 하나요?",
    saveFeedback: "피드백 저장",
    updateInstructions: "지침 업데이트",
    draftNotice: "초안만 저장되며 자동으로 변경되지 않습니다.",
    instructionTarget: "지침 대상",
    agentTarget: "에이전트",
    developerTarget: "개발자",
    skillTarget: "스킬",
    instructionPlaceholder: "사람이 검토할 지침 변경안을 작성하세요.",
