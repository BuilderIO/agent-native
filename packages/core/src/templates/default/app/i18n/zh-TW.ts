const messages = {
  ...
  observability: {
    ...
    categories: "分類",
    review: "人工審核",
    reviewDescription: "檢視問題與回答、留下回饋，並草擬指令更新。",
    ask: "提出的問題",
    answer: "代理的回答",
    reviewFeedback: "回饋",
    reviewOutput: "審核回答",
    ...
    needsChange: "需要修改",
    feedbackNote: "回饋備註",
    feedbackPlaceholder: "哪些內容需要修改或維持不變？",
    saveFeedback: "儲存回饋",
    updateInstructions: "更新指令",
    draftNotice: "僅儲存草稿，不會自動套用變更。",
    instructionTarget: "指令目標",
    agentTarget: "代理",
    developerTarget: "開發者",
    skillTarget: "技能",
    instructionPlaceholder: "寫下供人工審核的指令修改內容。",
    saveUpdate: "儲存更新草稿",
    draftSaved: "草稿已儲存",
