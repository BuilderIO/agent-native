const messages = {
  ...
  org: {
    ...
    recentIcons: "हाल के आइकन",
    iconColors: "रंग",
    defaultColor: "डिफ़ॉल्ट",
    removeIcon: "आइकन हटाएँ",
    uploadIcon: "आइकन अपलोड करें",
    uploadingIcon: "अपलोड हो रहा है…",
    workspaceIconSyncPending:
      "यहाँ सहेजा गया। दूसरे ऐप्स में अपडेट होने में अधिक समय लग सकता है।",
  ...
  observability: {
    ...
    review: "मानवीय समीक्षा",
    reviewDescription:
      "प्रश्न और उत्तर की समीक्षा करें, फ़ीडबैक दें और निर्देश अपडेट का मसौदा बनाएं।",
    ask: "क्या पूछा गया",
    answer: "एजेंट ने क्या उत्तर दिया",
    ...
    closeReview: "बंद करें",
    notReviewed: "समीक्षा नहीं हुई",
    noteSaved: "नोट सहेजा गया",
    looksGood: "अच्छा है",
    needsChange: "बदलाव चाहिए",
    feedbackNote: "फ़ीडबैक नोट",
    feedbackPlaceholder: "क्या बदलना या वैसा ही रखना चाहिए?",
    saveFeedback: "फ़ीडबैक सहेजें",
    updateInstructions: "निर्देश अपडेट करें",
    draftNotice: "सिर्फ़ मसौदा - कुछ भी अपने आप नहीं बदलेगा।",
    instructionTarget: "निर्देश लक्ष्य",
    agentTarget: "एजेंट",
    developerTarget: "डेवलपर",
    skillTarget: "स्किल",
    instructionPlaceholder: "मानवीय समीक्षा के लिए निर्देश बदलाव लिखें।",
