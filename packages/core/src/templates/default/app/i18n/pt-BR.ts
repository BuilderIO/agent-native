const messages = {
  ...
  org: {
    ...
    recentIcons: "Ícones recentes",
    iconColors: "Cores",
    defaultColor: "Padrão",
    removeIcon: "Remover ícone",
    uploadIcon: "Enviar ícone",
    uploadingIcon: "Enviando…",
    workspaceIconSyncPending:
      "Salvo aqui. A atualização em outros apps pode demorar mais.",
  ...
  observability: {
    ...
    reviewDescription:
      "Revise a solicitação e a resposta, registre feedback e rascunhe uma atualização de instrução.",
    ask: "O que foi perguntado",
    ...
    looksGood: "Está bom",
    needsChange: "Precisa mudar",
    feedbackNote: "Nota de feedback",
    feedbackPlaceholder: "O que deve mudar ou permanecer igual?",
    saveFeedback: "Salvar feedback",
    updateInstructions: "Atualizar instruções",
    draftNotice: "Apenas rascunho - nada muda automaticamente.",
    instructionTarget: "Destino da instrução",
    agentTarget: "Agente",
    developerTarget: "Desenvolvedor",
    skillTarget: "Skill",
    instructionPlaceholder: "Escreva a mudança para revisão humana.",
