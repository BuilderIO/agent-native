const messages = {
  ...
  org: {
    ...
    recentIcons: "Zuletzt verwendete Symbole",
    iconColors: "Farben",
    defaultColor: "Standard",
    removeIcon: "Symbol entfernen",
    uploadIcon: "Symbol hochladen",
    uploadingIcon: "Wird hochgeladen…",
    workspaceIconSyncPending:
      "Hier gespeichert. Die Aktualisierung in anderen Apps kann länger dauern.",
  ...
  observability: {
    ...
    reviewDescription:
      "Prüfe Frage und Antwort, gib Feedback und entwirf eine Aktualisierung der Anweisungen.",
    ask: "Was gefragt wurde",
    answer: "Was der Agent geantwortet hat",
    ...
    needsChange: "Änderung nötig",
    feedbackNote: "Feedbacknotiz",
    feedbackPlaceholder: "Was soll geändert oder beibehalten werden?",
    saveFeedback: "Feedback speichern",
    updateInstructions: "Anweisungen aktualisieren",
    draftNotice: "Nur Entwurf - nichts wird automatisch geändert.",
    instructionTarget: "Anweisungsziel",
    agentTarget: "Agent",
    developerTarget: "Entwickler",
    skillTarget: "Skill",
    instructionPlaceholder: "Schreibe die Änderung zur menschlichen Prüfung.",
