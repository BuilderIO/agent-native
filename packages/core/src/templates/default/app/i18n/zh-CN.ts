const messages = {
  ...
  org: {
    ...
    uploadIcon: "上传图标",
    uploadingIcon: "正在上传…",
    workspaceIconSyncPending: "已在此保存。其他应用的更新可能需要更长时间。",
  ...
  observability: {
    ...
    categories: "分类",
    review: "人工审核",
    reviewDescription: "查看问题和回答，记录反馈，并草拟指令更新。",
    ask: "提出的问题",
    answer: "代理的回答",
    reviewFeedback: "反馈",
    reviewOutput: "审核回答",
    ...
    needsChange: "需要修改",
    feedbackNote: "反馈备注",
    feedbackPlaceholder: "哪些内容需要修改或保持不变？",
    saveFeedback: "保存反馈",
    updateInstructions: "更新指令",
    draftNotice: "仅保存草稿，不会自动应用任何更改。",
    instructionTarget: "指令目标",
    agentTarget: "代理",
    developerTarget: "开发者",
    skillTarget: "技能",
    instructionPlaceholder: "写下供人工审核的指令修改内容。",
    saveUpdate: "保存更新草稿",
    draftSaved: "草稿已保存",
