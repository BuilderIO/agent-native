const messages = {
  ...
  observability: {
    ...
    reviewDescription:
      "Examinez la demande et la réponse, donnez votre avis et préparez une mise à jour des instructions.",
    ask: "Demande",
    ...
    looksGood: "C’est bien",
    needsChange: "À modifier",
    feedbackNote: "Note d’avis",
    feedbackPlaceholder: "Que faut-il changer ou conserver ?",
    saveFeedback: "Enregistrer l’avis",
    updateInstructions: "Mettre à jour les instructions",
    draftNotice: "Brouillon uniquement - rien ne change automatiquement.",
    instructionTarget: "Cible de l’instruction",
    agentTarget: "Agent",
    developerTarget: "Développeur",
    skillTarget: "Compétence",
    instructionPlaceholder:
      "Écrivez le changement d’instruction à faire relire.",
