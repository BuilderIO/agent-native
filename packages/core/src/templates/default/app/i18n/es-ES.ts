const messages = {
  ...
  org: {
    ...
    uploadingIcon: "Subiendo…",
    workspaceIconSyncPending:
      "Guardado aquí. La actualización en otras aplicaciones puede tardar más.",
  ...
  observability: {
    ...
    reviewDescription:
      "Revisa la solicitud y la respuesta, deja comentarios y prepara una actualización de instrucciones.",
    ask: "Qué se preguntó",
    ...
    looksGood: "Está bien",
    needsChange: "Necesita cambios",
    feedbackNote: "Nota de comentarios",
    feedbackPlaceholder: "¿Qué debería cambiar o mantenerse igual?",
    saveFeedback: "Guardar comentarios",
    updateInstructions: "Actualizar instrucciones",
    draftNotice: "Solo borrador; nada cambia automáticamente.",
    instructionTarget: "Destino de la instrucción",
    agentTarget: "Agente",
    developerTarget: "Desarrollador",
    skillTarget: "Habilidad",
    instructionPlaceholder:
      "Escribe el cambio de instrucciones para que lo revise una persona.",
