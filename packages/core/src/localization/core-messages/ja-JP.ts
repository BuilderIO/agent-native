...
const messages: AgentChatTranslation = {
  ...
  "usage.insights.verdictSmooth": "順調に動作中",
  "usage.insights.verdictLook_other": "気になる点が{{count}}件",
  ...
  "usage.insights.avgPerPrompt": "プロンプトあたりの平均",
  "usage.insights.completed": "完了",
  "usage.insights.completedDetail": "直近{{total}}件中{{done}}件",
  "usage.insights.completedRecovered_other":
    "直近{{total}}件中{{done}}件（ツールエラー{{count}}件から復帰後）",
  "usage.insights.typicalTime": "所要時間の目安",
  "usage.insights.median": "中央値",
  "usage.insights.changeSame": "前の期間と同じ",
  "usage.insights.changeUp": "↑ {{percent}}%（前の期間比）",
  "usage.insights.changeDown": "↓ {{percent}}%（前の期間比）",
  "usage.insights.kindProblem": "問題",
  "usage.insights.kindSaving": "節約",
  "usage.insights.kindInfo": "参考情報",
  "usage.insights.fixLabel": "対処法:",
  "usage.insights.openPrompt": "プロンプトを開く",
  "usage.insights.seePrompts_other": "{{count}}件のプロンプトを見る",
  "usage.insights.erroredTitle_other":
    "{{count}}件のプロンプトがエラーで終了しました",
  "usage.insights.erroredBody": "エージェントは完了前に停止しました。",
  "usage.insights.erroredFix":
    "プロンプトを開くと、停止する直前に行った操作を確認できます。",
  "usage.insights.toolFailedTitle_other":
    "{{tool}}ツールが{{count}}件のプロンプトで失敗しました",
  "usage.insights.toolFailedSaid": "表示されたエラー: 「{{error}}」",
  "usage.insights.toolFailedGeneric": "ツールがエラーを報告しました。",
  "usage.insights.toolRecoveredAll": "エージェントは毎回復帰して完了しました。",
  ...
  "usage.insights.reasonToolLookup": "新しいツールを取得した",
  "usage.insights.reasonPrefixChanged": "指示の先頭部分が変わった",
  ...
  "usage.insights.untitledPrompt": "無題のプロンプト",
  "usage.insights.promptsHeading": "プロンプト",
  "usage.insights.showing": "{{count}}件を表示中",
  "usage.insights.sortNewest": "新しい順",
  "usage.insights.sortCost": "コストが高い順",
  "usage.insights.emptyPrompts":
    "この期間のプロンプトはまだありません。完了すると数秒後にここに表示されます。",
  "usage.insights.promptNotSaved": "プロンプトのテキストは保存されませんでした",
  "usage.insights.ratedHelpful": "役立ったと評価",
  "usage.insights.ratedUnhelpful": "役に立たなかったと評価",
  "usage.insights.notRated": "未評価",
  "usage.insights.stoppedWithError": "エラーで停止",
  "usage.insights.detailsUnavailable": "ステップの詳細はもう確認できません",
  "usage.insights.answered": "回答済み",
  "usage.insights.finished": "終了",
  "usage.insights.startedOverShort": "{{count}}×やり直し",
  "usage.insights.recoveredShort_other": "{{count}}件のツールエラーから復帰",
  "usage.insights.toolsFailedShort_other": "{{count}}件のツールが失敗",
  "usage.insights.headerDuration": "{{duration}}で",
  "usage.insights.stepsCount_other": "{{count}}ステップ",
  "usage.insights.whatItDid": "実行内容:",
  "usage.insights.replyNotSaved":
    "このプロンプトの返信テキストは保存されませんでした。",
  "usage.insights.showAll": "すべて表示",
  "usage.insights.showLess": "表示を減らす",
  "usage.insights.moreTools": "他{{count}}件",
  ...
  "usage.insights.showSteps_other": "{{count}}ステップを表示",
  "usage.insights.hideSteps": "ステップを隠す",
  "usage.insights.costDetails": "コストの詳細とチェック",
  "usage.insights.turnReply": "返信を作成",
  "usage.insights.turnThought": "じっくり検討",
  "usage.insights.startedOverTag": "やり直し",
  "usage.insights.toolFailedTag": "ツール失敗",
  ...
  "usage.insights.turnOutput": "{{tokens}}トークンを出力しました。",
  ...
  "usage.insights.partReused": "再利用したコンテキスト",
  "usage.insights.partSaved": "キャッシュに保存",
  "usage.insights.partNew": "新しいコンテキスト",
  "usage.insights.partOutput": "モデルによる出力",
  "usage.insights.checksHeading": "自動チェック",
  "usage.insights.checksNone": "記録はありません。",
  "usage.insights.checksGraded": "（モデルによる採点）",
  "usage.insights.checksNote":
    "フレームワークのチェックは、結果の良し悪しではなく、実行の様子（エラー、ステップ数、速度）を見ています。",
  "usage.insights.lookedForTools": "ツールを追加で検索",
  "usage.insights.prevPrompt": "前のプロンプト (K)",
  "usage.insights.nextPrompt": "次のプロンプト (J)",
  "usage.insights.toolVerb.add": "{{object}}を追加",
  "usage.insights.toolVerb.analyze": "{{object}}を分析",
  "usage.insights.toolVerb.apply": "{{object}}を適用",
  "usage.insights.toolVerb.capture": "{{object}}を撮影",
  "usage.insights.toolVerb.check": "{{object}}を確認",
  "usage.insights.toolVerb.connect": "{{object}}に接続",
  "usage.insights.toolVerb.create": "{{object}}を作成",
  "usage.insights.toolVerb.delete": "{{object}}を削除",
  "usage.insights.toolVerb.duplicate": "{{object}}を複製",
  "usage.insights.toolVerb.edit": "{{object}}を編集",
  "usage.insights.toolVerb.export": "{{object}}を書き出し",
  "usage.insights.toolVerb.fetch": "{{object}}を取得",
  "usage.insights.toolVerb.find": "{{object}}を検出",
  "usage.insights.toolVerb.generate": "{{object}}を生成",
  "usage.insights.toolVerb.index": "{{object}}をインデックス化",
  "usage.insights.toolVerb.insert": "{{object}}を挿入",
  "usage.insights.toolVerb.list": "{{object}}を一覧表示",
  "usage.insights.toolVerb.move": "{{object}}を移動",
  "usage.insights.toolVerb.navigate": "{{object}}に移動",
  "usage.insights.toolVerb.open": "{{object}}を開く",
  "usage.insights.toolVerb.present": "{{object}}を提示",
  "usage.insights.toolVerb.propose": "{{object}}を提案",
  "usage.insights.toolVerb.query": "{{object}}を照会",
  "usage.insights.toolVerb.read": "{{object}}を読み込み",
  "usage.insights.toolVerb.remove": "{{object}}を削除",
  "usage.insights.toolVerb.rename": "{{object}}の名前を変更",
  "usage.insights.toolVerb.reply": "{{object}}に返信",
  "usage.insights.toolVerb.resolve": "{{object}}を解決",
  "usage.insights.toolVerb.run": "{{object}}を実行",
  "usage.insights.toolVerb.save": "{{object}}を保存",
  "usage.insights.toolVerb.search": "{{object}}を検索",
  "usage.insights.toolVerb.send": "{{object}}を送信",
  "usage.insights.toolVerb.set": "{{object}}を設定",
  "usage.insights.toolVerb.take": "{{object}}を取得",
  "usage.insights.toolVerb.update": "{{object}}を更新",
  "usage.insights.toolVerb.upload": "{{object}}をアップロード",
  "usage.insights.toolVerb.view": "{{object}}を表示",
  "usage.insights.toolVerb.write": "{{object}}を書き込み",
};
