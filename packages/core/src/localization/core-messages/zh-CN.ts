...
const messages: AgentChatTranslation = {
  ...
  "usage.insights.verdictSmooth": "运行流畅",
  "usage.insights.verdictLook_other": "{{count}} 项值得关注",
  ...
  "usage.insights.handledRecovered_other":
    "从 {{count}} 个工具错误中恢复，未中断运行。",
  "usage.insights.avgPerPrompt": "每个提示词的平均值",
  "usage.insights.completed": "已完成",
  "usage.insights.completedDetail": "最近 {{total}} 个中的 {{done}} 个",
  "usage.insights.completedRecovered_other":
    "从 {{count}} 个工具错误恢复后，最近 {{total}} 个中完成了 {{done}} 个",
  "usage.insights.typicalTime": "典型耗时",
  "usage.insights.median": "中位数",
  "usage.insights.changeSame": "与上一周期相同",
  "usage.insights.changeUp": "↑ 较上一周期 {{percent}}%",
  "usage.insights.changeDown": "↓ 较上一周期 {{percent}}%",
  "usage.insights.kindProblem": "问题",
  "usage.insights.kindSaving": "可节省",
  "usage.insights.kindInfo": "小提示",
  "usage.insights.fixLabel": "修复方法：",
  "usage.insights.openPrompt": "打开该提示词",
  "usage.insights.seePrompts_other": "查看这 {{count}} 个提示词",
  "usage.insights.erroredTitle_other": "{{count}} 个提示词以错误结束",
  "usage.insights.erroredBody": "代理在完成之前停止了。",
  "usage.insights.erroredFix": "打开提示词查看它停止前执行的最后一步。",
  "usage.insights.toolFailedTitle_other":
    "{{tool}} 工具在 {{count}} 个提示词中失败",
  "usage.insights.toolFailedSaid": "它说：“{{error}}”",
  "usage.insights.toolFailedGeneric": "该工具报告了一个错误。",
  "usage.insights.toolRecoveredAll": "代理每次都成功恢复并完成了任务。",
  "usage.insights.toolRecoveredSome":
    "代理在其中 {{count}} 次恢复并完成了任务。",
  "usage.insights.restartTitle":
    "重新开始花费了约 {{amount}}（占总支出的 {{percent}}%）",
  "usage.insights.restartBody":
    "在最近 {{total}} 个提示词中的 {{count}} 个中，代理在{{reason}}后重新发送了整段对话，而不是复用已发送的内容。",
  "usage.insights.reasonToolLookup": "获取新工具",
  "usage.insights.reasonPrefixChanged": "指令开头的内容发生了变化",
  "usage.insights.fixToolLookup":
    "使用 initialToolNames 预加载此应用所用的工具，让工具列表在整个提示词期间保持不变。",
  "usage.insights.fixPrefixChanged":
    "不要把时间戳或每步状态等会变化的内容放进系统提示词。",
  "usage.insights.priciestTitle": "有一个提示词占用了近期支出的 {{percent}}%",
  "usage.insights.priciestBody_other":
    "“{{prompt}}” 耗费了 {{amount}}，共 {{count}} 步。",
  "usage.insights.untitledPrompt": "未命名提示词",
  "usage.insights.promptsHeading": "提示词",
  "usage.insights.showing": "显示 {{count}} 个",
  "usage.insights.sortNewest": "最新",
  "usage.insights.sortCost": "花费最高",
  "usage.insights.emptyPrompts":
    "此时间段内还没有提示词。完成后几秒就会显示在这里。",
  "usage.insights.promptNotSaved": "提示词文本未保存",
  "usage.insights.ratedHelpful": "评为有帮助",
  "usage.insights.ratedUnhelpful": "评为没有帮助",
  "usage.insights.notRated": "未评分",
  "usage.insights.stoppedWithError": "因错误而停止",
  "usage.insights.detailsUnavailable": "步骤详情已不可用",
  "usage.insights.answered": "已回答",
  "usage.insights.finished": "已完成",
  "usage.insights.startedOverShort": "重新开始 {{count}}×",
  "usage.insights.recoveredShort_other": "从 {{count}} 个工具错误中恢复",
  "usage.insights.toolsFailedShort_other": "{{count}} 个工具失败",
  "usage.insights.headerDuration": "耗时 {{duration}}",
  "usage.insights.stepsCount_other": "{{count}} 步",
  "usage.insights.whatItDid": "执行内容：",
  "usage.insights.replyNotSaved": "此提示词的回复文本未保存。",
  "usage.insights.showAll": "显示全部",
  "usage.insights.showLess": "收起",
  "usage.insights.moreTools": "+{{count}} 更多",
  "usage.insights.failedSuffix": "失败",
  "usage.insights.timesCount": "{{label}} ×{{count}}",
  "usage.insights.startedOverNote_other":
    "在{{reason}}后重新开始了 {{count}} 次，共花费约 {{total}} 中的 {{amount}}。",
  "usage.insights.toolFailedNote_other": "{{tool}} 工具失败了 {{count}} 次。",
  "usage.insights.toolFailedRecoveredNote_other":
    "{{tool}} 工具失败了 {{count}} 次，但代理继续运行并完成了任务。",
  "usage.insights.showSteps_other": "显示这 {{count}} 步",
  "usage.insights.hideSteps": "隐藏步骤",
  "usage.insights.costDetails": "费用详情与检查",
  "usage.insights.turnReply": "撰写了回复",
  "usage.insights.turnThought": "进行了思考",
  "usage.insights.startedOverTag": "重新开始",
  "usage.insights.toolFailedTag": "工具失败",
  "usage.insights.turnContext":
    "发送了 {{tokens}} 个上下文 token，其中 {{percent}}% 来自此前的复用。",
  "usage.insights.turnExpired": "保存的上下文在暂停后已过期，这是正常现象。",
  "usage.insights.turnOutput": "生成了 {{tokens}} 个 token。",
  "usage.insights.turnRestart":
    "在{{reason}}后重新开始，比复用上下文多花费约 {{amount}}。",
  "usage.insights.noCacheCompare":
    "按标准价格计算，复用此前的上下文使该提示词的费用从 {{noCache}} 降至 {{estimated}}。",
  "usage.insights.partReused": "复用的上下文",
  "usage.insights.partSaved": "已缓存",
  "usage.insights.partNew": "新上下文",
  "usage.insights.partOutput": "模型生成",
  "usage.insights.checksHeading": "自动检查",
  "usage.insights.checksNone": "没有记录任何检查。",
  "usage.insights.checksGraded": "（由模型评分）",
  "usage.insights.checksNote":
    "框架检查关注运行过程本身（错误、步骤、速度），而不判断结果是否理想。",
  "usage.insights.lookedForTools": "查找了更多工具",
  "usage.insights.prevPrompt": "上一个提示词 (K)",
  "usage.insights.nextPrompt": "下一个提示词 (J)",
  "usage.insights.toolVerb.add": "添加了 {{object}}",
  "usage.insights.toolVerb.analyze": "分析了 {{object}}",
  "usage.insights.toolVerb.apply": "应用了 {{object}}",
  "usage.insights.toolVerb.capture": "捕获了 {{object}}",
  "usage.insights.toolVerb.check": "检查了 {{object}}",
  "usage.insights.toolVerb.connect": "连接了 {{object}}",
  "usage.insights.toolVerb.create": "创建了 {{object}}",
  "usage.insights.toolVerb.delete": "删除了 {{object}}",
  "usage.insights.toolVerb.duplicate": "复制了 {{object}}",
  "usage.insights.toolVerb.edit": "编辑了 {{object}}",
  "usage.insights.toolVerb.export": "导出了 {{object}}",
  "usage.insights.toolVerb.fetch": "获取了 {{object}}",
  "usage.insights.toolVerb.find": "找到了 {{object}}",
  "usage.insights.toolVerb.generate": "生成了 {{object}}",
  "usage.insights.toolVerb.index": "索引了 {{object}}",
  "usage.insights.toolVerb.insert": "插入了 {{object}}",
  "usage.insights.toolVerb.list": "列出了 {{object}}",
  "usage.insights.toolVerb.move": "移动了 {{object}}",
  "usage.insights.toolVerb.navigate": "导航到了 {{object}}",
  "usage.insights.toolVerb.open": "打开了 {{object}}",
  "usage.insights.toolVerb.present": "展示了 {{object}}",
  "usage.insights.toolVerb.propose": "提出了 {{object}}",
  "usage.insights.toolVerb.query": "查询了 {{object}}",
  "usage.insights.toolVerb.read": "读取了 {{object}}",
  "usage.insights.toolVerb.remove": "移除了 {{object}}",
  "usage.insights.toolVerb.rename": "重命名了 {{object}}",
  "usage.insights.toolVerb.reply": "回复了 {{object}}",
  "usage.insights.toolVerb.resolve": "解决了 {{object}}",
  "usage.insights.toolVerb.run": "运行了 {{object}}",
  "usage.insights.toolVerb.save": "保存了 {{object}}",
  "usage.insights.toolVerb.search": "搜索了 {{object}}",
  "usage.insights.toolVerb.send": "发送了 {{object}}",
  "usage.insights.toolVerb.set": "设置了 {{object}}",
  "usage.insights.toolVerb.take": "截取了 {{object}}",
  "usage.insights.toolVerb.update": "更新了 {{object}}",
  "usage.insights.toolVerb.upload": "上传了 {{object}}",
  "usage.insights.toolVerb.view": "查看了 {{object}}",
  "usage.insights.toolVerb.write": "写入了 {{object}}",
};
