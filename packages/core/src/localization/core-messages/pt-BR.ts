...
const messages: AgentChatTranslation = {
  ...
  "composer.addOwnKeys": "Adicione suas próprias chaves",
  ...
  "composer.documentTooLarge":
    '"{{name}}" tem {{size}} MB. Os PDFs são limitados a {{maxSize}} MB para não ultrapassar o tamanho máximo da mensagem. Reduza o arquivo ou divida-o em partes menores.',
  ...
  "errorMessages.noProviderConnected":
    "Nenhum provedor de LLM está conectado. Abra “Gerenciar agente” → “LLM” para este app e conecte o Builder.io ou adicione uma chave de provedor.",
