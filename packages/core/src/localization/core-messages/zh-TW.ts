...
const messages: AgentChatTranslation = {
  ...
  "usage.insights.verdictSmooth": "運作順暢",
  "usage.insights.verdictLook_other": "{{count}} 項值得關注",
  "usage.insights.verdictProblems_other": "{{count}} 個問題",
  "usage.insights.spentSummary_other":
    "過去 {{days}} 天內在 {{count}} 個提示詞上花費了 {{amount}}。",
  "usage.insights.handledLabel": "由 Agent-Native 處理：",
  "usage.insights.handledHeading": "由 Agent-Native 處理",
  "usage.insights.handledParallel":
    "同時執行了 {{count}} 個工具呼叫，比逐個執行快了約 {{duration}}。",
  "usage.insights.handledRecovered_other":
    "從 {{count}} 個工具錯誤中恢復，未中斷執行。",
  "usage.insights.avgPerPrompt": "每個提示詞的平均值",
  "usage.insights.completed": "已完成",
  "usage.insights.completedDetail": "最近 {{total}} 個中的 {{done}} 個",
  "usage.insights.completedRecovered_other":
    "從 {{count}} 個工具錯誤恢復後，最近 {{total}} 個中完成了 {{done}} 個",
  "usage.insights.typicalTime": "典型耗時",
  "usage.insights.median": "中位數",
  "usage.insights.changeSame": "與上一週期相同",
  "usage.insights.changeUp": "↑ 較上一週期 {{percent}}%",
  "usage.insights.changeDown": "↓ 較上一週期 {{percent}}%",
  "usage.insights.kindProblem": "問題",
  "usage.insights.kindSaving": "可節省",
  "usage.insights.kindInfo": "小提示",
  "usage.insights.fixLabel": "修復方法：",
  "usage.insights.openPrompt": "開啟該提示詞",
  "usage.insights.seePrompts_other": "檢視這 {{count}} 個提示詞",
  "usage.insights.erroredTitle_other": "{{count}} 個提示詞以錯誤結束",
  "usage.insights.erroredBody": "代理在完成之前停止了。",
  "usage.insights.erroredFix": "開啟提示詞檢視它停止前執行的最後一步。",
  "usage.insights.toolFailedTitle_other":
    "{{tool}} 工具在 {{count}} 個提示詞中失敗",
  "usage.insights.toolFailedSaid": "它說：「{{error}}」",
  "usage.insights.toolFailedGeneric": "該工具報告了一個錯誤。",
  "usage.insights.toolRecoveredAll": "代理每次都成功恢復並完成了任務。",
  "usage.insights.toolRecoveredSome":
    "代理在其中 {{count}} 次恢復並完成了任務。",
  "usage.insights.restartTitle":
    "重新開始花費了約 {{amount}}（佔總支出的 {{percent}}%）",
  "usage.insights.restartBody":
    "在最近 {{total}} 個提示詞中的 {{count}} 個中，代理在{{reason}}後重新傳送了整段對話，而不是複用已傳送的內容。",
  "usage.insights.reasonToolLookup": "取得新工具",
  "usage.insights.reasonPrefixChanged": "指令開頭的內容發生了變化",
  "usage.insights.fixToolLookup":
    "使用 initialToolNames 預載入此應用所用的工具，讓工具列表在整個提示詞期間保持不變。",
  "usage.insights.fixPrefixChanged":
    "不要把時間戳或每步狀態等會變化的內容放進系統提示詞。",
  "usage.insights.priciestTitle": "有一個提示詞佔用了近期支出的 {{percent}}%",
  "usage.insights.priciestBody_other":
    "「{{prompt}}」耗費了 {{amount}}，共 {{count}} 步。",
  "usage.insights.untitledPrompt": "未命名提示詞",
  "usage.insights.promptsHeading": "提示詞",
  "usage.insights.showing": "顯示 {{count}} 個",
  "usage.insights.sortNewest": "最新",
  "usage.insights.sortCost": "花費最高",
  "usage.insights.emptyPrompts":
    "此時間段內還沒有提示詞。完成後幾秒就會顯示在這裡。",
  "usage.insights.promptNotSaved": "提示詞文字未儲存",
  "usage.insights.ratedHelpful": "評為有幫助",
  "usage.insights.ratedUnhelpful": "評為沒有幫助",
  "usage.insights.notRated": "未評分",
  "usage.insights.stoppedWithError": "因錯誤而停止",
  "usage.insights.detailsUnavailable": "步驟詳情已不可用",
  "usage.insights.answered": "已回答",
  "usage.insights.finished": "已完成",
  "usage.insights.startedOverShort": "重新開始 {{count}}×",
  "usage.insights.recoveredShort_other": "從 {{count}} 個工具錯誤中恢復",
  "usage.insights.toolsFailedShort_other": "{{count}} 個工具失敗",
  "usage.insights.headerDuration": "耗時 {{duration}}",
  "usage.insights.stepsCount_other": "{{count}} 步",
  "usage.insights.whatItDid": "執行內容：",
  "usage.insights.replyNotSaved": "此提示詞的回覆文字未儲存。",
  "usage.insights.showAll": "顯示全部",
  "usage.insights.showLess": "收起",
  "usage.insights.moreTools": "+{{count}} 更多",
  "usage.insights.failedSuffix": "失敗",
  "usage.insights.timesCount": "{{label}} ×{{count}}",
  "usage.insights.startedOverNote_other":
    "在{{reason}}後重新開始了 {{count}} 次，共花費約 {{total}} 中的 {{amount}}。",
  "usage.insights.toolFailedNote_other": "{{tool}} 工具失敗了 {{count}} 次。",
  "usage.insights.toolFailedRecoveredNote_other":
    "{{tool}} 工具失敗了 {{count}} 次，但代理繼續執行並完成了任務。",
  "usage.insights.showSteps_other": "顯示這 {{count}} 步",
  "usage.insights.hideSteps": "隱藏步驟",
  "usage.insights.costDetails": "費用詳情與檢查",
  "usage.insights.turnReply": "撰寫了回覆",
  "usage.insights.turnThought": "進行了思考",
  "usage.insights.startedOverTag": "重新開始",
  "usage.insights.toolFailedTag": "工具失敗",
  "usage.insights.turnContext":
    "傳送了 {{tokens}} 個上下文 token，其中 {{percent}}% 來自此前的複用。",
  "usage.insights.turnExpired": "儲存的上下文在暫停後已過期，這是正常現象。",
  "usage.insights.turnOutput": "生成了 {{tokens}} 個 token。",
  "usage.insights.turnRestart":
    "在{{reason}}後重新開始，比複用上下文多花費約 {{amount}}。",
  "usage.insights.noCacheCompare":
    "按標準價格計算，複用此前的上下文使該提示詞的費用從 {{noCache}} 降至 {{estimated}}。",
  "usage.insights.partReused": "複用的上下文",
  "usage.insights.partSaved": "已快取",
  "usage.insights.partNew": "新上下文",
  "usage.insights.partOutput": "模型生成",
  "usage.insights.checksHeading": "自動檢查",
  "usage.insights.checksNone": "沒有記錄任何檢查。",
  "usage.insights.checksGraded": "（由模型評分）",
  "usage.insights.checksNote":
    "框架檢查關注執行過程本身（錯誤、步驟、速度），而不判斷結果是否理想。",
  "usage.insights.lookedForTools": "查找了更多工具",
  "usage.insights.prevPrompt": "上一個提示詞 (K)",
  "usage.insights.nextPrompt": "下一個提示詞 (J)",
  "usage.insights.toolVerb.add": "新增了 {{object}}",
  "usage.insights.toolVerb.analyze": "分析了 {{object}}",
  "usage.insights.toolVerb.apply": "套用了 {{object}}",
  "usage.insights.toolVerb.capture": "擷取了 {{object}}",
  "usage.insights.toolVerb.check": "檢查了 {{object}}",
  "usage.insights.toolVerb.connect": "連線了 {{object}}",
  "usage.insights.toolVerb.create": "建立了 {{object}}",
  "usage.insights.toolVerb.delete": "刪除了 {{object}}",
  "usage.insights.toolVerb.duplicate": "複製了 {{object}}",
  "usage.insights.toolVerb.edit": "編輯了 {{object}}",
  "usage.insights.toolVerb.export": "匯出了 {{object}}",
  "usage.insights.toolVerb.fetch": "取得了 {{object}}",
  ...
  "usage.insights.toolVerb.move": "移動了 {{object}}",
  "usage.insights.toolVerb.navigate": "導航到了 {{object}}",
  "usage.insights.toolVerb.open": "開啟了 {{object}}",
  "usage.insights.toolVerb.present": "展示了 {{object}}",
  "usage.insights.toolVerb.propose": "提出了 {{object}}",
  "usage.insights.toolVerb.query": "查詢了 {{object}}",
  "usage.insights.toolVerb.read": "讀取了 {{object}}",
  "usage.insights.toolVerb.remove": "移除了 {{object}}",
  "usage.insights.toolVerb.rename": "重新命名了 {{object}}",
  "usage.insights.toolVerb.reply": "回覆了 {{object}}",
  "usage.insights.toolVerb.resolve": "解決了 {{object}}",
  "usage.insights.toolVerb.run": "執行了 {{object}}",
  "usage.insights.toolVerb.save": "儲存了 {{object}}",
  "usage.insights.toolVerb.search": "搜尋了 {{object}}",
  "usage.insights.toolVerb.send": "傳送了 {{object}}",
  "usage.insights.toolVerb.set": "設定了 {{object}}",
  "usage.insights.toolVerb.take": "截取了 {{object}}",
  "usage.insights.toolVerb.update": "更新了 {{object}}",
  "usage.insights.toolVerb.upload": "上傳了 {{object}}",
  "usage.insights.toolVerb.view": "檢視了 {{object}}",
  "usage.insights.toolVerb.write": "寫入了 {{object}}",
};
