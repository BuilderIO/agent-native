...
const messages: AgentChatTranslation = {
  ...
  "usage.insights.verdictSmooth": "문제없이 작동 중",
  "usage.insights.verdictLook_other": "확인해볼 점 {{count}}개",
  ...
  "usage.insights.avgPerPrompt": "프롬프트당 평균",
  "usage.insights.completed": "완료",
  "usage.insights.completedDetail": "최근 {{total}}개 중 {{done}}개",
  "usage.insights.completedRecovered_other":
    "최근 {{total}}개 중 {{done}}개(도구 오류 {{count}}건 복구 후)",
  "usage.insights.typicalTime": "일반적인 소요 시간",
  "usage.insights.median": "중앙값",
  "usage.insights.changeSame": "이전 기간과 동일",
  "usage.insights.changeUp": "↑ {{percent}}%(이전 기간 대비)",
  "usage.insights.changeDown": "↓ {{percent}}%(이전 기간 대비)",
  "usage.insights.kindProblem": "문제",
  "usage.insights.kindSaving": "절약",
  "usage.insights.kindInfo": "참고",
  "usage.insights.fixLabel": "해결 방법:",
  "usage.insights.openPrompt": "프롬프트 열기",
  "usage.insights.seePrompts_other": "프롬프트 {{count}}개 보기",
  "usage.insights.erroredTitle_other": "프롬프트 {{count}}개가 오류로 종료됨",
  "usage.insights.erroredBody": "에이전트가 완료되기 전에 멈췄습니다.",
  ...
  "usage.insights.toolFailedSaid": '표시된 오류: "{{error}}"',
  "usage.insights.toolFailedGeneric": "도구에서 오류가 발생했습니다.",
  ...
  "usage.insights.reasonToolLookup": "새 도구를 가져온",
  "usage.insights.reasonPrefixChanged": "지침 앞부분이 바뀐",
  ...
  "usage.insights.untitledPrompt": "제목 없는 프롬프트",
  "usage.insights.promptsHeading": "프롬프트",
  "usage.insights.showing": "{{count}}개 표시 중",
  "usage.insights.sortNewest": "최신순",
  "usage.insights.sortCost": "비용 높은순",
  "usage.insights.emptyPrompts":
    "이 기간에는 아직 프롬프트가 없습니다. 완료되면 몇 초 후 여기에 표시됩니다.",
  "usage.insights.promptNotSaved": "프롬프트 텍스트가 저장되지 않았습니다",
  "usage.insights.ratedHelpful": "도움됨으로 평가",
  "usage.insights.ratedUnhelpful": "도움 안 됨으로 평가",
  "usage.insights.notRated": "평가 없음",
  "usage.insights.stoppedWithError": "오류로 중단됨",
  "usage.insights.detailsUnavailable":
    "단계별 세부 정보는 더 이상 확인할 수 없습니다",
  "usage.insights.answered": "답변 완료",
  "usage.insights.finished": "종료",
  "usage.insights.startedOverShort": "{{count}}× 다시 시작",
  "usage.insights.recoveredShort_other": "도구 오류 {{count}}건에서 복구",
  "usage.insights.toolsFailedShort_other": "도구 {{count}}개 실패",
  "usage.insights.headerDuration": "{{duration}} 만에",
  "usage.insights.stepsCount_other": "{{count}}단계",
  "usage.insights.whatItDid": "수행한 작업:",
  "usage.insights.replyNotSaved":
    "이 프롬프트의 답변 텍스트는 저장되지 않았습니다.",
  "usage.insights.showAll": "전체 보기",
  "usage.insights.showLess": "간략히 보기",
  "usage.insights.moreTools": "+{{count}}개 더",
  "usage.insights.failedSuffix": "실패",
  ...
  "usage.insights.showSteps_other": "{{count}}단계 보기",
  "usage.insights.hideSteps": "단계 숨기기",
  "usage.insights.costDetails": "비용 세부 정보 및 점검",
  "usage.insights.turnReply": "답변 작성",
  "usage.insights.turnThought": "충분히 검토",
  "usage.insights.startedOverTag": "다시 시작",
  "usage.insights.toolFailedTag": "도구 실패",
  ...
  "usage.insights.turnOutput": "{{tokens}} 토큰을 출력했습니다.",
  ...
  "usage.insights.partReused": "재사용한 컨텍스트",
  "usage.insights.partSaved": "캐시에 저장",
  "usage.insights.partNew": "새 컨텍스트",
  "usage.insights.partOutput": "모델이 생성한 출력",
  "usage.insights.checksHeading": "자동 점검",
  "usage.insights.checksNone": "기록된 항목이 없습니다.",
  "usage.insights.checksGraded": "(모델이 채점함)",
  "usage.insights.checksNote":
    "프레임워크 점검은 결과가 좋았는지가 아니라 실행 과정(오류, 단계, 속도)을 확인합니다.",
  "usage.insights.lookedForTools": "도구 추가 조회",
  "usage.insights.prevPrompt": "이전 프롬프트 (K)",
  "usage.insights.nextPrompt": "다음 프롬프트 (J)",
  "usage.insights.toolVerb.add": "{{object}} 추가",
  "usage.insights.toolVerb.analyze": "{{object}} 분석",
  "usage.insights.toolVerb.apply": "{{object}} 적용",
  "usage.insights.toolVerb.capture": "{{object}} 캡처",
  "usage.insights.toolVerb.check": "{{object}} 확인",
  "usage.insights.toolVerb.connect": "{{object}} 연결",
  "usage.insights.toolVerb.create": "{{object}} 만들기",
  "usage.insights.toolVerb.delete": "{{object}} 삭제",
  "usage.insights.toolVerb.duplicate": "{{object}} 복제",
  "usage.insights.toolVerb.edit": "{{object}} 편집",
  "usage.insights.toolVerb.export": "{{object}} 내보내기",
  "usage.insights.toolVerb.fetch": "{{object}} 가져오기",
  "usage.insights.toolVerb.find": "{{object}} 찾기",
  "usage.insights.toolVerb.generate": "{{object}} 생성",
  "usage.insights.toolVerb.index": "{{object}} 색인화",
  "usage.insights.toolVerb.insert": "{{object}} 삽입",
  "usage.insights.toolVerb.list": "{{object}} 목록 조회",
  "usage.insights.toolVerb.move": "{{object}} 이동",
  "usage.insights.toolVerb.navigate": "{{object}} 이동",
  "usage.insights.toolVerb.open": "{{object}} 열기",
  "usage.insights.toolVerb.present": "{{object}} 제시",
  "usage.insights.toolVerb.propose": "{{object}} 제안",
  "usage.insights.toolVerb.query": "{{object}} 조회",
  "usage.insights.toolVerb.read": "{{object}} 읽기",
  "usage.insights.toolVerb.remove": "{{object}} 제거",
  "usage.insights.toolVerb.rename": "{{object}} 이름 변경",
  "usage.insights.toolVerb.reply": "{{object}} 답장",
  "usage.insights.toolVerb.resolve": "{{object}} 해결",
  "usage.insights.toolVerb.run": "{{object}} 실행",
  "usage.insights.toolVerb.save": "{{object}} 저장",
  "usage.insights.toolVerb.search": "{{object}} 검색",
  "usage.insights.toolVerb.send": "{{object}} 전송",
  "usage.insights.toolVerb.set": "{{object}} 설정",
  "usage.insights.toolVerb.take": "{{object}} 가져오기",
  "usage.insights.toolVerb.update": "{{object}} 업데이트",
  "usage.insights.toolVerb.upload": "{{object}} 업로드",
  "usage.insights.toolVerb.view": "{{object}} 보기",
  "usage.insights.toolVerb.write": "{{object}} 작성",
};
