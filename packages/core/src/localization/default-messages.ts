...
const messages = {
  ...
  dispatch: {
    ...
    transactionalEmail: {
      ...
      sendLogExcludeToFilter: "Exclude to…",
      sendLogFromFilter: "From contains…",
      sendLogExcludeFromFilter: "Exclude from…",
      sendLogAllTemplates: "All templates",
      sendLogExcludeTemplates: "Exclude templates",
      sendLogExcludedTemplatesCount_one: "Exclude 1 template",
      sendLogExcludedTemplatesCount_other: "Exclude {{count}} templates",
