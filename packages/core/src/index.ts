...
// Keep the historical root server exports as a compatibility facade. The
// server modules defer optional React UI loading, so this does not make the
// Node entry require React for headless consumers.
export {
  createServer,
  createSSEHandler,
  defineNitroPlugin,
