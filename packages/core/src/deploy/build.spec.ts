...
`,
  ...
  it("generates a manifest-based Cloudflare Pages static shell fallback", () => {
    ...
    expect(html).toContain("data-agent-native-session-bootstrap");
    expect(html).toContain('fetch("/docs/_agent-native/auth/session"');
    expect(html).toContain("window.__agentNativeSessionBootstrap");
