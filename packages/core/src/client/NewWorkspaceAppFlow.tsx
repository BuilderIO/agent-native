...
function buildNewWorkspaceAppPrompt(input: {
  ...
  return [
    ...
    ``,
    `Pick a UI template that fits the user's prompt — analytics, assets, brain, calendar, content, design, dispatch, forms, mail, slides, clips, or starter when the request needs custom UI but none of the domain templates fit.`,
    `Use the starter template as the blank add-UI scaffold only. Do not treat Starter as the required default for primitive/headless action-only workflows unless the user explicitly asks for a UI app.`,
