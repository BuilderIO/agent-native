...
function buildNewWorkspaceAppPrompt(input: {
  ...
  return [
    ...
    ``,
    `Pick a UI template that fits the user's prompt — analytics, assets, base, brain, calendar, chat, content, design, dispatch, forms, mail, slides, or clips when the request needs custom UI but none of the domain templates fit.`,
    `Use the base template as the minimal add-UI scaffold. Do not treat Base as the required default for primitive/headless agent workflows unless the user explicitly asks for a UI app.`,
    `If you use the base template, treat it as scaffolding only: the finished app must use the requested app's real name, home screen, navigation, package metadata, and manifest, and it must not leave visible "Base", "Chat", "Starter", "Blank app", or "New app" UI behind.`,
