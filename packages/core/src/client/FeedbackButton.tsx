        ...
        <TooltipPrimitive.Root>
          ...
          <TooltipPrimitive.Portal>
            <TooltipPrimitive.Content
              sideOffset={6}
              className="z-[100040] overflow-hidden rounded-md border border-border bg-popover px-2 py-1 text-[11px] text-foreground shadow-md animate-in fade-in-0 zoom-in-95 origin-[--radix-tooltip-content-transform-origin]"
            >
              {resolvedLabel}
            </TooltipPrimitive.Content>
          </TooltipPrimitive.Portal>
