...
const FIELD_LABELS: Record<ShaderFieldKey, string> = {
  ...
  scaleWidth: "Max scale width (px)",
  centerX: "Center X",
  centerY: "Center Y",
  lightPitch: "Light pitch",
  lightYawStart: "Light start angle (deg)",
  lightYawEnd: "Light end angle (deg)",
  lightSpeed: "Light animation speed",
