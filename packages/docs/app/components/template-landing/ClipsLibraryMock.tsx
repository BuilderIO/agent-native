...
const CLIPS_MOCK_CSS = [
  ...
  ".clips-mock .library-new-recording { margin-bottom: 6px; padding: 7px 0; border-radius: 6px; background: #f2f2f2; color: #171717; font-size: 12.5px; font-weight: 600; text-align: center; }",
  ...
  ".clips-mock .primary { width: 100%; border-radius: var(--radius); padding: 12px 16px; background: var(--brand); color: var(--bg); font-size: 14px; font-weight: 600; display: inline-flex; align-items: center; justify-content: center; gap: 10px; height: 44px; box-shadow: 0 1px 2px rgba(0, 0, 0, 0.2); }",
