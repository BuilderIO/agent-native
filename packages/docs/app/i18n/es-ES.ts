...
const esES = {
  ...
  templateDetail: {
    ...
    notFoundBody: "Explore el catálogo de plantillas para encontrar una aplicación disponible.",
  ...
  legal: {
    ...
    privacy: {
      ...
      paragraphs: {
        ...
        scope2Suffix: "para el comportamiento de la aplicación alojada Agent-Native.",
        clips1:
      ...
      uses: {
        ...
        comply: "Cumplir con las obligaciones legales, de seguridad y de plataforma.",
      },
      links: {
    ...
    terms: {
      ...
      paragraphs: {
        ...
        scope2Prefix: "Estos términos complementan los términos más amplios de Builder.io.",
        ...
        disclaimers2Suffix:
          "u otro acuerdo escrito que se aplique a su uso.",
        changes1:
