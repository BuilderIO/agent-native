...
const deDE = {
  ...
  templateLanding: {
    ...
    design: {
      ...
      s007: "Erstellen Sie interaktive Designs und Prototypen. Verfeinern Sie sie mit gewohnten Werkzeugen oder fragen Sie einfach den Agenten. Exportieren Sie überall hin.",
