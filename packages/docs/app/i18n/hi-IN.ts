  ...
  templateLanding: {
    ...
    slides: {
      ...
      tryNow: {
        ...
        composerLabel: "प्रेज़ेंटेशन बनाने का प्रॉम्प्ट",
        uploadToSlides: "फ़ाइलें अपलोड करने के लिए Slides खोलें",
        modelLabel: "मॉडल",
        modelDefault: "डिफ़ॉल्ट मॉडल",
        ...
        animatedPrompt1: "रनिंग शू लॉन्च के लिए nike.com की शैली में एक डेक।",
        animatedPrompt2:
          "तटीय सफ़ाई गैर-लाभकारी संस्था के लिए Patagonia की शैली में फ़ंडरेज़िंग डेक।",
        animatedPrompt3:
          "Nvidia की निवेशक फाइलिंग से पिछली चार तिमाहियाँ, nvidia.com की शैली में।",
        animatedPrompt4: "AI सपोर्ट प्लेटफ़ॉर्म के लिए stripe.co की शैली में सेल्स डेक।",
        animatedPrompt5:
          "Census और Zillow के शोध डेटा के साथ अमेरिकी आवास बाज़ार का सारांश।",
        animatedPrompt6: "MBA छात्रों के लिए apple.com की शैली में LLM का परिचय।",
        promptPlaceholder:
          "इस प्रॉम्प्ट को बदलें: नीचे पेस्ट किए गए डेटा या नोट्स से [दर्शक] के लिए [उद्देश्य] हेतु ब्रांड के अनुरूप डेक बनाएँ: [डेटा या नोट्स यहाँ पेस्ट करें]।",
        sectionHeading: "अपने डेटा से तुरंत ब्रांड के अनुरूप डेक बनाएँ:",
