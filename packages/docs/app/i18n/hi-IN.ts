...
const hiIN = {
  ...
  templateLanding: {
    ...
    analytics: {
      ...
      keyFeaturesHeading: "क्वेरी करने, विज़ुअलाइज़ करने और एक्सप्लोर करने के लिए जो भी चाहिए",
    ...
    calendar: {
      faq: {
        ...
        question4:
          "क्या मेरे साथ मीटिंग बुक करने के लिए लोगों को अकाउंट चाहिए?",
        answer4:
        ...
        question5:
          "क्या कोई बुकिंग लिंक कई होस्ट के लिए उपलब्धता चेक कर सकता है?",
        answer5:
      ...
      keyFeaturesEyebrow: "मुख्य फीचर्स",
      keyFeaturesHeading:
        "शेड्यूल करने, बुक करने और रीशेड्यूल करने के लिए जो भी चाहिए",
    ...
    assets: {
      faq: {
        ...
        question5: "क्या Assets जनरेट की गई इमेजेस में मेरा असली लोगो इस्तेमाल कर सकता है?",
        answer5:
      ...
      keyFeaturesEyebrow: "मुख्य फीचर्स",
      keyFeaturesHeading: "जनरेट करने, बेहतर बनाने और दोबारा इस्तेमाल करने के लिए जो भी चाहिए",
    ...
    content: {
      faq: {
        ...
        question4: "क्या Content टास्क्स ट्रैक कर सकता है और टीम रिक्वेस्ट्स कलेक्ट कर सकता है?",
        answer4:
    ...
    plan: {
      faq: {
        ...
        question3:
          "क्या मेरा एजेंट मेरे कमेंट्स के आधार पर प्लान रिवाइज़ कर सकता है?",
        answer3:
