...
const hiIN = {
  ...
  templateLanding: {
    ...
    analytics: {
      ...
      heroDescription:
        "गोदाम, उत्पाद और राजस्व डेटा को एक साथ लाएँ। एजेंट आपकी मीट्रिक परिभाषाओं की जाँच करता है, SQL लिखता है, और उत्तर को पुन: प्रयोज्य डैशबोर्ड में बदल देता है।",
      heroCta: "अपना डेटा एक्सप्लोर करें",
      useCasesHeading: "मीट्रिक से सत्र तक संकेत का पालन करें",
      useCasesBody:
        "प्रत्येक परिणाम के साथ तर्क रखें, फिर एक चार्ट को डैशबोर्ड या सत्र जांच में ले जाएं।",
      useCase1Title: "सक्रियण में परिवर्तन को समझाइये",
      useCase1Body:
        "बातचीत में समूहों और चैनलों की तुलना करें. एजेंट आपकी प्रलेखित मीट्रिक परिभाषाओं का उपयोग करता है, क्वेरी लिखता है, और परिवर्तन के पीछे के सबूत दिखाता है।",
      useCase2Title: "एक जीवंत राजस्व समीक्षा बनाएँ",
      useCase2Body:
        "एजेंट से बिलिंग, सीआरएम, या वेयरहाउस मेट्रिक्स को डैशबोर्ड में संयोजित करने के लिए कहें। फ़िल्टर और पैनल आपकी अगली समीक्षा के लिए बने रहेंगे।",
      useCase3Title: "वास्तविक सत्र के लिए एक मीट्रिक ट्रेस करें",
      useCase3Body:
        "स्पाइक या त्रुटि से उसके पीछे के सत्र की ओर बढ़ें। कंसोल और नेटवर्क गतिविधि का निरीक्षण करें, फिर एजेंट के साथ अस्थायी निदान संदर्भ साझा करें।",
      keyFeaturesEyebrow: "मुख्य फीचर्स",
      keyFeaturesHeading:
        "क्वेरी करने, विज़ुअलाइज़ करने और एक्सप्लोर करने के लिए जो भी चाहिए",
      feature1Title: "कनेक्टेड डेटा के बारे में पूछें",
      feature1Body:
        "गोदाम, उत्पाद और राजस्व स्रोतों पर एक प्रश्न पूछें। एजेंट उत्तर को एक चार्ट में बदल देता है और अनुवर्ती विश्लेषण का समर्थन करता है।",
      feature2Title: "डैशबोर्ड को एजेंट संपादित कर सकता है",
      feature2Body:
        "एजेंट से पैनल, फिल्टर और ब्रेकडाउन जोड़ने या दोबारा आकार देने को कहें। परिवर्तन एक पुन: प्रयोज्य डैशबोर्ड में रहते हैं जिसे आपकी टीम साझा कर सकती है।",
      feature3Title: "दृश्यमान SQL और मीट्रिक संदर्भ",
      feature3Body:
        "किसी परिणाम के पीछे की क्वेरी और उसे लिखने के लिए उपयोग की गई मीट्रिक परिभाषा का निरीक्षण करें। जब आपको अधिक नियंत्रण की आवश्यकता हो तो SQL को परिष्कृत करें।",
      feature4Title: "डेटा स्रोतों के लिए एक कार्यक्षेत्र",
      feature4Body:
        "BigQuery, GA4, उत्पाद विश्लेषण, हबस्पॉट और स्ट्राइप को कनेक्ट करें, फिर उसी ऐप से उनके अनुमत डेटा का पता लगाएं।",
      feature5Title: "एजेंट जिन परिभाषाओं का अनुसरण करता है",
      feature5Body:
        "दस्तावेज़ मीट्रिक नियम, जोड़, उदाहरण और ज्ञात गोचर। जब एनालिटिक्स एजेंट प्रश्न लिखता है तो वह उसे वह संदर्भ देता है।",
      feature6Title: "डायग्नोस्टिक्स के साथ सत्र पुनः खेलना",
      feature6Body:
        "कंसोल और नेटवर्क इवेंट को ध्यान में रखते हुए त्रुटि से रिकॉर्डिंग की ओर बढ़ें। एजेंट-सहायता प्राप्त जांच के लिए एक अस्थायी डायग्नोस्टिक लिंक साझा करें।",
    ...
    calendar: {
      ...
      heroTitle: "समय निकालें, मीटिंग बुक करें और एक एजेंट के साथ अपने दिन को अनुकूलित करें",
      heroDescription:
        "कैलेंडर आपके Google कैलेंडर और उपलब्धता नियमों को एक साथ लाता है ताकि एजेंट साझा उद्घाटन ढूंढ सके, बुकिंग तैयार कर सके और घटनाओं को अपडेट करने में मदद कर सके।",
      heroCta: "शेड्यूलिंग शुरू करें",
      useCasesHeading: "एजेंट को शेड्यूलिंग विवरण संभालने दें",
      useCasesBody:
        "सभी कैलेंडरों में वास्तविक उपलब्धता की जाँच करें, फिर मीटिंग बनाने या स्थानांतरित करने से पहले एक स्पष्ट प्रस्ताव की समीक्षा करें।",
      useCase1Title: "बुकिंग लिंक को तैयार मीटिंग में बदलें",
      useCase1Body:
        "केवल वही समय ऑफ़र करें जो काम के घंटों, नोटिस और बफ़र्स का सम्मान करता हो। आपको आवश्यक विवरण एकत्र करें, फिर अतिथि के बुक करने पर वीडियो लिंक जोड़ें।",
      useCase2Title: "ऐसा स्लॉट ढूंढें जिसे हर कोई बना सके",
      useCase2Body:
        "एजेंट से सहभागी के खाली/व्यस्त समय और कैलेंडर ओवरले की तुलना करने के लिए कहें। यह साझा उद्घाटन और उसके द्वारा जाँचे गए कैलेंडर लौटाता है।",
      useCase3Title: "धागा खोए बिना पुनर्निर्धारित करें",
      useCase3Body:
        "बाद में समय मांगें और एजेंट को मेहमानों की जांच करने दें, मीटिंग विवरण सुरक्षित रखें और अपनी समीक्षा के लिए अद्यतन आमंत्रण तैयार करें।",
      keyFeaturesEyebrow: "मुख्य फीचर्स",
      keyFeaturesHeading: "शेड्यूल करने, बुक करने और रीशेड्यूल करने के लिए जो भी चाहिए",
      feature1Title: "प्राकृतिक-भाषा शेड्यूलिंग",
      feature1Body:
        "एजेंट से उपलब्धता की जांच करने, एक समय प्रस्तावित करने और अपने मेहमानों और बैठक के विवरण के साथ एक कार्यक्रम बनाने या स्थानांतरित करने के लिए कहें।",
      feature2Title: "सभी खातों में उपलब्धता",
      feature2Body:
        "कनेक्टेड Google कैलेंडर को एक साथ देखें और शेड्यूल संदर्भ के रूप में केवल पढ़ने योग्य फ़ीड शामिल करें।",
      feature3Title: "सेवन के साथ बुकिंग पेज",
      feature3Body:
        "विभिन्न प्रकार की मीटिंग के लिए लिंक बनाएं, अवधि और बुकिंग प्रश्न निर्धारित करें और मेहमानों को उपलब्ध स्लॉट चुनने दें।",
      feature4Title: "नियम जो हर स्लॉट को आकार देते हैं",
      feature4Body:
        "काम के घंटे, बफ़र्स, नोटिस, समय क्षेत्र और बुकिंग क्षितिज निर्धारित करें ताकि सुझाए गए और सार्वजनिक समय आपके शेड्यूल के अनुरूप हों।",
      feature5Title: "वास्तविक मल्टी-होस्ट जाँच",
      feature5Body:
        "आवश्यक सह-मेजबान जोड़ें और समय देने से पहले उनकी खाली/व्यस्त उपलब्धता की जांच करें। कॉन्फ़िगर होने पर कैलेंडर साझा कार्य-घंटे ओवरले का भी सम्मान करता है।",
      feature6Title: "एजेंट-प्रबंधित मीटिंग फॉलो-थ्रू",
      feature6Body:
        "जब एजेंट ईवेंट परिवर्तन और अद्यतन आमंत्रण तैयार करता है तो Google मीट या ज़ूम विवरण संलग्न रखें।",
    ...
    assets: {
      ...
      heroDescription:
        "वर्णन करें कि आपको क्या चाहिए, अपने एजेंट को एक ब्रांड किट या संदर्भ दें, और बातचीत के साथ-साथ उत्पन्न विविधताओं की तुलना करें।",
    ...
    chat: {
      ...
      heroDescription:
        "टिकाऊ थ्रेड्स, प्रमाणीकरण, साझा क्रियाओं और एक एजेंट के साथ एक मुफ़्त और ओपन-सोर्स चैट स्टार्टर जिसे आप अपने टूल और स्क्रीन के साथ बढ़ा सकते हैं।",
      heroCta: "अपना चैट बनाएं",
      heroSecondaryCta: "Chat खोलें",
      useCasesHeading: "बातचीत को कामकाजी सहायकों में बदलें",
      useCasesBody:
        "ऐसी कार्रवाइयां, डेटा और स्क्रीन जोड़ें जो आपके एजेंट को सवालों के जवाब देने और काम को आगे बढ़ाने दें।",
      useCase1Title: "अपनी टीम के संदर्भ के साथ प्रश्नों के उत्तर दें",
      useCase1Body:
        "कार्यों के माध्यम से आपके ऐप के लिए आवश्यक स्रोतों को कनेक्ट करें, फिर एजेंट को नोट्स, फ़ाइलें और प्रोजेक्ट विवरण एक उत्तर में लाने दें।",
      useCase2Title: "अपने एजेंट को कार्य करने के लिए उपकरण दें",
      useCase2Body:
        "चैट में वर्कफ़्लो को प्रोटोटाइप करें, आपके द्वारा परिभाषित क्रियाओं को कॉल करें और एजेंट प्रत्येक चरण को कैसे संभालता है, इसे परिष्कृत करें।",
      useCase3Title: "परिणामों को प्रयोग योग्य बनाएं",
      useCase3Body:
        "ओपन एजेंट एक कतार, तालिका या संपादक में काम करता है ताकि लोग उसी साझा डेटा का निरीक्षण और जारी रख सकें।",
      keyFeaturesEyebrow: "मुख्य विशेषताएँ",
      keyFeaturesHeading: "आपके agent और उसके interface के लिए एक शुरुआती आधार",
      feature1Title: "टिकाऊ बातचीत",
      feature1Body:
        "शामिल इतिहास साइडबार से थ्रेड बनाएं, दोबारा खोलें, नाम बदलें, पिन करें और संग्रहित करें।",
      feature2Title: "पूरे पेज की एजेंट चैट",
      feature2Body:
        "चैट सतह और रनटाइम से शुरुआत करें, अपने निर्देशों, टूल और वर्कफ़्लो के लिए तैयार रहें।",
      feature3Title: "अपनी स्वयं की सेवाएँ कनेक्ट करें",
      feature3Body:
        "ग्रेनोला, लीनियर, ड्राइव, या नोशन जैसे टूल के लिए प्रदाता क्रियाएं और कनेक्शन प्रवाह जोड़ें; स्टार्टर उन एकीकरणों को आपके ऐप पर छोड़ देता है।",
      feature4Title: "साझा क्रियाएं",
      feature4Body: "एजेंट टूल और इंटरफ़ेस संचालन को एक ही क्रिया सतह पर रखें।",
      feature5Title: "लाइव कार्यस्थल स्थिति",
      feature5Body:
        "उपयोगकर्ता और एजेंट के लिए वर्तमान नेविगेशन और चयनित कार्य को सिंक्रनाइज़ रखें।",
      feature6Title: "कस्टम स्क्रीन",
      feature6Body:
        "जब किसी वार्तालाप को कतार, संपादक या अन्य डोमेन इंटरफ़ेस की आवश्यकता हो तो केंद्रित दृश्य जोड़ें।",
    ...
    mail: {
      ...
      useCase1Title: "Jev से संचालित एक स्मार्ट इनबॉक्स",
      useCase1Body:
      ...
      feature1Title: "प्राथमिकता छँटाई",
      feature1Body:
        "आने वाले थ्रेड्स को तात्कालिकता और संदर्भ के आधार पर रैंक करें, ताकि समय सीमा और उत्तर की प्रतीक्षा कर रहे लोग शीर्ष पर पहुंच जाएं।",
      feature2Title: "प्रासंगिक एआई लेबल",
      feature2Body:
        "संदेशों को इस आधार पर वर्गीकृत करें कि बातचीत किस बारे में है, फिर मिलते-जुलते मेल आते ही उन्हें समूहीकृत रखें।",
      feature3Title: "एजेंट द्वारा संचालित इनबॉक्स",
      feature3Body:
        "जिस इनबॉक्स को आप देख रहे हैं, उसमें से एजेंट को खोजने, सारांशित करने, लेबल लगाने, संग्रह करने, तारांकित करने या उत्तर तैयार करने के लिए कहें।",
      feature4Title: "पृष्ठभूमि स्वचालन",
      feature4Body:
        "आने वाले संदेशों पर सरल भाषा के नियम लागू करें और मेल द्वारा की गई कार्रवाइयों का निरीक्षण करें।",
