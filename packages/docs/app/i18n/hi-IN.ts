...
const hiIN = {
  ...
  legal: {
    ...
    resources: {
      ...
      intro:
        "Agent-Native, Builder.io द्वारा संचालित होस्ट किए गए उदाहरणों के लिए एक केंद्रित पूरक रखता है और Builder.io की साझा नीतियों को उनके आधिकारिक स्रोत से जोड़ता है। फ्रेमवर्क स्वयं ओपन सोर्स है और ये होस्टेड-सेवा पृष्ठ forks या self-hosted deployments पर लागू नहीं होते।",
      agentNative: {
      ...
      builder: {
        title: "Builder.io की वर्तमान साझा नीतियां",
        body: "Builder.io की ये नीतियां होस्टेड सेवाओं, सामग्री, AI सुविधाओं, सुरक्षा, बौद्धिक संपदा और कानूनी अनुरोधों के लिए साझा नियम देती हैं। वर्तमान पाठ के लिए लिंक किए गए आधिकारिक स्रोत को देखें।",
      },
      links: {
      ...
      notIncluded: {
        ...
        body: "Agent-Native में कोई paid plans या enterprise contract नहीं है। Enterprise SLA, support terms, DPA, security addenda और professional-services terms जैसे Builder.io के वाणिज्यिक दस्तावेज़ अलग लिखित समझौते के बिना होस्ट किए गए उदाहरणों का हिस्सा नहीं हैं।",
      },
    },
    privacy: {
