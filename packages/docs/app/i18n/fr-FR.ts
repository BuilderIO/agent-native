...
const frFR = {
  ...
  templateDetail: {
    ...
    notFoundBody: "Parcourez le catalogue de modèles pour trouver une application disponible.",
  ...
  templates: {
    ...
    chat: {
      replaces: "Une application minimale de style ChatGPT pour votre propre agent",
      description:
  ...
  legal: {
    ...
    privacy: {
      ...
      paragraphs: {
        ...
        scope2Suffix: "pour le comportement de l’application hébergée Agent-Native.",
        clips1:
      ...
      uses: {
        ...
        comply: "Respectez les obligations légales, de sécurité et de plateforme.",
      },
      links: {
    ...
    terms: {
      ...
      paragraphs: {
        ...
        scope2Prefix: "Ces termes complètent la définition plus large de Builder.io",
