...
const koKR = {
  ...
  templateLanding: {
    ...
    mail: {
      ...
      heroDescription:
        "Mail은 다음 단계를 수행할 수 있는 상담원을 통해 우선순위 정렬, 상황 인식 라벨, 스레드 요약, 백그라운드 규칙을 하나의 키보드 우선 Gmail 받은편지함에 제공합니다.",
      heroCta: "받은편지함 관리하기",
      useCasesHeading: "메일이 첫 번째 패스를 받도록 하세요",
      useCasesBody:
        "긴급한 스레드를 표시하고, 메시지에 의미별로 라벨을 지정하고, 반복적인 받은 편지함 작업을 계속 진행하면서 제어할 수 있습니다.",
      useCase1Title: "오늘 당신에게 필요한 것이 무엇인지 확인하세요",
      useCase1Body:
        "Mail은 긴급성, 마감일, 기다리는 사람을 기준으로 스레드의 순위를 매긴 다음, 다음 유용한 작업이 포함된 받은 편지함 개요를 제공합니다.",
      useCase2Title: "의미별로 메시지에 라벨을 지정하세요.",
      useCase2Body:
        "상담원은 발신자 및 대화 컨텍스트의 라벨을 적용할 수 있으므로 연구, 재무 및 고객 스레드를 쉽게 찾을 수 있습니다.",
      ...
      feature6Title: "다중 계정 검색",
      feature6Body:
        "연결된 Gmail 계정을 검색하고 한 곳에서 동일한 우선순위, 라벨, 에이전트 도구를 사용하세요.",
