...
export const Route = createFileRoute('/templates/calendar')({
  component: CalendarTemplate,
  head: () => ({
    meta: [
      { title: 'AI-Native Calendar — Open Source Alternative to Google Calendar & Calendly' },
      { name: 'description', content: 'Build an AI-powered calendar you own. Open source alternative to Google Calendar and Calendly. Google Calendar sync, public booking pages, configurable availability, and natural language scheduling.' },
      { property: 'og:title', content: 'AI-Native Calendar — Open Source Alternative to Google Calendar & Calendly' },
      { property: 'og:description', content: 'Build an AI-powered calendar you own. Google Calendar sync, public booking pages, and natural language scheduling.' },
      { name: 'keywords', content: 'AI calendar, open source calendar, Google Calendar alternative, Calendly alternative, AI scheduling, agent-native calendar, AI booking page, open source scheduling, AI appointment booking, natural language scheduling' },
    ],
  }),
})
    ...
    <main className="mx-auto max-w-[1200px] px-6">
      ...
      <section className="py-20">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
          ...
          <div className="overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)]">
            <img src={template.screenshot} alt="Calendar template screenshot" className="w-full object-cover object-top" />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-[var(--border)] py-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
            ...
            <h3 className="mb-1 text-sm font-semibold">Multiple Calendar Views</h3>
            <p className="m-0 text-sm text-[var(--fg-secondary)]">Month, week, and day views with drag-and-drop event management.</p>
          </div>
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
            <div className="mb-3 text-[var(--accent)]">
            ...
            <h3 className="mb-1 text-sm font-semibold">Natural Language Scheduling</h3>
            <p className="m-0 text-sm text-[var(--fg-secondary)]">Tell the agent to find a slot, create an event, or reschedule — it handles the rest.</p>
          </div>
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
            <div className="mb-3 text-[var(--accent)]">
            ...
            <p className="m-0 text-sm text-[var(--fg-secondary)]">Calendly-style booking at /book/meeting. Visitors pick a slot from your availability.</p>
          </div>
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-5">
            <div className="mb-3 text-[var(--accent)]">
            ...
            <p className="m-0 text-sm text-[var(--fg-secondary)]">The agent modifies the app itself. Need a new view or booking flow? Just ask.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-[var(--border)] py-16">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-[var(--border)] p-6">
            <h3 className="mb-2 text-base font-semibold">Google Calendar Sync</h3>
            <p className="mb-4 text-sm text-[var(--fg-secondary)]">Connect via OAuth 2.0 and pull events from any Google Calendar. Create events that sync back to Google.</p>
          ...
          <div className="rounded-xl border border-[var(--border)] p-6">
            <h3 className="mb-2 text-base font-semibold">Calendly-Style Booking</h3>
            <p className="mb-4 text-sm text-[var(--fg-secondary)]">A public page where anyone can book time with you based on your configured availability.</p>
            <ul className="m-0 list-none space-y-2 p-0 text-sm text-[var(--fg-secondary)]">
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 shrink-0 text-[var(--accent)]" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
      ...
      <section className="border-t border-[var(--border)] py-16">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="mb-3 text-2xl font-bold tracking-tight">Agent-powered scheduling</h2>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-6">
            <div className="space-y-3 font-mono text-sm">
              <div className="text-[var(--fg-secondary)]">{'// Available agent scripts'}</div>
              <div><span className="text-[var(--accent)]">$</span> <span className="text-[var(--fg)]">pnpm script sync-google-calendar --from 2026-01-01 --to 2026-06-01</span></div>
              <div><span className="text-[var(--accent)]">$</span> <span className="text-[var(--fg)]">pnpm script create-event --title "Team Standup" --start "2026-03-15T09:00"</span></div>
              <div><span className="text-[var(--accent)]">$</span> <span className="text-[var(--fg)]">pnpm script check-availability --date "2026-03-18" --duration 30</span></div>
              <div><span className="text-[var(--accent)]">$</span> <span className="text-[var(--fg)]">pnpm script list-events --from "2026-03-14" --to "2026-03-21"</span></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <table className="comparison-table w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--border)] bg-[var(--bg-secondary)]">
                ...
                <th className="px-5 py-3 text-left font-semibold text-[var(--fg-secondary)]">Google Calendar</th>
                <th className="px-5 py-3 text-left font-semibold text-[var(--fg-secondary)]">Calendly</th>
                <th className="px-5 py-3 text-left font-semibold text-[var(--accent)]">Agent-Native Calendar</th>
              </tr>
            </thead>
            <tbody className="text-[var(--fg-secondary)]">
              <tr className="border-b border-[var(--border)]">
                <td className="px-5 py-3 font-medium text-[var(--fg)]">Calendar UI</td>
                <td className="px-5 py-3">Full, rigid</td>
                <td className="px-5 py-3">Minimal</td>
                <td className="px-5 py-3 text-[var(--fg)]">Full, fully customizable</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-5 py-3 font-medium text-[var(--fg)]">AI scheduling</td>
                <td className="px-5 py-3">None</td>
                <td className="px-5 py-3">None</td>
                <td className="px-5 py-3 text-[var(--fg)]">Natural language, full control</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-5 py-3 font-medium text-[var(--fg)]">Booking page</td>
                <td className="px-5 py-3">Appointment slots</td>
                <td className="px-5 py-3">Yes, limited branding</td>
                <td className="px-5 py-3 text-[var(--fg)]">Fully customizable, own domain</td>
              </tr>
              <tr className="border-b border-[var(--border)]">
