...
for the heartbeat, local-change ownership checks, review handling, conflict
recovery, and cadence. A lease only serializes durable watchers; lease
contention, read failures, or renewal failures never stop foreground shipping.
Continue the requested work here and manage only this task's watcher.
